...
from .. import (
    PublicIPAddressDnsSettings as _PublicIPAddressDnsSettings_d52a1111,
    PublicIPAddressProps as _PublicIPAddressProps_7be7fd0e,
    PublicIPAddressSku as _PublicIPAddressSku_c78fb223,
)
...
class PublicIPAddress(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        dns_settings: typing.Optional[typing.Union[_PublicIPAddressDnsSettings_d52a1111, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        sku: typing.Optional[typing.Union[_PublicIPAddressSku_c78fb223, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        props = _PublicIPAddressProps_7be7fd0e(
    ...
    def props(self) -> _PublicIPAddressProps_7be7fd0e:
        '''The input properties for this Public IP Address instance.'''
        return typing.cast(_PublicIPAddressProps_7be7fd0e, jsii.get(self, "props"))
...
class PublicIPAddressProps(_AzapiResourceProps_141a2340):
    def __init__(
        ...
        *,
        ...
        if isinstance(dns_settings, dict):
            dns_settings = _PublicIPAddressDnsSettings_d52a1111(**dns_settings)
        if isinstance(sku, dict):
            sku = _PublicIPAddressSku_c78fb223(**sku)
        if __debug__:
    ...
    @builtins.property
    def dns_settings(self) -> typing.Optional[_PublicIPAddressDnsSettings_d52a1111]:
        ...
        return typing.cast(typing.Optional[_PublicIPAddressDnsSettings_d52a1111], result)
    ...
    @builtins.property
    def sku(self) -> typing.Optional[_PublicIPAddressSku_c78fb223]:
        '''SKU of the public IP address Standard SKU supports zones and has SLA guarantees Basic SKU does not support zones.'''
        result = self._values.get("sku")
        return typing.cast(typing.Optional[_PublicIPAddressSku_c78fb223], result)
