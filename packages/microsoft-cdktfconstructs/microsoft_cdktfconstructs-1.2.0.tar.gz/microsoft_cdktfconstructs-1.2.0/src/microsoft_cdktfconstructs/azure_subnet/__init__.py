...
class Subnet(
    ...
    **Child Resource Pattern**: Subnets are child resources of Virtual Networks.
    ...
    def _create_azapi_resource(
        ...
        name: builtins.str,
        _location: typing.Optional[builtins.str] = None,
    ) -> _cdktf_9a9027ec.TerraformResource:
        '''Override createAzapiResource to explicitly prevent location from being added Subnets are child resources and inherit location from their parent VNet.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ff5b9845b8eff2ccd660b81430e1ce64f6a282cbe21acd14dd619dc551e5c62f)
            check_type(argname="argument properties", value=properties, expected_type=type_hints["properties"])
            check_type(argname="argument parent_id", value=parent_id, expected_type=type_hints["parent_id"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument _location", value=_location, expected_type=type_hints["_location"])
        return typing.cast(_cdktf_9a9027ec.TerraformResource, jsii.invoke(self, "createAzapiResource", [properties, parent_id, name, _location]))
...
def _typecheckingstub__ff5b9845b8eff2ccd660b81430e1ce64f6a282cbe21acd14dd619dc551e5c62f(
    properties: typing.Mapping[builtins.str, typing.Any],
    parent_id: builtins.str,
    name: builtins.str,
    _location: typing.Optional[builtins.str] = None,
