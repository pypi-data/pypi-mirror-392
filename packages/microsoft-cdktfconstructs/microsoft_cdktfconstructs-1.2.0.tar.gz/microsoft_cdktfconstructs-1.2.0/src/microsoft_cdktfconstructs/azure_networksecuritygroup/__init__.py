...
from .. import (
    NetworkSecurityGroupProps as _NetworkSecurityGroupProps_ab9a4a01,
    SecurityRule as _SecurityRule_096c68e4,
    SecurityRuleProperties as _SecurityRuleProperties_662089a5,
)
...
class NetworkSecurityGroup(
    ...
    def __init__(
        ...
        *,
        ...
        security_rules: typing.Optional[typing.Sequence[typing.Union[_SecurityRule_096c68e4, typing.Dict[builtins.str, typing.Any]]]] = None,
        ...
        props = _NetworkSecurityGroupProps_ab9a4a01(
    ...
    def props(self) -> _NetworkSecurityGroupProps_ab9a4a01:
        '''The input properties for this Network Security Group instance.'''
        return typing.cast(_NetworkSecurityGroupProps_ab9a4a01, jsii.get(self, "props"))
...
class NetworkSecurityGroupProps(_AzapiResourceProps_141a2340):
    ...
    @builtins.property
    def security_rules(self) -> typing.Optional[typing.List[_SecurityRule_096c68e4]]:
        ...
        return typing.cast(typing.Optional[typing.List[_SecurityRule_096c68e4]], result)
...
class SecurityRule:
    def __init__(
        ...
        *,
        name: builtins.str,
        properties: typing.Union[_SecurityRuleProperties_662089a5, typing.Dict[builtins.str, typing.Any]],
    ) -> None:
        ...
        if isinstance(properties, dict):
            properties = _SecurityRuleProperties_662089a5(**properties)
        if __debug__:
    ...
    @builtins.property
    def properties(self) -> _SecurityRuleProperties_662089a5:
        '''Properties of the security rule.'''
        result = self._values.get("properties")
        assert result is not None, "Required property 'properties' is missing"
        return typing.cast(_SecurityRuleProperties_662089a5, result)
