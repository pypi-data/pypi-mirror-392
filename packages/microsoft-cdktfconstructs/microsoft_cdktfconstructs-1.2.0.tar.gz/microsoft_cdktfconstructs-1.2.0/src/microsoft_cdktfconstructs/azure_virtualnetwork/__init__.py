...
from .. import (
    VirtualNetworkAddressSpace as _VirtualNetworkAddressSpace_8441d676,
    VirtualNetworkDhcpOptions as _VirtualNetworkDhcpOptions_1875d990,
    VirtualNetworkProps as _VirtualNetworkProps_69b0d21b,
)
...
class VirtualNetwork(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        address_space: typing.Union[_VirtualNetworkAddressSpace_8441d676, typing.Dict[builtins.str, typing.Any]],
        dhcp_options: typing.Optional[typing.Union[_VirtualNetworkDhcpOptions_1875d990, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        props = _VirtualNetworkProps_69b0d21b(
    ...
    def props(self) -> _VirtualNetworkProps_69b0d21b:
        '''The input properties for this Virtual Network instance.'''
        return typing.cast(_VirtualNetworkProps_69b0d21b, jsii.get(self, "props"))
...
class VirtualNetworkProps(_AzapiResourceProps_141a2340):
    def __init__(
        ...
        *,
        ...
        if isinstance(address_space, dict):
            address_space = _VirtualNetworkAddressSpace_8441d676(**address_space)
        if isinstance(dhcp_options, dict):
            dhcp_options = _VirtualNetworkDhcpOptions_1875d990(**dhcp_options)
        if __debug__:
    ...
    @builtins.property
    def address_space(self) -> _VirtualNetworkAddressSpace_8441d676:
        ...
        return typing.cast(_VirtualNetworkAddressSpace_8441d676, result)

    @builtins.property
    def dhcp_options(self) -> typing.Optional[_VirtualNetworkDhcpOptions_1875d990]:
        '''DHCP options configuration Optional - configures DNS servers for the VNet.'''
        result = self._values.get("dhcp_options")
        return typing.cast(typing.Optional[_VirtualNetworkDhcpOptions_1875d990], result)
