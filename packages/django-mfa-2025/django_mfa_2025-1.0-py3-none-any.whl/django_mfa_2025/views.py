...
from django_mfa_2025.models import *
from . import totp
...
def security_settings(request):
    ...
    return render(request, 'django_mfa_2025/security.html', {"prev_url": settings.LOGIN_REDIRECT_URL, "backup_codes": backup_codes, "u2f_enabled": u2f_enabled, "twofactor_enabled": twofactor_enabled})
...
def configure_mfa(request):
    ...
    return render(request, 'django_mfa_2025/configure.html', {"qr_code": qr_code, "secret_key": base_32_secret_utf8})
...
def enable_mfa(request):
    ...
    return render(request, 'django_mfa_2025/configure.html', {"is_verified": is_verified, "qr_code": qr_code, "secret_key": base_32_secret})
...
def disable_mfa(request):
    ...
    return render(request, 'django_mfa_2025/disable_mfa.html')
...
def verify_second_factor_totp(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'django_mfa_2025/verify_second_factor_mfa.html', ctx)
    ...
    ctx['next'] = request.GET.get('next', settings.LOGIN_REDIRECT_URL)
    return render(request, 'django_mfa_2025/verify_second_factor_mfa.html', ctx, status=400)
...
def recovery_codes(request):
    if request.method == "GET":
        ...
        return render(request, "django_mfa_2025/recovery_codes.html", {"user_codes": user_codes, "next_url": next_url})
...
def verify_second_factor(request):
    if request.method == "GET":
        ...
        if twofactor_enabled or u2f_enabled:
            return render(request, 'django_mfa_2025/verify_second_factor.html', {"u2f_enabled": u2f_enabled, "twofactor_enabled": twofactor_enabled})
