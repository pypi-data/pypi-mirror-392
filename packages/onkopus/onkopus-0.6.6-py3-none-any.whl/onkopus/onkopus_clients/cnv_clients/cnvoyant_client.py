...
class CNVoyantClient:

    def __init__(self, genome_version, error_logfile=None):
        self.genome_version = genome_version
        self.url_pattern = config.cnvoyant_src
        self.srv_prefix = config.cnvoyant_srv_prefix
        self.extract_keys = config.cnvoyant_keys
        self.info_lines = config.cnvoyant_info_lines
