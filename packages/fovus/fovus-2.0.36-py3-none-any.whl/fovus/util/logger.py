...
_fovus_logger = logging.getLogger(LOGGER_NAME)
...
def setup_fovus_logger(is_debug: bool = False, log_path: str = None) -> logging.Logger:
    """
    Setup a root logger for the Fovus CLI with the following handlers:
    ...
    The setup of 2) and 3) separates the informative messages from the final result and allows end users to easily get the final output without any additional processing.
    """
    global _fovus_logger
