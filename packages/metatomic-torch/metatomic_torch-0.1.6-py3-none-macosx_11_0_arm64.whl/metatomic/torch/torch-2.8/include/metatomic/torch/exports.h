...
#      define METATOMIC_TORCH_EXPORT __attribute__((visibility("default")))
#    else
...
#    define METATOMIC_TORCH_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef METATOMIC_TORCH_DEPRECATED
#  define METATOMIC_TORCH_DEPRECATED __attribute__ ((__deprecated__))
#endif
