...
MALE = ["i", "ragazzi", "siamo ragazzi", "siamo ragazzi.", "male", "maschio", "m"]
FEMALE = ["e", "ragazze", "siamo ragazze", "siamo ragazze.", "female", "femmina", "f"]
ENBY = ["ɜ", "ragazzɜ", "siamo ragazzɜ", "3", "ragazz3", "siamo ragazz3", "siamo ragazz3", "enby", "non-binary", "nonbinary", "nonbinario"]


@click.command()
@click.pass_context
@click.version_option(package_name="siamo_ragazzi", prog_name="siamo-ragazzi")
...
def main(ctx, top_text, output, bottom_text=None, background_color=None, foreground_color=None, kind=None, font=None, seed=None, variation=40):
    ...
    if not kind:
        kind = random.sample(["male", "female", "enby"], 1)[0]
