# @package portal.Connection
# Low-level message-oriented communications module
#
# The Portal Connection class enables sending and receiving Google protobuf
...
class Connection:
    ...
    #
    # @param server_host - Portal core server hostname or IP address
    ...
    def __init__(
        ...
        self._format = "%(asctime)s portal-cli %(levelname)s %(message)"
    ...
    def registerProtocol(self, msg_module):
        ...
        # defined Portal-sepcific numer message types
    ...
    def send(self, message, ctxt):
        ...
        # Initial Null frame
        self._socket.send_string("BEGIN_DATAERAI", zmq.SNDMORE)
        route_count = 0
