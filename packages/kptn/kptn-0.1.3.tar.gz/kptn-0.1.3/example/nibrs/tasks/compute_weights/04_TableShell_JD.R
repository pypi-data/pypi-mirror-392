...
jdall <- read.csv(paste0(output_weighting_data_folder,'jd_all.csv'))
...
write.csv(file=file.path(output_weighting_tableshell_folder,"TableAJDDummy.csv"),
...
fileoutTabA<-file.path(output_weighting_tableshell_folder,"TableA_JD_Shell.xlsx")
