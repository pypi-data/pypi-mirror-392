...
foall <- read.csv(paste0(output_weighting_data_folder,'fo_all.csv'))
...
write.csv(file=file.path(output_weighting_tableshell_folder,"TableAFODummy.csv"),
...
fileoutTabA<-file.path(output_weighting_tableshell_folder,"TableA_FO_Shell.xlsx")
