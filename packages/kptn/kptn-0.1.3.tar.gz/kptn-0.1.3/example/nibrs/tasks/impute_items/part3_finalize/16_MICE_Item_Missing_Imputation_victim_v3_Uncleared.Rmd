...
NIBRS <- data.frame(fread_logging(paste0(inputmainpath, "15_", input_state, "_victim_for_imputation.csv.gz")))
#Drop ethnicity
NIBRS <- NIBRS %>%
...
NIBRS %>%
     ...
     write_csv(gzfile(paste0(mainpath, "16_", input_state, "_victim_imputed_final.csv.gz")), na="" )

NIBRS %>%
     write_csv(gzfile(paste0(mainpath, "16_", input_state, "_victim_mice_final.csv.gz")), na="" )


} else{
log_debug("Imputation IS needed.")
write_xlsx(md2,paste0(miscpathout ,"16_mdpattern2_", input_state, ".xlsx"))
...
write_xlsx(as.data.frame(predQuick1), paste0(miscpathout, "16_predQuick1_", input_state, ".xlsx"))
...
check0 <- NIBRS[1:100,]
write_xlsx(check0,paste0(miscpathout, "16_check0_", input_state, ".xlsx"))

check1 <- NIBRS1[1:100,]
write_xlsx(check1, paste0(miscpathout, "16_check1_", input_state, ".xlsx"))
...
Sex_victim_imputed %>% write_csv(gzfile(paste0(mainpath, "16_", input_state, "_victim_imputed_final.csv.gz")), na="" )
