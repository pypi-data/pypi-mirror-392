...
log_info("Running 06_Table2b_part3_finalize.R")
...
#Need to update the object data14's ORI dataset (der_property_crime_no_mvt) with data11 (der_motor_vehicle_theft)
final_ori_data[[15]] <- combinedoris(incombined=final_ori_data[[15]], inadditional=final_ori_data[[12]], incombinednum=14, inadditionalnum=11)
#Need to update the object data2's ORI dataset (der_against_property_no_mvt) with data11 (der_motor_vehicle_theft)
final_ori_data[[2]] <- combinedoris(incombined=final_ori_data[[2]], inadditional=final_ori_data[[12]], incombinednum=1, inadditionalnum=11)
