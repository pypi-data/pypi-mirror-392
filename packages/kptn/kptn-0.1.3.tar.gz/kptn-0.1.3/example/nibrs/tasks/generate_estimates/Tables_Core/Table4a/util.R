...
assign_row <- function(data){
  ...
  row = fcase(
    ...
    der_weapon_no_yes %in% c(1:2) & section == 11,  der_weapon_no_yes + 51,
    der_weapon_yes_cat %in% c(1:3) & section == 12,  der_weapon_yes_cat + 53,
...
generate_est <- function(maindata, subsetvareq1, column_number){
  ...
  #Arrest type
  s2 <- agg_percent_arrestee(leftdata = main_filter, rightdata = agg_arrest_type_arrestee, var=der_arrest_type, section=2, mergeby=c( "incident_id", "arrestee_id"))


  #arrestee Age
  s3 <- agg_percent_arrestee(leftdata = main_filter, rightdata = agg_arrestee_age_cat_15_17_arrestee, var=der_arrestee_age_cat_15_17, section=3, mergeby=c( "incident_id", "arrestee_id"))
  ...
  s16 <- agg_percent_arrestee(leftdata = main_filter, rightdata = agg_arrestee_age_cat_12_17_cat_arrestee_imp, var=der_arrestee_age_cat_12_17_cat, section=16, mergeby=c( "incident_id", "arrestee_id"))
  ...
  #Arrestee Hispanic Origin
  s18 <- agg_percent_arrestee(leftdata = main_filter, rightdata = agg_arrestee_ethnicity_arrestee, var=der_arrestee_ethnicity, section=18, mergeby=c( "incident_id", "arrestee_id"))
  
  #Arrestee race and Hispanic Origin
  s19 <- agg_percent_arrestee(leftdata = main_filter, rightdata = agg_arrestee_ethnicity_race_arrestee, var=der_arrestee_ethnicity_race, section=19, mergeby=c( "incident_id", "arrestee_id"))
