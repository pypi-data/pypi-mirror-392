...
column == 54,  '35A - More Than 3 Types (X) - U (Using/consuming)'
  ...
  full_table = "TableDM7 - Drug Count By Arrestee",
...
createadditionalcolumns <- function(intotalcolumn, incolumnstart, colindex, insubset, inperm_num_series){
  ...
  if(colindex == 1){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 1", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(1, 2, 3, 6, 7, 8)", column_number=1+inperm_num_series) #Cocaine/crack cocaine (A, B):  Buying/receiving
  } else if(colindex == 2){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 2", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(1, 2, 3, 6, 7, 8)", column_number=2+inperm_num_series) #Cocaine/crack cocaine (A, B):  Cultivating/manufacturing/publishing
  } else if(colindex == 3){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 3", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(1, 2, 3, 6, 7, 8)", column_number=3+inperm_num_series) #Cocaine/crack cocaine (A, B):  Distributing/selling
  } else if(colindex == 4){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 6", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(1, 2, 3, 6, 7, 8)", column_number=4+inperm_num_series) #Cocaine/crack cocaine (A, B):  Possessing/concealing
  } else if(colindex == 5){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 7", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(1, 2, 3, 6, 7, 8)", column_number=5+inperm_num_series) #Cocaine/crack cocaine (A, B):  Transporting/transmitting/importing
  } else if(colindex == 6){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 8", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(1, 2, 3, 6, 7, 8)", column_number=6+inperm_num_series) #Cocaine/crack cocaine (A, B):  Using/consuming
  } else if(colindex == 7){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 9", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(9, 10, 11, 14, 15, 16)", column_number=7+inperm_num_series) #Marijuana/hashish (C, E):  Buying/receiving
  } else if(colindex == 8){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 10", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(9, 10, 11, 14, 15, 16)", column_number=8+inperm_num_series) #Marijuana/hashish (C, E):  Cultivating/manufacturing/publishing
  } else if(colindex == 9){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 11", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(9, 10, 11, 14, 15, 16)", column_number=9+inperm_num_series) #Marijuana/hashish (C, E):  Distributing/selling
  } else if(colindex == 10){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 14", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(9, 10, 11, 14, 15, 16)", column_number=10+inperm_num_series) #Marijuana/hashish (C, E):  Possessing/concealing
  } else if(colindex == 11){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 15", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(9, 10, 11, 14, 15, 16)", column_number=11+inperm_num_series) #Marijuana/hashish (C, E):  Transporting/transmitting/importing
  } else if(colindex == 12){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 16", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(9, 10, 11, 14, 15, 16)", column_number=12+inperm_num_series) #Marijuana/hashish (C, E):  Using/consuming
  } else if(colindex == 13){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 17", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(17, 18, 19, 22, 23, 24)", column_number=13+inperm_num_series) #Opiate/narcotic (D, F, G, H):  Buying/receiving
  } else if(colindex == 14){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 18", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(17, 18, 19, 22, 23, 24)", column_number=14+inperm_num_series) #Opiate/narcotic (D, F, G, H):  Cultivating/manufacturing/publishing
  } else if(colindex == 15){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 19", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(17, 18, 19, 22, 23, 24)", column_number=15+inperm_num_series) #Opiate/narcotic (D, F, G, H):  Distributing/selling
  } else if(colindex == 16){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 22", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(17, 18, 19, 22, 23, 24)", column_number=16+inperm_num_series) #Opiate/narcotic (D, F, G, H):  Possessing/concealing
  } else if(colindex == 17){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 23", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(17, 18, 19, 22, 23, 24)", column_number=17+inperm_num_series) #Opiate/narcotic (D, F, G, H):  Transporting/transmitting/importing
  } else if(colindex == 18){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 24", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(17, 18, 19, 22, 23, 24)", column_number=18+inperm_num_series) #Opiate/narcotic (D, F, G, H):  Using/consuming
  } else if(colindex == 19){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 25", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(25, 26, 27, 30, 31, 32)", column_number=19+inperm_num_series) #Hallucinogen (I, J, K):  Buying/receiving
  } else if(colindex == 20){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 26", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(25, 26, 27, 30, 31, 32)", column_number=20+inperm_num_series) #Hallucinogen (I, J, K):  Cultivating/manufacturing/publishing
  } else if(colindex == 21){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 27", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(25, 26, 27, 30, 31, 32)", column_number=21+inperm_num_series) #Hallucinogen (I, J, K):  Distributing/selling
  } else if(colindex == 22){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 30", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(25, 26, 27, 30, 31, 32)", column_number=22+inperm_num_series) #Hallucinogen (I, J, K):  Possessing/concealing
  } else if(colindex == 23){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 31", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(25, 26, 27, 30, 31, 32)", column_number=23+inperm_num_series) #Hallucinogen (I, J, K):  Transporting/transmitting/importing
  } else if(colindex == 24){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 32", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(25, 26, 27, 30, 31, 32)", column_number=24+inperm_num_series) #Hallucinogen (I, J, K):  Using/consuming
  } else if(colindex == 25){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 33", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(33, 34, 35, 38, 39, 40)", column_number=25+inperm_num_series) #Stimulant (L, M):  Buying/receiving
  } else if(colindex == 26){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 34", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(33, 34, 35, 38, 39, 40)", column_number=26+inperm_num_series) #Stimulant (L, M):  Cultivating/manufacturing/publishing
  } else if(colindex == 27){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 35", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(33, 34, 35, 38, 39, 40)", column_number=27+inperm_num_series) #Stimulant (L, M):  Distributing/selling
  } else if(colindex == 28){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 38", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(33, 34, 35, 38, 39, 40)", column_number=28+inperm_num_series) #Stimulant (L, M):  Possessing/concealing
  } else if(colindex == 29){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 39", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(33, 34, 35, 38, 39, 40)", column_number=29+inperm_num_series) #Stimulant (L, M):  Transporting/transmitting/importing
  } else if(colindex == 30){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 40", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(33, 34, 35, 38, 39, 40)", column_number=30+inperm_num_series) #Stimulant (L, M):  Using/consuming
  } else if(colindex == 31){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 41", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(41, 42, 43, 46, 47, 48)", column_number=31+inperm_num_series) #Depressant (N, O):  Buying/receiving
  } else if(colindex == 32){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 42", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(41, 42, 43, 46, 47, 48)", column_number=32+inperm_num_series) #Depressant (N, O):  Cultivating/manufacturing/publishing
  } else if(colindex == 33){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 43", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(41, 42, 43, 46, 47, 48)", column_number=33+inperm_num_series) #Depressant (N, O):  Distributing/selling
  } else if(colindex == 34){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 46", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(41, 42, 43, 46, 47, 48)", column_number=34+inperm_num_series) #Depressant (N, O):  Possessing/concealing
  } else if(colindex == 35){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 47", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(41, 42, 43, 46, 47, 48)", column_number=35+inperm_num_series) #Depressant (N, O):  Transporting/transmitting/importing
  } else if(colindex == 36){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 48", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(41, 42, 43, 46, 47, 48)", column_number=36+inperm_num_series) #Depressant (N, O):  Using/consuming
  } else if(colindex == 37){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 49", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(49, 50, 51, 54, 55, 56)", column_number=37+inperm_num_series) #Other (P):  Buying/receiving
  } else if(colindex == 38){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 50", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(49, 50, 51, 54, 55, 56)", column_number=38+inperm_num_series) #Other (P):  Cultivating/manufacturing/publishing
  } else if(colindex == 39){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 51", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(49, 50, 51, 54, 55, 56)", column_number=39+inperm_num_series) #Other (P):  Distributing/selling
  } else if(colindex == 40){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 54", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(49, 50, 51, 54, 55, 56)", column_number=40+inperm_num_series) #Other (P):  Possessing/concealing
  } else if(colindex == 41){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 55", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(49, 50, 51, 54, 55, 56)", column_number=41+inperm_num_series) #Other (P):  Transporting/transmitting/importing
  } else if(colindex == 42){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 56", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(49, 50, 51, 54, 55, 56)", column_number=42+inperm_num_series) #Other (P):  Using/consuming
  } else if(colindex == 43){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 57", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(57, 58, 59, 62, 63, 64)", column_number=43+inperm_num_series) #Unknown (U):  Buying/receiving
  } else if(colindex == 44){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 58", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(57, 58, 59, 62, 63, 64)", column_number=44+inperm_num_series) #Unknown (U):  Cultivating/manufacturing/publishing
  } else if(colindex == 45){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 59", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(57, 58, 59, 62, 63, 64)", column_number=45+inperm_num_series) #Unknown (U):  Distributing/selling
  } else if(colindex == 46){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 62", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(57, 58, 59, 62, 63, 64)", column_number=46+inperm_num_series) #Unknown (U):  Possessing/concealing
  } else if(colindex == 47){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 63", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(57, 58, 59, 62, 63, 64)", column_number=47+inperm_num_series) #Unknown (U):  Transporting/transmitting/importing
  } else if(colindex == 48){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 64", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(57, 58, 59, 62, 63, 64)", column_number=48+inperm_num_series) #Unknown (U):  Using/consuming
  } else if(colindex == 49){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 65", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(65, 66, 67, 70, 71, 72)", column_number=49+inperm_num_series) #More Than 3 Types (X):  Buying/receiving
  } else if(colindex == 50){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 66", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(65, 66, 67, 70, 71, 72)", column_number=50+inperm_num_series) #More Than 3 Types (X):  Cultivating/manufacturing/publishing
  } else if(colindex == 51){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 67", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(65, 66, 67, 70, 71, 72)", column_number=51+inperm_num_series) #More Than 3 Types (X):  Distributing/selling
  } else if(colindex == 52){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 70", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(65, 66, 67, 70, 71, 72)", column_number=52+inperm_num_series) #More Than 3 Types (X):  Possessing/concealing
  } else if(colindex == 53){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 71", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(65, 66, 67, 70, 71, 72)", column_number=53+inperm_num_series) #More Than 3 Types (X):  Transporting/transmitting/importing
  } else if(colindex == 54){
    temp <- generate_est(maindata=main %>% filter(!!insymbol), subsetvareq1 = "der_1suspected_type_of_drug_1crim_activity == 72", subsetvareq2="der_1suspected_type_of_drug_1crim_activity %in%c(65, 66, 67, 70, 71, 72)", column_number=54+inperm_num_series) #More Than 3 Types (X):  Using/consuming	
  }
  return(temp)
}