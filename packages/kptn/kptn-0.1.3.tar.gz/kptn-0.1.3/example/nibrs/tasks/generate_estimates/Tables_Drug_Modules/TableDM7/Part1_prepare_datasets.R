...
log_info("Running 23_TableDM7_part1_prepare_datasets.R")
...
# raw_main3 <- raw_main2 %>%
#   left_join(agg_1suspected_type_of_drug_1crim_activity_35A_c %>% select(-count), by="incident_id")
raw_main <- merge(raw_main, agg_1suspected_type_of_drug_1crim_activity_35A_c[,count:=NULL], by="incident_id", all.x = TRUE)

#Note that agg_1suspected_type_of_drug_1crim_activity_35A_c is a incident level with multiple levels due to the drug cross activity codes.
