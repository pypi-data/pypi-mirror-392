...
run_main <- function(){
  ...
  #Businesses: Victimization count
  #Businesses: Victimization rate (victimization county population)
  #Other non-person victims: Victimization count
  #Other non-person victims: Victimization rate (victimization county population)
