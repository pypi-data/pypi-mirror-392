  ...
  if(nrow(raw_percentage_3) > 0) {
    ...
    raw_percentage_3_dt[,
      raw_denominator := fcase(
        #Total
        row == 2, CREATE_PERCENTAGE_DENOMINATOR(c(2, 8), column), #Property description: Property seized
        row == 3, CREATE_PERCENTAGE_DENOMINATOR(c(2), column), #Property seized: Drugs/narcotics
        row == 4, CREATE_PERCENTAGE_DENOMINATOR(c(2), column), #Property seized: Drug/narcotic equipment
        row == 5, CREATE_PERCENTAGE_DENOMINATOR(c(2), column), #Property seized: Chemicals
        row == 6, CREATE_PERCENTAGE_DENOMINATOR(c(2), column), #Property seized: Money
        row == 7, CREATE_PERCENTAGE_DENOMINATOR(c(2), column), #Property seized: Firearms
        row == 8, CREATE_PERCENTAGE_DENOMINATOR(c(2, 8), column) #Property description: Property not seized
      ),
