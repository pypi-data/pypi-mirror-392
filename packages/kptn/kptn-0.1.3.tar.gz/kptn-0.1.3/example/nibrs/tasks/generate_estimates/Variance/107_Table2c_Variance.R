  ...
  if(nrow(raw_percentage_3) > 0) {
    ...
    raw_percentage_3_dt[,
      raw_denominator := fcase(
        ...
        row == 3, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Residence/hotel
        row == 4, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Transportation hub/outdoor public locations
        row == 5, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Schools, daycares, and universities
        row == 6, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Retail/financial/other commercial establishment
        row == 7, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Restaurant/bar/sports or entertainment venue
        row == 8, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Religious buildings
        row == 9, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Government/public buildings
        row == 10, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Jail/prison
        row == 11, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Shelter-mission/homeless
        row == 12, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Other/unknown location
        row == 13, CREATE_PERCENTAGE_DENOMINATOR(c(13:19), column), #Time of day- Incident time: Midnight-4am
        row == 14, CREATE_PERCENTAGE_DENOMINATOR(c(13:19), column), #Time of day- Incident time: 4-8am
        row == 15, CREATE_PERCENTAGE_DENOMINATOR(c(13:19), column), #Time of day- Incident time: 8am-noon
        row == 16, CREATE_PERCENTAGE_DENOMINATOR(c(13:19), column), #Time of day- Incident time: Noon-4pm
        row == 17, CREATE_PERCENTAGE_DENOMINATOR(c(13:19), column), #Time of day- Incident time: 4-8pm
        row == 18, CREATE_PERCENTAGE_DENOMINATOR(c(13:19), column), #Time of day- Incident time: 8pm-midnight
        row == 19, CREATE_PERCENTAGE_DENOMINATOR(c(13:19), column), #Time of day- Incident time: Unknown
        row == 20, CREATE_PERCENTAGE_DENOMINATOR(c(20:26), column), #Time of day- Report time: Midnight-4am
        row == 21, CREATE_PERCENTAGE_DENOMINATOR(c(20:26), column), #Time of day- Report time: 4-8am
        row == 22, CREATE_PERCENTAGE_DENOMINATOR(c(20:26), column), #Time of day- Report time: 8am-noon
        row == 23, CREATE_PERCENTAGE_DENOMINATOR(c(20:26), column), #Time of day- Report time: Noon-4pm
        row == 24, CREATE_PERCENTAGE_DENOMINATOR(c(20:26), column), #Time of day- Report time: 4-8pm
        row == 25, CREATE_PERCENTAGE_DENOMINATOR(c(20:26), column), #Time of day- Report time: 8pm-midnight
        row == 26, CREATE_PERCENTAGE_DENOMINATOR(c(20:26), column), #Time of day- Report time: Unknown
        row == 27, CREATE_PERCENTAGE_DENOMINATOR(c(27:31), column), #Population group: Cities and counties 100,000 or over
        row == 28, CREATE_PERCENTAGE_DENOMINATOR(c(27:31), column), #Population group: Cities and counties 25,000-99,999
        row == 29, CREATE_PERCENTAGE_DENOMINATOR(c(27:31), column), #Population group: Cities and counties 10,000-24,999
        row == 30, CREATE_PERCENTAGE_DENOMINATOR(c(27:31), column), #Population group: Cities and counties under 10,000
        row == 31, CREATE_PERCENTAGE_DENOMINATOR(c(27:31), column), #Population group: State police
        #Population group: Possessions and Canal Zone
        row == 33, CREATE_PERCENTAGE_DENOMINATOR(c(33:38), column), #Agency indicator: City
        row == 34, CREATE_PERCENTAGE_DENOMINATOR(c(33:38), column), #Agency indicator: County
        row == 35, CREATE_PERCENTAGE_DENOMINATOR(c(33:38), column), #Agency indicator: University or college
        row == 36, CREATE_PERCENTAGE_DENOMINATOR(c(33:38), column), #Agency indicator: State police
        row == 37, CREATE_PERCENTAGE_DENOMINATOR(c(33:38), column), #Agency indicator: Other state agencies
        row == 38, CREATE_PERCENTAGE_DENOMINATOR(c(33:38), column), #Agency indicator: Tribal agencies
        #Agency indicator: Federal agencies
        row == 40, CREATE_PERCENTAGE_DENOMINATOR(c(40:41), column), #Clearance: Not cleared through arrest
        row == 41, CREATE_PERCENTAGE_DENOMINATOR(c(40:41), column), #Clearance: Cleared through arrest
        row == 42, CREATE_PERCENTAGE_DENOMINATOR(c(42), column), #Gang Involvement: None/Unknown gang involvement
        #Gang Involvement: Juvenile or other gang
        row == 44, CREATE_PERCENTAGE_DENOMINATOR(c(44:47), column), #MSA: MSA Counties
        row == 45, CREATE_PERCENTAGE_DENOMINATOR(c(44:47), column), #MSA: Outside MSA
        row == 46, CREATE_PERCENTAGE_DENOMINATOR(c(44:47), column), #MSA: Non-MSA Counties
        row == 47, CREATE_PERCENTAGE_DENOMINATOR(c(44:47), column), #MSA: Missing
        row == 48, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Residence/hotel
        row == 49, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Transportation hub/outdoor public locations
        row == 50, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Schools, daycares, and universities
        row == 51, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Retail/financial/other commercial establishment
        row == 52, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Restaurant/bar/sports or entertainment venue
        row == 53, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Religious buildings
        row == 54, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Government/public buildings
        row == 55, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Jail/prison
        row == 56, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Shelter-mission/homeless
        row == 57, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Drug Store/Doctor Office/Hospital
        row == 58, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 2: Other/unknown location
		
		row == 59, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 3: Residence
		row == 60, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 3: Not residence
		row == 61, CREATE_PERCENTAGE_DENOMINATOR(c(61:62), column), #Clearance 2: Cleared incident
		row == 62, CREATE_PERCENTAGE_DENOMINATOR(c(61:62), column) #Clearance 2: Not cleared incident
...
run_main <- function(){
  ...
  der_drop_rows <- c(
    32,	#Population group	  Possessions and Canal Zone
    39,	#Agency indicator	  Federal agencies
    43	#Gang Involvement	  Juvenile or other gang
  )
  ######################################################################################################################
