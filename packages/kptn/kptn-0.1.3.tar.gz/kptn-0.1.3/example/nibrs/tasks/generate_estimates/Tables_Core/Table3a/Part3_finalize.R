...
start_row = c(
  2, 7, 18, 22, 29, 35, 41, 53, 75, 84, 87, 94, 97, 104, 110, 119, 125, 144, 153, 156, 175, 180, 185, 189)
...
table_sheet = "Table3a-Person Victims"
...
log_debug("The final reporting database is output")
log_debug(system("free -mh", intern = FALSE))
...
gc(rm(list=c("final_reporting_database_2", "final_reporting_database", "datasetforoutput","final_data","final_data2","final_data3")))
...
log_debug("Starting to create the ORI files")
log_debug(system("free -mh", intern = FALSE))
