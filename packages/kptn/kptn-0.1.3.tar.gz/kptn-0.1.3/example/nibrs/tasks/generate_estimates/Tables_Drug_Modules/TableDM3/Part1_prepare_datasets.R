...
log_info("Running 19_TableDM3_part1_prepare_datasets.R")
...
#Remove the datasets
remove(raw_main,agg_drug_narcotic_equipment_cat)
invisible(gc())


#Need to bring in the datasets needed for tables
agg_property_seized_categories_short <- fread(paste0(der_file_path, "agg_property_seized_categories_short.csv.gz"))
agg_property_seized_any <- fread(paste0(der_file_path, "agg_property_seized_any.csv.gz"))
