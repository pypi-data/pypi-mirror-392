  ...
  if(nrow(raw_percentage_3) > 0) {
    ...
    raw_percentage_3_dt[,
      raw_denominator := fcase(
        #Arrest rate (per 100k total population)
        row == 2, CREATE_PERCENTAGE_DENOMINATOR(c(2:4), column), #Arrest type-specific arrest rate: On-view arrest
        row == 3, CREATE_PERCENTAGE_DENOMINATOR(c(2:4), column), #Arrest type-specific arrest rate: Summoned/cited
        row == 4, CREATE_PERCENTAGE_DENOMINATOR(c(2:4), column), #Arrest type-specific arrest rate: Taken into custody
        row == 5, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: Under 5
        row == 6, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: 5-14
        row == 7, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: 15
        row == 8, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: 16
        row == 9, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: 17
        row == 10, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: 18-24
        row == 11, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: 25-34
        row == 12, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: 35-64
        row == 13, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: 65+
        row == 14, CREATE_PERCENTAGE_DENOMINATOR(c(5:14), column), #Age-specific arrest rate: Unknown
        row == 15, CREATE_PERCENTAGE_DENOMINATOR(c(15:16), column), #Sex-specific arrest rate: Male
        row == 16, CREATE_PERCENTAGE_DENOMINATOR(c(15:16), column), #Sex-specific arrest rate: Female
        #Sex-specific arrest rate: Unknown
        row == 18, CREATE_PERCENTAGE_DENOMINATOR(c(18:23), column), #Race-specific arrest rate: White
        row == 19, CREATE_PERCENTAGE_DENOMINATOR(c(18:23), column), #Race-specific arrest rate: Black
        row == 20, CREATE_PERCENTAGE_DENOMINATOR(c(18:23), column), #Race-specific arrest rate: American Indian or Alaska Native
        row == 21, CREATE_PERCENTAGE_DENOMINATOR(c(18:23), column), #Race-specific arrest rate: Asian
        row == 22, CREATE_PERCENTAGE_DENOMINATOR(c(18:23), column), #Race-specific arrest rate: Native Hawaiian or Other Pacific Islander
        row == 23, CREATE_PERCENTAGE_DENOMINATOR(c(18:23), column), #Race-specific arrest rate: Unknown
        row == 24, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Age-specific arrest rate 2: Under 12
        row == 25, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Age-specific arrest rate 2: 12-17
        row == 26, CREATE_PERCENTAGE_DENOMINATOR(c(25), column), #Age-specific arrest rate 2: 12-14
        row == 27, CREATE_PERCENTAGE_DENOMINATOR(c(25), column), #Age-specific arrest rate 2: 15-17
        row == 28, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Age-specific arrest rate 2: 18+
        row == 29, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Age-specific arrest rate 2: Unknown
        
        row == 30, CREATE_PERCENTAGE_DENOMINATOR(c(30:32), column), #Hispanic Origin-specific arrest rate: Hispanic or Latino
        row == 31, CREATE_PERCENTAGE_DENOMINATOR(c(30:32), column), #Hispanic Origin-specific arrest rate: Not Hispanic or Latino
        row == 32, CREATE_PERCENTAGE_DENOMINATOR(c(30:32), column), #Hispanic Origin-specific arrest rate: Unknown
        row == 33, CREATE_PERCENTAGE_DENOMINATOR(c(33:39), column), #Race and Hispanic Origin-specific arrest rate: Hispanic or Latino
        row == 34, CREATE_PERCENTAGE_DENOMINATOR(c(33:39), column), #Race and Hispanic Origin-specific arrest rate: Non-Hispanic, White
        row == 35, CREATE_PERCENTAGE_DENOMINATOR(c(33:39), column), #Race and Hispanic Origin-specific arrest rate: Non-Hispanic, Black
        row == 36, CREATE_PERCENTAGE_DENOMINATOR(c(33:39), column), #Race and Hispanic Origin-specific arrest rate: Non-Hispanic, American Indian or Alaska Native
        row == 37, CREATE_PERCENTAGE_DENOMINATOR(c(33:39), column), #Race and Hispanic Origin-specific arrest rate: Non-Hispanic, Asian
        row == 38, CREATE_PERCENTAGE_DENOMINATOR(c(33:39), column), #Race and Hispanic Origin-specific arrest rate: Non-Hispanic, Native Hawaiian or Other Pacific Islander
        row == 39, CREATE_PERCENTAGE_DENOMINATOR(c(33:39), column) #Race and Hispanic Origin-specific arrest rate: Unknown race or Hispanic origin
...
run_main <- function(){
  ...
  der_drop_rows <- c(
  17 #Sex-specific arrest rate: Unknown
  )
  ######################################################################################################################
