...
# run the markdown files in order
if(CONST_YEAR %in% c("1993", "1994")){
  log_info("Starting 01_BlockImputation_M3_v3b_no_outlier.Rmd....")
  rmarkdown::render("01_BlockImputation_M3_v3b_no_outlier.Rmd", output_format = html_document(),
                    output_file = paste0(filepathout, "01_BlockImputation_M3_v3b_no_outlier.html"),
                    envir = new.env(), quiet = TRUE)  
  
} else{

log_info("Starting 01_BlockImputation_M3_v3b.Rmd....")
rmarkdown::render("01_BlockImputation_M3_v3b.Rmd", output_format = html_document(),
                  output_file = paste0(filepathout, "01_BlockImputation_M3_v3b.html"),
                  envir = new.env(), quiet = TRUE)
}
...
log_info("Starting 02_BlockImputation_Incident_Table.Rmd....")
rmarkdown::render("02_BlockImputation_Incident_Table.Rmd", output_format = html_document(),
                  output_file = paste0(filepathout, "02_BlockImputation_Incident_Table.html"),
                  envir = new.env(), quiet = TRUE)
invisible(gc())
knitr::knit_meta(clean = TRUE)
