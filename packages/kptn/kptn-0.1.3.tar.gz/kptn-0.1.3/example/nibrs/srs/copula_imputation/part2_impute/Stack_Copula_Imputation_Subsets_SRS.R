  ...
  sapply(temp.stratVars,function(temp.stratVar){
    sapply(temp.stratLvls,function(temp.stratLvl){
      ...
      if (file.exists(file.path(output_copula_data_folder,
                                paste0("Table_",temp.table,"_Final_Agency_File_Perm_",temp.perm,"_ColNum_",temp.colnum,"_Nonzero_Pop_Rates_",temp.stratVar,"_",temp.stratLvl,"_SRS.csv")))){
      ...
      if (file.exists(file.path(output_copula_data_folder,
                                paste0("Table_",temp.table,"_Final_Agency_File_Perm_",temp.perm,"_ColNum_",temp.colnum,"_Missing_Demo_Rates_",temp.stratVar,"_",temp.stratLvl,"_SRS.csv")))){
      ...
      if (file.exists(file.path(output_copula_data_folder,
                                paste0("Table_",temp.table,"_Final_Agency_File_Perm_",temp.perm,"_ColNum_",temp.colnum,"_Zero_Pop_Rates_",temp.stratVar,"_",temp.stratLvl,"_SRS.csv")))){
...
outName <- paste0("Table_",temp.table,"_Final_Agency_File_Perm_",temp.perm,"_Rates_",temp.stratVar,"_SRS")
