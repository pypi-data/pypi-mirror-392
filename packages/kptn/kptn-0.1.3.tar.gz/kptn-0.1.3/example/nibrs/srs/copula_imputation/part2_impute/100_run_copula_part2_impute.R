...
source("Copula_Imputation_Instance_Step1_SRS.R",local=TRUE,echo=TRUE)
source("Copula_Imputation_Instance_Step2_Alt_SRS.R",local=TRUE,echo=TRUE)
source("Copula_Imputation_Instance_Step3_Alt_SRS.R",local=TRUE,echo=TRUE)
source("Copula_Imputation_Instance_Step4_SRS.R",local=TRUE,echo=TRUE)
