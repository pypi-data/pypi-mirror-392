---
title: '3-Implement SRS Rule Plus Block'
author: "Philip Lee"
date: "April 7, 2023"
output:
  html_document:
...
tbd_rape_counts <- readfiles(inpath=filepathin, inpatternfile="^agg_victim_rape_gender_completed_person_counts_\\w+.csv.gz")
...
merge_final5 %>%
  write_csv(paste0(filepathout, "SRS_NIBRS_BLOCK_IMP_ONLY.csv"))
