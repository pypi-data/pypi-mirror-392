...
This directory was generated by `kptn codegen-infra` for the `nibrs` pipeline.
...
5. Initialize and apply the Terraform configuration:
   ...
   ```bash
   terraform init
   terraform plan -var="pipeline_name=nibrs"
   terraform apply -var="pipeline_name=nibrs"
   ```
