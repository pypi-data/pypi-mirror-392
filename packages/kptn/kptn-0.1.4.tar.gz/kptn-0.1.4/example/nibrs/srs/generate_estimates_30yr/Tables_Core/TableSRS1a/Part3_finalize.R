...
log_info("Running 01_TableSRS1a_part3_finalize.R")
...
for(i in 1:maximum_column){
  ...
  #Get the data object
  raw_object <- readRDS(paste0(out_file_path,"/data_SRS1a_",i,".rds"))
...
fileout <- paste0(final_path, "Indicator_Table_SRS1a.xlsx")
