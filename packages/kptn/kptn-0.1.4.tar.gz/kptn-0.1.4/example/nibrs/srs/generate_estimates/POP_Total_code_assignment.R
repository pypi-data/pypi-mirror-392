...
pop_data_NATIONAL <- read_csv(paste0(inputPipelineDir,"/srs/weighting/Data/", "POP_TOTALS_PERM_", CONST_YEAR, "_FINAL_SRS.csv")) %>% filter(PERMUTATION_NUMBER == 1)
...
pop_data <- read_csv(paste0(inputPipelineDir,"/srs/weighting/Data/", "POP_TOTALS_PERM_", CONST_YEAR, "_FINAL_SRS.csv")) %>% filter(PERMUTATION_NUMBER == DER_CURRENT_PERMUTATION_NUM)
