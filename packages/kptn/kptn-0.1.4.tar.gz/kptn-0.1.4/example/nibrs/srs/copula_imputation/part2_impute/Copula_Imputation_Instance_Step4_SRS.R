...
outName <- paste0("Table_",temp.table,"_Final_Agency_File_Perm_",temp.perm,"_ColNum_",temp.colnum,"_",temp.subsetSuffix,"_Rates_",temp.stratVar,"_",temp.stratLvl,"_SRS")
