...
#Note (18Dec2024): Creating national SRS pipeline version (e.g., for 30 year run). Heaviy basing off original SRS pipeline version.
#Instance...
rm(list=ls() %>% 
...
statusStep1 <- file.path(output_copula_data_folder,
                         paste0("Table_",temp.table,"_Imputation_Step1_Summary_Perm_",temp.perm,"_ColNum_",temp.colnum,"_",temp.subsetSuffix,"_Rates_",temp.stratVar,"_",temp.stratLvl,"_National_SRS.csv")) %>%
  fread()
