...
tbd_rape_counts <- fread(paste0(filepathin, "agg_victim_legacy_rape_gender_completed_person_counts_", CONST_STATE ,".csv.gz") )
...
merge_final2 %>%
  write_csv(paste0(filepathout_lr, "raw_SRS_incidents_", CONST_YEAR ,"_", CONST_STATE ,"_lr.csv"))
...
merge_final5 %>%
  write_csv(paste0(filepathout_lr, "SRS_", CONST_YEAR ,"_", CONST_STATE ,"_lr.csv"))
