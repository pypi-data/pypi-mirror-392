...
msaall <- read.csv(paste0(output_weighting_data_folder,'msa_all.csv'))
...
write.csv(file=file.path(output_weighting_tableshell_folder,"TableAMSADummy.csv"),
...
fileoutTabA<-file.path(output_weighting_tableshell_folder,"TableA_MSA_Shell.xlsx")
