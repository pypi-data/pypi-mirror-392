#########################################################################
#Program      : 04_TableShell_Groupings_National
...
log_info("Running 04_TableShell_Groupings_National.R")
...
write_dot_csv_logging(file=file.path(output_weighting_tableshell_folder,"TableAGpNationalDummy.csv"),groupings_all_fin_SummTabA1)
...
fileoutTabA<-file.path(output_weighting_tableshell_folder,"TableA_Groupings_National_Shell.xlsx")
...
log_info("Finished 04_TableShell_Groupings_National.R\n\n")