#########################################################################
#Program      : 04_TableShell_National
#Description  : Create table shell for Table A within Appendix for national-level
#
...
log_info("Running 04_TableShell_National.R")
...
state_name_abb_fin_all<-subset(state_name_abb_fin_all,state_name=="NATIONAL LEVEL ESTIMATES" & Variable.Name %in% natWgt)
...
write_dot_csv_logging(file=file.path(output_weighting_tableshell_folder,"TableANationalDummy.csv"),state_name_abb_fin_SummTabA1)




######################################
# Table A shell National
######################################
#Merged Column Name
...
fileoutTabA<-file.path(output_weighting_tableshell_folder,"TableA_National_Shell.xlsx")
...
#State by Weight
writeData(wbShell_TabA_National,sheet="Summary_National_TabA_Ex1", x=state_name_abb_fin_all[,c("state_name_char", "Description") ],withFilter = F,colNames = FALSE, startRow =8,startCol=1)
...
for(i in 1:length(weight_lists)){
  ...
  writeData(wbShell_TabA_National,sheet=weight_lists[[R]], x=state_name_abb_fin_SummTabA[keepRows,],withFilter = F,colNames = FALSE, startRow =8, headerStyle=headerStyle)
...
log_info("Finished 04_TableShell_National.R\n\n")