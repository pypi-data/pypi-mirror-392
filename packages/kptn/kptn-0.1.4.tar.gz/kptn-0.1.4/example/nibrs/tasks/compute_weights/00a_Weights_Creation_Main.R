...
#06Aug2025: setting warn option to give warnings as they occur, rather than after a call (e.g., no longer report in bunches after a source() call
options(warn=1)
...
source("02b_Geography_Crossings.R") #Create list of geography crossings
