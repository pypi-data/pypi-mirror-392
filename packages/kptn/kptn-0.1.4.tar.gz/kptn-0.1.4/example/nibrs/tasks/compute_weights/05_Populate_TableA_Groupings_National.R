...
log_info("Running 05_Populate_TableA_Groupings_National.R")
#####################################################################
# Table A
...
dummyDatA_groupings<-
  read_dot_csv_logging(file.path(output_weighting_tableshell_folder,"TableAGpNationalDummy.csv"))%>%
...
str1 <- file.path(output_weighting_populated_folder,'TableA_Groupings_National_Populated')
...
filein <- file.path(output_weighting_tableshell_folder,"TableA_Groupings_National_Shell.xlsx")
...
log_info("Finished 05_Populate_TableA_Groupings_National.R\n\n")
