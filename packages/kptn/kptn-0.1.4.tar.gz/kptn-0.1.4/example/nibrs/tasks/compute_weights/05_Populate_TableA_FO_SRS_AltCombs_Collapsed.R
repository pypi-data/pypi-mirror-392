...
n_Univ_NIBRS_orig<-read_csv(paste0(output_weighting_data_folder,'weights_FO_cal_srs_altcombs_col.csv'),
                            guess_max=1e6)
...
#Update (05NOV2021): Adding guess_max argument
SF <- read_csv(paste0(output_weighting_data_folder,"SF_postFO_cal_srs_altcombs_col.csv"),
               guess_max=1e6) %>%
...
#Stratum Totals
#Update (05NOV2021): Adding guess_max argument
SF_tots<-read_csv(paste0(output_weighting_data_folder,"SF_postFO_cal_srs_altcombs_col.csv"),
...
ucr_SRS <- ucr_SRS_orig %>%
  ...
  left_join(SF_tots[,c("ORI_universe","county","FIELD_OFFICE_NAME","PARENT_POP_GROUP_DESC2")],
            by=c("ORI_universe","county","FIELD_OFFICE_NAME")) %>%
...
dummyDatA<-
  read.csv(file.path(output_weighting_tableshell_folder,"TableAFODummy.csv"))%>%
...
str1 <- file.path(output_weighting_populated_folder,'TableA_FO_Populated_SRS_AltCombs_Collapsed')
...
filein <- file.path(output_weighting_tableshell_folder,"TableA_FO_Shell.xlsx")
