  ...
  if(nrow(raw_percentage_3) > 0) {
    ...
    raw_percentage_3_dt[,
      raw_denominator := fcase(
		...
		row == 3, CREATE_PERCENTAGE_DENOMINATOR(c(3, 7), column), #Firearm type: Single gun type
		row == 4, CREATE_PERCENTAGE_DENOMINATOR(c(3), column), #Firearm type: Handgun only
		row == 5, CREATE_PERCENTAGE_DENOMINATOR(c(3), column), #Firearm type: Long gun (Rifle and Shotgun) only
		row == 6, CREATE_PERCENTAGE_DENOMINATOR(c(3), column), #Firearm type: Unknown firearm type (Other Firearm and Firearm) only
		row == 7, CREATE_PERCENTAGE_DENOMINATOR(c(3, 7), column), #Firearm type: Multiple firearm types
		row == 8, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Residence
		row == 9, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Hotel
		row == 10, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Transportation hub/outdoor public locations
		row == 11, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Schools, daycares, and universities
		row == 12, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Retail/financial/other commercial establishment
		row == 13, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Restaurant/bar/sports or entertainment venue
		row == 14, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Religious buildings
		row == 15, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Government/public buildings
		row == 16, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Jail/prison
		row == 17, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Shelter-mission/homeless
		row == 18, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column), #Location Type 4: Drug Store/Doctor’s Office/Hospital
		row == 19, CREATE_PERCENTAGE_DENOMINATOR(c(8:19), column) #Location Type 4: Other/unknown location			
