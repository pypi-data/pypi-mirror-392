...
log_info("Running 23_TableDM7_part3_finalize.R")
...
table_sheet = "TableDM7-Drug Count By Arrestee"
...
fileout <- paste0(final_path, "Additional_Drug_Indicator_Table_DM7.xlsx")
