  ...
  if(nrow(raw_percentage_3) > 0) {
    ...
    raw_percentage_3_dt[,
      raw_denominator := fcase(
        #Incident count
        row == 2, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Completed drug-related offenses: Only drug/narcotic violations
        row == 3, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Completed drug-related offenses: Only drug equipment violations
        row == 4, CREATE_PERCENTAGE_DENOMINATOR(c(1), column) #Completed drug-related offenses: Both drug/narcotic and drug equipment violations
      ),
