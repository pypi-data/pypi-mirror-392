  ...
  if(nrow(raw_percentage_3) > 0) {
    ...
    raw_percentage_3_dt[,
      raw_denominator := fcase(
        ...
        row == 16, CREATE_PERCENTAGE_DENOMINATOR(c(16:18), column), #Multiple offense incident: 1 offense
        row == 17, CREATE_PERCENTAGE_DENOMINATOR(c(16:18), column), #Multiple offense incident: 2 offenses
        row == 18, CREATE_PERCENTAGE_DENOMINATOR(c(16:18), column), #Multiple offense incident: 3+ offenses
        row == 19, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Residence/hotel
        row == 20, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Transportation hub/outdoor public locations
        row == 21, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Schools, daycares, and universities
        row == 22, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Retail/financial/other commercial establishment
        row == 23, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Restaurant/bar/sports or entertainment venue
        row == 24, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Religious buildings
        row == 25, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Government/public buildings
        row == 26, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Jail/prison
        row == 27, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Shelter-mission/homeless
        row == 28, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type: Other/unknown location
        row == 29, CREATE_PERCENTAGE_DENOMINATOR(c(29:35), column), #Time of day- Incident time: Midnight-4am
        row == 30, CREATE_PERCENTAGE_DENOMINATOR(c(29:35), column), #Time of day- Incident time: 4-8am
        row == 31, CREATE_PERCENTAGE_DENOMINATOR(c(29:35), column), #Time of day- Incident time: 8am-noon
        row == 32, CREATE_PERCENTAGE_DENOMINATOR(c(29:35), column), #Time of day- Incident time: Noon-4pm
        row == 33, CREATE_PERCENTAGE_DENOMINATOR(c(29:35), column), #Time of day- Incident time: 4-8pm
        row == 34, CREATE_PERCENTAGE_DENOMINATOR(c(29:35), column), #Time of day- Incident time: 8pm-midnight
        row == 35, CREATE_PERCENTAGE_DENOMINATOR(c(29:35), column), #Time of day- Incident time: Unknown
        row == 36, CREATE_PERCENTAGE_DENOMINATOR(c(36:42), column), #Time of day- Report time: Midnight-4am
        row == 37, CREATE_PERCENTAGE_DENOMINATOR(c(36:42), column), #Time of day- Report time: 4-8am
        row == 38, CREATE_PERCENTAGE_DENOMINATOR(c(36:42), column), #Time of day- Report time: 8am-noon
        row == 39, CREATE_PERCENTAGE_DENOMINATOR(c(36:42), column), #Time of day- Report time: Noon-4pm
        row == 40, CREATE_PERCENTAGE_DENOMINATOR(c(36:42), column), #Time of day- Report time: 4-8pm
        row == 41, CREATE_PERCENTAGE_DENOMINATOR(c(36:42), column), #Time of day- Report time: 8pm-midnight
        row == 42, CREATE_PERCENTAGE_DENOMINATOR(c(36:42), column), #Time of day- Report time: Unknown
        row == 43, CREATE_PERCENTAGE_DENOMINATOR(c(43:47), column), #Population group: Cities and counties 100,000 or over
        row == 44, CREATE_PERCENTAGE_DENOMINATOR(c(43:47), column), #Population group: Cities and counties 25,000-99,999
        row == 45, CREATE_PERCENTAGE_DENOMINATOR(c(43:47), column), #Population group: Cities and counties 10,000-24,999
        row == 46, CREATE_PERCENTAGE_DENOMINATOR(c(43:47), column), #Population group: Cities and counties under 10,000
        row == 47, CREATE_PERCENTAGE_DENOMINATOR(c(43:47), column), #Population group: State police
        #Population group: Possessions and Canal Zone
        row == 49, CREATE_PERCENTAGE_DENOMINATOR(c(49:54), column), #Agency indicator: City
        row == 50, CREATE_PERCENTAGE_DENOMINATOR(c(49:54), column), #Agency indicator: County
        row == 51, CREATE_PERCENTAGE_DENOMINATOR(c(49:54), column), #Agency indicator: University or college
        row == 52, CREATE_PERCENTAGE_DENOMINATOR(c(49:54), column), #Agency indicator: State police
        row == 53, CREATE_PERCENTAGE_DENOMINATOR(c(49:54), column), #Agency indicator: Other state agencies
        row == 54, CREATE_PERCENTAGE_DENOMINATOR(c(49:54), column), #Agency indicator: Tribal agencies
        #Agency indicator: Federal agencies
        row == 56, CREATE_PERCENTAGE_DENOMINATOR(c(56:58), column), #Clearance: Not cleared
        row == 57, CREATE_PERCENTAGE_DENOMINATOR(c(56:58), column), #Clearance: Cleared through arrest
        row == 58, CREATE_PERCENTAGE_DENOMINATOR(c(56:58), column), #Clearance: Exceptional clearance
        row == 59, CREATE_PERCENTAGE_DENOMINATOR(c(59:63), column), #Clearance: Death of offender
        row == 60, CREATE_PERCENTAGE_DENOMINATOR(c(59:63), column), #Clearance: Prosecution declined
        row == 61, CREATE_PERCENTAGE_DENOMINATOR(c(59:63), column), #Clearance: In custody of other jurisdiction
        row == 62, CREATE_PERCENTAGE_DENOMINATOR(c(59:63), column), #Clearance: Victim refused to cooperate
        row == 63, CREATE_PERCENTAGE_DENOMINATOR(c(59:63), column), #Clearance: Juvenile/no custody
        row == 64, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Property loss: None
        row == 65, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Property loss: Burned
        row == 66, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Property loss: Counterfeited/forged
        row == 67, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Property loss: Destroyed/damaged/vandalized
        row == 68, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Property loss: Recovered
        row == 69, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Property loss: Seized
        row == 70, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Property loss: Stolen/Et
        row == 71, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Property loss: Unknown
        row == 72, CREATE_PERCENTAGE_DENOMINATOR(c(72:75), column), #MSA: MSA Counties
        row == 73, CREATE_PERCENTAGE_DENOMINATOR(c(72:75), column), #MSA: Outside MSA
        row == 74, CREATE_PERCENTAGE_DENOMINATOR(c(72:75), column), #MSA: Non-MSA Counties
        row == 75, CREATE_PERCENTAGE_DENOMINATOR(c(72:75), column), #MSA: Missing
		...
		row == 87, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Location type 3: Residence
		row == 88, CREATE_PERCENTAGE_DENOMINATOR(c(1), column) #Location type 3: Not residence
...
run_main <- function(){
  ...
  der_drop_rows <- c(
    48,	#Population group	  Possessions and Canal Zone
    55	#Agency indicator	  Federal agencies
  )
  ######################################################################################################################
