  ...
  if(nrow(raw_percentage_3) > 0) {
    ...
    raw_percentage_3_dt[,
      raw_denominator := fcase(
        #Total
        row == 2, CREATE_PERCENTAGE_DENOMINATOR(c(2:10), column), #Suspected type of drug: Cocaine/crack cocaine (A, B)
        row == 3, CREATE_PERCENTAGE_DENOMINATOR(c(2:10), column), #Suspected type of drug: Marijuana/hashish (C, E)
        row == 4, CREATE_PERCENTAGE_DENOMINATOR(c(2:10), column), #Suspected type of drug: Opiate/narcotic (D, F, G, H)
        row == 5, CREATE_PERCENTAGE_DENOMINATOR(c(2:10), column), #Suspected type of drug: Hallucinogen (I, J, K)
        row == 6, CREATE_PERCENTAGE_DENOMINATOR(c(2:10), column), #Suspected type of drug: Stimulant (L, M)
        row == 7, CREATE_PERCENTAGE_DENOMINATOR(c(2:10), column), #Suspected type of drug: Depressant (N, O)
        row == 8, CREATE_PERCENTAGE_DENOMINATOR(c(2:10), column), #Suspected type of drug: Other (P)
        row == 9, CREATE_PERCENTAGE_DENOMINATOR(c(2:10), column), #Suspected type of drug: Unknown (U)
        row == 10, CREATE_PERCENTAGE_DENOMINATOR(c(2:10), column), #Suspected type of drug: More Than 3 Types (X)
        # row == 11, CREATE_PERCENTAGE_DENOMINATOR(c(11:19), column), #Suspected type of seized drug: Cocaine/crack cocaine (A, B)
        # row == 12, CREATE_PERCENTAGE_DENOMINATOR(c(11:19), column), #Suspected type of seized drug: Marijuana/hashish (C, E)
        # row == 13, CREATE_PERCENTAGE_DENOMINATOR(c(11:19), column), #Suspected type of seized drug: Opiate/narcotic (D, F, G, H)
        # row == 14, CREATE_PERCENTAGE_DENOMINATOR(c(11:19), column), #Suspected type of seized drug: Hallucinogen (I, J, K)
        # row == 15, CREATE_PERCENTAGE_DENOMINATOR(c(11:19), column), #Suspected type of seized drug: Stimulant (L, M)
        # row == 16, CREATE_PERCENTAGE_DENOMINATOR(c(11:19), column), #Suspected type of seized drug: Depressant (N, O)
        # row == 17, CREATE_PERCENTAGE_DENOMINATOR(c(11:19), column), #Suspected type of seized drug: Other (P)
        # row == 18, CREATE_PERCENTAGE_DENOMINATOR(c(11:19), column), #Suspected type of seized drug: Unknown (U)
        # row == 19, CREATE_PERCENTAGE_DENOMINATOR(c(11:19), column), #Suspected type of seized drug: More Than 3 Types (X)
      ),
