  ...
  if(nrow(raw_percentage_3) > 0) {
    ...
    raw_percentage_3_dt[,
      raw_denominator := fcase(
        ...
        row == 3, CREATE_PERCENTAGE_DENOMINATOR(c(3:7), column), #Number of Offenders: 1
        row == 4, CREATE_PERCENTAGE_DENOMINATOR(c(3:7), column), #Number of Offenders: 2
        row == 5, CREATE_PERCENTAGE_DENOMINATOR(c(3:7), column), #Number of Offenders: 3
        row == 6, CREATE_PERCENTAGE_DENOMINATOR(c(3:7), column), #Number of Offenders: 4+
        row == 7, CREATE_PERCENTAGE_DENOMINATOR(c(3:7), column), #Number of Offenders: Unknown Offender Incidents
        row == 8, CREATE_PERCENTAGE_DENOMINATOR(c(8:10), column), #Clearance: Not cleared
        row == 9, CREATE_PERCENTAGE_DENOMINATOR(c(8:10), column), #Clearance: Cleared through arrest
        row == 10, CREATE_PERCENTAGE_DENOMINATOR(c(8:10), column), #Clearance: Exceptional clearance
        row == 11, CREATE_PERCENTAGE_DENOMINATOR(c(11:15), column), #Clearance: Death of offender
        row == 12, CREATE_PERCENTAGE_DENOMINATOR(c(11:15), column), #Clearance: Prosecution declined
        row == 13, CREATE_PERCENTAGE_DENOMINATOR(c(11:15), column), #Clearance: In custody of other jurisdiction
        row == 14, CREATE_PERCENTAGE_DENOMINATOR(c(11:15), column), #Clearance: Victim refused to cooperate
        row == 15, CREATE_PERCENTAGE_DENOMINATOR(c(11:15), column) #Clearance: Juvenile/no custody
