  ...
  if(nrow(raw_percentage_3) > 0) {
    ...
    raw_percentage_3_dt[,
      raw_denominator := fcase(
        #Victimization count 12-17
        row == 2, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Age: 12-14
        row == 3, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Age: 15-17
        row == 4, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim sex: Male
        row == 5, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim sex: Female
        row == 6, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim sex: Unknown
        row == 7, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Ethnicity: Hispanic or Latino
        row == 8, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Ethnicity: Not Hispanic or Latino
        row == 9, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Ethnicity: Multiple/Unknown/Not Specified
        row == 10, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Hispanic or Latino/Race: White
        row == 11, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Hispanic or Latino/Race: Black
        row == 12, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Hispanic or Latino/Race: Other Race
        row == 13, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Hispanic or Latino/Race: Unknown Race
        row == 14, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Not Hispanic or Latino/Race: White
        row == 15, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Not Hispanic or Latino/Race: Black
        row == 16, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Not Hispanic or Latino/Race: Other Race
        row == 17, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Not Hispanic or Latino/Race: Unknown Race
        row == 18, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Multiple/Unknown/Not Specified Ethnicity/Race: White
        row == 19, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Multiple/Unknown/Not Specified Ethnicity/Race: Black
        row == 20, CREATE_PERCENTAGE_DENOMINATOR(c(1), column), #Victim Multiple/Unknown/Not Specified Ethnicity/Race: Other Race
        row == 21, CREATE_PERCENTAGE_DENOMINATOR(c(1), column) #Victim Multiple/Unknown/Not Specified Ethnicity/Race: Unknown Race
      ),
