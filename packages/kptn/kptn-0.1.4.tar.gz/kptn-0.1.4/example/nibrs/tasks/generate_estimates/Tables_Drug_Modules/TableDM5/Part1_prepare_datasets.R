...
log_info("Running 21_TableDM5_part1_prepare_datasets.R")
...
#Note each level needs to count one time due to multi-level structure of query (i.e. multiple offenses)
#The table wants to count the number of incident one time in each row.
