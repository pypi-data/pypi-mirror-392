...
class KDCObject:
    ...
    def init(self,
        ...
        self._domain = self._gn_crt_data['domain']
        self._kdc_domain = self._gn_crt_data['kdc_domain']

        
        self._datax_domain_keyId[self._kdc_domain] = 0
        self._datax_keyId_key[0] = self._gn_crt_data['kdc_key']
