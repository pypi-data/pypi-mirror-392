                ...
                if right_secondary == True:
                    ...
                    for k in range(len(res)):
                        ...
                        if two_right == True:
                            ...
                            secondary_indices = np.arange(k + 1, k + extra + 1) #avoid off by one error from using arange
                                ...
                                if len(np.where((labeled_array == value))[0]) >= 3:
                                    ...
                                    if normalized_flux[tertiary_peak_index][0] > median_flux + magic_flare_std * flux_std:
                                        ...
                                        if visualize_fit == True:
                                            ...
                                            plt.scatter(time[tertiary_flare_indices],
                                                        normalized_flux[tertiary_flare_indices], s = 10,
                                                        color = secondary_color, label = 'Flare Points')
                                            plt.errorbar(time[tertiary_flare_indices],
                                                         normalized_flux[tertiary_flare_indices],
                                                         yerr = flux_std, linestyle = '', capsize = 4, color = tertiary_color)
