...
# Function: Date Required to Finish with Probability Y
...
def gantt_chart(dataset, dates, size_x = 15, size_y = 10, show_slack = True, time_label = "Time"):
...
# Function: Gantt Chart
def gantt_chart_dep(dataset, dates, size_x = 15, size_y = 10, show_slack = True, time_label = "Time"):
