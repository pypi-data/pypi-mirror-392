...
* `worker_timeout_threshold` lets you override how many handler watchdog timeouts a worker tolerates before draining/restarting (0 keeps the automatic `ceil(0.3 * max_threads_per_process)` heuristic).
