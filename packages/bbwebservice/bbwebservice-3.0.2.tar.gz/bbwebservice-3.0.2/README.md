...
* `worker_processes` sets how many handler processes run in parallel (default: CPU count). Together with `max_threads` it determines the maximum number of concurrent sockets.
