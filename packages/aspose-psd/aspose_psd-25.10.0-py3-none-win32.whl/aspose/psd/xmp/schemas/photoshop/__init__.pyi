...
class ColorMode:
    ...
    @classmethod
    @property
    def BITMAP(cls) -> ColorMode:
        '''Bitmap color mode.'''
        ...
    
    @classmethod
    @property
    def GRAY_SCALE(cls) -> ColorMode:
        '''Gray scale color mode.'''
        ...
    
    @classmethod
    @property
    def INDEXED_COLOR(cls) -> ColorMode:
        '''The indexed color.'''
        ...
    
    @classmethod
    @property
    def RGB(cls) -> ColorMode:
        '''RGB color.'''
        ...
    
    @classmethod
    @property
    def CMYK(cls) -> ColorMode:
        '''CMYK color mode.'''
        ...
    
    @classmethod
    @property
    def MULTI_CHANNEL(cls) -> ColorMode:
        '''Multi-channel color.'''
        ...
    
    @classmethod
    @property
    def DUOTONE(cls) -> ColorMode:
        '''Duo-tone color.'''
        ...
    
    @classmethod
    @property
    def LAB_COLOR(cls) -> ColorMode:
        '''LAB color.'''
        ...
