...
class EventType:
    ...
    @classmethod
    @property
    def RELATIVE_PROGRESS(cls) -> EventType:
        '''Relative progress of current stage of the operation processing'''
        ...
    
    @classmethod
    @property
    def STAGE_CHANGE(cls) -> EventType:
        '''The next stage of the operation started'''
        ...
    
    @classmethod
    @property
    def INITIALIZATION(cls) -> EventType:
        '''The initialization of the operation'''
        ...
    
    @classmethod
    @property
    def PRE_PROCESSING(cls) -> EventType:
        '''The pre processing'''
        ...
    
    @classmethod
    @property
    def PROCESSING(cls) -> EventType:
        '''The processing'''
        ...
    
    @classmethod
    @property
    def FINALIZATION(cls) -> EventType:
