...
"""
    ...
    def test_vhs_installed(self):
        ...
        assert check_vhs_installed(), (
            "VHS is not installed. Install with: brew install vhs (macOS) "
    ...
    async def test_vhs_check_function(self):
        ...
        from massgen.tool._multimodal_tools.run_massgen_with_recording import _check_vhs_installed
    ...
    async def test_vhs_tape_creation(self, temp_dir):
        ...
        from massgen.tool._multimodal_tools.run_massgen_with_recording import _create_vhs_tape
    ...
    async def test_tool_without_vhs(self, temp_dir, simple_config, monkeypatch):
        ...
        from massgen.tool._multimodal_tools.run_massgen_with_recording import run_massgen_with_recording
