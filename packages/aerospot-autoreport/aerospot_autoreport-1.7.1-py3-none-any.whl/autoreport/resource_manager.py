...
class ResourceManager:
    ...
    def get_resource(self, url: str | list, resource_type: str, force_download: bool = False) -> str:
        """获取资源，优先使用缓存
        ...
        if isinstance(url, str):
            ...
            for each_url in url:
                filepath = self.get_resource(each_url, 'historical_csv')
                historical_csv_paths.append(os.path.abspath(filepath))
            return historical_csv_paths
