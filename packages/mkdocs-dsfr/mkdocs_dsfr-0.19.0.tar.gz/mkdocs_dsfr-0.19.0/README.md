...
## Options de lettre d'information `infolettre` (Déprécié)
...
Dépréciée. Utilisez le composant `newsletter` pour insérer la lettre d'information sur chaque page de votre choix.
...
### Version 0.19.0 (DSFR 1.14.2)
* Ajout du composant newsletter pour insérer la lettre d'information sur chaque page de votre choix
* Dépréciation du composant infolettre dans la configuration du thème
* Ajout d'un lien de retour haut de page dans le menu latéral
* Correction absence d'ancre en haut de page pour le bouton retour haut de page

### Version 0.18.1 (DSFR 1.14.2)
* Correction d'un bug sur les liens RSS
