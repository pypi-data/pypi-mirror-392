const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./BySF-3Qf.js","./f5NiF4Sn.js","./DUftb7my.js","./DEzry6cj.js","./DdkXqxbl.js","./CFcrUK-J.js","./Baatqp4e.js","./RvoTXknD.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./DUftb7my.js";
import { L as Logger, aF as SphericalPolynomial, V as Vector3, I as InternalTexture, B as BaseTexture, e as Tools, aG as ILog2, aH as PostProcess } from "./f5NiF4Sn.js";
import "./BWOjRsQS.js";
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
  ...
  if (expandTexture) {
    if (engine.isWebGPU) {
      shaderLanguage = 1;
      await __vitePreload(() => import("./BySF-3Qf.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url);
    } else {
      await __vitePreload(() => import("./Baatqp4e.js"), true ? __vite__mapDeps([6,1,2,3,4,7]) : void 0, import.meta.url);
    }
...
//# sourceMappingURL=6wiZhNu7.js.map
