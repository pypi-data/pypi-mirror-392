...
class OSDUUser(HttpUser):
    ...
    def check_service_health(self):
        ...
        response = self.client.get("/api/{service_name}/v2/liveness_check", headers=self.headers)
