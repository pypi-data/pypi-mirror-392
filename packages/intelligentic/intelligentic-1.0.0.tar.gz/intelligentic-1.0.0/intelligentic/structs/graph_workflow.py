...
from intelligentic.structs.agent import Agent  # noqa: F401
from intelligentic.structs.conversation import Conversation
from intelligentic.utils.get_cpu_cores import get_cpu_cores
    ...
    def to_json(
        ...
        try:
            ...
            if fast:
                ...
                try:
                    from intelligentic.tools.json_utils import str_to_json
    ...
    def from_json(cls, json_str, restore_runtime_state=False):
        ...
        try:
            ...
            if "conversation" in data and data["conversation"]:
                try:
                    from intelligentic.structs.conversation import (
                        Conversation,
                    )
