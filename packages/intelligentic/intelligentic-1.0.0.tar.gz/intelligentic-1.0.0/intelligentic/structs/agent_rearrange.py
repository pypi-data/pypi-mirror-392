...
from intelligentic.structs.multi_agent_exec import run_agents_concurrently
from intelligentic.structs.swarm_id import swarm_id
from intelligentic.telemetry.main import log_agent_data
from intelligentic.utils.any_to_str import any_to_str
...
def rearrange(
    ...
    **kwargs,
    ...
    Example:
        >>> from intelligentic import Agent, rearrange
        >>>
        >>> # Create agents
        >>> agent1 = Agent(name="researcher", ...)
        >>> agent2 = Agent(name="writer", ...)
