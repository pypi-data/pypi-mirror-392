...
1. **Import Statements**:
   ...
   - Import the SOPs for each agent type from intelligentic.prompts.(insert swarm team name here). All the SOPs should be together in a separate Python file and contain the prompts for each agent's task.
...
from intelligentic.structs import Agent
import intelligentic.prompts.swarm_daddy as sdsp
