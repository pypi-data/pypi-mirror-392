...
def get_metamodel_repository(
    ...
    return SQLMetamodelRepository(session)
...
def get_instances_repository(
    ...
    return ObjectInstanceRepositoryAdapter(sql_repo, metamodel_repository)
...
def get_linked_objects_repository(
    ...
    return LinkedObjectRepositoryAdapter(sql_repo, metamodel_repository)
...
def get_instances_service(
    ...
    return InstancesService(instances_repository, metamodel_repository, event_bus)
