...
def sign_canonical(payload: dict[str, Any], algo: str, private_repr: str, canonical: str = "json") -> str:
    message = canonical_bytes({k: v for k, v in payload.items() if k != "signature"}, mode=canonical)
    if algo == "ecdsa":
