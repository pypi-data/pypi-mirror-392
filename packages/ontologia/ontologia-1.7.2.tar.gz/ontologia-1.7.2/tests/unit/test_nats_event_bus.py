...
class TestNATSEventBus:
    ...
    @pytest.mark.asyncio
    async def test_ensure_connection_with_auth(self, event_bus: NATSEventBus, mock_nats: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ensure_connection_with_token(self, event_bus: NATSEventBus, mock_nats: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_publish_async_basic_nats(self, event_bus: NATSEventBus, mock_nats: MagicMock) -> None:
    ...
    def test_publish_sync_context(self, event_bus: NATSEventBus, mock_nats: MagicMock, caplog) -> None:
