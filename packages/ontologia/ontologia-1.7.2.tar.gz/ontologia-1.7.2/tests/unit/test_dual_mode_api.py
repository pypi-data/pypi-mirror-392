...
from ontologia_api.v2.routers.objects import router, OGM_AVAILABLE
from ontologia_api.v2.schemas.instances import ObjectUpsertRequest, ObjectReadResponse
...
class TestDualModeAPI:
    ...
    def test_get_ogm_mode(self, client, mock_user_principal):
        ...
        with patch('ontologia_api.v2.routers.objects.get_model_class') as mock_get_model, \
            ...
            response = client.get("/v3/ontologies/test/runtime/objects/test_type/test_pk?use_ogm=true&a=1&k=1")
    ...
    def test_delete_service_mode(self, client, app, mock_user_principal):
        ...
        with patch('ontologia.application.instances_service.InstancesService.delete_object') as mock_delete:
    ...
    def test_delete_ogm_mode(self, client, mock_user_principal):
        ...
        with patch('ontologia_api.v2.routers.objects.get_model_class') as mock_get_model:
            ...
            response = client.delete("/v3/ontologies/test/runtime/objects/test_type/test_pk?use_ogm=true")
    ...
    def test_ogm_fallback_to_service(self, client, app, mock_user_principal):
        ...
        with patch('ontologia_api.v2.routers.objects.get_model_class') as mock_get_model, \
             patch('ontologia.application.instances_service.InstancesService.upsert_object') as mock_upsert:
    ...
    def test_ogm_unavailable_fallback(self, client, app, mock_user_principal):
        ...
        with patch('ontologia_api.v2.routers.objects.OGM_AVAILABLE', False):
            with patch('ontologia.application.instances_service.InstancesService.upsert_object') as mock_upsert:
                mock_result = MagicMock()
                mock_result.pk_value = "test-pk"
                mock_result.rid = "test-rid"
                mock_result.properties = {"name": "test"}
