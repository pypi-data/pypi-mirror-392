...
def bump_semver(version: str, part: str) -> str:
    ...
    maj, min_, pat, rest = int(m.group("maj")), int(m.group("min")), int(m.group("pat")), m.group("rest")
...
def main() -> None:
    ...
    group.add_argument("part", nargs="?", choices=["major", "minor", "patch"], help="Which part to bump")
