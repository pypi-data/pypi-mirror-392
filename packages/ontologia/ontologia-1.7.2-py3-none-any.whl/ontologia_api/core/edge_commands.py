...
class CommandQueue:
    async def enqueue(self, cmd: EnqueuedCommand, *, ttl: int | None = None) -> None:  # pragma: no cover - interface
        raise NotImplementedError

    async def pull(self, node_id: str, *, max_items: int = 10) -> list[EnqueuedCommand]:  # pragma: no cover - interface
        raise NotImplementedError

    async def pull_blocking(self, node_id: str, *, timeout: int = 0, max_items: int = 10) -> list[EnqueuedCommand]:
