...
class InstancesService:
    ...
    def upsert_object(
        ...
        try:
            ...
            print(f"DEBUG: API service - session state after domain upsert: new={len(self._session.new)}, dirty={len(self._session.dirty)}")
    ...
    def get_object(
        ...
        *,
        ...
        try:
            ...
            if exc.status_code == status.HTTP_404_NOT_FOUND and swallow_404:
                domain_result = None
            else:
                raise
