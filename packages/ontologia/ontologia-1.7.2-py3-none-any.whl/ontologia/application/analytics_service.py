...
class AnalyticsService:
    ...
    async def _execute_count_query(
        ...
        # Build table name based on object type
        table_name = f"ot_{query.object_type_api_name}"
    ...
    async def _execute_sum_query(
        ...
        # Build sum query
        sql = f"SELECT SUM({query.property_name}) as sum_value FROM {table_name}{where_clause}"
    ...
    async def _execute_average_query(
        ...
        # Build average query
        sql = f"SELECT AVG({query.property_name}) as avg_value FROM {table_name}{where_clause}"
    ...
    async def _execute_min_query(
        ...
        # Build min query
        sql = f"SELECT MIN({query.property_name}) as min_value FROM {table_name}{where_clause}"
    ...
    async def _execute_max_query(
        ...
        # Build max query
        sql = f"SELECT MAX({query.property_name}) as max_value FROM {table_name}{where_clause}"
    ...
    async def _execute_distribution_query(
        ...
        sql = f"SELECT {query.property_name} as value, COUNT(*) as count FROM {table_name}{where_clause} GROUP BY {query.property_name} ORDER BY count DESC"
    ...
    async def _execute_trend_query(
        ...
        SELECT 
            ...
            AVG({query.property_name}) as avg_value,
            MIN({query.property_name}) as min_value,
            MAX({query.property_name}) as max_value,
            COUNT(*) as count
