...
from ontologia.application.instances_service import InstancesService as DomainInstancesService
...
class ChangeSetService:
    def __init__(
        ...
        *,
        ...
        # SQLObjectInstanceRepository kept for reference; no direct usage required here
        metamodel_service = DomainMetamodelService(meta_repo)
        # Pass session to InstancesService to use the SQL adapter path and avoid
        # interface mismatches with the domain repository Protocol.
        instances_service = DomainInstancesService(session, meta_repo)
