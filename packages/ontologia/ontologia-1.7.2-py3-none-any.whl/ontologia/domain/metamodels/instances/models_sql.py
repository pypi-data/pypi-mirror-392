...
class ObjectInstance(ResourceTypeBaseModel, table=True):
    ...
    service_value: str = Field(default="default", alias="_service", index=True, description="Service identifier")
    instance_value: str = Field(default="default", alias="_instance", index=True, description="Instance identifier")
