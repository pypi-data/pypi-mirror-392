...
STANDARD_LOGGING_LOCATION = pathlib.Path('/media/bitlockermount-d/') if sys.platform.startswith('linux') else pathlib.Path('D:\\')
production_run = 'operative' in pathlib.Path.cwd().parts
STANDARD_LOGGING_LOCATION = STANDARD_LOGGING_LOCATION.joinpath('ephem') if production_run else STANDARD_LOGGING_LOCATION.joinpath('temp')     
STANDARD_LOGGING_LOCATION = STANDARD_LOGGING_LOCATION.joinpath('logging') 
