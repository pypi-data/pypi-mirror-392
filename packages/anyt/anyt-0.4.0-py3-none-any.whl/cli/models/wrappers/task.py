...
class Task:
    ...
    def estimate(self) -> Optional[int]:
        """Get estimate as integer hours."""
        return int(self._task.estimate) if self._task.estimate is not None else None

    @property
    def labels(self) -> list[str]:
        """Get task labels (always returns a list, never None)."""
        return self._task.labels or []
    ...
    @property
    def estimate_hours(self) -> Optional[int]:
        """Get estimate as integer hours (alias for estimate property)."""
    ...
    def _convert_status_to_domain(
        ...
        status_enum_map = {  # type: ignore[unreachable]
            ...
            GeneratedTaskStatus.INPROGRESS: Status.IN_PROGRESS,
    ...
    def _convert_assignee_type_to_domain(
        ...
        assignee_type_map = {
            ...
            GeneratedAssigneeType.AGENT: AssigneeType.AGENT,
        }
