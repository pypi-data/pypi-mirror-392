...
async def getUserPreferences(api_config_override : Optional[APIConfig] = None, *, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Union[UserPreferencesResponse,None]:
...
async def deleteUserPreferences(api_config_override : Optional[APIConfig] = None, *, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def setCurrentWorkspace(api_config_override : Optional[APIConfig] = None, *, data : SetWorkspaceRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> UserPreferencesResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def setCurrentProject(api_config_override : Optional[APIConfig] = None, *, data : SetProjectRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> UserPreferencesResponse:
    api_config = api_config_override if api_config_override else APIConfig()
