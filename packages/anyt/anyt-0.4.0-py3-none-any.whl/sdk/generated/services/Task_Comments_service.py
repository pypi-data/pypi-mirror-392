...
def listTaskComments(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, limit : Optional[int] = None, offset : Optional[int] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> CommentListResponse:
...
def createTaskComment(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, data : CreateCommentRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> CommentResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
def getTaskCommentStats(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> CommentStatsResponse:
    api_config = api_config_override if api_config_override else APIConfig()
