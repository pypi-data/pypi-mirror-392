...
async def listLabels(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> List[Label]:
...
async def createLabel(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : LabelCreate, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Label:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def deleteLabel(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, label_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def updateLabel(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, label_id : int, data : LabelUpdate, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Label:
    api_config = api_config_override if api_config_override else APIConfig()
