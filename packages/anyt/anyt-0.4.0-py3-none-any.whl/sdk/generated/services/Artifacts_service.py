...
def listAttemptArtifacts(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, attempt_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> ArtifactListResponse:
...
def createArtifact(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, attempt_id : int, data : CreateArtifactRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Artifact:
    api_config = api_config_override if api_config_override else APIConfig()
...
def getArtifact(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, artifact_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Artifact:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return Artifact(**body) if body is not None else Artifact()
def downloadArtifact(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, artifact_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
