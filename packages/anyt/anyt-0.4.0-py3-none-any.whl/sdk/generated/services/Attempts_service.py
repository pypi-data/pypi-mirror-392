...
def startAttempt(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, data : StartAttemptRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptResponse:
...
def finishAttempt(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, attempt_id : int, data : FinishAttemptRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return AttemptResponse(**body) if body is not None else AttemptResponse()
def getAttempt(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, attempt_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return AttemptResponse(**body) if body is not None else AttemptResponse()
def updateAttempt(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, attempt_id : int, data : AttemptUpdate, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return AttemptResponse(**body) if body is not None else AttemptResponse()
def listTaskAttempts(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptListResponse:
    api_config = api_config_override if api_config_override else APIConfig()
