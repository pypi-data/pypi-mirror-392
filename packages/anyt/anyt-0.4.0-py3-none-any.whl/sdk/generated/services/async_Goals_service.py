...
async def listGoals(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, status_filter : Optional[Union[str,None]] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> List[GoalResponse]:
...
async def createGoal(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : CreateGoalRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> GoalResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def getGoal(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, goal_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> GoalResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return GoalResponse(**body) if body is not None else GoalResponse()
async def deleteGoal(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, goal_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def decomposeGoal(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, goal_id : int, data : DecompositionRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> DecompositionResponse:
    api_config = api_config_override if api_config_override else APIConfig()
