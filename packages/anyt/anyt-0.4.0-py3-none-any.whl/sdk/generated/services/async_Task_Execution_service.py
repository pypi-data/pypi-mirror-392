...
async def getWorkspaceExecutionOrder(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, project_id : Optional[Union[int,None]] = None, num_runners : Optional[int] = None, include_completed : Optional[bool] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> ExecutionOrderResponse:
...
async def getProjectExecutionOrder(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, project_id : int, num_runners : Optional[int] = None, include_completed : Optional[bool] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> ExecutionOrderResponse:
    api_config = api_config_override if api_config_override else APIConfig()
