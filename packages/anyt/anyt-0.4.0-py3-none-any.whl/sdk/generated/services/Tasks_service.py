...
def bulkUpdateTasks(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : BulkUpdateTasksRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> BulkUpdateTasksResponse:
...
def createTask(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : CreateTaskRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Task:
    api_config = api_config_override if api_config_override else APIConfig()
...
def getTask(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Task:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return Task(**body) if body is not None else Task()
def deleteTask(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def updateTask(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, data : TaskUpdate, If_Match : Optional[Union[int,None]] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Task:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return Task(**body) if body is not None else Task()
def autoFillTask(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, data : AutoFillRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AutoFillResponse:
    api_config = api_config_override if api_config_override else APIConfig()
