...
def getComment(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, comment_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> CommentResponse:
...
def deleteComment(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, comment_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def updateComment(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, comment_id : int, data : CommentUpdate, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> CommentResponse:
    api_config = api_config_override if api_config_override else APIConfig()
