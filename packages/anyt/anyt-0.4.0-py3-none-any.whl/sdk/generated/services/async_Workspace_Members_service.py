...
async def listWorkspaceMembers(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, page : Optional[int] = None, per_page : Optional[int] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> WorkspaceMemberListResponse:
...
async def addWorkspaceMember(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : AddMemberRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> WorkspaceMemberResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def removeWorkspaceMember(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, member_user_id : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def updateWorkspaceMember(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, member_user_id : str, data : UpdateMemberRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> WorkspaceMemberResponse:
    api_config = api_config_override if api_config_override else APIConfig()
