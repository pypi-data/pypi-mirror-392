...
async def organizeWorkspace(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : OrganizeRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> OrganizeResponse:
...
async def listSummaries(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, period : Optional[Union[str,None]] = None, limit : Optional[int] = None, offset : Optional[int] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> List[SummaryResponse]:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def createSummary(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : SummaryRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> SummaryResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def getDuplicates(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> List[DuplicateSuggestion]:
    api_config = api_config_override if api_config_override else APIConfig()
