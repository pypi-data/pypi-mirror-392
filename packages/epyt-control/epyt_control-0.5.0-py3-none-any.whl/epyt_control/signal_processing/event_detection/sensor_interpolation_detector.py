...
class SensorInterpolationDetector(EventDetector):
    ...
    def fit(self, scada_data: Union[ScadaData, np.ndarray]) -> None:
        ...
        Parameters
        ----------
        scada_data : `ScadaData <https://epyt-flow.readthedocs.io/en/stable/epyt_flow.simulation.scada.html#epyt_flow.simulation.scada.scada_data.ScadaData>`_ or `numpy.ndarray <https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html>`_
