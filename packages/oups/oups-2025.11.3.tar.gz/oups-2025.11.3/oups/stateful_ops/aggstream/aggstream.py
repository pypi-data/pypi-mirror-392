...
def _init_keys_config(
    ...
    for key, key_conf_in in keys_config.items():
        ...
        try:
            ...
            raise ValueError(f"'{KEY_BIN_BY}' parameter is missing for key '{key}'.") from None
        ...
        try:
            ...
            raise ValueError(f"exception raised for key '{key}'") from None
    ...
    for seed_chunk in seed:
        ...
        if pre:
            ...
            try:
                ...
                raise SeedPreException(str(e)) from None
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs : dict
            ...
            `row_group_target_size` or `duplicates_on` parameters (see notes below
            for `duplicates_on`).
