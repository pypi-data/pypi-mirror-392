"""
PNG to PDF converter with quality preservation.
"""
    ...
    def convert(self, input_path: str, output_path: str) -> None:
        ...
        try:
            ...
            raise ConversionError(
                f"PNG to PDF conversion failed: {e}",
                source_format="png",
                target_format="pdf",
                suggestions=[
                    "Ensure PNG file is not corrupted",
                    "Check if PNG file is readable by PIL/Pillow"
                ]
            )