...
class ScsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetWithHash = channel.unary_unary(
                '/cache_client.Scs/GetWithHash',
                request_serializer=cacheclient__pb2._GetWithHashRequest.SerializeToString,
                response_deserializer=cacheclient__pb2._GetWithHashResponse.FromString,
                )
        ...
        self.SetIfHash = channel.unary_unary(
                '/cache_client.Scs/SetIfHash',
                request_serializer=cacheclient__pb2._SetIfHashRequest.SerializeToString,
                response_deserializer=cacheclient__pb2._SetIfHashResponse.FromString,
                )
...
class ScsServicer(object):
    ...
    def GetWithHash(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def SetIfHash(self, request, context):
...
def add_ScsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetWithHash': grpc.unary_unary_rpc_method_handler(
                    servicer.GetWithHash,
                    request_deserializer=cacheclient__pb2._GetWithHashRequest.FromString,
                    response_serializer=cacheclient__pb2._GetWithHashResponse.SerializeToString,
            ),
            ...
            'SetIfHash': grpc.unary_unary_rpc_method_handler(
                    servicer.SetIfHash,
                    request_deserializer=cacheclient__pb2._SetIfHashRequest.FromString,
                    response_serializer=cacheclient__pb2._SetIfHashResponse.SerializeToString,
            ),
...
class Scs(object):
    ...
    def GetWithHash(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cache_client.Scs/GetWithHash',
            cacheclient__pb2._GetWithHashRequest.SerializeToString,
            cacheclient__pb2._GetWithHashResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetIfHash(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cache_client.Scs/SetIfHash',
            cacheclient__pb2._SetIfHashRequest.SerializeToString,
            cacheclient__pb2._SetIfHashResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
