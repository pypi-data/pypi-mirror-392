...
class _Discontinuity(_message.Message):
    __slots__ = ["last_topic_sequence", "new_sequence_page", "new_topic_sequence"]
    LAST_TOPIC_SEQUENCE_FIELD_NUMBER: _ClassVar[int]
    NEW_SEQUENCE_PAGE_FIELD_NUMBER: _ClassVar[int]
    NEW_TOPIC_SEQUENCE_FIELD_NUMBER: _ClassVar[int]
    last_topic_sequence: int
    new_sequence_page: int
    new_topic_sequence: int
    def __init__(self, last_topic_sequence: _Optional[int] = ..., new_topic_sequence: _Optional[int] = ..., new_sequence_page: _Optional[int] = ...) -> None: ...
...
class _SubscriptionRequest(_message.Message):
    __slots__ = ["cache_name", "resume_at_topic_sequence_number", "sequence_page", "topic"]
    CACHE_NAME_FIELD_NUMBER: _ClassVar[int]
    RESUME_AT_TOPIC_SEQUENCE_NUMBER_FIELD_NUMBER: _ClassVar[int]
    SEQUENCE_PAGE_FIELD_NUMBER: _ClassVar[int]
    TOPIC_FIELD_NUMBER: _ClassVar[int]
    cache_name: str
    resume_at_topic_sequence_number: int
    sequence_page: int
    topic: str
    def __init__(self, cache_name: _Optional[str] = ..., topic: _Optional[str] = ..., resume_at_topic_sequence_number: _Optional[int] = ..., sequence_page: _Optional[int] = ...) -> None: ...

class _TopicItem(_message.Message):
    __slots__ = ["publisher_id", "sequence_page", "topic_sequence_number", "value"]
    ...
    value: _TopicValue
    def __init__(self, topic_sequence_number: _Optional[int] = ..., value: _Optional[_Union[_TopicValue, _Mapping]] = ..., publisher_id: _Optional[str] = ..., sequence_page: _Optional[int] = ...) -> None: ...
