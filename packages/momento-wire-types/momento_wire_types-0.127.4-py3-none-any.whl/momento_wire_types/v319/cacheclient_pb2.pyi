...
class _GetWithHashRequest(_message.Message):
    __slots__ = ["cache_key"]
    CACHE_KEY_FIELD_NUMBER: _ClassVar[int]
    cache_key: bytes
    def __init__(self, cache_key: _Optional[bytes] = ...) -> None: ...

class _GetWithHashResponse(_message.Message):
    __slots__ = ["found", "missing"]
    class _Found(_message.Message):
        ...
        hash: bytes
        value: bytes
        def __init__(self, value: _Optional[bytes] = ..., hash: _Optional[bytes] = ...) -> None: ...
    class _Missing(_message.Message):
        __slots__ = []
        def __init__(self) -> None: ...
    FOUND_FIELD_NUMBER: _ClassVar[int]
    MISSING_FIELD_NUMBER: _ClassVar[int]
    found: _GetWithHashResponse._Found
    missing: _GetWithHashResponse._Missing
    def __init__(self, found: _Optional[_Union[_GetWithHashResponse._Found, _Mapping]] = ..., missing: _Optional[_Union[_GetWithHashResponse._Missing, _Mapping]] = ...) -> None: ...
...
class _SetIfHashRequest(_message.Message):
    __slots__ = ["absent_or_hash_equal", "absent_or_not_hash_equal", "cache_body", "cache_key", "present_and_hash_equal", "present_and_not_hash_equal", "ttl_milliseconds", "unconditional"]
    ABSENT_OR_HASH_EQUAL_FIELD_NUMBER: _ClassVar[int]
    ABSENT_OR_NOT_HASH_EQUAL_FIELD_NUMBER: _ClassVar[int]
    CACHE_BODY_FIELD_NUMBER: _ClassVar[int]
    CACHE_KEY_FIELD_NUMBER: _ClassVar[int]
    PRESENT_AND_HASH_EQUAL_FIELD_NUMBER: _ClassVar[int]
    PRESENT_AND_NOT_HASH_EQUAL_FIELD_NUMBER: _ClassVar[int]
    TTL_MILLISECONDS_FIELD_NUMBER: _ClassVar[int]
    UNCONDITIONAL_FIELD_NUMBER: _ClassVar[int]
    absent_or_hash_equal: _common_pb2.AbsentOrHashEqual
    absent_or_not_hash_equal: _common_pb2.AbsentOrNotHashEqual
    cache_body: bytes
    cache_key: bytes
    present_and_hash_equal: _common_pb2.PresentAndHashEqual
    present_and_not_hash_equal: _common_pb2.PresentAndNotHashEqual
    ttl_milliseconds: int
    unconditional: _common_pb2.Unconditional
    def __init__(self, cache_key: _Optional[bytes] = ..., cache_body: _Optional[bytes] = ..., ttl_milliseconds: _Optional[int] = ..., present_and_not_hash_equal: _Optional[_Union[_common_pb2.PresentAndNotHashEqual, _Mapping]] = ..., present_and_hash_equal: _Optional[_Union[_common_pb2.PresentAndHashEqual, _Mapping]] = ..., absent_or_hash_equal: _Optional[_Union[_common_pb2.AbsentOrHashEqual, _Mapping]] = ..., absent_or_not_hash_equal: _Optional[_Union[_common_pb2.AbsentOrNotHashEqual, _Mapping]] = ..., unconditional: _Optional[_Union[_common_pb2.Unconditional, _Mapping]] = ...) -> None: ...

class _SetIfHashResponse(_message.Message):
    ...
    class _Stored(_message.Message):
        ...
        new_hash: bytes
        def __init__(self, new_hash: _Optional[bytes] = ...) -> None: ...
    NOT_STORED_FIELD_NUMBER: _ClassVar[int]
    STORED_FIELD_NUMBER: _ClassVar[int]
    not_stored: _SetIfHashResponse._NotStored
    stored: _SetIfHashResponse._Stored
    def __init__(self, stored: _Optional[_Union[_SetIfHashResponse._Stored, _Mapping]] = ..., not_stored: _Optional[_Union[_SetIfHashResponse._NotStored, _Mapping]] = ...) -> None: ...
