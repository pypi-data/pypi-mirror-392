...
from .errors import AuthCodeInvalidError, AuthSSOError, AuthServerNetworkError, AuthServerResponseError
...
def create_sso_router(
    ...
    *,
    ...
    async def sso_login_wecom(
        ...
        consume_url = f"{base}/sso/consume"
    ...
    async def sso_consume(
        ...
        target = rd or "/"
        final_resp: Response = RedirectResponse(url=target, status_code=status.HTTP_302_FOUND)
