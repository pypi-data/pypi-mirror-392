...
def _extract_archive(file_name: str, output_dir: str, patch: bool):
    ...
    for rel_path, content in _parse_markdown_archive(md_text):
        ...
        if patch and os.path.exists(dest_path):
...
@add_argument('--patch', short='p', help='Add .patch suffix to duplicate files during extraction (default: overwrite existing files).', type=bool, default=False, required=False)
...
def entrypoint(create: bool, extract: bool, input_file: str, output_dir: str, file_name: str, locked: str, patch: bool, rules: List[str]):
    ...
    if create:
        ...
        _extract_archive(file_name, output_dir, patch)
