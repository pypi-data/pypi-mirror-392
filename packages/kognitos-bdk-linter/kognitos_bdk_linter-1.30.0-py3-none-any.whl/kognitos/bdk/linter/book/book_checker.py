        ...
        if authtoken_decorator:
            ...
            if access_token_arg:
                ...
                if not (util.is_sensitive_str_type(annotation) and not util.is_optional_type(annotation)):
                    self.add_message("oauthtoken-handler-wrong-arg-type", node=annotation, args=(annotation.as_string(), "Sensitive[str]"))
            else:
                self.add_message("oauthtoken-handler-missing-arg", node=node, args=("access_token", "Sensitive[str]"))
