    ...
    def make_instance(self, include_optional) -> RequeteSoumissionFlux:
        ...
        if include_optional:
            return RequeteSoumissionFlux(
                ...
                tracking_id = '',
                request_id = '',
                pdp_credentials = {client_id=factpulse_prod_abc123, client_secret=secret_xyz789, flow_service_url=https://api.pdp-example.fr/flow/v1, token_url=https://auth.pdp-example.fr/oauth/token}
            )
        else:
            return RequeteSoumissionFlux(
                nom_flux = 'Facture 2025-001',
