...
class UtilisateurApi:
    ...
    @validate_call
    def obtenir_infos_utilisateur_api_v1_moi_get(
        self,
        ...
        _param = self._obtenir_infos_utilisateur_api_v1_moi_get_serialize(
    ...
    @validate_call
    def obtenir_infos_utilisateur_api_v1_moi_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def obtenir_infos_utilisateur_api_v1_moi_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _obtenir_infos_utilisateur_api_v1_moi_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
