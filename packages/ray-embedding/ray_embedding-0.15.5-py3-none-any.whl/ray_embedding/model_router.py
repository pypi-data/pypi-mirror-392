    ...
    def __init__(self, deployed_models: Dict[str, DeployedModel], path_prefix: List[str],
        ...
        try:
            ...
            if ack:
                ...
                self.logger.warning("NodeRecycler registration returned no acknowledgement for ModelRouter.")
        except Exception as exc:
            self.logger.warning(f"Unable to register router replica with NodeRecycler: {exc}")
