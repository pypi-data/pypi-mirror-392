...
def register_replica_with_node_recycler(node_recycler: Optional[DeploymentHandle] = None) -> None:
    ...
    handle.register_replica.remote(replica_id, node_ip, actor_name)


def report_unhealthy_replica(error: Optional[str] = None,
                             node_recycler: Optional[DeploymentHandle] = None) -> None:
