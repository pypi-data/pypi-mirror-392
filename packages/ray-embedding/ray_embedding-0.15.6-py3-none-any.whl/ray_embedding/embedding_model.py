    ...
    def __init__(self, model: str, served_model_name: Optional[str] = None,
        ...
        try:
            ...
            if ack:
                ...
                self.logger.warning("NodeRecycler registration returned no acknowledgement for embedding model replica.")
        except Exception as exc:
            self.logger.warning(f"Unable to register embedding model replica with NodeRecycler: {exc}")
