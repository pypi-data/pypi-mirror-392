...
inline double dot(const vector3r_t& arg0, const vector3r_t& arg1) {
  return arg0[0] * arg1[0] + arg0[1] * arg1[1] + arg0[2] * arg1[2];
}

inline double norm(const vector3r_t& arg0) { return sqrt(dot(arg0, arg0)); }

inline vector3r_t operator*(double arg0, const vector3r_t& arg1) {
  return {arg0 * arg1[0], arg0 * arg1[1], arg0 * arg1[2]};
}

inline vector3r_t operator/(const vector3r_t& arg0, double arg1) {
