...
Antenna::Antenna(const StationCoordinateSystem& coordinate_system,
                 const vector3r_t& phase_reference_position, bool enable_x,
                 bool enable_y)
    : coordinate_system_(coordinate_system),
      phase_reference_position_(phase_reference_position),
      enabled_{enable_x, enable_y} {}
...
void Antenna::Transform(const StationCoordinateSystem& coordinate_system) {
