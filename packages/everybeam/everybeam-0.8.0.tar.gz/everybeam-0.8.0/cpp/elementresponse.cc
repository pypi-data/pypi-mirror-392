...
ElementResponseModel ElementResponseModelFromString(
  ...
  } else if (element_response_upper == "OSKAR_DIPOLE_COS" ||
             element_response_upper == "OSKARDIPOLECOS") {
    element_response_enum = everybeam::ElementResponseModel::kOSKARDipoleCos;
  ...
  } else if (element_response_upper == "SKALOW_FEKO") {
    element_response_enum = everybeam::ElementResponseModel::kSkaLowFeko;
...
std::ostream& operator<<(std::ostream& os, ElementResponseModel model) {
  switch (model) {
    ...
    case ElementResponseModel::kSkaMidAnalytical:
      ...
      break;
    case ElementResponseModel::kSkaLowFeko:
      os << "SKA LOW FEKO";
      break;
    default:
