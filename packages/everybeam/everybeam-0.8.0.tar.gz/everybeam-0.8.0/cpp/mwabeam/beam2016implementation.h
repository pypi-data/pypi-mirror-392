...
class JonesMatrix {
 public:
  ...
  static void zeros(std::vector<std::vector<aocommon::MC2x2>>& jones,
...
class Beam2016Implementation {
 public:
  ...
  // bZenithNorm )
  void CalcJones(aocommon::MC2x2* result, double az_deg, double za_deg,
                 std::span<const double> frequencies, bool bZenithNorm = true);
  void CalcJones(aocommon::MC2x2* result, double az_deg, double za_deg,
                 std::span<const double> frequencies, const double* delays,
                 const double* amps, std::recursive_mutex& lock,
  ...
  void CalcJonesArray(std::vector<std::vector<double>>& azim_arr,
                      ...
                      std::vector<std::vector<aocommon::MC2x2>>& jones,
