...
"""
                    ...
                    if project_result and project_result.get('generated_files'):
                        ...
                        try:
                            ...
                            if diagram_data:
                                ...
                                if 'python_code' in diagram_data:
    ...
    async def _single_agent_file_generation(self, description: str, project_name: str, project_dir: str) -> None:
        ...
        try:
            ...
            # Step 2: Generate Architecture as Code diagrams
            try:
                project_plan = {
                    'name': project_name,
            ...
            # Step 3: Create directories first
            directories = set()
            ...
            # Step 4: Generate files one by one
