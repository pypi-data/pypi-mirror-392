...
def _validate_path(path_str: str, base_dir: str = None) -> Path:
...
def download_geckodriver(tag: str, dest_dir: str = ".", validate_path: bool = True) -> bool:
    if validate_path:
        dest_dir = str(_validate_path(dest_dir))
