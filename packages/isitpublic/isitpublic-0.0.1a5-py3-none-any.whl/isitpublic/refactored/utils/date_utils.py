...
def calculate_pd_year(death_year: int, copyright_term: int) -> int:
    ...
    """
    return death_year + copyright_term + 1  # +1 since copyright lasts for the year of death too
...
def calculate_publication_based_pd_year(publication_year: int, copyright_term: int) -> int:
    """
