...
class CountryLawManager:
    ...
    def get_special_rules(self, country: str, rule_type: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_anonymous_work_rules(self, country: str) -> Dict[str, Any]:
        ...
        return {"term": 70, "explanation": "Anonymous works: 70 years after publication"}
    ...
    def get_corporate_work_rules(self, country: str) -> Dict[str, Any]:
        ...
        return {"term": 70, "explanation": "Corporate authorship: 70 years after publication"}
