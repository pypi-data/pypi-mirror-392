        ...
        # and take the earlier expiration date
            ...
            if country_upper == "US":
                ...
                # Check for US works published 1923-1977 (95 years from publication)
                    ...
                    pd_info[
                        "copyright_term"
                    ] = f"Published 1923-1977 in US: 95 years from publication"
                    pd_info["expiry_type"] = "publication_based"
                    pd_info[
                        "primary_expiry_basis"
                    ] = f"publication_in_{publication_year}_plus_95_years"
                    pd_info["explanation"].append(
                        f"US 1923-1977 rule: Published in {publication_year}, copyright expires {pd_year} (95 years from publication). {'Public domain' if pd_info['is_public_domain'] else 'Still under copyright'}."
                    )
                    return pd_info
