...
class ViewUpdateApi(object):
    ...
    @auto_fill
    @validate_arguments
    def get_contract(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ContractResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def get_contract_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get a contract  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def update_contract(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the resource.")], patch_contract_request : Annotated[PatchContractRequest, Field(..., description="Update contract properties request")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ContractResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def update_contract_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the resource.")], patch_contract_request : Annotated[PatchContractRequest, Field(..., description="Update contract properties request")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a contract  # noqa: E501
