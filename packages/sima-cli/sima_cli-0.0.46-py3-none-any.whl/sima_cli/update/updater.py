...
def _update_board(extracted_paths: List[str], board: str, passwd: str, flavor: str, target_ver: str):
    """
        ...
        if board in ['davinci', 'modalix']:
            ...
            if len(extracted_paths) > 0:
                if env_type == "host" and env_subtype == 'linux':
                    ...
                    _update_board(extracted_paths, board, passwd, flavor=flavor, target_ver=version_or_url)
                elif env_type == "sdk":
