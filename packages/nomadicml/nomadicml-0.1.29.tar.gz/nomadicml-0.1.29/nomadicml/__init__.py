...
__version__ = "0.1.29"  # This will be the clean version for PyPI (Overwritten by CI)
__build__ = "f64a681"      # This will hold the commit hash or full build string, populated by CI
