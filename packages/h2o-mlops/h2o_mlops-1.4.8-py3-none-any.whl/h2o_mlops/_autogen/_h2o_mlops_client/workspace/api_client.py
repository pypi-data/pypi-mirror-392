...
import _h2o_mlops_client.workspace.models
from _h2o_mlops_client.workspace import rest
from _h2o_mlops_client.workspace.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(_h2o_mlops_client.workspace.models, klass)
