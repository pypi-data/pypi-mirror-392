...
class V1Workspace(object):
    ...
    def __init__(self, name=None, display_name=None, description=None, annotations=None, create_time=None, update_time=None, creator=None, updater=None, delete_time=None, deleter=None, personal_workspace_subject=None, purge_time=None, archive_time=None, archiver=None, local_vars_configuration=None):  # noqa: E501
        """V1Workspace - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this V1Workspace.  # noqa: E501


        :return: The name of this V1Workspace.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1Workspace.


        :param name: The name of this V1Workspace.  # noqa: E501
        :type name: str
        """
    ...
    def display_name(self):
        """Gets the display_name of this V1Workspace.  # noqa: E501

        Name of the Workspace that is displayed on the front-end.  # noqa: E501

        :return: The display_name of this V1Workspace.  # noqa: E501
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this V1Workspace.

        Name of the Workspace that is displayed on the front-end.  # noqa: E501

        :param display_name: The display_name of this V1Workspace.  # noqa: E501
    ...
    def description(self):
        """Gets the description of this V1Workspace.  # noqa: E501

        Arbitrary description of the workspace.  # noqa: E501

        :return: The description of this V1Workspace.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this V1Workspace.

        Arbitrary description of the workspace.  # noqa: E501

        :param description: The description of this V1Workspace.  # noqa: E501
    ...
    def annotations(self):
        """Gets the annotations of this V1Workspace.  # noqa: E501
        ...
        :return: The annotations of this V1Workspace.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def annotations(self, annotations):
        """Sets the annotations of this V1Workspace.

        Arbitrary data associated with the Workspace. Can be provided by the User on the creation or by the client/services themselves to persist helper metadata. This should not contain any significant business logic data, just the data for the categorization and identification. Clients/Services can choose to prefixing the keys.  Keys should follow https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/#syntax-and-character-set  1st party services should use <service name>.h2o.ai/ prefix. workspace.h2o.ai/ prefix is reserved for internal purposes and annotations with this prefix can be ignored or modified without warning.  Defined reserved annotations:  'workspace.h2o.ai/resource-namespace' is used to set the name of the Kubernetes namespace where the workspace resources are created. Setting or modifying this annotation will is controlled by the actions/workspaceserver/workspaces/MODIFY_RESOURCE_NAMESPACE_ANNOTATION action. Functionality utilizes this enables needs to be enabled globally for the environment.  # noqa: E501

        :param annotations: The annotations of this V1Workspace.  # noqa: E501
    ...
    def create_time(self):
        """Gets the create_time of this V1Workspace.  # noqa: E501

        Output only.  # noqa: E501

        :return: The create_time of this V1Workspace.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this V1Workspace.

        Output only.  # noqa: E501

        :param create_time: The create_time of this V1Workspace.  # noqa: E501
    ...
    def update_time(self):
        """Gets the update_time of this V1Workspace.  # noqa: E501

        Output only.  # noqa: E501

        :return: The update_time of this V1Workspace.  # noqa: E501
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        """Sets the update_time of this V1Workspace.

        Output only.  # noqa: E501

        :param update_time: The update_time of this V1Workspace.  # noqa: E501
    ...
    @property
    def creator(self):
        """Gets the creator of this V1Workspace.  # noqa: E501

        Output only. Name of the user or service that requested creation of the Workspace.  # noqa: E501

        :return: The creator of this V1Workspace.  # noqa: E501
        :rtype: str
        """
    ...
    def creator(self, creator):
        """Sets the creator of this V1Workspace.

        Output only. Name of the user or service that requested creation of the Workspace.  # noqa: E501

        :param creator: The creator of this V1Workspace.  # noqa: E501
        :type creator: str
        """
    ...
    @property
    def updater(self):
        """Gets the updater of this V1Workspace.  # noqa: E501

        Output only. Name of the user or service that requested update of the Workspace.  # noqa: E501

        :return: The updater of this V1Workspace.  # noqa: E501
        :rtype: str
        """
    ...
    def updater(self, updater):
        """Sets the updater of this V1Workspace.

        Output only. Name of the user or service that requested update of the Workspace.  # noqa: E501

        :param updater: The updater of this V1Workspace.  # noqa: E501
        :type updater: str
        """
    ...
    def delete_time(self, delete_time):
        """Sets the delete_time of this V1Workspace.

        Output only. Set when the Workspace is deleted. When set workspace should be considered as deleted.  # noqa: E501

        :param delete_time: The delete_time of this V1Workspace.  # noqa: E501
    ...
    @property
    def deleter(self):
        """Gets the deleter of this V1Workspace.  # noqa: E501

        Output only. Name of the user or service that requested deletion of the Workspace.  # noqa: E501

        :return: The deleter of this V1Workspace.  # noqa: E501
        :rtype: str
        """
    ...
    def deleter(self, deleter):
        """Sets the deleter of this V1Workspace.

        Output only. Name of the user or service that requested deletion of the Workspace.  # noqa: E501

        :param deleter: The deleter of this V1Workspace.  # noqa: E501
        :type deleter: str
        """
    ...
    def personal_workspace_subject(self):
        """Gets the personal_workspace_subject of this V1Workspace.  # noqa: E501
        ...
        :return: The personal_workspace_subject of this V1Workspace.  # noqa: E501
        :rtype: str
        """
    ...
    def personal_workspace_subject(self, personal_workspace_subject):
        """Sets the personal_workspace_subject of this V1Workspace.

        Name of the user (users/<UUID>) or service that has this workspace associated with them as a personal workspace. When used during creation, and the subject already has a personal workspace, call will fail.  Caller requires actions/workspaceserver/workspaces/CREATE_PERSONAL on //workspaceserver when set during the creation.  # noqa: E501

        :param personal_workspace_subject: The personal_workspace_subject of this V1Workspace.  # noqa: E501
    ...
    @property
    def purge_time(self):
        """Gets the purge_time of this V1Workspace.  # noqa: E501
        ...
        :return: The purge_time of this V1Workspace.  # noqa: E501
        :rtype: datetime
        """
    ...
    def purge_time(self, purge_time):
        """Sets the purge_time of this V1Workspace.

        Output only. Set when the Workspace is deleted. Workspace will be purged from the system after this time and cannot be undeleted after this time.  # noqa: E501

        :param purge_time: The purge_time of this V1Workspace.  # noqa: E501
    ...
    def archive_time(self, archive_time):
        """Sets the archive_time of this V1Workspace.

        Output only. Set when the Workspace is archived. When set workspace should be considered as archived.  # noqa: E501

        :param archive_time: The archive_time of this V1Workspace.  # noqa: E501
    ...
    @property
    def archiver(self):
        """Gets the archiver of this V1Workspace.  # noqa: E501

        Output only. Name of the user or service that requested archiving of the Workspace.  # noqa: E501

        :return: The archiver of this V1Workspace.  # noqa: E501
        :rtype: str
        """
    ...
    def archiver(self, archiver):
        """Sets the archiver of this V1Workspace.

        Output only. Name of the user or service that requested archiving of the Workspace.  # noqa: E501

        :param archiver: The archiver of this V1Workspace.  # noqa: E501
        :type archiver: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1Workspace):
            return False
