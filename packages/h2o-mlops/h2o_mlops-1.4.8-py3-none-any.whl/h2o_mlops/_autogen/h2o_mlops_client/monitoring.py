...
from _h2o_mlops_client.monitoring.v2 import api
from _h2o_mlops_client.monitoring.v2 import api_client
from _h2o_mlops_client.monitoring.v2.exceptions import *  # noqa: F403, F401
...
class Client:
    """The composite client for accessing Monitoring services."""
    ...
    def __init__(
        ...
        self._aggregate = api.AggregateServiceApi(api_client=client)

    @property
    def aggregate(self) -> api.AggregateServiceApi:
