...
class DigestApi(object):
    ...
    def batch_mac(self, body, async_call=False, **kwargs):
        ...
        :type body: `BatchMacRequest`
        :param body: Batch MAC request (required)
        :rtype: `BatchMacResponse`
        :return:
    ...
    def batch_mac_verify(self, body, async_call=False, **kwargs):
        ...
        :type async_call: bool
        :param async_call: Whether the call should be performed asynchronously. (Default is False).
        :type body: `BatchMacVerifyRequest`
        :param body: Batch MAC verify request (required)
        :rtype: `BatchVerifyResponse`
        :return:
    ...
    def compute_mac(self, key_id, body, async_call=False, **kwargs):
        ...
        :type body: `MacGenerateRequest`
        :param body: MAC generation request (required)
        :rtype: `MacGenerateResponse`
        :return:
    ...
    def compute_mac_ex(self, body, async_call=False, **kwargs):
        ...
        :type async_call: bool
        :param async_call: Whether the call should be performed asynchronously. (Default is False).
        :type body: `MacGenerateRequestEx`
        :param body: MAC generation request (required)
        :rtype: `MacGenerateResponse`
        :return:
    ...
    def verify_mac(self, key_id, body, async_call=False, **kwargs):
        ...
        :type key_id: `str`
        :param key_id: kid of security object (required)
        :type body: `MacVerifyRequest`
        :param body: MAC Verify request (required)
        :rtype: `MacVerifyResponse`
        :return:
