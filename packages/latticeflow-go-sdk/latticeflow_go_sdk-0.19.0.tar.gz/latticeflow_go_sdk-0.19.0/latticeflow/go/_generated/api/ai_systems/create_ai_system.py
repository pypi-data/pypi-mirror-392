...
def _get_kwargs(body: AISystem) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {"method": "post", "url": "/ai-systems"}
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = StoredAISystem.model_validate(response.json())
...
def sync_detailed(
    body: AISystem, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, StoredAISystem]]:
    """Create an AI System
