...
try:
    ...
    from achatbot.thirdparty.deepseek_ocr_vllm.process.ngram_norepeat import NoRepeatNGramLogitsProcessor
    from achatbot.thirdparty.deepseek_ocr_vllm.process.image_process import DeepseekOCRProcessor
    from achatbot.thirdparty.deepseek_ocr_vllm.process import load_image
...
from achatbot.common.interface import ILlm, IVisionOCR
from achatbot.common.session import Session
from achatbot.common.types import SessionCtx
from achatbot.core.llm.vllm.base import VllmEngineBase
...
class VllmDeepSeekOCR(VllmEngineBase, IVisionOCR):
    ...
    def __init__(self, **kwargs) -> None:
        if self.TAG == "llm_vllm_deepseek_ocr":
            from achatbot.thirdparty.deepseek_ocr_vllm.model.deepseek_ocr import (
