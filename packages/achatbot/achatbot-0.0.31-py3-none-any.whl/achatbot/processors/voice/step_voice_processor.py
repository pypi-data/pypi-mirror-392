...
try:
    ...
    from achatbot.StepAudio.tts import StepAudioTTS
    from achatbot.StepAudio.tokenizer import StepAudioTokenizer
    from achatbot.StepAudio.utils import load_audio, speech_adjust, volumn_adjust
except ModuleNotFoundError as e:
    raise Exception(f"Missing module: {e}")

from achatbot.core.llm.transformers.manual_voice_step import TransformersManualVoiceStep
