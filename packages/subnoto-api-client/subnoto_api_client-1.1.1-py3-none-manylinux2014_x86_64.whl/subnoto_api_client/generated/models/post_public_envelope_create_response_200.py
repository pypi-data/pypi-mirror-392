...
if TYPE_CHECKING:
    from ..models.post_public_envelope_create_response_200_presigned_s3_params import (
...
class PostPublicEnvelopeCreateResponse200:
    ...
    presigned_s3_params: (
        PostPublicEnvelopeCreateResponse200PresignedS3Params | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_presigned_s3_params, Unset):
            ...
            presigned_s3_params = (
                PostPublicEnvelopeCreateResponse200PresignedS3Params.from_dict(
                    _presigned_s3_params
                )
            )
