...
if TYPE_CHECKING:
    from ..models.post_public_envelope_add_blocks_body_blocks_item_type_0 import (
        PostPublicEnvelopeAddBlocksBodyBlocksItemType0,
    )
    from ..models.post_public_envelope_add_blocks_body_blocks_item_type_1 import (
        PostPublicEnvelopeAddBlocksBodyBlocksItemType1,
    )
    from ..models.post_public_envelope_add_blocks_body_blocks_item_type_2 import (
...
class PostPublicEnvelopeAddBlocksBody:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for blocks_item_data in self.blocks:
            ...
            if isinstance(
                blocks_item_data, PostPublicEnvelopeAddBlocksBodyBlocksItemType0
            ):
                blocks_item = blocks_item_data.to_dict()
            elif isinstance(
                blocks_item_data, PostPublicEnvelopeAddBlocksBodyBlocksItemType1
            ):
                blocks_item = blocks_item_data.to_dict()
            else:
                blocks_item = blocks_item_data.to_dict()
            ...
            def _parse_blocks_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    blocks_item_type_0 = (
                        PostPublicEnvelopeAddBlocksBodyBlocksItemType0.from_dict(data)
                    )
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    blocks_item_type_1 = (
                        PostPublicEnvelopeAddBlocksBodyBlocksItemType1.from_dict(data)
                    )
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                blocks_item_type_2 = (
                    PostPublicEnvelopeAddBlocksBodyBlocksItemType2.from_dict(data)
                )
