...
from ..models.post_public_envelope_add_blocks_body_blocks_item_type_0_templated_text import (
    PostPublicEnvelopeAddBlocksBodyBlocksItemType0TemplatedText,
)
from ..models.post_public_envelope_add_blocks_body_blocks_item_type_0_type import (
...
class PostPublicEnvelopeAddBlocksBodyBlocksItemType0:
    ...
    templated_text: (
        PostPublicEnvelopeAddBlocksBodyBlocksItemType0TemplatedText | Unset
    ) = UNSET
