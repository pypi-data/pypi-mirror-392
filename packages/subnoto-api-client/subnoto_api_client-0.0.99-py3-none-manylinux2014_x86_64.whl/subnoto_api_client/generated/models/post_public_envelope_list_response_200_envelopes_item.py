...
from ..models.post_public_envelope_list_response_200_envelopes_item_status import (
    PostPublicEnvelopeListResponse200EnvelopesItemStatus,
)

if TYPE_CHECKING:
    from ..models.post_public_envelope_list_response_200_envelopes_item_metrics import (
        PostPublicEnvelopeListResponse200EnvelopesItemMetrics,
    )
    from ..models.post_public_envelope_list_response_200_envelopes_item_owner import (
...
class PostPublicEnvelopeListResponse200EnvelopesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        owner = PostPublicEnvelopeListResponse200EnvelopesItemOwner.from_dict(
            d.pop("owner")
        )

        metrics = PostPublicEnvelopeListResponse200EnvelopesItemMetrics.from_dict(
            d.pop("metrics")
        )
