...
from ...models.post_public_envelope_add_recipients_body import (
    PostPublicEnvelopeAddRecipientsBody,
)
from ...models.post_public_envelope_add_recipients_response_200 import (
    PostPublicEnvelopeAddRecipientsResponse200,
)
from ...models.post_public_envelope_add_recipients_response_400 import (
    PostPublicEnvelopeAddRecipientsResponse400,
)
from ...models.post_public_envelope_add_recipients_response_401 import (
    PostPublicEnvelopeAddRecipientsResponse401,
)
from ...models.post_public_envelope_add_recipients_response_403 import (
    PostPublicEnvelopeAddRecipientsResponse403,
)
from ...models.post_public_envelope_add_recipients_response_500 import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PostPublicEnvelopeAddRecipientsResponse200.from_dict(
            response.json()
        )
    ...
    if response.status_code == 400:
        response_400 = PostPublicEnvelopeAddRecipientsResponse400.from_dict(
            response.json()
        )
    ...
    if response.status_code == 401:
        response_401 = PostPublicEnvelopeAddRecipientsResponse401.from_dict(
            response.json()
        )
    ...
    if response.status_code == 403:
        response_403 = PostPublicEnvelopeAddRecipientsResponse403.from_dict(
            response.json()
        )
    ...
    if response.status_code == 500:
        response_500 = PostPublicEnvelopeAddRecipientsResponse500.from_dict(
            response.json()
        )
