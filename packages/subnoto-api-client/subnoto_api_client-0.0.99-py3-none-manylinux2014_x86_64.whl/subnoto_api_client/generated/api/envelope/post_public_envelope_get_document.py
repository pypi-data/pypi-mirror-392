...
from ...models.post_public_envelope_get_document_body import (
    PostPublicEnvelopeGetDocumentBody,
)
from ...models.post_public_envelope_get_document_response_400 import (
    PostPublicEnvelopeGetDocumentResponse400,
)
from ...models.post_public_envelope_get_document_response_401 import (
    PostPublicEnvelopeGetDocumentResponse401,
)
from ...models.post_public_envelope_get_document_response_403 import (
    PostPublicEnvelopeGetDocumentResponse403,
)
from ...models.post_public_envelope_get_document_response_500 import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = PostPublicEnvelopeGetDocumentResponse400.from_dict(
            response.content
        )
    ...
    if response.status_code == 401:
        response_401 = PostPublicEnvelopeGetDocumentResponse401.from_dict(
            response.content
        )
    ...
    if response.status_code == 403:
        response_403 = PostPublicEnvelopeGetDocumentResponse403.from_dict(
            response.content
        )
    ...
    if response.status_code == 500:
        response_500 = PostPublicEnvelopeGetDocumentResponse500.from_dict(
            response.content
        )
