...
from ...models.post_public_envelope_create_from_template_body import (
    PostPublicEnvelopeCreateFromTemplateBody,
)
from ...models.post_public_envelope_create_from_template_response_200 import (
    PostPublicEnvelopeCreateFromTemplateResponse200,
)
from ...models.post_public_envelope_create_from_template_response_400 import (
    PostPublicEnvelopeCreateFromTemplateResponse400,
)
from ...models.post_public_envelope_create_from_template_response_401 import (
    PostPublicEnvelopeCreateFromTemplateResponse401,
)
from ...models.post_public_envelope_create_from_template_response_403 import (
    PostPublicEnvelopeCreateFromTemplateResponse403,
)
from ...models.post_public_envelope_create_from_template_response_500 import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PostPublicEnvelopeCreateFromTemplateResponse200.from_dict(
            response.json()
        )
    ...
    if response.status_code == 400:
        response_400 = PostPublicEnvelopeCreateFromTemplateResponse400.from_dict(
            response.json()
        )
    ...
    if response.status_code == 401:
        response_401 = PostPublicEnvelopeCreateFromTemplateResponse401.from_dict(
            response.json()
        )
    ...
    if response.status_code == 403:
        response_403 = PostPublicEnvelopeCreateFromTemplateResponse403.from_dict(
            response.json()
        )
    ...
    if response.status_code == 500:
        response_500 = PostPublicEnvelopeCreateFromTemplateResponse500.from_dict(
            response.json()
        )
