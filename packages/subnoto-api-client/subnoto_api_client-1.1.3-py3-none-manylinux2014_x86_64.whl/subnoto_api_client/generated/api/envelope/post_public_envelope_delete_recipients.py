...
from ...models.post_public_envelope_delete_recipients_body import (
    PostPublicEnvelopeDeleteRecipientsBody,
)
from ...models.post_public_envelope_delete_recipients_response_200 import (
    PostPublicEnvelopeDeleteRecipientsResponse200,
)
from ...models.post_public_envelope_delete_recipients_response_400 import (
    PostPublicEnvelopeDeleteRecipientsResponse400,
)
from ...models.post_public_envelope_delete_recipients_response_401 import (
    PostPublicEnvelopeDeleteRecipientsResponse401,
)
from ...models.post_public_envelope_delete_recipients_response_403 import (
    PostPublicEnvelopeDeleteRecipientsResponse403,
)
from ...models.post_public_envelope_delete_recipients_response_500 import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PostPublicEnvelopeDeleteRecipientsResponse200.from_dict(
            response.json()
        )
    ...
    if response.status_code == 400:
        response_400 = PostPublicEnvelopeDeleteRecipientsResponse400.from_dict(
            response.json()
        )
    ...
    if response.status_code == 401:
        response_401 = PostPublicEnvelopeDeleteRecipientsResponse401.from_dict(
            response.json()
        )
    ...
    if response.status_code == 403:
        response_403 = PostPublicEnvelopeDeleteRecipientsResponse403.from_dict(
            response.json()
        )
    ...
    if response.status_code == 500:
        response_500 = PostPublicEnvelopeDeleteRecipientsResponse500.from_dict(
            response.json()
        )
