...
from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_2_color import (
    PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType2Color,
)
from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_2_label_icon import (
    PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType2LabelIcon,
)
from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_2_type import (
...
T = TypeVar(
    "T",
    bound="PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType2",
)
...
class PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType2:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_label_icon, Unset):
            ...
            label_icon = PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType2LabelIcon(
                _label_icon
            )
        ...
        if isinstance(_color, Unset):
            ...
            color = PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType2Color(
                _color
            )
