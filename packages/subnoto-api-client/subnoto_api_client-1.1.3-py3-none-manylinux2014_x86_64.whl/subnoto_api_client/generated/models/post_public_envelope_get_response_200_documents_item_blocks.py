...
if TYPE_CHECKING:
    from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_0 import (
        PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType0,
    )
    from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_1 import (
        PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType1,
    )
    from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_2 import (
                ...
                def _parse_additional_property_item(
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        additional_property_item_type_0 = PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType0.from_dict(
                            data
                        )
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        additional_property_item_type_1 = PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType1.from_dict(
                            data
                        )
                    ...
                    if not isinstance(data, dict):
                        raise TypeError()
                    additional_property_item_type_2 = PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType2.from_dict(
                        data
                    )
