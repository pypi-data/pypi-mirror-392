...
if TYPE_CHECKING:
    from ..models.post_public_envelope_create_from_template_body_recipients_item_type_0 import (
        PostPublicEnvelopeCreateFromTemplateBodyRecipientsItemType0,
    )
    from ..models.post_public_envelope_create_from_template_body_recipients_item_type_1 import (
        PostPublicEnvelopeCreateFromTemplateBodyRecipientsItemType1,
    )
    from ..models.post_public_envelope_create_from_template_body_recipients_item_type_2 import (
            ...
            def _parse_recipients_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    recipients_item_type_0 = PostPublicEnvelopeCreateFromTemplateBodyRecipientsItemType0.from_dict(
                        data
                    )
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    recipients_item_type_1 = PostPublicEnvelopeCreateFromTemplateBodyRecipientsItemType1.from_dict(
                        data
                    )
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                recipients_item_type_2 = PostPublicEnvelopeCreateFromTemplateBodyRecipientsItemType2.from_dict(
                    data
                )
