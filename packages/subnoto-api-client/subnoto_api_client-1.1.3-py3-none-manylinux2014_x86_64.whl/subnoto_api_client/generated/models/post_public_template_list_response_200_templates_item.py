...
from ..models.post_public_template_list_response_200_templates_item_status import (
    PostPublicTemplateListResponse200TemplatesItemStatus,
)

if TYPE_CHECKING:
    from ..models.post_public_template_list_response_200_templates_item_documents_item import (
        PostPublicTemplateListResponse200TemplatesItemDocumentsItem,
    )
    from ..models.post_public_template_list_response_200_templates_item_owner import (
        PostPublicTemplateListResponse200TemplatesItemOwner,
    )
    from ..models.post_public_template_list_response_200_templates_item_recipients_item import (
...
class PostPublicTemplateListResponse200TemplatesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        owner = PostPublicTemplateListResponse200TemplatesItemOwner.from_dict(
            d.pop("owner")
        )
        ...
        for documents_item_data in _documents:
            documents_item = (
                PostPublicTemplateListResponse200TemplatesItemDocumentsItem.from_dict(
                    documents_item_data
                )
            )
        ...
        for recipients_item_data in _recipients:
            recipients_item = (
                PostPublicTemplateListResponse200TemplatesItemRecipientsItem.from_dict(
