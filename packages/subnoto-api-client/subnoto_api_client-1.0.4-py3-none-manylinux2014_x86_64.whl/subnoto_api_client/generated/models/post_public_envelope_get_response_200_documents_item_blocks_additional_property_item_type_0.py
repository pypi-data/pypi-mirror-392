...
from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_0_color import (
    PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType0Color,
)
from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_0_label_icon import (
    PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType0LabelIcon,
)
from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_0_templated_text import (
    PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType0TemplatedText,
)
from ..models.post_public_envelope_get_response_200_documents_item_blocks_additional_property_item_type_0_type import (
...
T = TypeVar(
    "T",
    bound="PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType0",
)
...
class PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_label_icon, Unset):
            ...
            label_icon = PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType0LabelIcon(
                _label_icon
            )
        ...
        if isinstance(_color, Unset):
            ...
            color = PostPublicEnvelopeGetResponse200DocumentsItemBlocksAdditionalPropertyItemType0Color(
                _color
            )
