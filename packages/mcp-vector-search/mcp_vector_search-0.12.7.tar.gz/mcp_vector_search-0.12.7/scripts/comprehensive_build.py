...
class BuildManager:
    ...
    def setup_environment(self) -> bool:
        ...
        if not self.run_command(["uv", "run", "pre-commit", "install"], "Installing pre-commit hooks"):
    ...
    def run_integration_tests(self) -> bool:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                if not self.run_command(["mcp-vector-search", "index"], "Testing indexing"):
                    return False
...
def main():
    ...
    parser.add_argument("--skip-tools-check", action="store_true", help="Skip tools check")
    ...
    parser.add_argument("--version-bump", choices=["patch", "minor", "major"], help="Bump version")
    parser.add_argument("--build-increment", action="store_true", help="Increment build number")
