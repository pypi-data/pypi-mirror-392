...
def init(
    ...
    **kwargs: Any,
    ...
    env
        ...
        - doc: use for HTML doc generators, for example in autodoc, PDFS/ADFS doc, ... (default conf "myst.json")
        - notebook: use in interactive jupyter notebooks (default logging conf "tools.json")
        - cli: use in command line interface. Colorize logs (default logging conf "tools.json")
    """
