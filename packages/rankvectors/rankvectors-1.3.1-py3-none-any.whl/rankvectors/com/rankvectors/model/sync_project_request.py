...
class SyncProjectRequest(BaseModel):
    ...
    SyncProjectRequest
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="Domain to sync")
    project_name: Optional[StrictStr] = Field(default=None, description="Project name", alias="projectName")
    __properties: ClassVar[List[str]] = ["domain", "projectName"]
