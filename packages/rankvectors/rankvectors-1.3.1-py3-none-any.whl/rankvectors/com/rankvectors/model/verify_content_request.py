...
class VerifyContentRequest(BaseModel):
    ...
    """ # noqa: E501
    page_url: StrictStr = Field(description="URL of the page to verify", alias="pageUrl")
    suggestion_id: StrictStr = Field(description="ID of the suggestion to verify", alias="suggestionId")
    __properties: ClassVar[List[str]] = ["pageUrl", "suggestionId"]
