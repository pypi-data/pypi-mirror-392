...
class VerifyContent200Response(BaseModel):
    """
    VerifyContent200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    verification: Optional[ContentVerification] = None
    __properties: ClassVar[List[str]] = ["success", "verification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "verification": ContentVerification.from_dict(obj["verification"]) if obj.get("verification") is not None else None
        })
        return _obj
