...
class PageAllowanceUsageHistoryInner(BaseModel):
    """
    PageAllowanceUsageHistoryInner
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, alias="date")
    pages_indexed: Optional[StrictInt] = Field(default=None, alias="pagesIndexed")
    __properties: ClassVar[List[str]] = ["date", "pagesIndexed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "pagesIndexed": obj.get("pagesIndexed")
        })
        return _obj
