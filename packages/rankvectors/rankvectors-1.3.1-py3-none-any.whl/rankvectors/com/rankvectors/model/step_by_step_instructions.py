...
class StepByStepInstructions(BaseModel):
    """
    StepByStepInstructions
    """ # noqa: E501
    steps: List[StrictStr] = Field(description="Step-by-step instructions")
    html_example: StrictStr = Field(description="HTML example of the implementation", alias="htmlExample")
    __properties: ClassVar[List[str]] = ["steps", "htmlExample"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "steps": obj.get("steps"),
            "htmlExample": obj.get("htmlExample")
        })
        return _obj
