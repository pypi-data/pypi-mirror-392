...
class ListImplementations200Response(BaseModel):
    """
    ListImplementations200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    implementations: Optional[List[Implementation]] = None
    count: Optional[StrictInt] = Field(default=None, description="Number of implementations returned")
    filters: Optional[Dict[str, Any]] = Field(default=None, description="Applied filters")
    __properties: ClassVar[List[str]] = ["success", "implementations", "count", "filters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListImplementations200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListImplementations200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "implementations": [Implementation.from_dict(_item) for _item in obj["implementations"]] if obj.get("implementations") is not None else None,
            "count": obj.get("count"),
