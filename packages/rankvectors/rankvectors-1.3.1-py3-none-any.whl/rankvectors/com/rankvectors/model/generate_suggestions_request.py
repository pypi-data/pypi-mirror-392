...
class GenerateSuggestionsRequest(BaseModel):
    ...
    """ # noqa: E501
    min_relevance_score: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, description="Minimum relevance score for suggestions", alias="minRelevanceScore")
    __properties: ClassVar[List[str]] = ["minRelevanceScore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minRelevanceScore": obj.get("minRelevanceScore")
        })
        return _obj
