...
class ImplementationResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool = Field(description="Whether any implementations succeeded")
    results: List[ImplementationResult] = Field(description="Individual implementation results")
    summary: ImplementationSummary
    __properties: ClassVar[List[str]] = ["success", "results", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ImplementationResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "summary": ImplementationSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None
        })
        return _obj
