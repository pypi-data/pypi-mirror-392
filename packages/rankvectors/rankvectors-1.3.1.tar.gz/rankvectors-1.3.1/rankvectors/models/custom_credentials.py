...
class CustomCredentials(BaseModel):
    ...
    CustomCredentials
    """ # noqa: E501
    webhook_url: StrictStr = Field(description="Webhook URL for implementation", alias="webhookUrl")
    api_key: StrictStr = Field(description="Webhook secret key", alias="apiKey")
    __properties: ClassVar[List[str]] = ["webhookUrl", "apiKey"]
