...
class PagePricingTiersInner(BaseModel):
    """
    ...
    annual_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="annualPrice")
    page_limit: Optional[StrictInt] = Field(default=None, alias="pageLimit")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "name", "monthlyPrice", "annualPrice", "pageLimit", "description"]
