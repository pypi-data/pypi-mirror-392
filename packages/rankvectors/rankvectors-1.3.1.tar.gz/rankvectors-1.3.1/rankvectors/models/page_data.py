...
class PageData(BaseModel):
    ...
    content: Optional[StrictStr] = Field(default=None, description="Page content")
    word_count: Optional[StrictInt] = Field(default=None, description="Word count", alias="wordCount")
    description: Optional[StrictStr] = Field(default=None, description="Page description/meta")
    __properties: ClassVar[List[str]] = ["url", "title", "content", "wordCount", "description"]
