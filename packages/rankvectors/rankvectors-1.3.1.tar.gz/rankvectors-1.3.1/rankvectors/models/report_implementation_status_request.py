...
class ReportImplementationStatusRequest(BaseModel):
    """
    ReportImplementationStatusRequest
    """ # noqa: E501
    suggestion_id: StrictStr = Field(description="ID of the suggestion", alias="suggestionId")
    api_key: StrictStr = Field(description="Your RankVectors API key", alias="apiKey")
    status: StrictStr = Field(description="Implementation status")
    __properties: ClassVar[List[str]] = ["suggestionId", "apiKey", "status"]
