...
class PageAllowance(BaseModel):
    """
    PageAllowance
    """ # noqa: E501
    allowance: Optional[PageAllowanceInfo] = None
    usage_history: Optional[List[PageAllowanceUsageHistoryInner]] = Field(default=None, alias="usageHistory")
    __properties: ClassVar[List[str]] = ["allowance", "usageHistory"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allowance": PageAllowanceInfo.from_dict(obj["allowance"]) if obj.get("allowance") is not None else None,
            "usageHistory": [PageAllowanceUsageHistoryInner.from_dict(_item) for _item in obj["usageHistory"]] if obj.get("usageHistory") is not None else None
        })
        return _obj
