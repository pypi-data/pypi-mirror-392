...
class SpendingLimitStatus(BaseModel):
    ...
    SpendingLimitStatus
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether spending limit is enabled")
    limit: Union[StrictFloat, StrictInt] = Field(description="Spending limit")
    used: Union[StrictFloat, StrictInt] = Field(description="Amount used")
    remaining: Union[StrictFloat, StrictInt] = Field(description="Amount remaining")
    __properties: ClassVar[List[str]] = ["enabled", "limit", "used", "remaining"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpendingLimitStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpendingLimitStatus from a dict"""
        if obj is None:
            return None
