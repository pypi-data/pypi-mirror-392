...
class GetPageChanges200Response(BaseModel):
    """
    GetPageChanges200Response
    """ # noqa: E501
    changes: Optional[List[PageChange]] = None
    summary: Optional[GetPageChanges200ResponseSummary] = None
    __properties: ClassVar[List[str]] = ["changes", "summary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetPageChanges200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetPageChanges200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "changes": [PageChange.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None,
            "summary": GetPageChanges200ResponseSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None
        })
        return _obj
