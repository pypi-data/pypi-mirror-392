...
class GenerateSuggestions200Response(BaseModel):
    """
    GenerateSuggestions200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    count: Optional[StrictInt] = Field(default=None, description="Number of suggestions generated")
    auto_approved: Optional[StrictInt] = Field(default=None, description="Number of suggestions auto-approved", alias="autoApproved")
    opportunities: Optional[Annotated[List[LinkOpportunity], Field(max_length=10)]] = Field(default=None, description="Top 10 opportunities preview")
    __properties: ClassVar[List[str]] = ["success", "count", "autoApproved", "opportunities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "opportunities": [LinkOpportunity.from_dict(_item) for _item in obj["opportunities"]] if obj.get("opportunities") is not None else None
        })
        return _obj
