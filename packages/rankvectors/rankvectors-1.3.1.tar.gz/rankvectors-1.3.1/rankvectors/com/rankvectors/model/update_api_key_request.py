...
class UpdateApiKeyRequest(BaseModel):
    ...
    UpdateApiKeyRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="New name for the API key")
    is_active: Optional[StrictBool] = Field(default=None, description="Activate or deactivate the key", alias="isActive")
    __properties: ClassVar[List[str]] = ["name", "isActive"]
