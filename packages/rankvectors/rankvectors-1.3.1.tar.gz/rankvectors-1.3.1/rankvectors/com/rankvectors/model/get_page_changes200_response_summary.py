...
class GetPageChanges200ResponseSummary(BaseModel):
    """
    GetPageChanges200ResponseSummary
    """ # noqa: E501
    total: Optional[StrictInt] = None
    by_status: Optional[Dict[str, Any]] = Field(default=None, alias="byStatus")
    __properties: ClassVar[List[str]] = ["total", "byStatus"]
