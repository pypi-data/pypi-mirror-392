...
class BatchSyncPages200Response(BaseModel):
    """
    BatchSyncPages200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    synced: Optional[StrictInt] = Field(default=None, description="Number of pages synced")
    skipped: Optional[StrictInt] = Field(default=None, description="Number of pages skipped")
    __properties: ClassVar[List[str]] = ["success", "synced", "skipped"]
