...
class CreateApiKeyRequest(BaseModel):
    ...
    CreateApiKeyRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Name for the API key")
    expires_at: Optional[datetime] = Field(default=None, description="Optional expiration date", alias="expiresAt")
