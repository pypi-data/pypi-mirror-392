...
class PageInfo(BaseModel):
    ...
    word_count: Optional[StrictInt] = Field(default=None, description="Page word count", alias="wordCount")
    __properties: ClassVar[List[str]] = ["url", "title", "description", "wordCount"]
