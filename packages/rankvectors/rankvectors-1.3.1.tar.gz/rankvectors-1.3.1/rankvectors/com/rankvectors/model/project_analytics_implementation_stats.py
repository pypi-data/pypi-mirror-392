...
class ProjectAnalyticsImplementationStats(BaseModel):
    """
    ...
    avg_credits_used: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="avgCreditsUsed")
    platform_breakdown: Optional[Dict[str, Any]] = Field(default=None, alias="platformBreakdown")
    __properties: ClassVar[List[str]] = ["total", "success", "failed", "pending", "inProgress", "successRate", "avgCreditsUsed", "platformBreakdown"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "avgCreditsUsed": obj.get("avgCreditsUsed"),
            "platformBreakdown": obj.get("platformBreakdown")
        })
        return _obj
