...
class PagePricing(BaseModel):
    ...
    PagePricing
    """ # noqa: E501
    tiers: Optional[List[PagePricingTiersInner]] = None
    page_packs: Optional[List[PagePricingPagePacksInner]] = Field(default=None, alias="pagePacks")
    __properties: ClassVar[List[str]] = ["tiers", "pagePacks"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.tiers:
            ...
            _dict['tiers'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in page_packs (list)
        _items = []
        if self.page_packs:
            for _item_page_packs in self.page_packs:
                if _item_page_packs:
                    _items.append(_item_page_packs.to_dict())
            _dict['pagePacks'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tiers": [PagePricingTiersInner.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None,
            "pagePacks": [PagePricingPagePacksInner.from_dict(_item) for _item in obj["pagePacks"]] if obj.get("pagePacks") is not None else None
        })
        return _obj
