...
class BatchSyncPagesRequest(BaseModel):
    """
    BatchSyncPagesRequest
    """ # noqa: E501
    pages: Annotated[List[PageData], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pages": [PageData.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None
        })
        return _obj
