...
class AddCredits200Response(BaseModel):
    """
    AddCredits200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    balance: Optional[CreditBalanceInfo] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["success", "balance", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCredits200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCredits200Response from a dict"""
        if obj is None:
            return None
