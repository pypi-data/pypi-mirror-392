...
class AddCreditsRequest(BaseModel):
    ...
    AddCreditsRequest
    """ # noqa: E501
    amount: Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]] = Field(description="Number of credits to add")
    source: Optional[StrictStr] = Field(default='manual_addition', description="Source of credits")
    __properties: ClassVar[List[str]] = ["amount", "source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": obj.get("source") if obj.get("source") is not None else 'manual_addition'
        })
        return _obj
