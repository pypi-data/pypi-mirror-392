...
class TestImplementationResult(unittest.TestCase):
    """ImplementationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImplementationResult:
        """Test ImplementationResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImplementationResult`
        """
    ...
    def testImplementationResult(self):
        """Test ImplementationResult"""
