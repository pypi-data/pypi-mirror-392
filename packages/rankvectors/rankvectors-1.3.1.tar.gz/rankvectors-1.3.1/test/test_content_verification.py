...
class TestContentVerification(unittest.TestCase):
    """ContentVerification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentVerification:
        """Test ContentVerification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentVerification`
        """
    ...
    def testContentVerification(self):
        """Test ContentVerification"""
