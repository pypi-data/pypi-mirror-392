...
class TestStepByStepInstructions(unittest.TestCase):
    """StepByStepInstructions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StepByStepInstructions:
        """Test StepByStepInstructions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StepByStepInstructions`
        """
        model = StepByStepInstructions()
        if include_optional:
    ...
    def testStepByStepInstructions(self):
        """Test StepByStepInstructions"""
