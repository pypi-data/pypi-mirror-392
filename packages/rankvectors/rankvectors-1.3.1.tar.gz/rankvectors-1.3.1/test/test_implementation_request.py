...
class TestImplementationRequest(unittest.TestCase):
    """ImplementationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImplementationRequest:
        """Test ImplementationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImplementationRequest`
        """
    ...
    def testImplementationRequest(self):
        """Test ImplementationRequest"""
