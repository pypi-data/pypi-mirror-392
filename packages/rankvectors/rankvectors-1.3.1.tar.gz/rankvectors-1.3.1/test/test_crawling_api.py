...
class TestCrawlingApi(unittest.TestCase):
    """CrawlingApi unit test stubs"""
    ...
    def test_get_crawl_history(self) -> None:
        """Test case for get_crawl_history
