...
class TestUsageHistoryItem(unittest.TestCase):
    """UsageHistoryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageHistoryItem:
        """Test UsageHistoryItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageHistoryItem`
        """
        model = UsageHistoryItem()
        if include_optional:
