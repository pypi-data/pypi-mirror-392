...
class TestProjectCount(unittest.TestCase):
    """ProjectCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectCount:
        """Test ProjectCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectCount`
        """
        model = ProjectCount()
        if include_optional:
            return ProjectCount(
