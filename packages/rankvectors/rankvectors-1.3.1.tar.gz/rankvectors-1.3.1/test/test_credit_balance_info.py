...
from rankvectors.com.rankvectors.model.credit_balance_info import CreditBalanceInfo

class TestCreditBalanceInfo(unittest.TestCase):
    """CreditBalanceInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditBalanceInfo:
        """Test CreditBalanceInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditBalanceInfo`
        """
    ...
    def testCreditBalanceInfo(self):
        """Test CreditBalanceInfo"""
