...
class TestPeriodCharges(unittest.TestCase):
    """PeriodCharges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeriodCharges:
        """Test PeriodCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeriodCharges`
        """
        model = PeriodCharges()
        if include_optional:
