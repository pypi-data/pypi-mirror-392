...
class TestChangeResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChangeResult:
        """Test ChangeResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangeResult`
        """
        model = ChangeResult()
        if include_optional:
            return ChangeResult(
