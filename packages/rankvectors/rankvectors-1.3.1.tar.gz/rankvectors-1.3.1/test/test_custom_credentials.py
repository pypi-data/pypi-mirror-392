...
class TestCustomCredentials(unittest.TestCase):
    """CustomCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomCredentials:
        """Test CustomCredentials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomCredentials`
        """
    ...
    def testCustomCredentials(self):
        """Test CustomCredentials"""
