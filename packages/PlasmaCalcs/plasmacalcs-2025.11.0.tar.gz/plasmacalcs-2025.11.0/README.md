...
- Interested in adding a new hookup? The [dev_guide_new_hookup.pdf](https://gitlab.com/Sevans7/plasmacalcs/-/blob/main/examples/dev_guide_new_hookup.pdf) is a good place to start. Also, try to follow the implementation pattern of existing hookups, and feel free to reach out to PlasmaCalcs developers to ask for help!
