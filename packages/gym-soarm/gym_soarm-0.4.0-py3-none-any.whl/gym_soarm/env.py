...
class SoArmAlohaEnv(gym.Env):
    ...
    def __init__(
        ...
        camera_config="diagonal_wrist",  # "front_only", "front_wrist", "all"
        render_camera="overview_camera"
    ):
        super().__init__()
        self.task = task
        self.obs_type = obs_type
        self.degree_action = degree_action
        ...
        self._current_camera = "diagonal_camera"  # Default camera for viewer
    ...
    def _get_camera_names(self, camera_config):
        ...
        # TODO Cameraの命名規則を揃える。影響範囲を確認し修正する。
