...
T = TypeVar("T", bound="DeleteContainerIdBody")


@_attrs_define
class DeleteContainerIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_container_id_body.additional_properties = d
        return delete_container_id_body
