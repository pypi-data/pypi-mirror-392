...
T = TypeVar("T", bound="PostRoutePartEventInPolygonBody")


@_attrs_define
class PostRoutePartEventInPolygonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_route_part_event_in_polygon_body = cls(
            polygon=polygon,
            filters_values=filters_values,
        )

        post_route_part_event_in_polygon_body.additional_properties = d
        return post_route_part_event_in_polygon_body
