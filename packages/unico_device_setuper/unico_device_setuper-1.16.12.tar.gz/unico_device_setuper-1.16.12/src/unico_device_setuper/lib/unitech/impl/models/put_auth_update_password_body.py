...
T = TypeVar("T", bound="PutAuthUpdatePasswordBody")


@_attrs_define
class PutAuthUpdatePasswordBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_auth_update_password_body = cls(
            password=password,
            new_password=new_password,
        )

        put_auth_update_password_body.additional_properties = d
        return put_auth_update_password_body
