...
class DensityFlow(nn.Module):
    ...
    def predict(self, zs, perturbs_predict:list, perturbs_reference:list, show_progress=True):
    ...
    def get_counts(self, zs, batch_size: int = 1024, show_progress=True):
