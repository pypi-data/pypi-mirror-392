...
class BaseTrainer(ABC):
    ...
    def __call__(
        ...
        if self.use_ddp:
            ...
            train_sampler = torch.utils.data.DistributedSampler(dataset, shuffle=not self.use_iterable_dataset and self.ddp_shuffle, rank=rank, num_replicas=world_size, drop_last=not self.use_iterable_dataset)
