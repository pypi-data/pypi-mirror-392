    ...
    def batch_update_issue_detections(
        ...
        try:
            ...
            if existing_doc.exists:
                ...
                issues_map = existing_data.get('issues', {})
            else:
                # Create new document
                issues_map = {}
            
            # Process all issues and update the map
            for issue in issues:
                ...
                # Create issue details string (reuse logic from single update)
                ...
                # Preserve existing acknowledgment status where present
                existing_issue = issues_map.get(issue_key_simple, {})
                issues_map[issue_key_simple] = {
