...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    """
    log.info("Starting ___APPLICATION_NAME___ API...")
    await init_models()
    ...
    log.info("Shutting down ___APPLICATION_NAME___ API...")
...
async def health_check() -> Dict[str, str]:
    return {"status": "ok", "message": "___APPLICATION_NAME___ API is running"}
