...
from fandango import tango, printf
...
from fandango.interface import FullTangoInheritance, updateChildClassDicts
from fandango.threads import wait, get_tango_thread_context
...
class WorkerDS(DynamicDS,PyTango.LatestDeviceImpl):
...
#
# ==================================================================
class WorkerDSClass(DynamicDSClass,PyTango.DeviceClass):
    ...
    device_property_list = {
        ...
        "UseProcess": [
            PyTango.DevBoolean,
            "If true, use multiprocessing, if False, threading",
            [ False ],
        ],
    }
...
updateChildClassDicts(WorkerDSClass,DynamicDSClass)
