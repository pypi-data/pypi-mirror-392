...
def query_socketPortMetricsTimeSeries_parse(query_subparsers):
    ...
    query_socketPortMetricsTimeSeries_parser.add_argument('--trace-id', dest='trace_id', action='store_true', help='Enable tracing and print the trace ID from the response')
