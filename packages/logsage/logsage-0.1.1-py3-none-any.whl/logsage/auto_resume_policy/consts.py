...
DOMAIN_SIZE = 8  # Number of GPUs per domain (Hopper: 8, Blackwell: 4)
...
HARDWARE_WORDS = [
    ...
    "NET/IB : Got async event : local catastrophic error",
...
BENIGN_WORDS = [
    ...
    "Got async event : client reregistration",
    "Got async event : port active",
