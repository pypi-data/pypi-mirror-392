...
from logsage.auto_resume_policy.utils import handle_text_file, sanitize_xss
...
logs_dict: dict[str, dict[str, float | list[str]]] = {}
...
def get_attribution_from_file(log_path, isolation, attribution, verbose):
    ...
    auto_resume_output, auto_resume_verbose, attribution_output, attribution_verbose, training_started = (
    ...
    try:
        ...
        if not application_errors_full:
            ...
            return ErrorAttributionWithJobId(
                ...
                application_errors_unique=application_errors_list_unique,
                auto_resume="Errors not found",
                auto_resume_verbose="Errors not found",
                attribution="Errors not found",
                job_id=job_id,
            )
