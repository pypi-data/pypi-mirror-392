...
@click.group(help="Setup command group for enabling setting up a Flexlar environment")
def setup():
	pass
...
@click.command("fonts", help="Add Flexlar fonts to system")
def setup_fonts():
...
@click.command(
	"production", help="Setup Flexlar production environment for specific user"
)
@click.argument("user")
