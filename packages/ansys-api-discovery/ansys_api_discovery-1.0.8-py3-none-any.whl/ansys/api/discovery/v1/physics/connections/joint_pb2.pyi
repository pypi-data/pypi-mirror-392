...
class SetJointTypeRequest(google.protobuf.message.Message):
    ...
    @property
    def object_id(self) -> ansys.api.discovery.v1.commonmessages_pb2.EntityIdentifier: ...
    joint_type: global___JointType.ValueType = ...
    def __init__(self,
        *,
        object_id : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.EntityIdentifier] = ...,
        joint_type : global___JointType.ValueType = ...,
        ) -> None: ...
