...
class TestReferenceFrameConfiguration(unittest.TestCase):
    ...
    def test_initialization_sets_properties_correctly(self) -> None:
        ...
        self.assertEqual(
            self.reference_frame_config.default_position, self.default_position
        )
        self.assertEqual(
...
class TestReferenceFrame(MatrixAssertionsMixin):
    ...
    def test_initialization_creates_configuration_with_correct_values(self) -> None:
        self.assertIsInstance(
            self.reference_frame._configuration, ReferenceFrameConfiguration
        )
        ...
        self.assertEqual(
            self.reference_frame._configuration.default_position, self.default_position
        )
        self.assertEqual(
