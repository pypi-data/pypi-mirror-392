...
$Id: request.py 5720 2025-11-06 09:28:35Z rodrigo.ristow $
"""
import base64
import logging
import re
    ...
    def _decode(self, text):
        ...
        if not isinstance(text, bytes):
            try:
                ...
                # Minimal change: only re-encode to latin-1 if possible. If that fails,
                # the input is already a real Unicode string, so immediately return a
                # normalized string.
