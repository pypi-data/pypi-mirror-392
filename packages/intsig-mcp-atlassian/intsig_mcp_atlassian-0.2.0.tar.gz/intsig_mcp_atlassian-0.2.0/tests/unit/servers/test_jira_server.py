...
from src.intsig_mcp_atlassian.jira import JiraFetcher
from src.intsig_mcp_atlassian.jira.config import JiraConfig
from src.intsig_mcp_atlassian.servers.context import MainAppContext
from src.intsig_mcp_atlassian.servers.main import AtlassianMCP
from src.intsig_mcp_atlassian.utils.oauth import OAuthConfig
...
def mock_jira_fetcher():
    ...
    from src.intsig_mcp_atlassian.models.jira.common import JiraUser
...
def test_jira_mcp(mock_jira_fetcher, mock_base_jira_config):
    ...
    from src.intsig_mcp_atlassian.servers.jira import (
        add_comment,
        add_worklog,
        batch_create_issues,
...
def no_fetcher_test_jira_mcp(mock_base_jira_config):
    ...
    from src.intsig_mcp_atlassian.servers.jira import get_issue
...
async def jira_client(test_jira_mcp, mock_jira_fetcher, mock_request):
    ...
    with (
        patch(
            "src.intsig_mcp_atlassian.servers.jira.get_jira_fetcher",
            AsyncMock(return_value=mock_jira_fetcher),
        ),
        patch(
            "src.intsig_mcp_atlassian.servers.dependencies.get_http_request",
...
async def test_get_issue_with_user_specific_fetcher_in_state(
    ...
    from src.intsig_mcp_atlassian.servers.dependencies import (
