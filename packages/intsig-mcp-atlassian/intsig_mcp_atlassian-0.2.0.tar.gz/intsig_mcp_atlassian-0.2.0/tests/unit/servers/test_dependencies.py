...
from intsig_mcp_atlassian.confluence import ConfluenceConfig, ConfluenceFetcher
from intsig_mcp_atlassian.jira import JiraConfig, JiraFetcher
...
from intsig_mcp_atlassian.utils.oauth import OAuthConfig
...
class TestGetJiraFetcher:
    ...
    @patch("intsig_mcp_atlassian.servers.dependencies.get_http_request")
    @patch("intsig_mcp_atlassian.servers.dependencies.JiraFetcher")
...
class TestGetConfluenceFetcher:
    ...
    @patch("intsig_mcp_atlassian.servers.dependencies.get_http_request")
    @patch("intsig_mcp_atlassian.servers.dependencies.ConfluenceFetcher")
    async def test_cached_fetcher_returned(
        self,
