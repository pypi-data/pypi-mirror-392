...
from src.intsig_mcp_atlassian.confluence import ConfluenceFetcher
from src.intsig_mcp_atlassian.confluence.config import ConfluenceConfig
from src.intsig_mcp_atlassian.models.confluence.page import ConfluencePage
...
def test_confluence_mcp(mock_confluence_fetcher, mock_base_confluence_config):
    ...
    from src.intsig_mcp_atlassian.servers.confluence import (
        add_comment,
        add_label,
        create_page,
        delete_page,
...
async def client(test_confluence_mcp, mock_confluence_fetcher):
    ...
    with (
        patch(
            "src.intsig_mcp_atlassian.servers.confluence.get_confluence_fetcher",
