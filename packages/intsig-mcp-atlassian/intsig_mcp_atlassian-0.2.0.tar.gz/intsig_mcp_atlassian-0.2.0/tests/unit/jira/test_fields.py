...
from intsig_mcp_atlassian.jira.fields import FieldsMixin
...
class TestFieldsMixin:
    ...
    #
    # See also:
    # https://github.com/sooperset/mcp-atlassian/blob/651c271e8aa76b469e9c67535669d93267ad5da6/src/intsig_mcp_atlassian/jira/fields.py#L279-L297
