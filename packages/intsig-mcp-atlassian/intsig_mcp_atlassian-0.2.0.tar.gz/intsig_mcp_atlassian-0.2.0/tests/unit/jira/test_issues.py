...
from intsig_mcp_atlassian.jira.issues import IssuesMixin, logger
from intsig_mcp_atlassian.models.jira import JiraIssue
...
class TestIssuesMixin:
    ...
    def test_create_epic(self, issues_mixin: IssuesMixin):
        ...
        with patch(
            "intsig_mcp_atlassian.jira.epics.EpicsMixin.prepare_epic_fields", autospec=True
