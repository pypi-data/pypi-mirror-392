...
from intsig_mcp_atlassian.exceptions import MCPAtlassianAuthenticationError
from intsig_mcp_atlassian.jira.client import JiraClient
from intsig_mcp_atlassian.jira.config import JiraConfig
from intsig_mcp_atlassian.utils.oauth import BYOAccessTokenOAuthConfig, OAuthConfig
...
class TestJiraClientOAuth:
    ...
    def test_init_with_oauth_config(self):
        ...
        # Mock dependencies
        with (
            patch("intsig_mcp_atlassian.jira.client.Jira") as mock_jira,
            patch(
                "intsig_mcp_atlassian.jira.client.configure_oauth_session"
            ) as mock_configure_oauth,
            patch(
                "intsig_mcp_atlassian.jira.client.configure_ssl_verification"
    ...
    def test_init_with_oauth_failed_session_config(self):
        ...
        with (
            ...
            patch(
                "intsig_mcp_atlassian.preprocessing.jira.JiraPreprocessor"
    ...
    def test_init_with_byo_oauth_failed_session_config(self):
        ...
        # Mock dependencies with OAuth configuration failure
        with (
            patch("intsig_mcp_atlassian.jira.client.Jira"),  # No need to assert mock_jira
            patch(
                "intsig_mcp_atlassian.jira.client.configure_oauth_session"
            ) as mock_configure_oauth,
            patch("intsig_mcp_atlassian.jira.client.configure_ssl_verification"),
        ):
            # Configure the mock to return failure for OAuth configuration
            mock_configure_oauth.return_value = False
    ...
    def test_init_with_byo_oauth_empty_token_failed_session_config(self):
        ...
        with (
            patch("intsig_mcp_atlassian.jira.client.Jira"),
            patch("intsig_mcp_atlassian.jira.client.configure_ssl_verification"),
    ...
    def test_from_env_with_oauth(self):
        ...
        with (
            ...
            patch(
                "intsig_mcp_atlassian.jira.config.get_oauth_config_from_env",
            ...
            patch("intsig_mcp_atlassian.jira.client.Jira") as mock_jira,
            patch(
                "intsig_mcp_atlassian.jira.client.configure_oauth_session", return_value=True
            ) as mock_configure_oauth,
            patch(
                "intsig_mcp_atlassian.jira.client.configure_ssl_verification"
            ) as mock_configure_ssl,
