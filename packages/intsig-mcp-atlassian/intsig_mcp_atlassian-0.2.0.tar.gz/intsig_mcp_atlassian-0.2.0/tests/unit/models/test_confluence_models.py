...
from src.intsig_mcp_atlassian.models import (
...
from src.intsig_mcp_atlassian.models.constants import EMPTY_STRING

# Optional: Import real API client for optional real-data testing
try:
    from src.intsig_mcp_atlassian.confluence.client import ConfluenceClient  # noqa: F401
except ImportError:
    pass
...
class TestRealConfluenceData:
    ...
    def test_real_confluence_page(
        ...
        try:
            ...
            from src.intsig_mcp_atlassian.confluence.client import ConfluenceClient
            from src.intsig_mcp_atlassian.confluence.config import ConfluenceConfig
            from src.intsig_mcp_atlassian.confluence.pages import PagesMixin
            ...
            # Convert to model
            from src.intsig_mcp_atlassian.models import ConfluencePage
            ...
            try:
                from src.intsig_mcp_atlassian.models import ConfluenceComment
