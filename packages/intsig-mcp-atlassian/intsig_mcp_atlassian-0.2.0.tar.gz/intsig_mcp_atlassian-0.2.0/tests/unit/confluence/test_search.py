...
from intsig_mcp_atlassian.confluence.search import SearchMixin
from intsig_mcp_atlassian.confluence.utils import quote_cql_identifier_if_needed
...
class TestSearchMixin:
    ...
    def search_mixin(self, confluence_client):
        ...
        with patch(
            "intsig_mcp_atlassian.confluence.search.ConfluenceClient.__init__"
        ) as mock_init:
