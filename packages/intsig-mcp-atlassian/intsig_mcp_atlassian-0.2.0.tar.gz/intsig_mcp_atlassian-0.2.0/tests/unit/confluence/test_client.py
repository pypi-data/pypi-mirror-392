...
from intsig_mcp_atlassian.confluence import ConfluenceFetcher
...
def test_init_with_basic_auth():
    ...
    with (
        patch("intsig_mcp_atlassian.confluence.client.Confluence") as mock_confluence,
        patch(
            "intsig_mcp_atlassian.preprocessing.confluence.ConfluencePreprocessor"
        ) as mock_preprocessor,
        patch(
            "intsig_mcp_atlassian.confluence.client.configure_ssl_verification"
...
def test_init_from_env():
    ...
    with (
        ...
        patch("intsig_mcp_atlassian.confluence.client.Confluence") as mock_confluence,
        patch("intsig_mcp_atlassian.preprocessing.confluence.ConfluencePreprocessor"),
        patch("intsig_mcp_atlassian.confluence.client.configure_ssl_verification"),
    ):
...
def test_process_html_content():
    ...
    # Arrange
    with (
        patch("intsig_mcp_atlassian.confluence.client.ConfluenceConfig.from_env"),
        patch("intsig_mcp_atlassian.confluence.client.Confluence"),
        patch(
            "intsig_mcp_atlassian.preprocessing.confluence.ConfluencePreprocessor"
...
def test_get_user_details_by_accountid():
    ...
    with (
        patch("intsig_mcp_atlassian.confluence.client.ConfluenceConfig.from_env"),
        patch("intsig_mcp_atlassian.confluence.client.Confluence") as mock_confluence_class,
        patch("intsig_mcp_atlassian.preprocessing.confluence.ConfluencePreprocessor"),
        patch("intsig_mcp_atlassian.confluence.client.configure_ssl_verification"),
    ):
...
def test_init_sets_proxies_and_no_proxy(monkeypatch):
    ...
    monkeypatch.setattr(
        "intsig_mcp_atlassian.confluence.client.Confluence", lambda **kwargs: mock_confluence
    )
    monkeypatch.setattr(
        "intsig_mcp_atlassian.confluence.client.configure_ssl_verification",
        lambda **kwargs: None,
