...
from intsig_mcp_atlassian.confluence.labels import LabelsMixin
from intsig_mcp_atlassian.models.confluence import ConfluenceLabel
...
class TestLabelsMixin:
    ...
    def labels_mixin(self, confluence_client):
        ...
        with patch(
            "intsig_mcp_atlassian.confluence.labels.ConfluenceClient.__init__"
        ) as mock_init:
