...
from intsig_mcp_atlassian.models.confluence import ConfluencePage
...
class TestPagesMixin:
    ...
    def pages_mixin(self, confluence_client):
        ...
        with patch(
            "intsig_mcp_atlassian.confluence.pages.ConfluenceClient.__init__"
        ) as mock_init:
...
class TestPagesOAuthMixin:
    ...
    def test_create_page_oauth_uses_v2_api(self, oauth_pages_mixin):
        ...
        # Mock the v2 adapter
        with patch(
            "intsig_mcp_atlassian.confluence.pages.ConfluenceV2Adapter"
