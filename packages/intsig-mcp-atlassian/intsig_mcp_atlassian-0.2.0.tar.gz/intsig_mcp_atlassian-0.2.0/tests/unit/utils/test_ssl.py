...
from intsig_mcp_atlassian.utils.ssl import SSLIgnoreAdapter, configure_ssl_verification
...
def test_ssl_ignore_adapter_init_poolmanager():
    ...
    with patch("ssl.create_default_context") as mock_create_context:
        ...
        with patch(
            "intsig_mcp_atlassian.utils.ssl.PoolManager", return_value=mock_pool_manager
...
def test_configure_ssl_verification_disabled():
    ...
    with patch("intsig_mcp_atlassian.utils.ssl.logger") as mock_logger:
        with patch("intsig_mcp_atlassian.utils.ssl.SSLIgnoreAdapter") as mock_adapter_class:
