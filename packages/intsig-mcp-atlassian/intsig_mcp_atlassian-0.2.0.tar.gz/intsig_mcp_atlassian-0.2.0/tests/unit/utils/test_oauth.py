...
from intsig_mcp_atlassian.utils.oauth import (
...
@patch("intsig_mcp_atlassian.utils.oauth.BYOAccessTokenOAuthConfig.from_env")
@patch("intsig_mcp_atlassian.utils.oauth.OAuthConfig.from_env")
...
@patch("intsig_mcp_atlassian.utils.oauth.logger")
