...
from intsig_mcp_atlassian.confluence import ConfluenceConfig
from intsig_mcp_atlassian.jira import JiraConfig
from intsig_mcp_atlassian.servers.context import MainAppContext
from intsig_mcp_atlassian.servers.dependencies import (
    _create_user_config_for_fetcher,
    get_confluence_fetcher,
    get_jira_fetcher,
)
from intsig_mcp_atlassian.servers.main import AtlassianMCP, main_lifespan
from intsig_mcp_atlassian.utils.environment import get_available_services
from intsig_mcp_atlassian.utils.ssl import configure_ssl_verification
...
class TestSharedAuthentication:
    ...
    async def test_authentication_context_in_request(self):
        ...
        with patch(
            "intsig_mcp_atlassian.servers.dependencies.get_http_request", return_value=request
        ):
            ...
            with (
                patch("intsig_mcp_atlassian.jira.JiraFetcher") as mock_jira_fetcher,
                patch(
                    "intsig_mcp_atlassian.confluence.ConfluenceFetcher"
...
class TestCrossServiceErrorHandling:
    ...
    async def test_jira_failure_does_not_affect_confluence(self):
        ...
        with MockEnvironment.basic_auth_env():
            ...
            with patch(
                "intsig_mcp_atlassian.jira.config.JiraConfig.from_env"
            ) as mock_jira_config:
    ...
    async def test_confluence_failure_does_not_affect_jira(self):
        ...
        with MockEnvironment.basic_auth_env():
            ...
            with patch(
                "intsig_mcp_atlassian.confluence.config.ConfluenceConfig.from_env"
            ) as mock_conf_config:
...
class TestConcurrentServiceInitialization:
    ...
    async def test_parallel_fetcher_creation(self):
        ...
        with MockEnvironment.oauth_env():
            ...
            with (
                patch(
                    "intsig_mcp_atlassian.servers.dependencies.get_http_request",
