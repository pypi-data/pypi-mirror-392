...
class ConfluenceConfig:
    ...
    auth_type: Literal["basic", "pat", "oauth", "intsig_sso"]  # Authentication type
    ...
    def from_env(cls) -> "ConfluenceConfig":
        ...
        """
        # Support INTSIG SSO mode first (dedicated env vars)
        intsig_url = os.getenv("INTSIG_CONFLUENCE_URL")
        intsig_username = os.getenv("INTSIG_CONFLUENCE_EMAIL")
        intsig_password = os.getenv("INTSIG_CONFLUENCE_PWD")

        # Fall back to standard variables if INTSIG variables are not present
        url = os.getenv("CONFLUENCE_URL") or intsig_url
        ...
        username = os.getenv("CONFLUENCE_USERNAME") or intsig_username
        api_token = os.getenv("CONFLUENCE_API_TOKEN") or intsig_password
        ...
        if intsig_url and intsig_username and intsig_password:
            auth_type = "intsig_sso"
        elif oauth_config:
    ...
    def is_auth_configured(self) -> bool:
        ...
        elif self.auth_type == "intsig_sso":
            # For INTSIG SSO, username/password come via INTSIG_* and are mapped
            return bool(self.username and self.api_token)
        logger.warning(
