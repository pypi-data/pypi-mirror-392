...
from intsig_mcp_atlassian.servers.dependencies import get_confluence_fetcher
from intsig_mcp_atlassian.utils.decorators import (
    check_write_access,
)
...
async def create_page(
    ...
    content_format: Annotated[
        str,
        Field(
            description="(Optional) The format of the content parameter. Options: 'markdown' (default), 'wiki', 'atlas_doc_format', or 'storage'. Wiki format uses Confluence wiki markup syntax",
            default="markdown",
        ),
    ] = "markdown",
    ...
    Args:
        ...
        content_format: The format of the content ('markdown', 'wiki', 'atlas_doc_format', or 'storage').
