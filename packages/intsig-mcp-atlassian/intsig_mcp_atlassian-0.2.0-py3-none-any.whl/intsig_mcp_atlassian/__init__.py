...
from intsig_mcp_atlassian.utils.env import is_env_truthy
from intsig_mcp_atlassian.utils.lifecycle import (
    ensure_clean_exit,
    setup_signal_handlers,
)
from intsig_mcp_atlassian.utils.logging import setup_logging
...
@click.option(
    "--intsig-confluence-url",
    help="doc.intsig.net",
)
@click.option("--intsig-confluence-email", help="INTSIG email")
@click.option("--intsig-confluence-pwd", help="INTSIG password")
@click.option(
    "--confluence-url",
...
def main(
    ...
    host: str,
    path: str | None,
    intsig_confluence_url: str | None,
    intsig_confluence_email: str | None,
    intsig_confluence_pwd: str | None,
    ...
    if click_ctx and was_option_provided(click_ctx, "intsig_confluence_url"):
        os.environ["INTSIG_CONFLUENCE_URL"] = intsig_confluence_url
    if click_ctx and was_option_provided(click_ctx, "intsig_confluence_email"):
        os.environ["INTSIG_CONFLUENCE_EMAIL"] = intsig_confluence_email
    if click_ctx and was_option_provided(click_ctx, "intsig_confluence_pwd"):
        os.environ["INTSIG_CONFLUENCE_PWD"] = intsig_confluence_pwd
    ...
    from intsig_mcp_atlassian.servers import main_mcp
