...
def get_available_services() -> dict[str, bool | None]:
    ...
    # Support INTSIG SSO mode - check INTSIG_CONFLUENCE_URL as fallback
    confluence_url = os.getenv("CONFLUENCE_URL") or os.getenv("INTSIG_CONFLUENCE_URL")
    confluence_is_setup = False
    
    # Check for INTSIG SSO configuration first (dedicated env vars)
    ...
    if intsig_url and intsig_username and intsig_password:
        ...
        logger.info("Using Confluence INTSIG SSO authentication")
    elif confluence_url:
