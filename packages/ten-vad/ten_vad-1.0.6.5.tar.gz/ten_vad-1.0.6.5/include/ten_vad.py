    ...
    def __init__(self, hop_size: int = 256, threshold: float = 0.5):
        ...
        if platform.system() == "Linux" and platform.machine() == "x86_64":
            ...
            if os.path.exists(git_path):
                ...
                raise FileNotFoundError(f"Cannot find libten_vad.so at {git_path} or {pip_path}")
            ...
            if os.path.exists(git_path):
                ...
                raise FileNotFoundError(f"Cannot find libten_vad at {git_path} or {pip_path}")
            ...
            if platform.machine().upper() in ['X64', 'X86_64', 'AMD64']:
                ...
                if os.path.exists(git_path):
                    ...
                    raise FileNotFoundError(f"Cannot find ten_vad.dll at {git_path} or {pip_path}")
            else:
                # Try git repo structure first
