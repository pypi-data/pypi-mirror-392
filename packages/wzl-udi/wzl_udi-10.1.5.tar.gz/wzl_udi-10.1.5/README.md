...
**10.1.5** - 2025-11-14
  - fixed serialization of variables of datatype "time" for streams

**10.1.4** - 2025-11-14
  - improved error message for mismatched dimension of variables

**10.1.3** - 2025-11-03
  - fixed missing unit attribute for parameters, arguments and returns
