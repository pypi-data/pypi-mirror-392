...
SAMPLE_RATE = 24000
_AVATAR_AGENT_IDENTITY = "hg-avatar-agent"
_AVATAR_AGENT_NAME = "hg-avatar-agent"
...
class AvatarSession:
    ...
    async def start(
        ...
        *,
        ...
        heygen_quality = os.getenv("HEYGEN_STREAM_QUALITY", "low").strip().lower()
        heygen_encoding = os.getenv("HEYGEN_VIDEO_ENCODING", "VP8").strip().upper()
