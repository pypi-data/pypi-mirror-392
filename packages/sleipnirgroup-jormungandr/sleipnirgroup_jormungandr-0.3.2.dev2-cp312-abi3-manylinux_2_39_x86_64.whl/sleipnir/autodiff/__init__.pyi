...
class VariableMatrix:
    ...
    @overload
    def __eq__(self, lhs: Variable) -> _sleipnir.optimization.EqualityConstraints: ...
    ...
    @overload
    def __lt__(self, lhs: Variable) -> _sleipnir.optimization.InequalityConstraints:
        """
        Greater-than comparison operator that returns an inequality constraint
        for two Variables.
    ...
    @overload
    def __gt__(self, lhs: Variable) -> _sleipnir.optimization.InequalityConstraints:
        """
        Less-than comparison operator that returns an inequality constraint
        for two Variables.
    ...
    @overload
    def __le__(self, lhs: Variable) -> _sleipnir.optimization.InequalityConstraints:
        """
        Greater-than-or-equal-to comparison operator that returns an
        inequality constraint for two Variables.
    ...
    @overload
    def __ge__(self, lhs: Variable) -> _sleipnir.optimization.InequalityConstraints:
        """
        Less-than-or-equal-to comparison operator that returns an inequality
        constraint for two Variables.
