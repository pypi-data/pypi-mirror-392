...
class BaseTicket(BaseModel):
    ...
    _default_sla_targets: ClassVar[Dict[str, int]] = {
        'P1': 4,
        'P2': 8,
        'P3': 24,
        'P4': 48
    ...
    def calculate_sla_compliance(
        ...
        for priority in ['P1', 'P2', 'P3', 'P4']:
            priority_tickets = [
                ...
                if t.priority == priority and t.resolution_hours is not None
            ]
            ...
            compliant = sum(
                1 for t in priority_tickets
                if t.calculate_sla_compliance(target_hours)
            )
