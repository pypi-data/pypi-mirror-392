...
const main = async () => {
    ...
    let cfatIamUserPass = false;
    let cfatIamIdPOrgServicePass = false;
    let cfatIamIdcConfiguredPass = false;
    let cfatCloudTrailPass = false;
    let cfatCloudTrailOrgTrailPass = false;
    let cfatVpcPass = true;
    let cfatEc2Pass = false;
    let cfatConfigManagementAccountPass = false;
    let cfatConfigRecorderManagementAccountPass = false;
    let cfatCloudTrailOrgServiceEnabledPass = false;
    let cfatTagPoliciesEnabledPass = false;
    let cfatScpEnabledPass = false;
    let cfatBackupPoliciesEnabledPass = false;
    let cfatOrgCloudFormationEnabledPass = false;
    let cfatOrgCloudFormationStatusPass = false;
    let cfatOrgServiceGuardDutyEnabledPass = false;
    let cfatOrgServiceSecurityHubEnabledPass = false;
    let cfatOrgServiceIamAccessAnalyzerEnabledPass = false;
    let cfatOrgServiceAwsConfigEnabledPass = false;
    let cfatOrgServiceRamEnabledPass = false;
    let cfatControlTowerDeployedPass = false;
    let cfatControlTowerNotDriftedPass = false;
    let cfatControlTowerLatestVersionPass = false;
    let cfatLogArchiveAccountPass = false;
    let cfatAuditAccountPass = false;
    let cfatManagementAccountPass = true;
        ...
        if (report.cloudTrailDetails && report.cloudTrailDetails.length > 0) {
            ...
            for (const ctFind of report.cloudTrailDetails) {
                if (ctFind.trailFound) {
                    if (ctFind.isOrgTrail) {
                        cfatCloudTrailOrgTrailPass = true;
                    }
                }
            }
        }
        ...
        if (report.orgMemberAccounts && report.orgMemberAccounts.length > 0) {
            for (const memberAccount of report.orgMemberAccounts) {
                if (memberAccount.accountName) {
                    if (memberAccount.accountName.toLowerCase() === 'log archive') {
                        cfatLogArchiveAccountPass = true;
                    }
                    if (memberAccount.accountName.toLowerCase() === 'audit') {
                        cfatAuditAccountPass = true;
                    }
                    if (memberAccount.accountName.toLowerCase() === 'security tooling') {
                        cfatAuditAccountPass = true;
                    }
                }
            }
    ...
    const cfatCloudTrailOrgServiceEnabledCheck = {
    ...
    const cfatCloudTrailOrgTrailCheck = {
    ...
    const cfatConfigManagementAccountCheck = {
    ...
    const cfatConfigRecorderManagementAccountCheck = {
    ...
    const cfatCloudFormationEnableCheck = {
    ...
    const cfatOrgServiceGuardDutyCheck = {
    ...
    const cfatOrgServiceSecurityHubCheck = {
    ...
    const cfatOrgServiceIamAccessAnalyzerCheck = {
    ...
    const cfatOrgServiceConfigCheck = {
    ...
    const cfatOrgServiceCloudFormationCheck = {
    ...
    const cfatOrgServiceBackupCheck = {
    ...
    const cfatIamIdCOrgServiceCheck = {
    ...
    const cfatIamIdcConfiguredCheck = {
    ...
    const cfatOrgPolicyTagPolicyCheck = {
    ...
    const cfatBackupPoliciesEnabledCheck = {
    ...
    const cfatControlTowerDeployedCheck = {
    ...
    const cfatControlTowerLatestVersionCheck = {
    ...
    const cfatControlTowerNotDriftedCheck = {
    ...
    const cfatLogArchiveAccountCheck = {
    ...
    const tasks = await createReport(report);
    const backlog = await createBacklog(report);
