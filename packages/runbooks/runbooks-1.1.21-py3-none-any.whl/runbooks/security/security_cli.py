...
@click.option("--profile", default="MANAGEMENT_PROFILE", help="AWS profile for management account (Organizations + GuardDuty admin)")
...
@click.pass_context
def deploy_guardduty(ctx, profile: str, delegated_admin: str, region: str, auto_enable_new_accounts: bool, dry_run: bool, output_file: str):
    """
...
@click.option("--profile", default="${MANAGEMENT_PROFILE}", help="AWS profile with SecurityHub and Organizations permissions")
