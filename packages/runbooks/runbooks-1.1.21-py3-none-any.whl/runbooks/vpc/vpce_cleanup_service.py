...
class VPCECleanupService:
    ...
    def run_full_workflow(
        ...
        try:
            ...
            enrichment_results = self.enrich_all(
    ...
    def validate_all(self, billing_profile: Optional[str] = None) -> Dict:
        ...
        if billing_profile:
            try:
                ...
                cost_validation = self.manager.compare_with_cost_explorer(
        ...
        try:
            ...
            results['decision_framework'] = {
                ...
                'medium_priority': len(recommendations[
                    (recommendations['two_gate_score'] >= 4) &
                    (recommendations['two_gate_score'] < 7)
                ]),
        ...
        try:
            ...
            analysis['recommendations'] = {
                ...
                'high_priority_count': len(
                    recommendations_df[recommendations_df['two_gate_score'] >= 7]
                ),
                'high_priority_savings': recommendations_df[
                    recommendations_df['two_gate_score'] >= 7
                ]['annual_cost'].sum()
            }
        except Exception as e:
    ...
    def export_all(
        ...
        for fmt in formats:
            try:
                export_path = self.manager.export_results(
                    format=fmt,
    ...
    def get_executive_summary(self) -> Dict:
        ...
        try:
            ...
            # Account breakdown
            account_breakdown = recommendations_df.groupby('account_id').agg({
                'vpce_id': 'count',
                'annual_cost': 'sum'
            }).to_dict()
            ...
            return {
                ...
                'endpoints': {
                    ...
                    'percentage_high_priority': (
                        high_priority_count / total_endpoints * 100
                ...
                'costs': {
                    ...
                    'percentage_high_priority': (
                        high_priority_savings / total_annual_cost * 100
