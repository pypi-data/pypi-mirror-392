...
AWS Profile Usage Examples:
  ...
  Legacy All:         runbooks finops --all (still supported, use --all-profile instead)
    ...
    # Persona Analysis (combines --cxo-analysis + --cxo-persona into single flag)
    parser.add_argument(
        "--persona",
        choices=["CFO", "CTO", "CEO", "ALL"],
        help="Executive persona for tailored analysis. CFO: cost optimization & ROI. CTO: technical debt & architecture. CEO: strategic KPIs & business impact.",
    )
