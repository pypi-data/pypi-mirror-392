...
class S3StorageLensAnalyzer:
    ...
    def calculate_optimization_score(metrics: S3BucketStorageLensMetrics) -> int:
        ...
        Score Components (5 categories):
        - Lifecycle Policy (25 pts): Has lifecycle rules configured
        - Storage Class Optimization (25 pts): Using appropriate storage classes for access patterns
        - Incomplete MPU Cleanup (15 pts): No abandoned multipart uploads
        - Intelligent-Tiering (20 pts): Using I-T for large buckets (>100GB)
        - Cost Spike Risk Management (15 pts): Growth rate under control
