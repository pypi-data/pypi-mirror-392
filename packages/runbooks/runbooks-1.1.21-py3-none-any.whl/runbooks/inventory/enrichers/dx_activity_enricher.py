            ...
            for idx, row in df.iterrows():
                ...
                try:
                    ...
                    if connections:
                        ...
                        bandwidth_gbps = int(bandwidth_str.replace('Gbps', '').replace('Mbps', '')) if 'Gbps' in bandwidth_str else 0
                    ...
                    total_traffic_bps = df.at[idx, 'connection_bps_egress_90d'] + df.at[idx, 'connection_bps_ingress_90d']
                    ...
                    try:
                        vif_response = self.dx.describe_virtual_interfaces(
                            connectionId=connection_id
                        )
