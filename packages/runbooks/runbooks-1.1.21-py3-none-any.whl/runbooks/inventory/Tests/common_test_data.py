...
DescribeRegionsResponseData = {
    "Regions": [
        ...
        {"Endpoint": "ec2.ap-southeast-6.amazonaws.com", "RegionName": "ap-southeast-6", "OptInStatus": "opt-in-not-required"},
    ]
}
...
function_response_data = {
    "Functions": [
        ...
        },
        {
            ...
            "RevisionId": "bbfc8a57-67de-426f-a63d-08996b688bd8",
            "Layers": [
                {"Arn": "arn:aws:lambda:ap-southeast-2:111122223333:layer:DistributedBoto3Library:9", "CodeSize": 12119917}
            ],
            "PackageType": "Zip",
            "Architectures": ["x86_64"],
            "EphemeralStorage": {"Size": 512},
