...
class CIDRConflictDetector:
    ...
    def export_conflicts(self, output_file: str = '/tmp/vpc-cidr-conflicts.xlsx'):
        ...
        column_order = [
            'vpc1', 'vpc1_name', 'vpc1_account', 'vpc1_region', 'vpc1_cidr',
            'vpc2', 'vpc2_name', 'vpc2_account', 'vpc2_region', 'vpc2_cidr',
            'severity', 'impact'
        ]
        ...
        conflicts_df.columns = [
            'VPC 1 ID', 'VPC 1 Name', 'VPC 1 Account', 'VPC 1 Region', 'VPC 1 CIDR',
            'VPC 2 ID', 'VPC 2 Name', 'VPC 2 Account', 'VPC 2 Region', 'VPC 2 CIDR',
