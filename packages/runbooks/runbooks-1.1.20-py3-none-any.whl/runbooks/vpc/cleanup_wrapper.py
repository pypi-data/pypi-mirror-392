...
class VPCCleanupCLI:
    ...
    def generate_cleanup_plan(self, vpc_id: str, use_three_bucket: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            # Add warnings
            if dependencies.get('eni_count', 0) > 0:
                plan['warnings'].append(f"⚠️ {dependencies['eni_count']} ENIs detected - VPC cannot be deleted until ENIs removed")
...
def validate_cleanup_safety(vpc_id: str, profile: Optional[str] = None, region: str = "ap-southeast-2") -> Dict[str, Any]:
    """
