    ...
    def enrich_dataframe(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        with create_progress_bar() as progress:
            task = progress.add_task(
                "[cyan]Enriching with EC2 metadata...",
                total=len(df)
            )
                ...
                try:
                    ...
                    for idx, row in region_df.iterrows():
                        ...
                        if instance_id in instance_lookup:
                            ...
                            df.at[idx, 'availability_zone'] = instance.get('Placement', {}).get('AvailabilityZone', 'N/A')
                            ...
                            df.at[idx, 'platform'] = instance.get('Platform', 'Linux')  # Default to Linux if not Windows
