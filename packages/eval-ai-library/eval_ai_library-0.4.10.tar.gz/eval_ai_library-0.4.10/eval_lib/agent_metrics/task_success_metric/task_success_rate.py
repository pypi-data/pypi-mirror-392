  ...
  "The assistant explained the password reset steps clearly."
    ...
    async def _generate_success_criteria(self, goal: str, dialogue: str) -> Tuple[List[str], float]:
        ...
        prompt = (
            ...
            f"User goal: {goal}\n\n"
            f"Generate 1-2 concrete SUCCESS CRITERIA that can be OBSERVED from the conversation to determine if the user goal was achieved.\n\n"
            "DO NOT assume user actions (confirming, clicking, receiving).\n"
