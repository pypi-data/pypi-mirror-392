...
class AirflowManager:
    ...
    @catch_airflow_errors
    def get_dags_count(self, tags: list[str] | None = ..., dag_id_pattern: str = ..., only_active: bool = ...) -> int:
    ...
    @catch_airflow_errors
    def get_dag_runs(self, states: list[DagState] | None = ...) -> list[DagRun] | None:
    ...
    @catch_airflow_errors
    def get_last_dag_run(self, username: str | None = ...) -> DagRun | None:
        """Получить список запусков дага.
    ...
    @catch_airflow_errors
    def trigger(self, conf: dict[str, Any] | None = ...) -> DagRun | None:
        """Запустить даг.
    ...
    @catch_airflow_errors
    def get_logs(self, task_id: str, try_num: int, continuation_token: str | None = ...) -> Logs | None:
