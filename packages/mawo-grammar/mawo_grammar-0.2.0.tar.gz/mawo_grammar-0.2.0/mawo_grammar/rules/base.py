...
if TYPE_CHECKING:
    from mawo_grammar.errors import ErrorSeverity, GrammarError
...
class Rule(ABC):
    ...
    def __init__(
        self, rule_id: str, category: str, severity: ErrorSeverity | str = "major"
    ) -> None:
        """Initialize rule.
        ...
        """
        from mawo_grammar.errors import ErrorSeverity
