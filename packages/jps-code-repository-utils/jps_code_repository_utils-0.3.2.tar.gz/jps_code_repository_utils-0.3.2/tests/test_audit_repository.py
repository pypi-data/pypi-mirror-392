...
runner = CliRunner()
log = logging.getLogger("jps-code-repository-utils.audit")
...
@patch("scripts.audit_repository.run_git")
...
@pytest.mark.skip(reason="Temporarily disabled")
@patch("scripts.audit_repository.run_git")
@patch("scripts.audit_repository.get_active_prs_github")
@patch("scripts.audit_repository.find_hotfix_drifts")
@patch("scripts.audit_repository.detect_file_overlap")
@patch("scripts.audit_repository.get_latest_release_tag")
