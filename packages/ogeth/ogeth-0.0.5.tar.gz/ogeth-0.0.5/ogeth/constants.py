...
CBO_UNITS = {
    ...
    "w_growth": "Percent",
    "L_growth": "Percent",
    "I_total": r"Billions of ብር",
    "L": "2012=100",
    "C": r"Billions of ብር",
    "agg_pension_outlays": r"Billions of ብር",
    "G": r"Billions of ብር",
    "iit_revenue": r"Billions of ብር",
    "payroll_tax_revenue": r"Billions of ብር",
    "business_tax_revenue": r"Billions of ብር",
    "wL": r"Billions of ብር",
    "D": r"Billions of ብር",
}
