...
class InstructionsAdmin:
    ...
    def add_instruction(self, instruction_data: InstructionCreate, integration_name: str | None = None) -> Instruction:
        """
    ...
    def get_instruction_by_name(self, instruction_name: str, integration_name: str | None = None) -> Instruction | None:
        """
    ...
    def get_instruction_by_id(self, instruction_id: str, integration_name: str | None = None) -> Instruction | None:
        """
    ...
    def delete_instruction(self, instruction_id: str, integration_name: str | None = None) -> None:
        """
    ...
    def remove_agent(self, instruction_id: str, agent_name: str, integration_name: str | None = None) -> Instruction:
        """
