...
class FileStorageAIKnowledge:
    ...
    def create_folder(
        ...
        **other,
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/folder/create"
        params = {
    ...
    def __get_upload_link_for_document(self, integration_name: str | None = None) -> dict[str, Any]:
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/file/upload-link"
    ...
    def create_files_reference(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/file/create-reference"
        params = {
            "from_uuid": from_uuid,
            "to_uuid": to_uuid,
            "metadata": metadata,
    ...
    def delete_files_reference(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/file/delete-reference"
        params = {
            "from_uuid": from_uuid,
            "to_uuid": to_uuid,
            "integration_name": integration_name,
    ...
    def rename_file_or_folder(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/files-system-item/rename"
        params = {
            "item_id": item_id,
            "new_name": new_name,
            "integration_name": integration_name,
    ...
    def update_file_or_folder(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/files-system-item/update"
        params = {
            "item_id": item_id,
            "integration_name": integration_name,
        }
    ...
    def delete_file_or_folder(self, item_id: str, integration_name: str | None = None) -> None:
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/file-system-item/delete"
    ...
    def get_file_or_folder(self, item_id: str, integration_name: str | None = None) -> AIKnowledgeFileSystemItem:
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/files-system-item/get"
        params = {"item_id": item_id, "integration_name": integration_name}
    ...
    def get_file_or_folder_path(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/files-system-item/get-path"
        params = {"item_id": item_id, "integration_name": integration_name}
    ...
    def list_files_and_folders(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/files-system-item/list"
        params = {"integration_name": integration_name}
    ...
    def execute_files_and_folders_list_query(
        ...
        **kwargs,
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/files-system-item/list-query"
        params = {"integration_name": integration_name}
    ...
    def count_files_and_folders(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/files-system-item/count"
    ...
    def get_download_link_for_document(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/file/download-link"
        params = {
            "item_id": item_id,
    ...
    def grant_or_revoke_user_access(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/files-system-item/grant-revoke-access/user"
        params = {
            "item_id": item_id,
            "user_id": user_id,
    ...
    def grant_or_revoke_security_group_access(
        ...
        url = f"{self.client.base_url}/v1/ai-knowledge/files-system-item/grant-revoke-access/security-group"
        params = {
            "item_id": item_id,
            "group_id": group_id,
            "has_access": has_access,
