...
def test_read_dummy_case_file_with_unmarked_timesets():
    ...
    assert str(records[5].message) == 'Geometry model looks transient, but no timeset is given - assuming it uses timeset 1 (path=./data/dummy_case_file/dummy_case_file_with_unmarked_timesets.case)'
    assert str(records[6].message) == 'Variable my_transient_scalar_per_element looks transient, but no timeset is given - assuming it uses timeset 1 (path=./data/dummy_case_file/dummy_case_file_with_unmarked_timesets.case)'
    assert str(records[7].message) == 'Variable my_transient_vector_per_element looks transient, but no timeset is given - assuming it uses timeset 1 (path=./data/dummy_case_file/dummy_case_file_with_unmarked_timesets.case)'
    assert str(records[8].message) == 'Variable my_transient_tensorsymm_per_element looks transient, but no timeset is given - assuming it uses timeset 1 (path=./data/dummy_case_file/dummy_case_file_with_unmarked_timesets.case)'
    assert str(records[9].message) == 'Variable my_transient_tensorasym_per_element looks transient, but no timeset is given - assuming it uses timeset 1 (path=./data/dummy_case_file/dummy_case_file_with_unmarked_timesets.case)'
