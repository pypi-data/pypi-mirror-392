...
class InterventionSpec:
    ...
    Attributes:
        feature_id: The ID of the SAE feature to intervene on
    ...
    def __init__(
        ...
        Args:
            feature_id: The SAE feature ID (int or str)
    ...
    def __repr__(self) -> str:
        ...
        return f"InterventionSpec(feature_id={self.feature_id}, strength={self.strength}, mode={self.mode!r})"
...
class Variant:
    ...
    Example:
        ...
        variant.add_intervention(feature_id=28612, strength=0.75)
    ...
    def add_intervention(
        ...
        Args:
            feature_id: The SAE feature ID to intervene on
        ...
        """
        intervention = InterventionSpec(feature_id, strength, mode)
