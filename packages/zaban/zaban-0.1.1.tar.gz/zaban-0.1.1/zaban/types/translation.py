...
class TranslationRequest(BaseModel):
    ...
    source_lang: Optional[str] = Field(
        None, 
        description="Source language code (e.g., 'eng_Latn'). Leave empty for auto-detection."
    )
    ...
    auto_detect: Optional[bool] = Field(
        False, 
        description="Enable automatic language detection for source language"
    )
...
class TranslationResponse(BaseModel):
    ...
    auto_detected: Optional[bool] = Field(
        False, 
        description="Whether source language was auto-detected"
    )
