...
class NumberTaskItemData(ElementDataText, NumberElementDataValue, total=False):
    pass


class PercentageTaskItemData(ElementDataText, PercentageElementDataValue, total=False):
    pass


class BooleanTaskItemData(ElementDataText, BooleanElementDataValue, total=False):
    pass
