...
class NumericElementDataValue(typing.TypedDict, total=True):
    value: typing.Required[int | float]
...
class NumberElementDataValue(NumericElementDataValue, total=True):
    type: typing.Required[Literal['number']]
    total: typing.Required[int | float]


class PercentageElementDataValue(NumericElementDataValue, total=True):
    type: typing.Required[Literal['percentage']]


class BooleanElementDataValue(typing.TypedDict, total=True):
    type: typing.Required[Literal['boolean']]
    value: typing.Required[bool]


class ElementDataText(typing.TypedDict, total=True):
...
class AbstractTaskItemData(typing.TypedDict, total=True):
