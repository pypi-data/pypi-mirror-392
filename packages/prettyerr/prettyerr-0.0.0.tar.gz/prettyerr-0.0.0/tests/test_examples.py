...
def _error_highlight_multiple_tokens(use_color: bool) -> Error:
    return Error(
        ...
        pointer_messages=[
            PointerMessage(span=Span(0, 6), message="<message about the identifier token>"),
            PointerMessage(span=Span(6, 6), message="<message about the juxtapose token>"),
...
def _error_dealing_with_tightly_packed(use_color: bool) -> Error:
    return Error(
        ...
        pointer_messages=[
            PointerMessage(span=Span(0, 2), message="<message about the `10` token>"),
            PointerMessage(span=Span(2, 3), message="<message about the `x` token>"),
            PointerMessage(span=Span(3, 4), message="<message about the `(` token>"),
            PointerMessage(span=Span(4, 5), message="<message about the `y` token>"),
            PointerMessage(span=Span(5, 6), message="<message about the `)` token>"),
            PointerMessage(span=Span(2, 2), message="<message about the 10x juxtaposition>"),
            PointerMessage(span=Span(3, 3), message="<message about the x(y) juxtaposition>"),
        ],
        hint="<some helpful hint>",
        use_color=use_color,
    )
...
def _error_multi_line_expression(use_color: bool) -> Error:
    pointer_messages = [
        PointerMessage(span=Span(2, 2), message="<message about the 10x juxtaposition>"),
        PointerMessage(span=Span(3, 3), message="<message about the x(y) juxtaposition>"),
        PointerMessage(span=Span(0, 2), message="<message about the `10` token>"),
        ...
        PointerMessage(span=Span(4, 5), message="<message about the `y` token>"),
        PointerMessage(span=Span(5, 6), message="<message about the `)` token>"),
        PointerMessage(span=Span(7, 8), message="<message about the `*` token>"),
        PointerMessage(span=Span(9, 11), message="<message about the `42` token>"),
        PointerMessage(span=Span(12, 13), message="<message about the `+` token>"),
        PointerMessage(span=Span(14, 15), message="<message about the `3` token>"),
...
def _error_triple_tightly_packed(use_color: bool) -> Error:
    return Error(
        ...
        pointer_messages=[
            PointerMessage(span=Span(0, 1), message="<message about the `[` token>"),
            PointerMessage(span=Span(1, 2), message="<message about the `a` token>"),
            PointerMessage(span=Span(2, 3), message="<message about the `]` token>"),
            PointerMessage(span=Span(3, 4), message="<message about the `5` token>"),
            PointerMessage(span=Span(4, 5), message="<message about the `x` token>"),
            PointerMessage(span=Span(5, 6), message="<message about the `(` token>"),
            PointerMessage(span=Span(6, 7), message="<message about the `y` token>"),
            PointerMessage(span=Span(7, 8), message="<message about the `)` token>"),
            PointerMessage(span=Span(3, 3), message="<message about the `[a]5` juxtaposition>"),
            PointerMessage(span=Span(4, 4), message="<message about the `5x` juxtaposition>"),
...
def _error_three_line_spanning(use_color: bool) -> Error:
    tri_pointers = [
        PointerMessage(span=Span(0, 5), message="<message about alpha>"),
        PointerMessage(span=Span(6, 10), message="<message about beta>"),
        PointerMessage(span=Span(11, 16), message="<message about gamma>"),
        PointerMessage(span=Span(17, 18), message="<message about `+`>"),
        PointerMessage(span=Span(19, 24), message="<message about delta>"),
        PointerMessage(span=Span(25, 32), message="<message about epsilon>"),
...
def _error_multiline_span_pointer(use_color: bool) -> Error:
    return Error(
        ...
        pointer_messages=[
            PointerMessage(span=full_span, message="<message covering the entire block>"),
        ],
...
def _error_multidigit_line_numbers(use_color: bool) -> Error:
    return Error(
        ...
        pointer_messages=[
            PointerMessage(span=span_text(9, "finalize"), message="<message on line 9>"),
            PointerMessage(span=span_text(10, "verify outputs"), message="<message on line 10>"),
            PointerMessage(span=span_text(12, "shutdown services"), message="<message on line 12>"),
        ],
...
def _error_type_mismatch(use_color: bool) -> Error:
    return Error(
        src_file=py_sf,
...
EXPECTED_COLOR = {
    'UNABLE_TO_JUXTAPOSE': "Error: \x1b[31mdewy.errors.E1234 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Unable to juxtapose identifier and string\n    ╭─[path/to/file.dewy:1:7]\n  \x1b[38;5;245m1\x1b[0m | printl'Hello, World'\n    ·      \x1b[95m╱\x1b[0m\x1b[95m╲\x1b[0m\n    ·      \x1b[95m╰\x1b[0m\x1b[95m─ tried to juxtapose printl (string:>void) and 'Hello, World' (string)\x1b[0m\n    · \x1b[95m        expected whitespace or operator between identifier and string\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m insert a space or an operator",
    'TOKEN_NEEDS_CONTEXT': "Error: \x1b[31mdewy.errors.E2234 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Token needs additional context\n    ╭─[path/to/file.dewy:1:1]\n  \x1b[38;5;245m1\x1b[0m | printl'Hello, World'\n    · \x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m┬\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\n    ·   \x1b[95m╰\x1b[0m\x1b[95m─ <per token message>\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m <some helpful hint>",
    'HIGHLIGHT_MULTIPLE_TOKENS': "Error: \x1b[31mdewy.errors.E2234 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Highlight multiple adjacent tokens\n    ╭─[path/to/file.dewy:1:1]\n  \x1b[38;5;245m1\x1b[0m | printl'Hello, World'\n    · \x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m┬\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[96m╱\x1b[0m\x1b[96m╲\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m┬\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\n    ·   \x1b[95m│\x1b[0m  \x1b[96m│\x1b[0m      \x1b[92m╰\x1b[0m\x1b[92m─ <message about the string token>\x1b[0m\n    ·   \x1b[95m│\x1b[0m  \x1b[96m╰\x1b[0m\x1b[96m─ <message about the juxtapose token>\x1b[0m\n    ·   \x1b[95m╰\x1b[0m\x1b[95m─ <message about the identifier token>\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m <some helpful hint>",
    'DEALING_WITH_TIGHTLY_PACKED': 'Error: \x1b[31mdewy.errors.E3234 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Dealing with tightly packed tokens\n    ╭─[path/to/file.dewy:1:1]\n    ·  \x1b[95m╭\x1b[0m\x1b[95m─ <message about the 10x juxtaposition>\x1b[0m\n    ·  \x1b[95m│\x1b[0m\x1b[96m╭\x1b[0m\x1b[96m─ <message about the x(y) juxtaposition>\x1b[0m\n    ·  \x1b[95m╲\x1b[0m\x1b[96m╳\x1b[0m\x1b[96m╱\x1b[0m\n  \x1b[38;5;245m1\x1b[0m | 10x(y)\n    · \x1b[95m┬\x1b[0m\x1b[95m─\x1b[0m\x1b[96m┬\x1b[0m\x1b[92m┬\x1b[0m\x1b[93m┬\x1b[0m\x1b[94m┬\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m\x1b[92m│\x1b[0m\x1b[93m│\x1b[0m\x1b[94m╰\x1b[0m\x1b[94m─ <message about the `)` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m\x1b[92m│\x1b[0m\x1b[93m╰\x1b[0m\x1b[93m─ <message about the `y` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m\x1b[92m╰\x1b[0m\x1b[92m─ <message about the `(` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m╰\x1b[0m\x1b[96m─ <message about the `x` token>\x1b[0m\n    · \x1b[95m╰\x1b[0m\x1b[95m─ <message about the `10` token>\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m <some helpful hint>',
    'FLIPPING_POINTER_DIRECTIONS': 'Error: \x1b[31mdewy.errors.E3234 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Flipping pointer directions\n    ╭─[path/to/file.dewy:1:1]\n    ·  \x1b[95m╭\x1b[0m\x1b[95m─ <message about the 10x juxtaposition>\x1b[0m\n    ·  \x1b[95m│\x1b[0m\x1b[96m╭\x1b[0m\x1b[96m─ <message about the x(y) juxtaposition>\x1b[0m\n    ·  \x1b[95m╲\x1b[0m\x1b[96m╳\x1b[0m\x1b[96m╱\x1b[0m\n  \x1b[38;5;245m1\x1b[0m | 10x(y)\n    · \x1b[92m┬\x1b[0m\x1b[92m─\x1b[0m\x1b[93m┬\x1b[0m\x1b[94m┬\x1b[0m\x1b[95m┬\x1b[0m\x1b[96m┬\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m\x1b[94m│\x1b[0m\x1b[95m│\x1b[0m\x1b[96m╰\x1b[0m\x1b[96m─ <message about the `)` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m\x1b[94m│\x1b[0m\x1b[95m╰\x1b[0m\x1b[95m─ <message about the `y` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m\x1b[94m╰\x1b[0m\x1b[94m─ <message about the `(` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m╰\x1b[0m\x1b[93m─ <message about the `x` token>\x1b[0m\n    · \x1b[92m╰\x1b[0m\x1b[92m─ <message about the `10` token>\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m <some helpful hint>',
    'MULTI_LINE_EXPRESSION_POINTERS': 'Error: \x1b[31mdewy.errors.E3234 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Multi-line expression pointers\n    ╭─[path/to/file.dewy:1:1]\n    ·  \x1b[95m╭\x1b[0m\x1b[95m─ <message about the 10x juxtaposition>\x1b[0m\n    ·  \x1b[95m│\x1b[0m\x1b[96m╭\x1b[0m\x1b[96m─ <message about the x(y) juxtaposition>\x1b[0m\n    ·  \x1b[95m╲\x1b[0m\x1b[96m╳\x1b[0m\x1b[96m╱\x1b[0m\n  \x1b[38;5;245m1\x1b[0m | 10x(y)\n    · \x1b[92m┬\x1b[0m\x1b[92m─\x1b[0m\x1b[93m┬\x1b[0m\x1b[94m┬\x1b[0m\x1b[95m┬\x1b[0m\x1b[96m┬\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m\x1b[94m│\x1b[0m\x1b[95m│\x1b[0m\x1b[96m╰\x1b[0m\x1b[96m─ <message about the `)` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m\x1b[94m│\x1b[0m\x1b[95m╰\x1b[0m\x1b[95m─ <message about the `y` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m\x1b[94m╰\x1b[0m\x1b[94m─ <message about the `(` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m╰\x1b[0m\x1b[93m─ <message about the `x` token>\x1b[0m\n    · \x1b[92m╰\x1b[0m\x1b[92m─ <message about the `10` token>\x1b[0m\n  \x1b[38;5;245m2\x1b[0m | * 42 + 3^x\n    · \x1b[92m┬\x1b[0m \x1b[93m┬\x1b[0m\x1b[93m─\x1b[0m \x1b[94m┬\x1b[0m \x1b[95m┬\x1b[0m\x1b[96m┬\x1b[0m\x1b[92m┬\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m  \x1b[94m│\x1b[0m \x1b[95m│\x1b[0m\x1b[96m│\x1b[0m\x1b[92m╰\x1b[0m\x1b[92m─ <message about the `x` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m  \x1b[94m│\x1b[0m \x1b[95m│\x1b[0m\x1b[96m╰\x1b[0m\x1b[96m─ <message about the `^` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m  \x1b[94m│\x1b[0m \x1b[95m╰\x1b[0m\x1b[95m─ <message about the `3` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m  \x1b[94m╰\x1b[0m\x1b[94m─ <message about the `+` token>\x1b[0m\n    · \x1b[92m│\x1b[0m \x1b[93m╰\x1b[0m\x1b[93m─ <message about the `42` token>\x1b[0m\n    · \x1b[92m╰\x1b[0m\x1b[92m─ <message about the `*` token>\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m <some helpful hint>',
    'UPPER_ABOVE_LOWER_BELOW': 'Error: \x1b[31mdewy.errors.E3234 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Upper line pointers above, lower line below\n    ╭─[path/to/file.dewy:1:1]\n    · \x1b[95m╭\x1b[0m\x1b[95m─ <message about the `10` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m╭\x1b[0m\x1b[96m─ <message about the `x` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m\x1b[92m╭\x1b[0m\x1b[92m─ <message about the `(` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m\x1b[92m│\x1b[0m\x1b[93m╭\x1b[0m\x1b[93m─ <message about the `y` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m\x1b[92m│\x1b[0m\x1b[93m│\x1b[0m\x1b[94m╭\x1b[0m\x1b[94m─ <message about the `)` token>\x1b[0m\n    · \x1b[95m┴\x1b[0m\x1b[95m─\x1b[0m\x1b[96m┴\x1b[0m\x1b[92m┴\x1b[0m\x1b[93m┴\x1b[0m\x1b[94m┴\x1b[0m\n  \x1b[38;5;245m1\x1b[0m | 10x(y)\n  \x1b[38;5;245m2\x1b[0m | * 42 + 3^x\n    · \x1b[95m┬\x1b[0m \x1b[96m┬\x1b[0m\x1b[96m─\x1b[0m \x1b[92m┬\x1b[0m \x1b[93m┬\x1b[0m\x1b[94m┬\x1b[0m\x1b[95m┬\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m  \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m\x1b[94m│\x1b[0m\x1b[95m╰\x1b[0m\x1b[95m─ <message about the `x` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m  \x1b[92m│\x1b[0m \x1b[93m│\x1b[0m\x1b[94m╰\x1b[0m\x1b[94m─ <message about the `^` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m  \x1b[92m│\x1b[0m \x1b[93m╰\x1b[0m\x1b[93m─ <message about the `3` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m│\x1b[0m  \x1b[92m╰\x1b[0m\x1b[92m─ <message about the `+` token>\x1b[0m\n    · \x1b[95m│\x1b[0m \x1b[96m╰\x1b[0m\x1b[96m─ <message about the `42` token>\x1b[0m\n    · \x1b[95m╰\x1b[0m\x1b[95m─ <message about the `*` token>\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m <some helpful hint>',
    'TRIPLE_TIGHTLY_PACKED': 'Error: \x1b[31mdewy.errors.E3234 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Triple tightly packed tokens\n    ╭─[path/to/file.dewy:1:1]\n    ·   \x1b[93m╭\x1b[0m\x1b[93m─ <message about the `[a]5` juxtaposition>\x1b[0m\n    ·   \x1b[93m│\x1b[0m\x1b[94m╭\x1b[0m\x1b[94m─ <message about the `5x` juxtaposition>\x1b[0m\n    ·   \x1b[93m│\x1b[0m\x1b[94m│\x1b[0m\x1b[95m╭\x1b[0m\x1b[95m─ <message about the `x(y)` juxtaposition>\x1b[0m\n    ·   \x1b[93m╲\x1b[0m\x1b[94m╳\x1b[0m\x1b[95m╳\x1b[0m\x1b[95m╱\x1b[0m\n  \x1b[38;5;245m1\x1b[0m | [a]5x(y)\n    · \x1b[95m┬\x1b[0m\x1b[96m┬\x1b[0m\x1b[92m┬\x1b[0m\x1b[93m┬\x1b[0m\x1b[94m┬\x1b[0m\x1b[95m┬\x1b[0m\x1b[96m┬\x1b[0m\x1b[92m┬\x1b[0m\n    · \x1b[95m│\x1b[0m\x1b[96m│\x1b[0m\x1b[92m│\x1b[0m\x1b[93m│\x1b[0m\x1b[94m│\x1b[0m\x1b[95m│\x1b[0m\x1b[96m│\x1b[0m\x1b[92m╰\x1b[0m\x1b[92m─ <message about the `)` token>\x1b[0m\n    · \x1b[95m│\x1b[0m\x1b[96m│\x1b[0m\x1b[92m│\x1b[0m\x1b[93m│\x1b[0m\x1b[94m│\x1b[0m\x1b[95m│\x1b[0m\x1b[96m╰\x1b[0m\x1b[96m─ <message about the `y` token>\x1b[0m\n    · \x1b[95m│\x1b[0m\x1b[96m│\x1b[0m\x1b[92m│\x1b[0m\x1b[93m│\x1b[0m\x1b[94m│\x1b[0m\x1b[95m╰\x1b[0m\x1b[95m─ <message about the `(` token>\x1b[0m\n    · \x1b[95m│\x1b[0m\x1b[96m│\x1b[0m\x1b[92m│\x1b[0m\x1b[93m│\x1b[0m\x1b[94m╰\x1b[0m\x1b[94m─ <message about the `x` token>\x1b[0m\n    · \x1b[95m│\x1b[0m\x1b[96m│\x1b[0m\x1b[92m│\x1b[0m\x1b[93m╰\x1b[0m\x1b[93m─ <message about the `5` token>\x1b[0m\n    · \x1b[95m│\x1b[0m\x1b[96m│\x1b[0m\x1b[92m╰\x1b[0m\x1b[92m─ <message about the `]` token>\x1b[0m\n    · \x1b[95m│\x1b[0m\x1b[96m╰\x1b[0m\x1b[96m─ <message about the `a` token>\x1b[0m\n    · \x1b[95m╰\x1b[0m\x1b[95m─ <message about the `[` token>\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m <some helpful hint>',
    ...
    'THREE_LINE_SPANNING': 'Error: \x1b[31mdewy.errors.E4000 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Three-line spanning diagnostic\n    ╭─[path/to/file.dewy:1:1]\n    ·   \x1b[95m╭\x1b[0m\x1b[95m─ <message about alpha>\x1b[0m\n    ·   \x1b[95m│\x1b[0m    \x1b[96m╭\x1b[0m\x1b[96m─ <message about beta>\x1b[0m\n    · \x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m┴\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m \x1b[96m─\x1b[0m\x1b[96m┴\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\n  \x1b[38;5;245m1\x1b[0m | alpha beta\n  \x1b[38;5;245m2\x1b[0m | gamma + delta\n    · \x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m┬\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m \x1b[93m┬\x1b[0m \x1b[94m─\x1b[0m\x1b[94m─\x1b[0m\x1b[94m┬\x1b[0m\x1b[94m─\x1b[0m\x1b[94m─\x1b[0m\n    ·   \x1b[92m│\x1b[0m   \x1b[93m│\x1b[0m   \x1b[94m╰\x1b[0m\x1b[94m─ <message about delta>\x1b[0m\n    ·   \x1b[92m│\x1b[0m   \x1b[93m╰\x1b[0m\x1b[93m─ <message about `+`>\x1b[0m\n    ·   \x1b[92m╰\x1b[0m\x1b[92m─ <message about gamma>\x1b[0m\n  \x1b[38;5;245m3\x1b[0m | epsilon & zeta\n    · \x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m┬\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m \x1b[96m┬\x1b[0m \x1b[92m─\x1b[0m\x1b[92m┬\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\n    ·    \x1b[95m│\x1b[0m    \x1b[96m│\x1b[0m  \x1b[92m╰\x1b[0m\x1b[92m─ <message about zeta>\x1b[0m\n    ·    \x1b[95m│\x1b[0m    \x1b[96m╰\x1b[0m\x1b[96m─ <message about `&`>\x1b[0m\n    ·    \x1b[95m╰\x1b[0m\x1b[95m─ <message about epsilon>\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m defaults to showing all markers below for 3+ lines',
    'MULTILINE_SPAN_POINTER': 'Error: \x1b[31mdewy.errors.E6000 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Illustrate multi-line span pointer\n    ╭─[path/to/block.dewy:1:1]\n  \x1b[38;5;245m1\x1b[0m | block start {\n  \x1b[38;5;245m2\x1b[0m |   inner stuff\n  \x1b[38;5;245m3\x1b[0m | } block end\n    · \x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m┬\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\n    ·       \x1b[95m╰\x1b[0m\x1b[95m─ <message covering the entire block>\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m multi-line spans draw a single pointer after the block',
    'MULTIDIGIT_LINE_NUMBERS': 'Error: \x1b[31mdewy.errors.E5000 (link)\x1b[0m\n\n  \x1b[31m×\x1b[0m Demonstrate multi-digit line numbers\n     ╭─[path/to/long_example.dewy:9:10]\n     ·             \x1b[95m╭\x1b[0m\x1b[95m─ <message on line 9>\x1b[0m\n     ·          \x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m┴\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\n  \x1b[38;5;245m 9\x1b[0m | step 09: finalize partial sum\n  \x1b[38;5;245m10\x1b[0m | step 10: verify outputs\n     ·          \x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m┬\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\x1b[96m─\x1b[0m\n     ·                \x1b[96m╰\x1b[0m\x1b[96m─ <message on line 10>\x1b[0m\n  \x1b[38;5;245m12\x1b[0m | step 12: shutdown services\n     ·          \x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m┬\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\x1b[92m─\x1b[0m\n     ·                  \x1b[92m╰\x1b[0m\x1b[92m─ <message on line 12>\x1b[0m\n     ╰───\n  \x1b[38;5;245mhelp:\x1b[0m line numbers stay aligned even after 9',
    'TYPE_MISMATCH_TIMES': 'Error: \x1b[31mtype mismatch for argument `times`\x1b[0m\n\n    ╭─[path/to/py_example.py:4:10]\n  \x1b[38;5;245m4\x1b[0m | result = repeat("hello", "3")\n    ·          \x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m┬\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m\x1b[95m─\x1b[0m          \x1b[96m─\x1b[0m\x1b[96m┬\x1b[0m\x1b[96m─\x1b[0m\n    ·            \x1b[95m│\x1b[0m              \x1b[96m╰\x1b[0m\x1b[96m─ argument given is type \'str\'\x1b[0m\n    ·            \x1b[95m╰\x1b[0m\x1b[95m─ `repeat` function\'s second argument `times` expects an \'int\'\x1b[0m\n    ╰───\n  \x1b[38;5;245mhelp:\x1b[0m Consider changing string literal "3" to integer 3',
}
...
def test_multi_line_expression_plain() -> None:
    assert str(_error_multi_line_expression(False)) == EXPECTED_PLAIN['MULTI_LINE_EXPRESSION_POINTERS']


def test_multi_line_expression_color() -> None:
    assert str(_error_multi_line_expression(True)) == EXPECTED_COLOR['MULTI_LINE_EXPRESSION_POINTERS']
...
def test_type_mismatch_plain() -> None:
    assert str(_error_type_mismatch(False)) == EXPECTED_PLAIN['TYPE_MISMATCH_TIMES']


def test_type_mismatch_color() -> None:
    assert str(_error_type_mismatch(True)) == EXPECTED_COLOR['TYPE_MISMATCH_TIMES']
