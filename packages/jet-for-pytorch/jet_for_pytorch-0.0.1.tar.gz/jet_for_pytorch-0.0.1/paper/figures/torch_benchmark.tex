\begin{figure*}[!t]
  ...
  \begin{tabular}{CDEE}
    ...
    & \includegraphics[trim={0.475cm 0 0 0},clip]{jet/exp/exp01_benchmark_laplacian/figures/architecture_tanh_mlp_768_768_512_512_1_device_cuda_dim_50_name_weighted_laplacian_vary_batch_size_rank_ratio_1_0.pdf}
    & \includegraphics[trim={0.475cm 0 0 0},clip]{jet/exp/exp01_benchmark_laplacian/figures/architecture_tanh_mlp_768_768_512_512_1_device_cuda_dim_5_name_bilaplacian_vary_batch_size.pdf}
    \\[-6ex]
  \scalebox{0.85}{
    \begin{tikzpicture}
