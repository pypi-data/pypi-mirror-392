...
FILE_TYPE_DICT = {"vhdr": "raw_files", "txt": "log_files", "matrix": "besa_files"}
...
def _write_ucap_manifest():
    ...
    participants = df["name"].str.split(r"_|\.").str[0].str.zfill(2)
    ...
    df = df[["local_path", "url", "hash", "participant_id", "file_type", "size"]]
