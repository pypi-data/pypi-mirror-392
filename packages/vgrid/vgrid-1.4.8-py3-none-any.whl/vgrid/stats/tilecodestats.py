...
def tilecodeinspect(res):
    ...
    """
    tilecode_gdf = tilecodegrid(res, output_format="gpd")
...
def tilecode_norm_area(tilecode_gdf: gpd.GeoDataFrame, crs: str | None = 'proj=moll'):
    ...
    tilecode_gdf = tilecode_gdf[
        ~tilecode_gdf["crossed"]
...
def tilecode_compactness_ipq(tilecode_gdf: gpd.GeoDataFrame, crs: str | None = 'proj=moll'):
    """
...
def tilecode_compactness_cvh(tilecode_gdf: gpd.GeoDataFrame, crs: str | None = 'proj=moll'):
    """
