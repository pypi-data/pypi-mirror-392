...
def quadkeyinspect(res):
    ...
    """
    quadkey_gdf = quadkeygrid(res, output_format="gpd")
...
def quadkey_compactness_ipq(quadkey_gdf: gpd.GeoDataFrame, crs: str | None = 'proj=moll'):
    """
...
def quadkey_compactness_cvh(quadkey_gdf: gpd.GeoDataFrame, crs: str | None = 'proj=moll'):
    """
