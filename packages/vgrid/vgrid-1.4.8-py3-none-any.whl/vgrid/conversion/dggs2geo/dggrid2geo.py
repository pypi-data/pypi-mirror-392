...
def dggrid2geo(
    dggrid_instance, dggs_type, dggrid_ids, resolution=None, input_address_type="SEQNUM", split_antimeridian=False
):
    """
    ...
    if split_antimeridian:
        dggrid_cells["geometry"] = dggrid_cells["geometry"].apply(
...
def dggrid2geojson(
    dggrid_instance, dggs_type, dggrid_ids, resolution, input_address_type="SEQNUM", split_antimeridian=False
):
    """
    ...
    gdf = dggrid2geo(
        dggrid_instance, dggs_type, dggrid_ids, resolution, input_address_type, split_antimeridian=split_antimeridian
    )
