...
def raster2dggrid(
    ...
    for dggrid_id, band_values in tqdm(
        ...
        try:
            ...
            cell_polygon = dggrid2geo(dggrid_instance, dggs_type, dggrid_id, resolution, split_antimeridian=split_antimeridian)
...
def raster2dggrid_cli():
    ...
    result = raster2dggrid(
        dggrid_instance, dggs_type, raster, resolution, output_format
    )
