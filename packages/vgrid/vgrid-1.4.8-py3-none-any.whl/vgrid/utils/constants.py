...
DGGAL_TYPES = {
    ...
    "isea4r": {"min_res": 0, "max_res": 20, "default_res": 12, "class_name": "ISEA4R"},
    ...
    "isea7h_z7": {"min_res": 0, "max_res": 19, "default_res": 11, "class_name": "ISEA7H_Z7"},
    
    "ivea4r": {"min_res": 0, "max_res": 20, "default_res": 12, "class_name": "IVEA4R"},
    ...
    "ivea7h_z7": {"min_res": 0, "max_res": 19, "default_res": 11, "class_name": "IVEA7H_Z7"},
    
    "rtea4r": {"min_res": 0, "max_res": 20, "default_res": 12, "class_name": "RTEA4R"},
    ...
    "rtea7h_z7": {"min_res": 0, "max_res": 19, "default_res": 11, "class_name": "RTEA7H_Z7"},
    
    "healpix": {"min_res": 0, "max_res": 26, "default_res": 18, "class_name": "HEALPix"},
    "rhealpix": {
        "min_res": 0,
        "max_res": 16,
        "default_res": 10,
...
DGGS_INSPECT = {
    ...
    "dggrid_isea4t": {
        "min_res": 2,
        "max_res": 5,
    },  # 6,7 beinng created seperaetaly due to large size
    "dggrid_fuller4t": {
        "min_res": 2,
        "max_res": 5,
    },  # 6,7 beinng created seperaetaly due to large size
    ...
    "dggrid_isea7h": {
        "min_res": 2,
        "max_res": 4,
    },  # 5 beinng created seperaetaly due to large size
    "dggrid_fuller7h": {
        "min_res": 2,
        "max_res": 4,
    },  # 5 beinng created seperaetaly due to large size
