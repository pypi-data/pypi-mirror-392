    ...
    for polyline in polylines:
        ...
        if seed_cell_polygon.contains(bbox_polygon):
            ...
            while queue:
                ...
                cell_polygon = rhealpix2geo(current_cell_id, split_antimeridian=split_antimeridian)
...
def vector2rhealpix(
    ...
    **kwargs,
    ...
    result = geodataframe2rhealpix(
        gdf, resolution, predicate, compact, topology, include_properties, split_antimeridian=split_antimeridian
    )
