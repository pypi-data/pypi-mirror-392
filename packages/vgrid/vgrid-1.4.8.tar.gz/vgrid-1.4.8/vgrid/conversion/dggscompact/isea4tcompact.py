...
def isea4tcompact(
    ...
    for isea4t_id_compact in isea4t_ids_compact:
        try:
            cell_polygon = isea4t2geo(isea4t_id_compact, split_antimeridian=split_antimeridian)
...
def isea4texpand(
    ...
    for isea4t_id_expand in isea4t_ids_expand:
        try:
            cell_polygon = isea4t2geo(isea4t_id_expand, split_antimeridian=split_antimeridian)
