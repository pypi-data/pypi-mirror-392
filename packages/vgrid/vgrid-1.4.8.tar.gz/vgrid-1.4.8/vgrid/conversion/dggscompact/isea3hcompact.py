...
def isea3hcompact(
    ...
    for isea3h_id_compact in isea3h_ids_compact:
        try:
            cell_polygon = isea3h2geo(isea3h_id_compact, split_antimeridian=split_antimeridian)
...
def isea3hexpand(
    ...
    for isea3h_id_expand in isea3h_ids_expand:
        try:
            cell_polygon = isea3h2geo(isea3h_id_expand, split_antimeridian=split_antimeridian)
