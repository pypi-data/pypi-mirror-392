...
def a5compact(
    ...
    for a5_hex_compact in a5_hexes_compact:
        try:
            cell_polygon = a52geo(a5_hex_compact, options, split_antimeridian=split_antimeridian)
...
def a5expand(
    ...
    for a5_hex_expand in a5_hexes_expand:
        try:
            cell_polygon = a52geo(a5_hex_expand, options, split_antimeridian=split_antimeridian)
