...
def rhealpixcompact(
    ...
    for rhealpix_token_compact in rhealpix_tokens_compact:
        try:
            cell_polygon = rhealpix2geo(rhealpix_token_compact, split_antimeridian=split_antimeridian)
...
def rhealpixexpand(
    ...
    for rhealpix_token_expand in rhealpix_tokens_expand:
        try:
            cell_polygon = rhealpix2geo(rhealpix_token_expand, split_antimeridian=split_antimeridian)
