...
def dggal2geo(dggs_type: str, zone_ids: str, options: dict = {}, split_antimeridian=False):
    """
...
def dggal2geo_cli():
    ...
    polys = dggal2geo(args.dggs_type, args.zone_id, split_antimeridian=args.fix_antimeridian)
    return polys


def dggal2geojson(dggs_type: str, zone_ids: str, options: dict = {}, split_antimeridian=False):
    """
    ...
    for zone_id in zone_ids:
        try:
            ...
            cell_polygon = dggal2geo(dggs_type, zone_id, options, split_antimeridian=split_antimeridian)
...
def dggal2geojson_cli():
    ...
    args = parser.parse_args()
    geojson_data = json.dumps(dggal2geojson(args.dggs_type, args.zone_id, split_antimeridian=args.fix_antimeridian))
