...
def rhealpix2geo(rhealpix_ids, split_antimeridian=False):
    """
...
def rhealpix2geo_cli():
    ...
    polys = rhealpix2geo(args.rhealpix, split_antimeridian=args.fix_antimeridian)
    return polys


def rhealpix2geojson(rhealpix_ids, split_antimeridian=False):
    """
...
def rhealpix2geojson_cli():
    ...
    args = parser.parse_args()
    geojson_data = json.dumps(rhealpix2geojson(args.rhealpix, split_antimeridian=args.fix_antimeridian))
    print(geojson_data)
