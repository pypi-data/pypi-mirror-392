...
def a5inspect(res, options=None, split_antimeridian=False):
    """
    ...
    """
    a5_gdf = a5grid(res, output_format="gpd", options=options, split_antimeridian=split_antimeridian)
...
def a5_norm_area(a5_gdf: gpd.GeoDataFrame, crs: str | None = 'proj=moll'):
    ...
    a5_gdf = a5_gdf[~a5_gdf["crossed"]]  # remove cells that cross the dateline
...
def a5inspect_cli():
    ...
    print(a5inspect(resolution, split_antimeridian=args.fix_antimeridian))
