...
def maidenhead_norm_area(maidenhead_gdf: gpd.GeoDataFrame, crs: str | None = 'proj=moll'):
    """
    ...
    maidenhead_gdf = maidenhead_gdf[
        ~maidenhead_gdf["crossed"]
...
def maidenhead_compactness_ipq(maidenhead_gdf: gpd.GeoDataFrame, crs: str | None = 'proj=moll'):
    """
...
def maidenhead_compactness_cvh(maidenhead_gdf: gpd.GeoDataFrame, crs: str | None = 'proj=moll'):
    """
