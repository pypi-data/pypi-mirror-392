...
lib.UpdateModelAnimation.argtypes = [Model, ModelAnimation, c_int]

lib.UpdateModelAnimationBones.restype = None
lib.UpdateModelAnimationBones.argtypes = [Model, ModelAnimation, c_int]

lib.UnloadModelAnimation.restype = None
lib.UnloadModelAnimation.argtypes = [ModelAnimation]
...
lib.IsModelAnimationValid.argtypes = [Model, ModelAnimation]
...
def update_model_animation(model, anim, frame):
    lib.UpdateModelAnimation(model, anim, frame)

def update_model_animation_bones(model, anim, frame):
    lib.UpdateModelAnimationBones(model, anim, frame)

def unload_model_animation(anim):
    lib.UnloadModelAnimation(anim)
