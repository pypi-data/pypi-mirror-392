...
from codec_cub.common import extract, first_token
...
class PrimitiveParser:
    ...
    def __init__(self) -> None:
        ...
        quoted.setParseAction(lambda t: unescape_string(extract(first_token(t))))
