...
T = TypeVar("T", bound="PolicyP3MatrixSLAResponsePublicDto")


@_attrs_define
class PolicyP3MatrixSLAResponsePublicDto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        policy_p3_matrix_sla_response_public_dto = cls(
            id=id,
            label=label,
        ...
        policy_p3_matrix_sla_response_public_dto.additional_properties = d
        return policy_p3_matrix_sla_response_public_dto
