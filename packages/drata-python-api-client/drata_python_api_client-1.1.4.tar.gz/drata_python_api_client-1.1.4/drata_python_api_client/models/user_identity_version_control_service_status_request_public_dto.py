...
T = TypeVar("T", bound="UserIdentityVersionControlServiceStatusRequestPublicDto")


@_attrs_define
class UserIdentityVersionControlServiceStatusRequestPublicDto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_identity_version_control_service_status_request_public_dto = cls(
            service_account=service_account,
            service_account_reason=service_account_reason,
        )

        user_identity_version_control_service_status_request_public_dto.additional_properties = d
        return user_identity_version_control_service_status_request_public_dto
