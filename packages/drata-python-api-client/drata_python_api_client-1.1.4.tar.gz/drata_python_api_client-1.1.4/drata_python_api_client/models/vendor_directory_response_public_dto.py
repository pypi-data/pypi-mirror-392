...
from ..models.vendor_directory_response_public_dto_trust_center_provider import (
...
if TYPE_CHECKING:
    ...
    from ..models.vendor_directory_response_public_dto_last_questionnaire_type_0 import (
    ...
    from ..models.vendor_security_review_compact_response_public_dto import VendorSecurityReviewCompactResponsePublicDto


T = TypeVar("T", bound="VendorDirectoryResponsePublicDto")


@_attrs_define
class VendorDirectoryResponsePublicDto:
    """
    Attributes:
        ...
        trust_center_provider (VendorDirectoryResponsePublicDtoTrustCenterProvider): The providing service for this
            Trust Center Example: DRATA.
        ...
        last_questionnaire (Union['VendorDirectoryResponsePublicDtoLastQuestionnaireType0', None]): The last
            questionnaire associated with the vendor
        ...
        security_review (Union['VendorSecurityReviewCompactResponsePublicDto', None, Unset]): Vendor Security Review
    """
    ...
    trust_center_provider: VendorDirectoryResponsePublicDtoTrustCenterProvider
    ...
    last_questionnaire: Union["VendorDirectoryResponsePublicDtoLastQuestionnaireType0", None]
    ...
    security_review: Union["VendorSecurityReviewCompactResponsePublicDto", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.vendor_security_review_compact_response_public_dto import (
        ...
        if isinstance(self.last_questionnaire, VendorDirectoryResponsePublicDtoLastQuestionnaireType0):
        ...
        security_review: Union[None, Unset, dict[str, Any]]
        if isinstance(self.security_review, Unset):
            security_review = UNSET
        elif isinstance(self.security_review, VendorSecurityReviewCompactResponsePublicDto):
        ...
        if security_review is not UNSET:
            field_dict["securityReview"] = security_review
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trust_center_provider = VendorDirectoryResponsePublicDtoTrustCenterProvider(d.pop("trustCenterProvider"))
        ...
        def _parse_last_questionnaire(
            data: object,
        ) -> Union["VendorDirectoryResponsePublicDtoLastQuestionnaireType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_questionnaire_type_0 = VendorDirectoryResponsePublicDtoLastQuestionnaireType0.from_dict(data)

                return last_questionnaire_type_0
            except:  # noqa: E722
                pass
            return cast(Union["VendorDirectoryResponsePublicDtoLastQuestionnaireType0", None], data)
        ...
        def _parse_security_review(data: object) -> Union["VendorSecurityReviewCompactResponsePublicDto", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                security_review_type_1 = VendorSecurityReviewCompactResponsePublicDto.from_dict(data)

                return security_review_type_1
            except:  # noqa: E722
                pass
            return cast(Union["VendorSecurityReviewCompactResponsePublicDto", None, Unset], data)

        security_review = _parse_security_review(d.pop("securityReview", UNSET))

        vendor_directory_response_public_dto = cls(
            id=id,
            name=name,
            category=category,
            risk=risk,
        ...
        vendor_directory_response_public_dto.additional_properties = d
        return vendor_directory_response_public_dto
