...
from ..models.control_test_response_public_dto_event_types_item import ControlTestResponsePublicDtoEventTypesItem

if TYPE_CHECKING:
    from ..models.control_monitor_response_public_dto import ControlMonitorResponsePublicDto
    from ..models.control_test_response_public_dto_graph import ControlTestResponsePublicDtoGraph
...
T = TypeVar("T", bound="ControlTestResponsePublicDto")


@_attrs_define
class ControlTestResponsePublicDto:
    """
    Attributes:
        ...
        last_check (datetime.datetime): Timestamp since this control test has been evaluated for complaince Example:
        ...
        graph (ControlTestResponsePublicDtoGraph): Graph of control test. history Example:
            ControlTestInstanceHistoryType.
        event_types (list[ControlTestResponsePublicDtoEventTypesItem]): Control event type array from all monitors
            Example: EventType[].
    """
    ...
    graph: "ControlTestResponsePublicDtoGraph"
    event_types: list[ControlTestResponsePublicDtoEventTypesItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        graph = ControlTestResponsePublicDtoGraph.from_dict(d.pop("graph"))

        event_types = []
        _event_types = d.pop("eventTypes")
        for event_types_item_data in _event_types:
            event_types_item = ControlTestResponsePublicDtoEventTypesItem(event_types_item_data)

            event_types.append(event_types_item)

        control_test_response_public_dto = cls(
            id=id,
            name=name,
            description=description,
        ...
        control_test_response_public_dto.additional_properties = d
        return control_test_response_public_dto
