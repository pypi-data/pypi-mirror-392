...
T = TypeVar("T", bound="VendorResponsePublicDtoLastQuestionnaireType0")


@_attrs_define
class VendorResponsePublicDtoLastQuestionnaireType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vendor_response_public_dto_last_questionnaire_type_0 = cls(
            vendor_id=vendor_id,
            send_at=send_at,
        ...
        vendor_response_public_dto_last_questionnaire_type_0.additional_properties = d
        return vendor_response_public_dto_last_questionnaire_type_0
