...
T = TypeVar("T", bound="UserIdentityInfrastructureResponsePublicDto")


@_attrs_define
class UserIdentityInfrastructureResponsePublicDto:
    """
    Attributes:
        ...
        admin_access (datetime.datetime): Indicates external user admin access ability Example:
            2025-07-01T16:45:55.246Z.
        db_access (datetime.datetime): Indicates external user production database access ability Example:
            2025-07-01T16:45:55.246Z.
    """
    ...
    admin_access: datetime.datetime
    db_access: datetime.datetime
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        admin_access = self.admin_access.isoformat()

        db_access = self.db_access.isoformat()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        admin_access = isoparse(d.pop("adminAccess"))

        db_access = isoparse(d.pop("dbAccess"))

        user_identity_infrastructure_response_public_dto = cls(
            id=id,
        ...
        user_identity_infrastructure_response_public_dto.additional_properties = d
        return user_identity_infrastructure_response_public_dto
