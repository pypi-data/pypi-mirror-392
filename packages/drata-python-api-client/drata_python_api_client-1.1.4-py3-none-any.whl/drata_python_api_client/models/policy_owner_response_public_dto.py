...
T = TypeVar("T", bound="PolicyOwnerResponsePublicDto")


@_attrs_define
class PolicyOwnerResponsePublicDto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        policy_owner_response_public_dto = cls(
            id=id,
            email=email,
        ...
        policy_owner_response_public_dto.additional_properties = d
        return policy_owner_response_public_dto
