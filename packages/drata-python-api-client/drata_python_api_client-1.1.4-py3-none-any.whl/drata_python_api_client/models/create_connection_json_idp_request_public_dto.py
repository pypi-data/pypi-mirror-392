...
T = TypeVar("T", bound="CreateConnectionJsonIdpRequestPublicDto")


@_attrs_define
class CreateConnectionJsonIdpRequestPublicDto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_connection_json_idp_request_public_dto = cls(
            personnel_data=personnel_data,
        )

        create_connection_json_idp_request_public_dto.additional_properties = d
        return create_connection_json_idp_request_public_dto
