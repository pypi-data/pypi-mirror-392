...
T = TypeVar("T", bound="NoteResponsePublicDto")


@_attrs_define
class NoteResponsePublicDto:
    """
    Attributes:
        id (str): Note UUID Example: aaaaaaaa-bbbb-0000-cccc-dddddddddddd.
        comment (str): The main comment of the note Example: This is a good comment.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        note_response_public_dto.additional_properties = d
        return note_response_public_dto
