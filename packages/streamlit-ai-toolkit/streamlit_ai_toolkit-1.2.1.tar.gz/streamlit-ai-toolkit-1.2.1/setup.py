...
setup(
    ...
    # 使用packages而不是py_modules，确保目录结构被保留
    packages=["streamlit_ai_toolkit"],
    ...
    entry_points={
        'console_scripts': [
            'streamlit-ai-toolkit=streamlit_ai_toolkit.streamlit_ai_cli:main',
        ],
    },

    # 包含模板文件
    package_data={
        'streamlit_ai_toolkit': ['templates/*.py', 'templates/*.json', 'templates/*.md'],
    },
