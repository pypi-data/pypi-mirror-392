...
def rasterize_textures_from_renders(scene: lagrange.scene.Scene, renders: Sequence[Annotated[NDArray[numpy.float32], dict(shape=(None, None, None), order='C', device='cpu')]], width: Optional[int] = None, height: Optional[int] = None, low_confidence_ratio: float = 0.75, base_confidence: Optional[float] = None) -> tuple[list[object], list[object]]:
    """
