...
class AppRedisInterface:
    ...
    """
    def __init__(self, app: Flask, is_host: bool = False, support_legacy: bool = False,
        ...
        :param support_legacy: If True, support legacy session event manager commands and responders
        ...
        self.__event_manager = SessionEventManager(self.app, self.__redis_session, self.__redis_cache,
                                                   host=is_host, legacy_host=support_legacy)
