...
def _get_service_for_url(rest_service_base_url: str, session: Session):
    """
...
def _get_rest_service_wadl(
    wadl_url: str, session: Session, *, logger: Optional[logging.Logger] = None
) -> str:
    """
...
class Client:
    ...
    def loginWithOptions(self, username: str, password: str, options: str) -> str:
        """
