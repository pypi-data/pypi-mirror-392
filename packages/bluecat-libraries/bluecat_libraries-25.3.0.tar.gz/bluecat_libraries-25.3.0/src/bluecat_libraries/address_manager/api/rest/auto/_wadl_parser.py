...
class ServiceBase:
    ...
    def __init__(self, url: Optional[str] = None, version: Optional[str] = None) -> None:
        self.url = url
...
class WADLParser:
    ...
    def generate_service(self) -> ServiceBase:
        """
    ...
    def generate_all_methods(self, target: object):
        """
    ...
    def generate_method(self, target: object, rest_method):
        """
