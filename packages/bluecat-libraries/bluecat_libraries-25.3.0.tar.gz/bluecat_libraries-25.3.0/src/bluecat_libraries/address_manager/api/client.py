...
import json
from typing import Any, Optional, Union, List, IO, Dict
...
class Client:
    ...
    def login_with_options(self, username: str, password: str, options: dict):
        """
    ...
    def export_entities(
        self, select_criteria: dict, start: Optional[int] = 0, count: Optional[int] = 1000
    ) -> iter:
        """
    ...
    def get_linked_entities_by_udl(
        self, link_type: str, entity_id: Optional[int] = None
    ) -> List[Dict]:
        """
    ...
    def update_configuration_setting(self, entity_id: int, setting: str, properties: dict) -> None:
        """
    ...
    def selective_deploy(self, entity_ids: list[int], properties: Optional[dict] = None) -> str:
        """
    ...
    def add_parent_block(self, object_ids: list[int]) -> int:
        """
    ...
    def add_parent_block_with_properties(
        self, object_ids: list[int], properties: Optional[dict] = None
    ) -> int:
        """
    ...
    def merge_blocks_with_parent(self, ip4_block_ids: list[int]) -> None:
        """
