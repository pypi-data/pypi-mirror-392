...
# Stubs for namespace: AgilentErrorReporter.com.agilent.cos.gsdcwtest
...
class ErrorReport(
    ...
    Errors: (
        AgilentErrorReporter.com.agilent.cos.gsdcwtest.ErrorReport.ErrorsDataTable
    )  # readonly
    ...
    class ErrorsDataTable(
        ...
        def __getitem__(
            self, index: int
        ) -> AgilentErrorReporter.com.agilent.cos.gsdcwtest.ErrorReport.ErrorsRow: ...
        ...
        def RemoveErrorsRow(
            self,
            row: AgilentErrorReporter.com.agilent.cos.gsdcwtest.ErrorReport.ErrorsRow,
        ) -> None: ...
        @staticmethod
        ...
        ErrorsRowChanged: (
            AgilentErrorReporter.com.agilent.cos.gsdcwtest.ErrorReport.ErrorsRowChangeEventHandler
        )  # Event
        ErrorsRowChanging: (
            AgilentErrorReporter.com.agilent.cos.gsdcwtest.ErrorReport.ErrorsRowChangeEventHandler
        )  # Event
    ...
    class ErrorsRowChangeEventHandler(
        ...
        def BeginInvoke(
            self,
            sender: Any,
            e: AgilentErrorReporter.com.agilent.cos.gsdcwtest.ErrorReport.ErrorsRowChangeEvent,
...
class ReportErr(
    ...
    def ReportError(
        self, er: AgilentErrorReporter.com.agilent.cos.gsdcwtest.ErrorReport
    ) -> str: ...
    @overload
    ...
    def ReportErrorAsync(
        self,
        er: AgilentErrorReporter.com.agilent.cos.gsdcwtest.ErrorReport,
        userState: Any,
    ) -> None: ...
    def CancelAsync(self, userState: Any) -> None: ...

    ReportErrorCompleted: (
        AgilentErrorReporter.com.agilent.cos.gsdcwtest.ReportErrorCompletedEventHandler
    )  # Event
...
class ReportErrorCompletedEventHandler(
    ...
    def BeginInvoke(
        self,
        sender: Any,
        e: AgilentErrorReporter.com.agilent.cos.gsdcwtest.ReportErrorCompletedEventArgs,
        callback: System.AsyncCallback,
        object: Any,
    ) -> System.IAsyncResult: ...
    def Invoke(
