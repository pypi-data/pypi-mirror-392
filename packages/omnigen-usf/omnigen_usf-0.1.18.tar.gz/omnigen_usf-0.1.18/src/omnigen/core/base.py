...
class BaseLLMProvider(ABC):
    ...
    def _prepare_messages(self, messages: List[Message]) -> List[Dict]:
        """
        Convert messages to provider-specific format, preserving tool and reasoning fields.
        ...
        for i, msg in enumerate(messages):
            ...
            # Preserve reasoning fields for interleaved thinking support
            # These are needed when interleaved_thinking is enabled
            if 'thinking' in msg:
