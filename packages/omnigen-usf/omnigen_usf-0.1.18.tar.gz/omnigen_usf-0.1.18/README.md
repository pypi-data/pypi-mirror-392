...
- ✅ **Production-Ready** - Clean configs, 80+ options, all documented
...
### � Universal Anthropic-Compatible Provider Support
- ✅ **Any Anthropic-compatible provider** - Use ANY provider that supports Anthropic-style SDK/API
- ✅ **User-controlled** - No auto-detection, you explicitly declare compatibility
- ✅ **Future-proof** - Works with new providers without code changes
...
### 🧠 Enhanced Reasoning Output Preservation
- ✅ **New default** - `save_all_reasoning: true` (maximum transparency)
- ✅ **Two powerful options** - Full transparency OR strategic saving
- ✅ **Flexible control** - Save reasoning at key decision points only
...
### 🐛 Bug Fixes
- ✅ **None message filtering** - Fixed edge case in interleaved thinking
