...
class ConversationGenerator:
    ...
    def __init__(
        ...
        self.reasoning_output_rules = self.tool_calling_config.get('reasoning_output_rules', {})
        ...
        try:
            ...
            if self.enable_reasoning:
                final_conversation = ReasoningManager.clean_conversation_reasoning(
                    final_conversation,
                    config={'reasoning_output_rules': self.reasoning_output_rules}
                )
    ...
    def _generate_response(self, conversation: List[Dict], datetime_str: str, base_conv: Dict, track_tokens: bool = True) -> tuple:
        ...
        try:
            ...
            # Only OpenRouter supports the unified 'reasoning' parameter reliably.
            # Avoid passing it to other providers to prevent API errors.
