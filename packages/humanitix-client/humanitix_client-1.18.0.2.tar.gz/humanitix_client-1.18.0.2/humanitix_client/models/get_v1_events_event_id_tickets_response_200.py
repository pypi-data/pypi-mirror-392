...
T = TypeVar("T", bound="GetV1EventsEventIdTicketsResponse200")


@_attrs_define
class GetV1EventsEventIdTicketsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v1_events_event_id_tickets_response_200 = cls(
            total=total,
            page=page,
            page_size=page_size,
            tickets=tickets,
        ...
        get_v1_events_event_id_tickets_response_200.additional_properties = d
        return get_v1_events_event_id_tickets_response_200
