# Tim Lehr: Python exception hooks with Qt message box
...
def show_exception_box(log_msg):
    """Checks if a QApplication instance is available and shows a messagebox with the
    exception message.
...
class UncaughtHook(QtCore.QObject):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # registers the exception_hook() function as hook with the Python interpreter
