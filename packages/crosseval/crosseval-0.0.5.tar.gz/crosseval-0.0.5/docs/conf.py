#!/usr/bin/env python
#
# crosseval documentation build configuration file, created by sphinx-quickstart.
#
...
version = crosseval.__version__
# The full version, including alpha/beta/rc tags.
release = crosseval.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(crosseval.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "crosseval/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/crosseval/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "crossevaldoc"
