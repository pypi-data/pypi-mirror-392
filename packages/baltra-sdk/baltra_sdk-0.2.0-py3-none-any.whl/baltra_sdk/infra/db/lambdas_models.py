from sqlalchemy import (
    ...
    PrimaryKeyConstraint, text, Enum
)
...
class _DBShim:
    """A lightweight SQLAlchemy setup similar to Flask-SQLAlchemy for AWS Lambda."""
    def __init__(self):
    ...
    def remove_session(self):
        """Useful if you need to clean up the scoped_session (e.g., at the end of a Lambda)."""
        self.Session.remove()
