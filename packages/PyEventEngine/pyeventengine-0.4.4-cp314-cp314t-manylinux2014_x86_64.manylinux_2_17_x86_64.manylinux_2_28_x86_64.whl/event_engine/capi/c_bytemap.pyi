...
class ByteMap:
    ...
    This class wraps a C-level hash table (`ByteMapHeader`) that supports
    ...
    @classmethod
    def from_buffer(cls, heap: Allocator, init_capacity: int = ...) -> ByteMap:
        """Create a ByteMap using a custom memory allocator.

        Args:
            heap: Memory allocator instance.
            init_capacity: Initial table capacity.

        Returns:
            A new ByteMap that uses the provided allocator.
    ...
    def __contains__(self, key: BYTE_KEY_T) -> bool:
        """Check if a key exists in the map."""

    def __getitem__(self, key: BYTE_KEY_T) -> Any:
    ...
    def __setitem__(self, key: BYTE_KEY_T, value: Any) -> None:
    ...
    def __repr__(self) -> str:
        """Return a string representation of the ByteMap."""

    def get(self, key: BYTE_KEY_T, default=None) -> Any:
    ...
    def get_addr(self, key: BYTE_KEY_T) -> int:
    ...
    def set(self, key: BYTE_KEY_T, value: Any) -> None:
        """Insert or update a key-value pair (alias for `__setitem__`)."""

    def set_addr(self, key: BYTE_KEY_T, value: int) -> None:
    ...
    def pop(self, key: BYTE_KEY_T, default: Any = ...) -> Any:
    ...
    def contains(self, key: BYTE_KEY_T) -> bool:
