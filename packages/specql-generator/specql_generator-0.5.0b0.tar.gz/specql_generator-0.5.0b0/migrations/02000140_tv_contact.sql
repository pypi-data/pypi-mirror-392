...
BEGIN
    ...
    SELECT
        ...
        jsonb_build_object('company', tv_company.data, 'email', base.email, 'first_name', base.first_name, 'last_name', base.last_name, 'status', base.status, 'phone', base.phone) AS data
