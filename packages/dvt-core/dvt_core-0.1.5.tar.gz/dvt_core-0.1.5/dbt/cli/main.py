...
@click.pass_context
@p.profiles_dir
def target_list(ctx, profile, **kwargs):
...
@p.profiles_dir
@p.project_dir
def target_test(ctx, target_name, profile, **kwargs):
...
@click.pass_context
@p.project_dir
def compute_add(ctx, name, cluster_type, master, config_str, description, replace, **kwargs):
...
@click.pass_context
@p.project_dir
def compute_test(ctx, name, **kwargs):
