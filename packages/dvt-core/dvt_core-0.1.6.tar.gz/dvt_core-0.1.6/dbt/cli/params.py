...
profiles_dir = _create_option_and_track_env_var(
    ...
    help="Which directory to look in for the profiles.yml file. If not set, DVT will look in the current working directory first, then HOME/.dvt/ (or HOME/.dbt/ for backward compatibility)",
