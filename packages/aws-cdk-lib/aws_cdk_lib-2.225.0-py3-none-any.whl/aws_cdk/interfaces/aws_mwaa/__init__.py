    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            from aws_cdk.interfaces import aws_mwaa as interfaces_aws_mwaa
            
            environment_reference = interfaces_aws_mwaa.EnvironmentReference(
                environment_arn="environmentArn",
                environment_name="environmentName"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ef33bf7356d4d77898d81dde6d08508edc50ac2ccc667eae7b803d4fc25588ba)
