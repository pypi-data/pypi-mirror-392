...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_applicationinsights.ApplicationReference",
    jsii_struct_bases=[],
...
class ApplicationReference:
    def __init__(self, *, application_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ac683d896649c7f8c5079b0ebedc1cc6c4fcb2d5a85829cc1e2535dac93a1474)
...
@jsii.interface(
    jsii_type="aws-cdk-lib.interfaces.aws_applicationinsights.IApplicationRef"
)
...
class _IApplicationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_applicationinsights.IApplicationRef"
...
def _typecheckingstub__ac683d896649c7f8c5079b0ebedc1cc6c4fcb2d5a85829cc1e2535dac93a1474(
    *,
