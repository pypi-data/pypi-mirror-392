...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_finspace.EnvironmentReference",
    jsii_struct_bases=[],
    name_mapping={
...
class EnvironmentReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__be89db9fe78c5d1d38eed09ae3fec6ff24d4e6a8f50a165a166363b701f34549)
...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_finspace.IEnvironmentRef")
...
class _IEnvironmentRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_finspace.IEnvironmentRef"
...
def _typecheckingstub__be89db9fe78c5d1d38eed09ae3fec6ff24d4e6a8f50a165a166363b701f34549(
    *,
    environment_arn: builtins.str,
    environment_id: builtins.str,
) -> None:
