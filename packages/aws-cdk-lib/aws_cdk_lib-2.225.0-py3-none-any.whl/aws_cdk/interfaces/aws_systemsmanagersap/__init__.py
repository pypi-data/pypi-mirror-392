...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_systemsmanagersap.ApplicationReference",
    jsii_struct_bases=[],
...
class ApplicationReference:
    def __init__(self, *, application_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9e53b8f0494703b05332ebfc8b88fc6b41f5a111b5d51819ca8cd721188843a5)
...
@jsii.interface(
    jsii_type="aws-cdk-lib.interfaces.aws_systemsmanagersap.IApplicationRef"
)
...
class _IApplicationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_systemsmanagersap.IApplicationRef"
...
def _typecheckingstub__9e53b8f0494703b05332ebfc8b88fc6b41f5a111b5d51819ca8cd721188843a5(
    *,
