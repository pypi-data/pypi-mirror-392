...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_sdb.DomainReference",
    jsii_struct_bases=[],
...
class DomainReference:
    def __init__(self, *, domain_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e8aaf55482861dc0634e0d5a49141d961194dfea0d133e2973206bcd56dc49d7)
...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_sdb.IDomainRef")
class IDomainRef(
...
class _IDomainRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_sdb.IDomainRef"
...
def _typecheckingstub__e8aaf55482861dc0634e0d5a49141d961194dfea0d133e2973206bcd56dc49d7(
    *,
