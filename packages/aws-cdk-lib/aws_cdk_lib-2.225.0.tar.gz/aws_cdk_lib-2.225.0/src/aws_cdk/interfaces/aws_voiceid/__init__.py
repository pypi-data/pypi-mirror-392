...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_voiceid.DomainReference",
    jsii_struct_bases=[],
...
class DomainReference:
    def __init__(self, *, domain_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__142163a60806c80060d0e1a658651b194cd9f4efe61bd252a2410c7f80d5d7bf)
...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_voiceid.IDomainRef")
class IDomainRef(
...
class _IDomainRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_voiceid.IDomainRef"
...
def _typecheckingstub__142163a60806c80060d0e1a658651b194cd9f4efe61bd252a2410c7f80d5d7bf(
    *,
