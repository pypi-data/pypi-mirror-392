...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_pipes.IPipeRef")
class IPipeRef(
...
class _IPipeRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_pipes.IPipeRef"
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_pipes.PipeReference",
    jsii_struct_bases=[],
...
class PipeReference:
    def __init__(self, *, pipe_arn: builtins.str, pipe_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fe8e00ec5aec07081be1f2a924ee8233bd128587de2afe6df7fcc0a3451d7d62)
...
def _typecheckingstub__fe8e00ec5aec07081be1f2a924ee8233bd128587de2afe6df7fcc0a3451d7d62(
    *,
