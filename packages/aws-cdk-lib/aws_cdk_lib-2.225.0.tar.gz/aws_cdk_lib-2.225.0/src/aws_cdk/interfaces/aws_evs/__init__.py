...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_evs.EnvironmentReference",
    jsii_struct_bases=[],
    name_mapping={
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            from aws_cdk.interfaces import aws_evs as interfaces_aws_evs
            
            environment_reference = interfaces_aws_evs.EnvironmentReference(
                environment_arn="environmentArn",
                environment_id="environmentId"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d19fcf2ab9a0aa7e050fd0ab2dc67e7d4c862c7b3a754394aa852f0aa243fd9f)
...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_evs.IEnvironmentRef")
...
class _IEnvironmentRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_evs.IEnvironmentRef"
...
def _typecheckingstub__d19fcf2ab9a0aa7e050fd0ab2dc67e7d4c862c7b3a754394aa852f0aa243fd9f(
    *,
    environment_arn: builtins.str,
    environment_id: builtins.str,
) -> None:
