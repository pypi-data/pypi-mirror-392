...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_launchwizard.DeploymentReference",
    jsii_struct_bases=[],
...
class DeploymentReference:
    def __init__(self, *, deployment_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__59599ed70e5d9599e833b42c84850f96db419df9dda7d49b64851f9cbff86b26)
...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_launchwizard.IDeploymentRef")
...
class _IDeploymentRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_launchwizard.IDeploymentRef"
...
def _typecheckingstub__59599ed70e5d9599e833b42c84850f96db419df9dda7d49b64851f9cbff86b26(
    *,
