...
class PatternRecognizer:
    ...
    def _extract_patterns_from_existing_data(
        ...
        try:
            ...
            # 按equal_points_type分组处理
            for equal_type in df_with_equal_points["equal_points_type"].unique():
                type_df = df_with_equal_points[
                    df_with_equal_points["equal_points_type"] == equal_type
                ]
                ...
                if len(points) >= 2:
                    ...
                    pattern = PatternCandidate(
                        ...
                        metadata={
                            ...
                            "equal_points_price": float(type_df.iloc[0].get("equal_points_price", 0)),
                        },
                    )
