...
# Elements directory: defaults to package-bundled, overridable via env var
_env_elements_dir = os.getenv("REALTIMEX_ELEMENTS_DIR")
ELEMENTS_DIR = (
    Path(_env_elements_dir).expanduser().resolve()
    if _env_elements_dir
    else Path(__file__).resolve().parent / "elements"
)
MODIFIER_KEYS = (
    "shift",
    "shiftleft",
...
def wait_for_element(
    ...
    poll_interval = 0.5
    image_path = ELEMENTS_DIR / image_name
