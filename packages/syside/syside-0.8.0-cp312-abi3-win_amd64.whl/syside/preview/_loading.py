...
def open_model_unlocked(
    ...
    *,
    ...
    :param allow_errors:
        if False, tries to return a partial or invalid model even in the presence of errors
    ...
    model, diagnostics = syside_loading.try_load_model(actual_source_file_paths())
