...
class WikimediaAnalysisInput(BaseModel):
    ...
    results_json: Union[str, Dict[str, Any], None] = Field(
        default=None,
...
class WikimediaMultiLangAnalysisTool(BaseTool):
    ...
    def _run(
        ...
        results_json: Union[str, Dict[str, Any], None] = None,
    ...
    def _execute(self, keyword, keyword_dict, results_json, analysis_focus, max_contexts, return_json, extraction_strategy, debug):
        ...
        if not results_json:
            raise ValueError("results_json is required - provide KWIC data from got3.search_keyword_corpus")
