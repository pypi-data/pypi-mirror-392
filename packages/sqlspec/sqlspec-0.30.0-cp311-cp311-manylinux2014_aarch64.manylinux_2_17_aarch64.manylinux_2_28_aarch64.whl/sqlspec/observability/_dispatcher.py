...
class LifecycleDispatcher:
    ...
    def __init__(self, hooks: "dict[str, Iterable[Any]] | None" = None) -> None:
        ...
        self._hooks: dict[LifecycleEvent, tuple[Any, ...]] = normalized
    ...
    def _emit(self, event: LifecycleEvent, context: "dict[str, Any]") -> None:
    ...
    @staticmethod
    def _invoke_callback(callback: Any, context: "dict[str, Any]", event: LifecycleEvent) -> None:
        try:
            callback(context)
