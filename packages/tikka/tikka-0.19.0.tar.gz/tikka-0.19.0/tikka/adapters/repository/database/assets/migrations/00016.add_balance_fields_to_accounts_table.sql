...
CREATE TABLE IF NOT EXISTS `accounts_new` (
    ...
    `balance_available` TEXT DEFAULT NULL,
    `balance_reserved` TEXT DEFAULT NULL,
...
INSERT INTO accounts_new (
    ...
    category_id, legacy_v1, total_transfers_count, last_transfer_timestamp, oldest_transfer_timestamp
)
SELECT
    address, name, crypto_type, balance, path, root, file_import,
    category_id, legacy_v1, total_transfers_count, last_transfer_timestamp, oldest_transfer_timestamp
