...
@pytest.fixture
def dmp_af_graph(manifest, profiles, project_profile_name, config):
    return DmpAfGraph.from_manifest(manifest, profiles, project_profile_name, etl_service_name='', config=config)
