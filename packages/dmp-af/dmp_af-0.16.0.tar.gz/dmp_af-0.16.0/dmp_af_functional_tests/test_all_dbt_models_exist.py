...
def check_if_all_dbt_models_are_in_dmp_af_graph(manifest, profiles, project_profile_name, config, etl=None):
    dbt_graph = DmpAfGraph.from_manifest(
        manifest=manifest,
        profiles=profiles,
...
def test_check_if_all_dbt_models_are_in_dmp_af_graph(manifest, profiles, project_profile_name, config, etl_name):
    check_if_all_dbt_models_are_in_dmp_af_graph(manifest, profiles, project_profile_name, config, etl_name)
