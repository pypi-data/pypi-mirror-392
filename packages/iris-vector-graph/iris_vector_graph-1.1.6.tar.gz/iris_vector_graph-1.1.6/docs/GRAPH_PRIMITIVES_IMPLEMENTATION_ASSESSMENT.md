...
- **Core Schema**: [`iris_vector_graph_core/schema.py:44`](iris_vector_graph_core/schema.py) - Edge identity with auto-increment
...
- **Vector Identity**: Separate PK on embeddings tables
  ...
  - [`iris_vector_graph_core/schema.py:56`](iris_vector_graph_core/schema.py) - Domain-agnostic schema
...
- **Engine**: [`TextSearchEngine.search_documents()`](iris_vector_graph_core/text_search.py:24-55)
...
- **Advanced**: JSON_TABLE attempts in [`IRISGraphEngine.kg_TXT()`](iris_vector_graph_core/engine.py:159-197)
...
- [`iris_vector_graph_core/schema.py:15`](iris_vector_graph_core/schema.py) - Domain-agnostic schema utilities
...
- **HNSW Optimized**: [`IRISGraphEngine._kg_KNN_VEC_hnsw_optimized()`](iris_vector_graph_core/engine.py:53-90) - Uses VECTOR_COSINE/TO_VECTOR
- **Python CSV Fallback**: [`IRISGraphEngine._kg_KNN_VEC_python_optimized()`](iris_vector_graph_core/engine.py:93-155) - When IRIS vector functions unavailable
- **Migration Utilities**: [`VectorOptimizer.migrate_to_optimized()`](iris_vector_graph_core/vector_utils.py:86-208)

**Text Search**:
- **Documents**: [`TextSearchEngine.search_documents()`](iris_vector_graph_core/text_search.py:24-82) - %FIND with fallback
- **Qualifiers**: [`IRISGraphOperators.kg_TXT()`](python/iris_vector_graph_operators.py:210-261) - JSON_TABLE with LIKE fallback

**Hybrid Fusion**:
- **RRF Implementation**: [`IRISGraphEngine.kg_RRF_FUSE()`](iris_vector_graph_core/engine.py:250-305)
- **Advanced Fusion**: [`HybridSearchFusion.multi_modal_search()`](iris_vector_graph_core/fusion.py:109-237)
...
- **iFind Text Search**: [`TextSearchEngine.search_documents()`](iris_vector_graph_core/text_search.py:24-82) uses %FIND
...
- **Migration**: [`VectorOptimizer.migrate_to_optimized()`](iris_vector_graph_core/vector_utils.py:86-208) converts CSV to VECTOR format
...
3. **Vector Function Detection**: Use [`VectorOptimizer.check_hnsw_availability()`](iris_vector_graph_core/vector_utils.py:30-84) to determine optimal path
