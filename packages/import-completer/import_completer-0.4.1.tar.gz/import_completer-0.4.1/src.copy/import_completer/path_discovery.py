...
def discover_paths_for_python_executable(python_executable: str = "python") -> Iterable[Path]:
    output = subprocess.check_output([python_executable, "-c", r"import sys; print('\n'.join(sys.path))"])
