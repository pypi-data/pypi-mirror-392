...
// #include "open_spiel/python/pybind11/games_bridge.h"  // Commented out - missing double_dummy_solver
...
PYBIND11_MODULE(pyspiel, m) {
  ...
  // init_pyspiel_games_bridge(m);  // Commented out - missing double_dummy_solver
