...
module.exports = {
  input: {
    path: "./arches_modular_reports/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_modular_reports/locale", // output path of all created files
