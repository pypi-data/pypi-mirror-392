...
from gradientlab.experiments.exp20251025_0_vlm_kda_20m_in1k.modeling.img_patchify import ImagePatchifier
from gradientlab.experiments.exp20251025_0_vlm_kda_20m_in1k.modeling.model_cfg import (
    ModelConfig,
)
from gradientlab.experiments.exp20251025_0_vlm_kda_20m_in1k.modeling.transformer import (
    TransformerEncoder,
)
    ...
    def forward(
        ...
        **kwargs,
        ...
        if pixel_values is None:
            ...
            attention_mask = torch.cat((attn_mask_img, attention_mask), dim=1) # type: ignore
