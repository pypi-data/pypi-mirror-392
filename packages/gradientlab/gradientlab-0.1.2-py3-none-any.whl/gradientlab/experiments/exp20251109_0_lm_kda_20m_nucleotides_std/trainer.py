...
from gradientlab.experiments.exp20251109_0_lm_kda_20m_nucleotides_std.exp_config import (
    ExpConfig,
)
...
class Trainer:
    ...
    def train_one_epoch(self, epoch_idx: int):
        ...
        for i, batch in enumerate(pbar, start=1):
            ...
            if i > 0 and i % self.exp_cfg.save_steps == 0:
                self._generate()
                self._save_state()
    ...
    def _build_dataloader(self, split_name: str):
        ...
        self.collate_fn = NucleotidesTaskCollate(self.tokenizer)
        return DataLoader(
            self.torch_ds,
    ...
    def _generate(self):
        ...
        print(f"GT: '{lbl}' - PREFIX: '{prefix}' - PRED: '{self.tokenizer.decode(preds[0])}'")
