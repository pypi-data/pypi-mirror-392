...
Встроенные_функции = {
    ...
    'Вспять': ( 'reversed', None, False ), # Обратить, Обращённое, Наоборот, Развернуть
    ...
    'По_порядку': ( 'sorted', { 'ф_сравнения': 'key', 'наоборот': 'reverse' }, False ), # Упорядочить, Упорядоченное
    'Установить_поле': ( 'setattr', None, False ),
    'Выборка': ( 'filter', None, False ), # Фильтр, По_условию, Только, Отбор
