...
from flagdataset.baai_config import Application
...
def download_share(dataset, save_path, prefix=None, key=None, jobs_down=4, debug=False):
    import pathlib
    ...
    print(f"save_path: {save_path.absolute().__str__()}")
