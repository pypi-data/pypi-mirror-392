...
class DatasetConditionChecker:
    def has_enough_space(self, size_mbytes: int, buffer_ratio: float = 1.2) -> bool:
    ...
    def check_huggingface_size(self, dataset_name: str, revision: str = "main"):
        """
        ...
        if estimated_size > 0:
            has_space, free_space = self.has_enough_space(estimated_size/(1024 ** 2))
            if not has_space:
