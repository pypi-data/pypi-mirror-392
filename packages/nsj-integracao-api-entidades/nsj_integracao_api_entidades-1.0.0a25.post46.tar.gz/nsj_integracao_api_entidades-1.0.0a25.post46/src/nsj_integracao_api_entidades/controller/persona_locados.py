...
from nsj_integracao_api_entidades.dto.persona_locados import LocadosDTO as DTO
from nsj_integracao_api_entidades.entity.persona_locados import LocadosEntity as Entity

ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/locados"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/locados/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/locados/verificacao-integridade"
...
def persona_locados_list_action(_, response):
    return response
...
def persona_locados_get_action(_, response):
    return response
...
def persona_locados_post_action(_, response):
    return response
...
def persona_locados_put_action(_, response):
    return response
...
def persona_locados_put_list_action(_, response):
    return response
...
def persona_locados_delete_action(_, response):
    return response
...
def persona_locados_delete_list_action(_, response):
    return response
...
def persona_locados_integrity_check_action(_, response):
    return response
...
def persona_locados_delete_bulk_action(_, response):
    return response
