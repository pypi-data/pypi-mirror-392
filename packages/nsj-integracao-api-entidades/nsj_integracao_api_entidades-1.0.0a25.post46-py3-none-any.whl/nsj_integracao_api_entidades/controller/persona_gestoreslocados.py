...
from nsj_integracao_api_entidades.dto.persona_gestoreslocados import GestoreslocadosDTO as DTO
from nsj_integracao_api_entidades.entity.persona_gestoreslocados import GestoreslocadosEntity as Entity

ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/gestoreslocados"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/gestoreslocados/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/gestoreslocados/verificacao-integridade"
...
def persona_gestoreslocados_list_action(_, response):
    return response
...
def persona_gestoreslocados_get_action(_, response):
    return response
...
def persona_gestoreslocados_post_action(_, response):
    return response
...
def persona_gestoreslocados_put_action(_, response):
    return response
...
def persona_gestoreslocados_put_list_action(_, response):
    return response
...
def persona_gestoreslocados_delete_action(_, response):
    return response
...
def persona_gestoreslocados_delete_list_action(_, response):
    return response
...
def persona_gestoreslocados_integrity_check_action(_, response):
    return response
...
def persona_gestoreslocados_delete_bulk_action(_, response):
    return response
