...
class RemoteTaskLoader:
    ...
    def _get_all_tasks(self) -> List[TaskDefinition]:
        self.task_definitions = self._get_all_task_definitions("chakra-labs/dojo-bench-mini")
    ...
    def load_task(self, task_path: str) -> TaskDefinition:
        """
        Load a specific task by org/repo/dojo/task_id path or chakra-labs/dojo-bench-mini/dojo/task_id path
        ...
        print(f"{org}/{repo}/{dojo_name}/{task_id}")
