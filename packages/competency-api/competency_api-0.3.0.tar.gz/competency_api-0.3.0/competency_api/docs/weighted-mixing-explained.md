...
1. Individual skill uncertainties
2. Mixing of different skill levels
...
1. **Nuanced Evaluation**: Beyond binary "has skill" or "doesn't have skill"
2. **Transfer Learning**: Recognizes related expertise
3. **Uncertainty Quantification**: Honest about confidence levels
4. **Explainability**: Can show which skills contributed to score
