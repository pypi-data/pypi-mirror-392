...
impl SkillDomain {
    ...
    pub fn classify_skill(skill_name: &str) -> SkillDomain {
        ...
        // Software Development keywords - check FIRST to avoid conflicts with generic "development"
        // This must come before HR which also contains "development"
        ...
        // Data Science keywords - check EARLY to avoid conflicts with "learning" in HR
