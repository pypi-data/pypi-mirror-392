...
2. **Start a New Message** (MANDATORY)
   - `wait_for_element("imessage/new_message_button.png", timeout=10)` → click using returned coordinates. DO NOT proceed to the “To:” field unless this click succeeds.

3. **Enter Recipient**
   - `wait_for_element("imessage/to_field.png", timeout=10)` → click using returned coordinates.
