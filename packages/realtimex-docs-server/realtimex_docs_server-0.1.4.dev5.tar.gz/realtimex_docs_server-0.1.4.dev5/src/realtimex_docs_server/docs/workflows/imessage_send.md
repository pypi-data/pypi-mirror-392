...
2. **Start a New Message & Enter Recipient**
   - Validate and click the New Message button: `wait_for_element("imessage/new_message_button.png", timeout=10)` → you MUST click using returned coordinates before proceeding.
