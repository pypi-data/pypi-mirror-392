...
void init_InfoTree(py::module& m)
{
    ...
    py::class_<mtlearn::InfoTreePybind>(m, "InfoTree")
        ...
        .def_static(
            "get_jacobian_dense",
            &mtlearn::InfoTreePybind::getJacobianDense,
            py::arg("tree"),
            "Obtém a matriz jacobiana da árvore como um tensor."
        )
        .def_static(
            "get_info_for_jacobian",
            &mtlearn::InfoTreePybind::getInfoForJacobian,
            py::arg("tree"),
            py::call_guard<py::gil_scoped_release>(),
            "Obtém os resíduos e a jacobiana Info2 da árvore como tensores."
        )
        .def_static(
            "get_acumulated_gradient",
            &mtlearn::InfoTreePybind::getAcumulatedGradient,
            py::arg("tree"),
            py::arg("gradient_of_loss"),
            py::call_guard<py::gil_scoped_release>(),
            "Calcula o gradiente acumulado nos nós da árvore a partir do gradiente da loss."
        );
}
