...
class V1alpha1StorageVersionList(ListModel):
    ...
    kubernetes_meta: ClassVar[Final[tuple[KubeMeta, ...]]] = KubeMeta(
        group="internal.apiserver.k8s.io", kind="StorageVersionList", version="v1alpha1"
    )
    ...
    items: Annotated[
        list[V1alpha1StorageVersion],
        Field(description="""Items holds a list of StorageVersion"""),
    ]
