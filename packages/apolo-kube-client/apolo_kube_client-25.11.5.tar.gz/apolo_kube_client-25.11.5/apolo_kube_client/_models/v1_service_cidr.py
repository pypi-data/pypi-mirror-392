...
class V1ServiceCIDR(ResourceModel):
    ...
    kubernetes_ref: ClassVar[Final[str]] = "io.k8s.api.networking.v1.ServiceCIDR"
    ...
    spec: Annotated[
        ...
        BeforeValidator(_default_if_none(V1ServiceCIDRSpec)),
    ] = V1ServiceCIDRSpec()
    ...
    status: Annotated[
        ...
        BeforeValidator(_default_if_none(V1ServiceCIDRStatus)),
    ] = V1ServiceCIDRStatus()
