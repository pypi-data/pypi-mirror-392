...
class V1ClusterRoleBindingList(ListModel):
    ...
    kubernetes_ref: ClassVar[Final[str]] = "io.k8s.api.rbac.v1.ClusterRoleBindingList"

    kubernetes_meta: ClassVar[Final[tuple[KubeMeta, ...]]] = KubeMeta(
        group="rbac.authorization.k8s.io", kind="ClusterRoleBindingList", version="v1"
    )
