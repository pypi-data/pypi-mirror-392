...
class Loggers:
    ...
    def setup_logger(
        self, parts: list[str] = None, logger: Logger | None = None, settings: dict = None
    ) -> None:
    ...
    def _set_property_logger(
        self, obj: Logger, short_name: str, long_name: str, value: Logger | None
    ) -> None:
        self._set_property(obj, short_name, value)
        self._logger_property_names.update({long_name: value})

    def _set_property_settings(
        self, name: str, value: dict[str, dict[str, int | str | Backend | float | DispatchMode]]
    ) -> None:
    ...
    def _get_property(
        self, obj: Logger, key: str, default_value: None
    ) -> dict[str, dict[str, int | str | Backend | float | DispatchMode]] | Logger:
    ...
    def _set_property(
        ...
        obj: Logger,
        key: str,
        value: None | (dict[str, dict[str, int | str | Backend | float | DispatchMode]] | Logger),
    ) -> None:
