...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7422);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(65483),
    __webpack_require__(81594),
    __webpack_require__(85638),
    __webpack_require__(31903),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(40074),
  __webpack_require__(39817),
  __webpack_require__(61066),
  __webpack_require__(38101),
  __webpack_require__(40824),
  __webpack_require__(4402),
  __webpack_require__(93784),
  
      (__webpack_require__(27295)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(99534)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(83806),
  __webpack_require__(45193),
  
      (__webpack_require__(44084)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(55226)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      (__webpack_require__(17933)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(70995)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(20286)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(10883)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(35088)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(68560),
  __webpack_require__(67407),
  __webpack_require__(15169),
  __webpack_require__(99387),
  
      (__webpack_require__(19456)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(53285),
  __webpack_require__(46598),
  __webpack_require__(33447),
  
      (__webpack_require__(35022)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(39418),
  __webpack_require__(52981),
  __webpack_require__(24814),
  __webpack_require__(51025),
  __webpack_require__(1692),
  __webpack_require__(53511),
  __webpack_require__(78643),
  __webpack_require__(70040),
  __webpack_require__(79109),
  __webpack_require__(58723),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(27649),
  
      (__webpack_require__(61236)["default"].filter)(({id}) => [
  ...
  __webpack_require__(55859),
  
      (__webpack_require__(83529)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:sources',
      ...
      __webpack_require__(55337),
  __webpack_require__(62573),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(5733)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(827)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(24565).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(74691).IServiceManager);
...
//# sourceMappingURL=8781.1bce4f4674bb4b498909.js.map?v=1bce4f4674bb4b498909