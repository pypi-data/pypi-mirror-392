...
from h2o_featurestore.gen import rest
from h2o_featurestore.gen.configuration import Configuration
from h2o_featurestore.gen.exceptions import ApiTypeError, ApiValueError, ApiException
from h2o_featurestore.gen.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CoreServiceApi()
        api_instance.core_service_add_feature_set_permission  # this is an instance of the class Endpoint
        api_instance.core_service_add_feature_set_permission()  # this invokes api_instance.core_service_add_feature_set_permission.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.core_service_add_feature_set_permission.callable or self.callable in this class
