...
RSS_file="material/IG_RSS.fasta"
hep_nona_file="material/IG_heptamer_nonamer.fasta"
person_name="HG01952_doubleV"
...
flanking_file="/home/mlin77/scr4_blangme2/maojan/IGLoo/doubleV/HG01952.doubleV.fasta"
flanking_file_idx="/home/mlin77/scr4_blangme2/maojan/IGLoo/doubleV/bwa/HG01952.doubleV.fasta"

bwa mem -t 16 -a -k 10 -T 20 ${flanking_file_idx} ${RSS_file} > ${outer_dir}${first_dir}/bwa_${person_name}_${allele}_RSS_first_scan.sam
