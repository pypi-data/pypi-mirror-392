...
@typing.final
class CircleOfConfusionSettings(google.protobuf.message.Message):
...
global___CircleOfConfusionSettings = CircleOfConfusionSettings
...
global___DepthOfField = DepthOfField

@typing.final
class CircleOfConfusionCalculator(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    @property
    def settings(self) -> global___CircleOfConfusionSettings: ...
    @property
    def depth_of_field(self) -> global___DepthOfField: ...
    def __init__(
        self,
        *,
        settings: global___CircleOfConfusionSettings | None = ...,
...
global___CircleOfConfusionCalculator = CircleOfConfusionCalculator
