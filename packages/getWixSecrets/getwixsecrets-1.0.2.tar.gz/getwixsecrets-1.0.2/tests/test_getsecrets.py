...
class TestGetSecrets(unittest.TestCase):
    ...
    def test_getUpdateSecrets(self):
        secret = gs.get_secret('cambristiGoogleServiceAccount')
        secret = 'test1'
    ...
    def test_usr_pwd(self):
        usr, pwd = gs.get_user_pwd('cambristiMembersPlanEventsSheetID')
        self.assertEqual(usr, 'id')
        self.assertEqual(pwd, '1FMsQCnrDGBXw9o2bBy57CXQNQG1HsTeHgKAk24Zu5Is')
