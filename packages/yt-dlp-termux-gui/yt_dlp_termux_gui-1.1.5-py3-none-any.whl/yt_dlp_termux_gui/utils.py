...
def ensure_curl_impersonate(force: bool = False):
    ...
    if os.path.exists(install_dir):
        assign_permissions_to_path(install_dir)
        try:
    ...
    try:
        ...
        assign_permissions_to_path(curl_dir)
        assign_permissions_to_path(lib_dir)
        ...
        for file in files:
            ...
            if os.path.exists(lib_file_src):
                ...
                assign_permissions_to_path(lib_file_dest)
        shutil.rmtree(install_dir)
    except Exception as e:
...
def ensure_termux_widget(force: bool = False):
    ...
    for p in [
        ...
        try:
            ...
            assign_permissions_to_path(p, 700)
        except Exception as e:
