...
class Group(annize.features.distributables.common.Group):
    ...
    def description(self):
        ...
        part_1 = annize.i18n.TrStr.tr("an_Dist_FlatpakDesc").format(project_short_hint_name=project_short_hint_name,
                                                                    package_name=package_name,
                                                                    repository_public_url=repository_public_url)
        outro_text = annize.i18n.TrStr.tr("an_Dist_FlatpakDescOutro")
        outro_post_text = annize.i18n.TrStr.tr("an_Dist_FlatpakDescOutroPost")
...
class _FlatpakImage(annize.fs.FilesystemContent):
    ...
    __ = annize.i18n.tr("an_int_FlatpakPackage", culture="en")  # to be used by Annize projects
