...
class Document(annize.features.documentation.common.Document, abc.ABC):
    ...
    def project_name(self) -> annize.i18n.TrStr:
        ...
        return (self.original_project_name or annize.features.base.pretty_project_name()
                or annize.i18n.TrStr.tr("an_ThisProject"))
    ...
    def __generate__prepare_annize_icons(info):
        substitutions = "\n".join((f".. |annizeicon_{icon_name}| image:: /_annize_icons/{icon_name}.png"
                                   for icon_name in sorted(_.stem for _ in annize.asset.data.icons_dir.iterdir())))
        info.config_values["rst_epilog"] += substitutions + "\n"
        annize.asset.data.icons_dir.copy_to(info.document_source_dir("_annize_icons"))
...
class AboutProjectDocument(Document):
    ...
    def _generate_sources(self, info):
        ...
        content_license = annize.i18n.tr("an_HP_Lic_Text")
        content_uptodate = annize.i18n.tr("an_Doc_ReadmeUpToDate")
        content_dependencies = annize.i18n.tr("an_HP_DL_Uses3rdParty")
        content_readme_for_version = annize.i18n.tr("an_Doc_ReadmeUpToDateCurrentVersion")
...
class ReadmeDocument(CompositeDocument):  # TODO noh maturity flags?!
    ...
    def title(self):
        project_name = self.project_name
        return self.original_title or annize.i18n.TrStr.tr("an_Doc_ReadmeTitle").format(project_name=project_name)
