...
class HtmlOutputGenerator(annize.features.documentation.sphinx.output.common.OutputGenerator):
    ...
    def prepare_generate(self, info):
        ...
        info.config_values["html_theme_path"] = [str(_) for _ in (*info.config_values.get("html_theme_path", ()),
                                                                  annize.asset.data.data_dir)]
        ...
        html_static_paths.append(str(annize.asset.data.data_dir("icons/docrender")))
