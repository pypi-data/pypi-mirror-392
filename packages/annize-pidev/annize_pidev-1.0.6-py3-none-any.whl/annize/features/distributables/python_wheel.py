...
import annize.features.keywords
...
class Package(annize.fs.FilesystemContent):
    ...
    def __init__(self, *, source: annize.fs.FilesystemContent, executable_links: t.Sequence[ExecutableLink],
                 ...
                 version: annize.data.Version|None, keywords: annize.features.keywords.Keywords|None,
    ...
    def _path(self):
        ...
        return self.__make_package(self._BuildInfo(
            ...
            keywords=self.__keywords or annize.features.keywords.project_keywords(),
    ...
    class _BuildInfo:
        ...
        keywords: annize.features.keywords.Keywords
        name: str
