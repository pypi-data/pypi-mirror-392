...
class Attachment(BaseModel):
    ...
    relationships: Optional[List[StrictStr]] = Field(default=None, description="Array of relationships with other entities. It contains relationship type, target ids and target entity type.")
