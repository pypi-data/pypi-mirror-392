...
from ..types import EventstreamSchemaType, EventstreamType, SplitExpr
...
class FilterEventsHelperMixin:
    ...
    def filter_events(
        ...
        func: Optional[Callable[[DataFrame, Optional[EventstreamSchemaType]], Series]] = None,
        segment: Optional[SplitExpr] = None,
    ) -> EventstreamType:
        """
        ...
        node = EventsNode(processor=FilterEvents(params=FilterEventsParams(func=func, segment=segment)))  # type: ignore
