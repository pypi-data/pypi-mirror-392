...
class Page(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["css_link_color", "support_url", "activity_score", "password_protected", "css_no_data", "hero_cover", "company_logo", "page_description", "css_body_background_color", "css_button_border_color", "favicon_logo", "email_logo", "google_analytics_id", "css_button_text_color", "allow_rss_atom_feeds", "organization_id", "css_spinner_color", "city", "css_greens", "name", "url", "yandex_metrica_id", "allow_sms_subscribers", "notifications_email_footer", "id", "transactional_logo", "subdomain", "updated_at", "css_graph_color", "template", "country", "viewers_must_be_team_members", "allow_page_subscribers", "ip_restrictions", "css_font_color", "language", "allow_incident_subscribers", "allow_webhook_subscribers", "css_button_color", "css_light_font_color", "css_border_color", "css_yellows", "headline", "allow_email_subscribers", "notifications_from_email", "template_id", "css_button_hover_color", "hidden_from_search", "css_blues", "time_zone", "state", "css_reds", "created_at", "domain", "css_oranges"]
