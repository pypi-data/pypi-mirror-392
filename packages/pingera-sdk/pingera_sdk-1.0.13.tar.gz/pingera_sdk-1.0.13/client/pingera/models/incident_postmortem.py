...
class IncidentPostmortem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "incident_id", "body_updated_at", "preview_key", "updated_at", "notify_subscribers", "body", "body_draft_updated_at", "published_at", "body_draft", "created_at"]
