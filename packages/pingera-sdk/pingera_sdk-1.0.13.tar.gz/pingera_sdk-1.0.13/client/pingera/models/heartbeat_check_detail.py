...
class HeartbeatCheckDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "last_ping_at", "updated_at", "grace_seconds", "active", "ping_url", "created_at", "name", "recent_pings", "next_expected_ping", "period_seconds"]
