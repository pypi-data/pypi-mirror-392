...
class MonitorCheckResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["response_time", "id", "status", "error_message", "check_server_id", "execution_id", "triggered_alerts", "created_at", "check_metadata", "check_server", "check_id"]
