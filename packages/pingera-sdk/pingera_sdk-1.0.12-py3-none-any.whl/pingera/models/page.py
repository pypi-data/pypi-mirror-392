...
class Page(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["css_no_data", "organization_id", "language", "allow_incident_subscribers", "css_button_border_color", "name", "allow_webhook_subscribers", "css_button_hover_color", "support_url", "password_protected", "css_light_font_color", "css_greens", "company_logo", "state", "headline", "activity_score", "city", "page_description", "css_link_color", "css_border_color", "country", "allow_page_subscribers", "allow_sms_subscribers", "created_at", "subdomain", "notifications_email_footer", "css_blues", "favicon_logo", "google_analytics_id", "email_logo", "template_id", "css_body_background_color", "css_button_text_color", "css_spinner_color", "css_yellows", "domain", "css_button_color", "css_reds", "css_graph_color", "yandex_metrica_id", "css_font_color", "css_oranges", "notifications_from_email", "ip_restrictions", "allow_email_subscribers", "updated_at", "hidden_from_search", "time_zone", "allow_rss_atom_feeds", "transactional_logo", "hero_cover", "viewers_must_be_team_members", "template", "id", "url"]
