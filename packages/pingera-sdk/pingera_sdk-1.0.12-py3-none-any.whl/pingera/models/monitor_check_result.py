...
class MonitorCheckResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["check_id", "triggered_alerts", "check_metadata", "response_time", "execution_id", "created_at", "status", "check_server", "check_server_id", "error_message", "id"]
