...
class TestHeartbeatPingCountHistory(unittest.TestCase):
    """HeartbeatPingCountHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeartbeatPingCountHistory:
        """Test HeartbeatPingCountHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeartbeatPingCountHistory`
        """
        model = HeartbeatPingCountHistory()
        if include_optional:
            return HeartbeatPingCountHistory(
                ping_count = 12,
    ...
    def testHeartbeatPingCountHistory(self):
        """Test HeartbeatPingCountHistory"""
