...
class MonitorCheck(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uptime_data", "timeout", "port", "interval", "secrets", "name", "url", "host", "id", "parameters", "updated_at", "position", "group", "last_checked_at", "status", "uptime_summary", "type", "group_id", "active", "created_at"]
