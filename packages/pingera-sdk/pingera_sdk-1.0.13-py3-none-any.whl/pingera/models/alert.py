...
class Alert(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["acknowledged_at", "notification_count", "trigger_results", "fired_at", "is_active", "duration", "check_name", "last_notification_at", "regional_summary", "resolved_at", "check_id", "id", "rule_name", "status", "alert_metadata", "acknowledged_by_id", "description", "severity", "rule_id", "title"]
