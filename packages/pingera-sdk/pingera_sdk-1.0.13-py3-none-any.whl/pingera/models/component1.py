...
class Component1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "start_date", "updated_at", "name", "description", "position", "only_show_if_degraded", "group_id", "group", "created_at", "page_id", "showcase"]
