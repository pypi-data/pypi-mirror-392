...
class TestCheckSecretInput(unittest.TestCase):
    """CheckSecretInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckSecretInput:
        """Test CheckSecretInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckSecretInput`
        """
        model = CheckSecretInput()
        if include_optional:
            return CheckSecretInput(
