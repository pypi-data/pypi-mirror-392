...
class IncidentPostmortem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_key", "body_updated_at", "notify_subscribers", "published_at", "body", "updated_at", "body_draft", "body_draft_updated_at", "created_at", "incident_id", "id"]
