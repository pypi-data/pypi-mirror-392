...
class HeartbeatCheckDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["next_expected_ping", "name", "updated_at", "created_at", "ping_url", "status", "last_ping_at", "active", "id", "grace_seconds", "recent_pings", "period_seconds"]
