...
class AuthenticationComplete(BaseModel):
    ...
    """ # noqa: E501
    credential: Dict[str, Any] = Field(description="The raw WebAuthn credential assertion generated by the browser/authenticator.")
    challenge_id: StrictStr = Field(description="The server-generated challenge ID from the authentication initiation step.")
    __properties: ClassVar[List[str]] = ["credential", "challenge_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthenticationComplete from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthenticationComplete from a dict"""
        if obj is None:
            return None
