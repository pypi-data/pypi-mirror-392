...
class Component(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["showcase", "position", "name", "description", "group", "updated_at", "group_id", "created_at", "status", "only_show_if_degraded", "start_date", "page_id", "id"]
