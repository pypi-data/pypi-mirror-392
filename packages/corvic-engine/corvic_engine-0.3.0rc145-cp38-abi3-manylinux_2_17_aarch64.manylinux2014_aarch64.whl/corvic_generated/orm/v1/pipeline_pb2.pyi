...
class PipelineTransformation(_message.Message):
    __slots__ = ("chunk_pdf", "ocr_pdf", "sanitize_parquet", "table_function_passthrough", "table_function_structured_passthrough", "processed_input_names")
