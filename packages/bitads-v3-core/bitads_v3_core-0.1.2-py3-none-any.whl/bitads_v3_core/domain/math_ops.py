...
# Constants
W_SALES = 0.40  # Weight for sales normalization in base score
W_REV = 0.60  # Weight for revenue normalization in base score
...
def base_score(sales_norm: float, rev_norm: float, w_sales: float = W_SALES, w_rev: float = W_REV) -> float:
    ...
    Args:
        ...
        w_sales: Weight for sales (default W_SALES=0.40)
        w_rev: Weight for revenue (default W_REV=0.60)
