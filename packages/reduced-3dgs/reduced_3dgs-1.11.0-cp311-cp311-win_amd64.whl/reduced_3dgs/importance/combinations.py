...
from gaussian_splatting.trainer import DepthTrainerWrapper, NoopDensifier, DensificationTrainerWrapper, AdaptiveDensificationTrainerWrapper
...
def BaseImportancePrunerInAdaptiveDensifyTrainer(
        model: GaussianModel,
        scene_extent: float,
        dataset: List[Camera],
        *args,
...
def DepthImportancePrunerInAdaptiveDensifyTrainer(model: GaussianModel, scene_extent: float, dataset: TrainableCameraDataset, *args, **kwargs):
    return DepthTrainerWrapper(
        BaseImportancePrunerInAdaptiveDensifyTrainer,
        model, scene_extent, dataset,
        *args, **kwargs)
...
ImportancePrunerInAdaptiveDensifyTrainer = DepthImportancePrunerInAdaptiveDensifyTrainer
