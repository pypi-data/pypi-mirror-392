...
2025年11月17日，修改了函数：my_read_from_txtfile_for_cn ，让它在 chardet 判断不出编码的时候，同时进行 utf-8 和 ansi 两种尝试，这种改进使得函数 my_read_from_txtfile_for_cn 的功能比 1.3.0 版的同名函数功能强了一点。原函数 my_read_from_txtfile 继续保留，等以后测试无明细错误时，会在保留新函数名的前提下把原函数 my_read_from_txtfile 用新函数 my_read_from_txtfile_for_cn 的代码重写，以增强原函数 my_read_from_txtfile 的功能。
