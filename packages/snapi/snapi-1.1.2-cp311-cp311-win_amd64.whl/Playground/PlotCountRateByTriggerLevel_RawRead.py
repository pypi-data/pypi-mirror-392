...
if(__name__ == "__main__"):
    ...
    for trigLvl in range(-33, 32):
        ...
        idx = sn.raw.measure(1000, size, True, savePTU)
        sn.logPrint("Counts", idx.value)
        data = sn.raw.getData(idx.value)
        ...
        sn.logPrint(trigLvl, cnts, idx.value, idx.value - sum(cnts))
        x.append(trigLvl)
