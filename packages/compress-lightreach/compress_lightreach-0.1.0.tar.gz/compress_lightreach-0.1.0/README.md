...
Compress Light Reach uses intelligent algorithms to identify repeated substrings in your prompts and replace them with shorter placeholders. The compression format is:

```
DICT:key1=value1;key2=value2|PROMPT:compressed_text
```
