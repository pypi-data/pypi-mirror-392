...
# Create imported target momentum::io_usd
add_library(momentum::io_usd STATIC IMPORTED)

set_target_properties(momentum::io_usd PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_20"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "momentum::character;momentum::io_common;momentum::io_skeleton;\$<LINK_ONLY:usd>;\$<LINK_ONLY:usdGeom>;\$<LINK_ONLY:usdSkel>;\$<LINK_ONLY:TBB::tbb>;\$<LINK_ONLY:Python3::Python>"
)
...
set_target_properties(momentum::io PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_20"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "momentum::io_common;momentum::io_fbx;momentum::io_gltf;momentum::io_legacy_json;momentum::io_motion;momentum::io_marker;momentum::io_shape;momentum::io_skeleton;momentum::io_usd"
)
