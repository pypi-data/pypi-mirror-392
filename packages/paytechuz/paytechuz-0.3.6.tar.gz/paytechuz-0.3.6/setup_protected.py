"""Setup script for protected PayTechUZ package."""
...
setup(
    ...
    # Use obfuscated files from dist_protected
    packages=find_packages(where='dist_protected'),
    package_dir={'': 'dist_protected'},
    include_package_data=True,
    
    # Include only compiled/obfuscated files
    package_data={
        '': ['*.so', '*.pyd', '*.pyc'],  # Only compiled files
    },
    
    # Exclude source files
    exclude_package_data={
        '': ['*.py'],  # Exclude source Python files
    },
    ...
    install_requires=[
        ...
        'pyarmor>=8.0',  # Required for obfuscated code
    ],
