...
class ClickGateway(BasePaymentGateway):
    ...
    def __init__(
        ...
        """
        super().__init__(is_test_mode=is_test_mode, api_key=api_key)
    ...
    def create_payment(
        ...
        **kwargs
        ...
        if self.api_key:
            ...
            return api_client.create_payment("click", payload)
    ...
    def check_payment(self, transaction_id: str) -> Dict[str, Any]:
        ...
        if self.api_key:
            api_client = self._get_api_client()
            return api_client.check_payment(transaction_id)
    ...
    def cancel_payment(
        ...
        if self.api_key:
            api_client = self._get_api_client()
            return api_client.cancel_payment(transaction_id, reason=reason)
