...
from paytechuz.core.license import require_api_key
...
class PaymeWebhook(View):
    ...
    def __init__(self, **kwargs):
        ...
        # Get PayTechUZ API key
        self.paytechuz_api_key = (
            paytechuz_settings.get('API_KEY') or
            getattr(settings, 'PAYTECHUZ_API_KEY', None)
        )
        ...
        # Validate PayTechUZ API key
        require_api_key(self.paytechuz_api_key)
