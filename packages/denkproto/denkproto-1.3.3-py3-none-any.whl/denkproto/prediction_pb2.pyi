...
class InterpretationMap(_message.Message):
...
class ClassificationPrediction(_message.Message):
    ...
    def __init__(self, label_id: _Optional[str] = ..., probability: _Optional[float] = ..., interpretation_map: _Optional[_Union[InterpretationMap, _Mapping]] = ...) -> None: ...
