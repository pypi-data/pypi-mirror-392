...
class MagicwandAnnotation(_message.Message):
    __slots__ = ("x", "y", "width", "height", "center_x", "center_y", "points", "threshold")
    ...
    threshold: int
    def __init__(self, x: _Optional[int] = ..., y: _Optional[int] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., center_x: _Optional[int] = ..., center_y: _Optional[int] = ..., points: _Optional[_Iterable[_Union[_geometry_pb2.Point2D, _Mapping]]] = ..., threshold: _Optional[int] = ...) -> None: ...

class PenAnnotation(_message.Message):
    __slots__ = ("x", "y", "width", "height", "points", "thickness")
    X_FIELD_NUMBER: _ClassVar[int]
    Y_FIELD_NUMBER: _ClassVar[int]
    WIDTH_FIELD_NUMBER: _ClassVar[int]
    HEIGHT_FIELD_NUMBER: _ClassVar[int]
    ...
    points: _containers.RepeatedCompositeFieldContainer[_geometry_pb2.Point2D]
    thickness: int
    def __init__(self, x: _Optional[int] = ..., y: _Optional[int] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., points: _Optional[_Iterable[_Union[_geometry_pb2.Point2D, _Mapping]]] = ..., thickness: _Optional[int] = ...) -> None: ...
...
class PixelAnnotation(_message.Message):
    ...
    width: int
    height: int
    def __init__(self, data: _Optional[_Union[_geometry_pb2.BinaryMaskData, _Mapping]] = ..., x: _Optional[int] = ..., y: _Optional[int] = ..., width: _Optional[int] = ..., height: _Optional[int] = ...) -> None: ...

class SausageAnnotation(_message.Message):
    __slots__ = ("x", "y", "width", "height", "points", "radius")
    X_FIELD_NUMBER: _ClassVar[int]
    Y_FIELD_NUMBER: _ClassVar[int]
    WIDTH_FIELD_NUMBER: _ClassVar[int]
    HEIGHT_FIELD_NUMBER: _ClassVar[int]
    ...
    points: _containers.RepeatedCompositeFieldContainer[_geometry_pb2.Point2D]
    radius: int
    def __init__(self, x: _Optional[int] = ..., y: _Optional[int] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., points: _Optional[_Iterable[_Union[_geometry_pb2.Point2D, _Mapping]]] = ..., radius: _Optional[int] = ...) -> None: ...
