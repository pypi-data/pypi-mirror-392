...
class ObjectDetectionPrediction(_message.Message):
    __slots__ = ("label_id", "x", "y", "width", "height", "probability", "angle", "full_orientation")
    LABEL_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, label_id: _Optional[str] = ..., x: _Optional[int] = ..., y: _Optional[int] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., probability: _Optional[float] = ..., angle: _Optional[float] = ..., full_orientation: bool = ...) -> None: ...

class InstanceSegmentationPrediction(_message.Message):
    __slots__ = ("label_id", "x", "y", "mask", "probability")
    LABEL_ID_FIELD_NUMBER: _ClassVar[int]
    X_FIELD_NUMBER: _ClassVar[int]
    Y_FIELD_NUMBER: _ClassVar[int]
    ...
    mask: bytes
    probability: float
    def __init__(self, label_id: _Optional[str] = ..., x: _Optional[int] = ..., y: _Optional[int] = ..., mask: _Optional[bytes] = ..., probability: _Optional[float] = ...) -> None: ...
