...
SWITCH_ENTITY_ID = os.getenv('XIAOMI_SMART_SURVEILLANCE_SWITCH_ENTITY_ID', 'switch.xiaomi_surveillance')
MODE_SELECT_ENTITY_ID = os.getenv('XIAOMI_SMART_SURVEILLANCE_NIGHT_VISION_MODE_SELECT_ENTITY_ID', 'select.xiaomi_surveillance_night_vision')
