...
from cfn_check.yaml.compat import MutableSliceableSequence, nprintf  # NOQA
from cfn_check.yaml.scalarstring import ScalarString
...
class CommentedBase:
    ...
    def yaml_set_comment_before_after_key(
        ...
        """
        from cfn_check.yaml.error import CommentMark
        from cfn_check.yaml.tokens import CommentToken
