...
from cfn_check.yaml.compat import StreamType  # NOQA
from cfn_check.yaml.error import YAMLError, YAMLStreamError
...
# fmt: off
from cfn_check.yaml.compat import nprint, dbg, DBG_EVENT, \
