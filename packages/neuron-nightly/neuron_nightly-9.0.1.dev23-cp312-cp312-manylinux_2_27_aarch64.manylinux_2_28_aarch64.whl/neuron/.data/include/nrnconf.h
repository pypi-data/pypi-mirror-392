...
#define NEURON_DATA_DIR "/tmp/tmpr2yqt3l6/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpr2yqt3l6/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-mgbd5g1b/bin/python)"};
