...
#define NEURON_DATA_DIR "/tmp/tmp0z3_j052/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp0z3_j052/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-nuayw5h_/bin/python)"};
