...
#define NEURON_DATA_DIR "/tmp/tmpeg7rp6lt/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpeg7rp6lt/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-al1t2ihl/bin/python)"};
