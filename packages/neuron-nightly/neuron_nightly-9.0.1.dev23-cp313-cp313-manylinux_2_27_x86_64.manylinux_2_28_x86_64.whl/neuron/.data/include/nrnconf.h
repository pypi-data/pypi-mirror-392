...
#define NEURON_DATA_DIR "/tmp/tmp6rh0i6l4/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp6rh0i6l4/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-xssmr8mx/bin/python)"};
