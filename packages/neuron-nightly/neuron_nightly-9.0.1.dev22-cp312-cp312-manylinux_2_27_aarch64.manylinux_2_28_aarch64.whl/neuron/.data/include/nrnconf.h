...
#define NEURON_DATA_DIR "/tmp/tmp4n73280m/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp4n73280m/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-yrqe4891/bin/python)"};
