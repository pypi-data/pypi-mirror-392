...
#define NEURON_DATA_DIR "/tmp/tmps_7kzcer/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmps_7kzcer/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-_pzxad4k/bin/python)"};
