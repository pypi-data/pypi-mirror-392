...
#define NEURON_DATA_DIR "/tmp/tmp_sb4xmra/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp_sb4xmra/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-qozb6qi3/bin/python)"};
