...
#define NEURON_DATA_DIR "/tmp/tmpjnm39i4o/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpjnm39i4o/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-pykao_9j/bin/python)"};
