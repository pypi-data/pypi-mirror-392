...
#define NEURON_DATA_DIR "/tmp/tmpnqfp3pll/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpnqfp3pll/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-znjl8xb1/bin/python)"};
