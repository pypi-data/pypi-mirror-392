...
#define NEURON_DATA_DIR "/tmp/tmplcvdct9x/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmplcvdct9x/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-xz9830a9/bin/python)"};
