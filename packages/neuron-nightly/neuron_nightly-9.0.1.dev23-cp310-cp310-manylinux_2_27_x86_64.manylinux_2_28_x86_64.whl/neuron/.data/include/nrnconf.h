...
#define NEURON_DATA_DIR "/tmp/tmps2o3e12a/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmps2o3e12a/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-fi551bo8/bin/python)"};
