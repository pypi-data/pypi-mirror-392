...
#define NEURON_DATA_DIR "/tmp/tmpok34s6ok/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpok34s6ok/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-8kw0jwq8/bin/python)"};
