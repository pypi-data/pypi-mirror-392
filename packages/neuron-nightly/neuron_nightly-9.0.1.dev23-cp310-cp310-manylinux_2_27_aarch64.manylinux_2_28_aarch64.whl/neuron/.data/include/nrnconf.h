...
#define NEURON_DATA_DIR "/tmp/tmpglms0yom/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpglms0yom/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-a1zo1vi4/bin/python)"};
