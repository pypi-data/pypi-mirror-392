...
#define NEURON_DATA_DIR "/tmp/tmp9nri29kg/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp9nri29kg/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-uyj8kgpf/bin/python)"};
