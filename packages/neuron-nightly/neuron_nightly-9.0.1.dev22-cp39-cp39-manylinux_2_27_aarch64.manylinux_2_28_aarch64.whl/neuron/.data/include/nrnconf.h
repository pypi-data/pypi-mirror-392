...
#define NEURON_DATA_DIR "/tmp/tmpe74svf3e/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpe74svf3e/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-_inmzt7i/bin/python)"};
