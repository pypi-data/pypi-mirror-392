...
#define NEURON_DATA_DIR "/tmp/tmp_j6tdljs/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp_j6tdljs/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-f_n_nx1u/bin/python)"};
