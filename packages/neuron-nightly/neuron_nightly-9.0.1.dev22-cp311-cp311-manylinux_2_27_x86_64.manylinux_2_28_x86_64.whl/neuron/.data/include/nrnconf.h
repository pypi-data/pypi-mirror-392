...
#define NEURON_DATA_DIR "/tmp/tmppksg_hv9/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmppksg_hv9/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-wp0ejhn6/bin/python)"};
