...
#define NEURON_DATA_DIR "/tmp/tmptip0aftm/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmptip0aftm/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-2quf42sw/bin/python)"};
