...
#define NEURON_DATA_DIR "/tmp/tmpn2bwnyut/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpn2bwnyut/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-y23o_bzi/bin/python)"};
