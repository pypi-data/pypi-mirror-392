...
#define NEURON_DATA_DIR "/tmp/tmp8b1qe_bm/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp8b1qe_bm/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-3u95m3z0/bin/python)"};
