...
#define NEURON_DATA_DIR "/tmp/tmp6tqlfsga/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp6tqlfsga/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-qbmo09__/bin/python)"};
