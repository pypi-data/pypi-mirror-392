...
#define NEURON_DATA_DIR "/tmp/tmplhapabna/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmplhapabna/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-hktqkgtf/bin/python)"};
