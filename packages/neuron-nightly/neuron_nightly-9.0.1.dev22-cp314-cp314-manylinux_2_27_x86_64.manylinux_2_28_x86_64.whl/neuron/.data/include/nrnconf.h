...
#define NEURON_DATA_DIR "/tmp/tmpgcrw_yqt/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpgcrw_yqt/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-hmbd7xmn/bin/python)"};
