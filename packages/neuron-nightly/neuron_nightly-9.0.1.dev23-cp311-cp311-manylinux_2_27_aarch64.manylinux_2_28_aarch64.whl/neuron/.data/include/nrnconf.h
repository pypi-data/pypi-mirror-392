...
#define NEURON_DATA_DIR "/tmp/tmpgvndcrxi/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpgvndcrxi/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-3u__c0pc/bin/python)"};
