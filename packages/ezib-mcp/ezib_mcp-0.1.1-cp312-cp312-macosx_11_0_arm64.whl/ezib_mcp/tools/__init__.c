...
{
    "distutils": {
        "name": "ezib_mcp.tools.__init__",
        "sources": [
            "src/ezib_mcp/tools/__init__.py"
        ]
    },
    "module_name": "ezib_mcp.tools.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__ezib_mcp__tools
#define __PYX_HAVE_API__ezib_mcp__tools
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "ezib_mcp.tools" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "ezib_mcp.tools.__init__"
extern int __pyx_module_is_main_ezib_mcp__tools____init__;
int __pyx_module_is_main_ezib_mcp__tools____init__ = 0;

/* Implementation of "ezib_mcp.tools" */
...
#define __pyx_kp_u_ezib_mcp_tools___init __pyx_string_tab[1]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_tools(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_tools", 0);
  ...
  if (__pyx_module_is_main_ezib_mcp__tools____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_ezib_mcp_tools___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ezib_mcp.tools")) {
      if (unlikely((PyDict_SetItemString(modules, "ezib_mcp.tools", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init ezib_mcp.tools", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init ezib_mcp.tools");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
const char* const cstring = "x\332%\214\301\r\2000\014\0037\352\n\214b\245!H\021I\0134\3750=\001\3748\237?^\344\326\n\347\243D\3576\n\240M\003`\323&\351\210\213X*\361\0168\345\316x_\247\311k\215\374\353s\222\375>$V\331hZ~\204\214\344\003x5'\003";
...
const char* const bytes = "?ezib_mcp.tools.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
