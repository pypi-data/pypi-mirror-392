...
{
    "distutils": {
        "name": "ezib_mcp.__init__",
        "sources": [
            "src/ezib_mcp/__init__.py"
        ]
    },
    "module_name": "ezib_mcp.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__ezib_mcp
#define __PYX_HAVE_API__ezib_mcp
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "ezib_mcp" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "ezib_mcp.__init__"
extern int __pyx_module_is_main_ezib_mcp____init__;
int __pyx_module_is_main_ezib_mcp____init__ = 0;

/* Implementation of "ezib_mcp" */
...
#define __pyx_kp_u_ezib_mcp___init __pyx_string_tab[1]
...
static int __pyx_pymod_exec_ezib_mcp(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ezib_mcp},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_ezib_mcp(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_ezib_mcp(); }
#endif
__Pyx_PyMODINIT_FUNC PyInit_ezib_mcp(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ezib_mcp(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ezib_mcp' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "ezib_mcp" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_ezib_mcp", 0);
  ...
  if (__pyx_module_is_main_ezib_mcp____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_ezib_mcp___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ezib_mcp")) {
      if (unlikely((PyDict_SetItemString(modules, "ezib_mcp", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init ezib_mcp", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init ezib_mcp");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
const char* const cstring = "x\332%\214\301\r\2000\014\0037b\005F\261\3224H\021I)4\3750=\001\3748\237?^\345\326\002\347\276\000\3324\0006m\222\216\270\210\245\020\357\200S\356\214\037u\232\274\326\310\277>'\331\357C\242\312F\323\362#d$\037\226w$\244";
...
const char* const bytes = "?ezib_mcp.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
