...
class FeatrixSphereClient:
    ...
    def create_session(self, session_type: str = "sphere", metadata: Dict[str, Any] = None, session_name_prefix: str = None, name: str = None) -> SessionInfo:
        """
    ...
    def upload_file_and_create_session(self, file_path: Path, session_name_prefix: str = None, name: str = None) -> SessionInfo:
        """
