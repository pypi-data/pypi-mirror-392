    ...
    return [
        ...
        Tool(
            ...
            description=(
                ...
                "**IMPORTANT: AI agents should call this tool only after fully completing a user's request.** "
                ...
                "**WHEN TO USE**: Call this only when you have fully completed the user's request. "
                "Do NOT call for intermediate steps like finishing a code file, completing a research subtask, "
                "or modifying individual files - wait until the entire user request is complete. "
        ...
        Tool(
            ...
            description=(
                ...
                "**WHEN TO USE**: Call this only after fully completing a user's request. "
                "Do NOT call for intermediate steps - wait until the entire user request is complete."
            ),
            inputSchema={
                "type": "object",
                "properties": {
