...
# PACKET (64 bits)   water5_device_warm_reset_v_jupiter_freescale
#
# RESULT int:        10051
# RESULT bin:  MSB   0000000000000000000000000000000000000000000000000010011101000011   LSB
# RESULT hex:  LE    43 27 00 00 00 00 00 00
#
#
...
class Water5DeviceWarmResetVJupiterFreescaleData(Packet):
    power_on_reset: bool
    watchdog_reset: bool
    low_voltage: bool
    software_reset: bool
    ...
    @classmethod
    def parse(cls, buf: BufRef) -> 'Water5DeviceWarmResetVJupiterFreescaleData':
        ...
        buf.shift(50)
        result = Water5DeviceWarmResetVJupiterFreescaleData(**result__el_tmp1)
        return result
