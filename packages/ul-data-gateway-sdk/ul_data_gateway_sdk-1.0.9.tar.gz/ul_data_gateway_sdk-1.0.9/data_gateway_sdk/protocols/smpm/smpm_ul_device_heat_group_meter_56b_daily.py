from datetime import timedelta, time, tzinfo, datetime as dt
from decimal import Decimal
from typing import Any, Dict, List

from data_aggregator_sdk.constants.enums import SensorType, IntegrationV0MessageEvent, JournalDataType
from data_aggregator_sdk.integration_message import IntegrationV0MessageSensor, ResourceType, CounterType, IntegrationV0MessageConsumption, IntegrationV0MessageData, IntegrationV0MessageClock
...
# PACKET (448 bits)   smpm_ul_device_heat_group_meter_56b_daily
#
# RESULT int:        43684511744865104171663618271027972830519343432424159902670923543619678656573609919319963312622099900359995401101220275334
# RESULT bin:  MSB   00000000 00000000 00000000 00000000 00000000 00010000 11101010 11001111 10000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000110 01110010 00000000 00000000 00000000 00000110 01110010 00000000 00000000 00000000 00000110 01110010 00000000 00000000 00000000 00000110 01110010 00000000 01100100 10000110   LSB
# RESULT hex:  LE    86 64 00 72 06 00 00 00 72 06 00 00 00 72 06 00 00 00 72 06 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 80 cf ea 10 00 00 00 00 00
#
# name                                                type       size  value(int)                                                                                                                                                                                                                                                                                                                                                                                                                                                        data(bits)
# --------------------------------------------------  ---------  ----  ----------  ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# packet_type_id.0.VAL                                u7            7           6                                                                                                                                                                                                                                                                                                                                                                                                                                                           0000110
...
# value_ch1                                           uf40p3       40        3300                                                                                                                                                                                                                                                                                                                                                                                                   0000000000000000000000000000110011100100
# value_ch2                                           uf40p3       40        3300                                                                                                                                                                                                                                                                                                                                                           0000000000000000000000000000110011100100
# value_ch3                                           uf40p3       40        3300                                                                                                                                                                                                                                                                                                                   0000000000000000000000000000110011100100
# value_ch4                                           uf40p3       40        3300                                                                                                                                                                                                                                                                           0000000000000000000000000000110011100100
# uptime_ch1                                          timedelta    22           0                                                                                                                                                                                                                                                     0000000000000000000000
# uptime_ch2                                          timedelta    22           0                                                                                                                                                                                                                               0000000000000000000000
# uptime_ch3                                          timedelta    22           0                                                                                                                                                                                                         0000000000000000000000
# uptime_ch4                                          timedelta    22           0                                                                                                                                                                                   0000000000000000000000
# event_device_power_supply_lost                      bool          1           0                                                                                                                                                                                  0
# event_device_power_supply_enabled                   bool          1           0                                                                                                                                                                                 0
# event_device_common_settings_changed                bool          1           0                                                                                                                                                                                0
# event_device_measure_channels_settings_changed      bool          1           0                                                                                                                                                                               0
# event_device_digital_i_o_settings_changed           bool          1           0                                                                                                                                                                              0
# event_device_datetime_changed                       bool          1           0                                                                                                                                                                             0
# event_device_ethernet_settings_changed              bool          1           0                                                                                                                                                                            0
# event_device_system_settings_changed1               bool          1           0                                                                                                                                                                           0
# event_device_system_settings_changed2               bool          1           0                                                                                                                                                                          0
# event_device_system_settings_changed3               bool          1           0                                                                                                                                                                         0
# event_device_system_settings_changed4               bool          1           0                                                                                                                                                                        0
# event_device_alarm_digital_input1                   bool          1           0                                                                                                                                                                       0
# event_device_alarm_overrate_digital_input1          bool          1           0                                                                                                                                                                      0
# event_device_alarm_overrate_digital_input2          bool          1           0                                                                                                                                                                     0
# event_device_alarm_underrate_digital_input1         bool          1           0                                                                                                                                                                    0
# event_device_alarm_underrate_digital_input2         bool          1           0                                                                                                                                                                   0
...
# datetime                                            timedelta    31   567648000                                            0100001110101011001111100000000
# RESERVED                                            u42          42           0  000000000000000000000000000000000000000000


class SmpmUlDeviceHeatGroupMeter56BDailyData(Packet):
    days_ago: timedelta
    value_ch1: float
    value_ch2: float
    value_ch3: float
    ...
    def serialize(self) -> bytes:
        ...
        datetime_tmp6 = int(data.datetime.total_seconds() // 1 if isinstance(data.datetime, timedelta) else data.datetime // 1)
        assert 0 <= datetime_tmp6 <= 2147483647
        result |= ((datetime_tmp6) & (2 ** (31) - 1)) << size
        size += 31
        return result.to_bytes(56, "little")

    @classmethod
    def parse(cls, buf: BufRef) -> 'SmpmUlDeviceHeatGroupMeter56BDailyData':
        result__el_tmp7: Dict[str, Any] = dict()
        if 6 != buf.shift(7):
        ...
        if 0 != buf.shift(1):
            raise ValueError("packet_type_id: buffer doesn't match value")
        result__el_tmp7["days_ago"] = timedelta(seconds=buf.shift(6) * 86400)
        result__el_tmp7["value_ch1"] = round(buf.shift(40) / 1000.0, 3)
        result__el_tmp7["value_ch2"] = round(buf.shift(40) / 1000.0, 3)
        result__el_tmp7["value_ch3"] = round(buf.shift(40) / 1000.0, 3)
        result__el_tmp7["value_ch4"] = round(buf.shift(40) / 1000.0, 3)
        result__el_tmp7["uptime_ch1"] = timedelta(seconds=buf.shift(22) * 60)
        result__el_tmp7["uptime_ch2"] = timedelta(seconds=buf.shift(22) * 60)
        result__el_tmp7["uptime_ch3"] = timedelta(seconds=buf.shift(22) * 60)
        result__el_tmp7["uptime_ch4"] = timedelta(seconds=buf.shift(22) * 60)
        result__el_tmp7["event_device_power_supply_lost"] = bool(buf.shift(1))
        result__el_tmp7["event_device_power_supply_enabled"] = bool(buf.shift(1))
        result__el_tmp7["event_device_common_settings_changed"] = bool(buf.shift(1))
        result__el_tmp7["event_device_measure_channels_settings_changed"] = bool(buf.shift(1))
        result__el_tmp7["event_device_digital_i_o_settings_changed"] = bool(buf.shift(1))
        result__el_tmp7["event_device_datetime_changed"] = bool(buf.shift(1))
        result__el_tmp7["event_device_ethernet_settings_changed"] = bool(buf.shift(1))
        result__el_tmp7["event_device_system_settings_changed1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_system_settings_changed2"] = bool(buf.shift(1))
        result__el_tmp7["event_device_system_settings_changed3"] = bool(buf.shift(1))
        result__el_tmp7["event_device_system_settings_changed4"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_digital_input1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_overrate_digital_input1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_overrate_digital_input2"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_underrate_digital_input1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_underrate_digital_input2"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_t_high_digital_input1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_t_high_digital_input2"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_t_low_digital_input1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_t_low_digital_input2"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_delta_t_high_digital_input1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_delta_t_high_digital_input2"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_delta_t_low_digital_input1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_delta_t_low_digital_input2"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_power_high_digital_input1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_power_high_digital_input2"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_power_low_digital_input1"] = bool(buf.shift(1))
        result__el_tmp7["event_device_alarm_power_low_digital_input2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_circuit_break_t_sensor_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_circuit_break_t_sensor_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_circuit_break_t_sensor_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_error_delta_t"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_consumption_lower_g_min_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_consumption_lower_g_min_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_consumption_lower_g_min_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_consumption_lower_g_max_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_consumption_lower_g_max_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_consumption_lower_g_max_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_no_coolant_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_no_coolant_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_no_coolant_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_circuit_break_stimulation_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_circuit_break_stimulation_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_circuit_break_pressure_sensor_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_circuit_break_pressure_sensor_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_circuit_break_pressure_sensor_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch1_reverse"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_circuit_break_t_sensor_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_circuit_break_t_sensor_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_circuit_break_t_sensor_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_error_delta_t"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_consumption_lower_g_min_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_consumption_lower_g_min_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_consumption_lower_g_min_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_consumption_lower_g_max_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_consumption_lower_g_max_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_consumption_lower_g_max_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_no_coolant_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_no_coolant_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_no_coolant_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_circuit_break_stimulation_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_circuit_break_stimulation_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_circuit_break_pressure_sensor_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_circuit_break_pressure_sensor_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_circuit_break_pressure_sensor_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch2_reverse"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_circuit_break_t_sensor_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_circuit_break_t_sensor_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_circuit_break_t_sensor_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_error_delta_t"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_consumption_lower_g_min_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_consumption_lower_g_min_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_consumption_lower_g_min_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_consumption_lower_g_max_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_consumption_lower_g_max_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_consumption_lower_g_max_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_no_coolant_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_no_coolant_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_no_coolant_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_circuit_break_stimulation_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_circuit_break_stimulation_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_circuit_break_pressure_sensor_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_circuit_break_pressure_sensor_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_circuit_break_pressure_sensor_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch3_reverse"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_circuit_break_t_sensor_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_circuit_break_t_sensor_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_circuit_break_t_sensor_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_error_delta_t"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_consumption_lower_g_min_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_consumption_lower_g_min_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_consumption_lower_g_min_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_consumption_lower_g_max_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_consumption_lower_g_max_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_consumption_lower_g_max_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_no_coolant_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_no_coolant_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_no_coolant_channel_rate_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_circuit_break_stimulation_channel_rate_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_circuit_break_stimulation_channel_rate_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_circuit_break_pressure_sensor_1"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_circuit_break_pressure_sensor_2"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_circuit_break_pressure_sensor_3"] = bool(buf.shift(1))
        result__el_tmp7["event_ch4_reverse"] = bool(buf.shift(1))
        result__el_tmp7["datetime"] = timedelta(seconds=buf.shift(31) * 1)
        result = SmpmUlDeviceHeatGroupMeter56BDailyData(**result__el_tmp7)
        buf.shift(42)
        return result

    def to_integration_data(self, received_at: dt, device_tz: tzinfo, **kwargs: Any) -> List[IntegrationV0MessageData]:
            ...
            IntegrationV0MessageData(
                ...
                clock=[
                    IntegrationV0MessageClock(
                        value=dt(year=2020, month=1, day=1) + self.datetime,
                    ),
                ],
            ),
        ]
