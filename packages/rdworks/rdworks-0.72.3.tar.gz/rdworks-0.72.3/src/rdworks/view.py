...
class DescriptiveDraw:
    ...
    style = {
        'aromatic':   {'r': 0.3, 'rgba': (136, 180, 168, 0.6), 'linewidth': 1, 'fill': True},
        'conjugated': {'r': 0.1, 'rgba': (51, 51, 51, 0.7), 'linewidth': 1, 'fill': True},
        'HBA':        {'r': 0.4, 'rgba': (11, 57, 235, 0.7), 'linewidth': 3, 'fill': False},
        'HBD':        {'r': 0.5, 'rgba': (254, 97, 0, 0.7), 'linewidth': 3, 'fill': False},
        'ionizable':  {'r': 0.5, 'rgba': (254, 97, 0, 0.7), 'linewidth': 3, 'fill': False},
        # Bootstrap colors
        'primary':    {'r': 0.5, 'rgba': (13, 110, 253, 0.7), 'linewidth': 3, 'fill': False}, 
        'secondary':  {'r': 0.5, 'rgba': (108, 117, 125, 0.7),'linewidth': 3, 'fill': False},
        'success':    {'r': 0.5, 'rgba': (25, 135, 84, 0.7), 'linewidth': 3, 'fill': False},
        'info':       {'r': 0.5, 'rgba': (13, 202, 240, 0.7), 'linewidth': 3, 'fill': False},
        'warning':    {'r': 0.5, 'rgba': (255, 193, 7, 0.7), 'linewidth': 3, 'fill': False},
        'danger':     {'r': 0.5, 'rgba': (220, 53, 69, 0.7), 'linewidth': 3, 'fill': False},
        'light':      {'r': 0.5, 'rgba': (248, 249, 250, 0.7), 'linewidth': 3, 'fill': False},
        'dark':       {'r': 0.5, 'rgba': (33, 37, 41, 0.7), 'linewidth': 3, 'fill': False},
        'blue':       {'r': 0.5, 'rgba': (13, 110, 253, 0.7), 'linewidth': 3, 'fill': False}, 
        'indigo':     {'r': 0.5, 'rgba': (102, 16, 242, 0.7), 'linewidth': 3, 'fill': False}, 
        'purple':     {'r': 0.5, 'rgba': (111, 66, 193, 0.7), 'linewidth': 3, 'fill': False}, 
        'pink':       {'r': 0.5, 'rgba': (214, 51, 132, 0.7), 'linewidth': 3, 'fill': False}, 
        'red':        {'r': 0.5, 'rgba': (220, 53, 69, 0.7), 'linewidth': 3, 'fill': False}, 
        'orange':     {'r': 0.5, 'rgba': (253, 126, 20, 0.7), 'linewidth': 3, 'fill': False}, 
        ...
        'white':      {'r': 0.5, 'rgba': (255, 255, 255, 0.7), 'linewidth': 3, 'fill': False}, 
    ...
    def _set_acidic_oxygens(self) -> None:
        #carboxylates
        oxygens = [i[0] for i in self.rdmol.GetSubstructMatches(Chem.MolFromSmarts("[$([OD1][CX3](=[OD1]))]"))]
        for oidx in oxygens:
    ...
    def show_styles(self) -> None:
        ...
        for k, v in sorted(self.style.items()):
            print(f"{k:<16} {v['r']:<8.2f} {str(v['rgba']):<24} {v['linewidth']:<10} {v['fill']:<10}")
        print()
    ...
    def draw(self, 
        ...
        if HBA:
            _HBA = Chem.MolFromSmarts("[$([O,S;H1;v2]-[!$(*=[O,N,P,S])]),$([O,S;H0;v2]),$([O,S;-]),$("+"[N;v3;!$(N-*=!@[O,N,P,S])]),$([nH0,o,s;+0])]")
        ...
        if (isinstance(circles, list) or isinstance(circles, tuple)) and isinstance(circles[0], int):
