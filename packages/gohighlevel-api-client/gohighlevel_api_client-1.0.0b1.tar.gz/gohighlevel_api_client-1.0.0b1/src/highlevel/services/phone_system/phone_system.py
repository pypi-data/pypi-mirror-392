...
class PhoneSystem:
    ...
    async def active_numbers(
        ...
        """
        param_defs = [{"name": "locationId", "in": "path"}, {"name": "pageSize", "in": "query"}, {"name": "page", "in": "query"}, {"name": "searchFilter", "in": "query"}, {"name": "skipNumberPool", "in": "query"}, ]
        extracted = extract_params({ "location_id": location_id, "page_size": page_size, "page": page, "search_filter": search_filter, "skip_number_pool": skip_number_pool,  }, param_defs)
        requirements = ["Location-Access"]
