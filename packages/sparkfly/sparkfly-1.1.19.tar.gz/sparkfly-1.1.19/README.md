...
*EventNotificationsApi* | [**delete_event_notifications_callbacks_callback_id**](docs/EventNotificationsApi.md#delete_event_notifications_callbacks_callback_id) | **DELETE** /event_notifications/callbacks/{callback_id} | Delete Callback
*EventNotificationsApi* | [**delete_event_notifications_subscriptions_subscription_id**](docs/EventNotificationsApi.md#delete_event_notifications_subscriptions_subscription_id) | **DELETE** /event_notifications/subscriptions/{subscription_id} | Delete Subscription
*EventNotificationsApi* | [**get_event_notifications_callbacks**](docs/EventNotificationsApi.md#get_event_notifications_callbacks) | **GET** /event_notifications/callbacks | List Callbacks
*EventNotificationsApi* | [**get_event_notifications_callbacks_callback_id**](docs/EventNotificationsApi.md#get_event_notifications_callbacks_callback_id) | **GET** /event_notifications/callbacks/{callback_id} | Get Callback by ID
*EventNotificationsApi* | [**get_event_notifications_subscriptions**](docs/EventNotificationsApi.md#get_event_notifications_subscriptions) | **GET** /event_notifications/subscriptions | List Subscriptions
*EventNotificationsApi* | [**get_event_notifications_subscriptions_subscription_id**](docs/EventNotificationsApi.md#get_event_notifications_subscriptions_subscription_id) | **GET** /event_notifications/subscriptions/{subscription_id} | Get Subscription by ID
*EventNotificationsApi* | [**post_event_notifications_callbacks**](docs/EventNotificationsApi.md#post_event_notifications_callbacks) | **POST** /event_notifications/callbacks | Create Callback
*EventNotificationsApi* | [**post_event_notifications_subscriptions**](docs/EventNotificationsApi.md#post_event_notifications_subscriptions) | **POST** /event_notifications/subscriptions | Create Subscription
