...
class Grid(GridCore, Interpolation, Focal, Zonal):
    ...
    def to_geojson(self, polygonize: bool = False, include_nan: bool = False) -> dict[str, Any]:
        return {
            ...
            "features": [
                ...
                for i, (shape, value) in enumerate(
                    ...
                    if polygonize
                    else [(Point(x, y), value) for x, y, value in self.to_points(include_nan=include_nan)]
                )
            ],
        }
