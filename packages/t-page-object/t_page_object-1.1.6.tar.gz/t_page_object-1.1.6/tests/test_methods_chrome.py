...
class TestMethodsChrome:
    ...
    def test_headless_table_elements_chrome(self):
        """Test Table elements."""
        # Arrange
        self.app.browser.open_browser(
            browser="chrome",
    ...
    def test_scroll_to_element(self):
        """Test scroll_to_element functionality (always instant scroll)."""
        # Setup - use table page as it has scrollable content
        self.app.browser.open_browser(
            browser="chrome",
            url=self.app.table_page.url,
            remote_url=self.remote_url,
        ...
        # Test with centering
        self.app.table_page.table.scroll_to_element(center=True)

        # Test with top alignment
        self.app.table_page.table.scroll_to_element(center=False)

    def test_scroll_to_top(self):
        """Test scroll_to_top functionality (always instant scroll)."""
        # Setup - use table page as it has scrollable content
        self.app.browser.open_browser(
            browser="chrome",
            url=self.app.table_page.url,
        ...
        # First scroll down to table element
        self.app.table_page.table.scroll_to_element()

        # Test scroll to top
        self.app.table_page.scroll_to_top()

        # Scroll down again
        self.app.table_page.table.scroll_to_element()

        # Test scroll to top again
        self.app.table_page.scroll_to_top()

    def test_take_ui_element_screenshot_crop(self, tmp_path):
        """Test take_ui_element_screenshot cropping the element."""
        self.app.browser.open_browser(
            browser="chrome",
            url=self.app.table_page.url,
            remote_url=self.remote_url,
        ...
        element_screenshot_path = tmp_path / "element_screenshot.png"
        self.app.table_page.copyright_icon.take_element_screenshot(str(element_screenshot_path))

        # Verify screenshot was created
        assert os.path.exists(element_screenshot_path)

    def test_take_ui_element_screenshot_no_crop(self, tmp_path):
        """Test take_ui_element_screenshot functionality with crop set as False."""
        # Setup - use table page as it has a good sized element to screenshot
        self.app.browser.open_browser(
            browser="chrome",
            url=self.app.table_page.url,
            remote_url=self.remote_url,
        ...
        # Test taking element screenshot
        element_screenshot_path = tmp_path / "element_screenshot.png"
        self.app.table_page.table.take_element_screenshot(str(element_screenshot_path), crop=False)
