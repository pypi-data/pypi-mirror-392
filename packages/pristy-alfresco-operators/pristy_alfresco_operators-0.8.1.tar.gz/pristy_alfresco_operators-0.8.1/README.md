...
⚠️ **Important:** Only fields defined in the [InjectorNode schema](https://gitlab.com/pristy-oss/pristy-core/-/blob/develop/docs/PristyInjector.md) should be included in the pivot. Never add custom fields like `isFile`, `isFolder`, etc. directly to the pivot structure.
