...
def update_node_path(
    ...
    target_site = Variable.get(target_site_var, default=None)
    target_root_uuid = Variable.get(target_root_uuid_var, default=None)
    ...
    short_path_remove = Variable.get(short_path_remove_var, default=None)
