...
def s3_download_task(s3_client, bucket, key, extra_args, deferred, parent_logcontext):
    ...
    with LoggingContext(parent_context=parent_logcontext):
        ...
        # Get the response body - ensure it's properly decoded
        body = resp["Body"]
        # For OpenStack/OBS compatibility, ensure we read the raw stream correctly
        # The body should be a StreamingBody object that handles chunked encoding automatically
