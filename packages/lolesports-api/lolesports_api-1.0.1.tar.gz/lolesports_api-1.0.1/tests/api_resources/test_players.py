...
from lolesports_api.types import PlayerListResponse
...
class TestPlayers:
    ...
    def test_method_list(self, client: LolesportsAPI) -> None:
        player = client.players.list(
            slug="slug",
            tournament="ecc2efdd-ddfa-11a9-906f-9e4aada37aa7",
        )
        assert_matches_type(PlayerListResponse, player, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_list(self, client: LolesportsAPI) -> None:
        response = client.players.with_raw_response.list(
            slug="slug",
            tournament="ecc2efdd-ddfa-11a9-906f-9e4aada37aa7",
        )
    ...
    def test_streaming_response_list(self, client: LolesportsAPI) -> None:
        with client.players.with_streaming_response.list(
            slug="slug",
            tournament="ecc2efdd-ddfa-11a9-906f-9e4aada37aa7",
        ) as response:
...
class TestAsyncPlayers:
    ...
    async def test_method_list(self, async_client: AsyncLolesportsAPI) -> None:
        player = await async_client.players.list(
            slug="slug",
            tournament="ecc2efdd-ddfa-11a9-906f-9e4aada37aa7",
        )
        assert_matches_type(PlayerListResponse, player, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncLolesportsAPI) -> None:
        response = await async_client.players.with_raw_response.list(
            slug="slug",
            tournament="ecc2efdd-ddfa-11a9-906f-9e4aada37aa7",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncLolesportsAPI) -> None:
        async with async_client.players.with_streaming_response.list(
            slug="slug",
            tournament="ecc2efdd-ddfa-11a9-906f-9e4aada37aa7",
        ) as response:
            assert not response.is_closed
