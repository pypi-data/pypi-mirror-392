...
from lolesports_api.types import GetTeamListResponse
...
class TestGetTeams:
    ...
    def test_method_list(self, client: LolesportsAPI) -> None:
        get_team = client.get_teams.list(
            hl="en-US",
        )
        assert_matches_type(GetTeamListResponse, get_team, path=["response"])
    ...
    def test_raw_response_list(self, client: LolesportsAPI) -> None:
        response = client.get_teams.with_raw_response.list(
            hl="en-US",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        get_team = response.parse()
        assert_matches_type(GetTeamListResponse, get_team, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_list(self, client: LolesportsAPI) -> None:
        with client.get_teams.with_streaming_response.list(
            hl="en-US",
        ) as response:
...
class TestAsyncGetTeams:
    ...
    async def test_method_list(self, async_client: AsyncLolesportsAPI) -> None:
        get_team = await async_client.get_teams.list(
            hl="en-US",
        )
        assert_matches_type(GetTeamListResponse, get_team, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncLolesportsAPI) -> None:
        response = await async_client.get_teams.with_raw_response.list(
            hl="en-US",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        get_team = await response.parse()
        assert_matches_type(GetTeamListResponse, get_team, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_list(self, async_client: AsyncLolesportsAPI) -> None:
        async with async_client.get_teams.with_streaming_response.list(
            hl="en-US",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
