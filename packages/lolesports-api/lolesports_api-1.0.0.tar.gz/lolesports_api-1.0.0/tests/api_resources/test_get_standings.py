...
class TestGetStandings:
    ...
    def test_method_retrieve(self, client: LolesportsAPI) -> None:
        get_standing = client.get_standings.retrieve(
            hl="en-US",
        )
        assert_matches_type(GetStandingRetrieveResponse, get_standing, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: LolesportsAPI) -> None:
        response = client.get_standings.with_raw_response.retrieve(
            hl="en-US",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        get_standing = response.parse()
        assert_matches_type(GetStandingRetrieveResponse, get_standing, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve(self, client: LolesportsAPI) -> None:
        with client.get_standings.with_streaming_response.retrieve(
            hl="en-US",
        ) as response:
...
class TestAsyncGetStandings:
    ...
    async def test_method_retrieve(self, async_client: AsyncLolesportsAPI) -> None:
        get_standing = await async_client.get_standings.retrieve(
            hl="en-US",
        )
        assert_matches_type(GetStandingRetrieveResponse, get_standing, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLolesportsAPI) -> None:
        response = await async_client.get_standings.with_raw_response.retrieve(
            hl="en-US",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        get_standing = await response.parse()
        assert_matches_type(GetStandingRetrieveResponse, get_standing, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncLolesportsAPI) -> None:
        async with async_client.get_standings.with_streaming_response.retrieve(
            hl="en-US",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
