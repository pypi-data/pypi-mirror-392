...
class UserTaskHandler(BaseClient):
    ...
    def query(self, request: UserTaskQuery = UserTaskQuery(), options: dict={}) -> List[UserTaskResponse]:
    ...
    def reserve(self, user_task_instance_id: str, request: ReserveUserTaskRequest, options: dict={}) -> bool:
    ...
    def finish(self, user_task_instance_id: str, request: Dict[str, Any], options: dict={}) -> bool:
    ...
    def cancel_reservation(self, user_task_instance_id: str, options: dict={}) -> bool:
