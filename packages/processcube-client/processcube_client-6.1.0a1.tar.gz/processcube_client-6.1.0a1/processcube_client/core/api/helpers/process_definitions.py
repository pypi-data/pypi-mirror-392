...
class ProcessDefinitionHandler(BaseClient):
    ...
    def upload(self, request: ProcessDefinitionUploadPayload, options: dict={}) -> None:
    ...
    def delete(self, process_definition_id: str, delete_all_related_data: bool = False, options: dict={}) -> None:
