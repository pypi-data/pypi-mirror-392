...
class ExternalTaskHandler(BaseClient):
    ...
    def extend_lock(self, external_task_id: str, request: ExtendLockRequest, options: dict={}) -> bool:
    ...
    def finish(self, external_task_id: str, request: FinishExternalTaskRequestPayload, options: dict={}) -> bool:
    ...
    def handle_error(self, external_task_id: str, request: ServiceErrorRequest, options: dict={}) -> bool:
    ...
    def handle_bpmn_error(self, external_task_id: str, request: BpmnErrorRequest, options: dict={}) -> bool:
        return self.handle_error(external_task_id, request, options)

    def handle_service_error(self, external_task_id: str, request: ServiceErrorRequest, options: dict={}) -> bool:
        return self.handle_error(external_task_id, request, options)
