...
class Account(_message.Message):
    __slots__ = ("name", "owner", "number", "ledger_id", "ledger", "display_name", "live_data_retrieved_at", "state", "balances", "signatories")
...
class Signatory(_message.Message):
    __slots__ = ("display_name", "ledger_id")
    DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
    LEDGER_ID_FIELD_NUMBER: _ClassVar[int]
    display_name: str
    ledger_id: str
    def __init__(self, display_name: _Optional[str] = ..., ledger_id: _Optional[str] = ...) -> None: ...
