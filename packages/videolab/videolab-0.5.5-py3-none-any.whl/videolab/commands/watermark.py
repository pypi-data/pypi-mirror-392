...
def _create_watermark_image(
    ...
    font_size = font_size_arg if font_size_arg is not None else max(10, int(frame_height * 0.05))
    ...
    try:
        ...
        logging.warning("Invalid font color format '%s': %s. Using default %s.", font_color_str, e, DEFAULT_COLOR)
