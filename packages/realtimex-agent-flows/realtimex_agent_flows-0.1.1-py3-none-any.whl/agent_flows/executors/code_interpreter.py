...
class CodeInterpreterExecutor(BaseExecutor):
    ...
    async def execute(
        ...
        # Note: consider leveraging stdout/stderr in streaming once downstream consumers or UIs can ingest it.
        # For now, we just return the raw result object as node's output.
