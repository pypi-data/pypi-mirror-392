...
def print_global_help():
    print("""
YOLO4R - Unified Training & Detection Pipeline
==============================================

Available Commands:
  yolo4r train      Train, update, or resume a YOLO4r model.
  yolo4r detect     Run YOLO4r detection on one or more video/camera sources.
