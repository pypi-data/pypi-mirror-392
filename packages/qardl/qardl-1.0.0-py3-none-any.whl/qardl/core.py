...
class QARDLCorrected:
    ...
    Parameters
    ----------
    data : array-like, shape (n, k+1)
        Data matrix where first column is dependent variable and 
        remaining k columns are explanatory variables
    p : int
    ...
    def _compute_correct_standard_errors(
        ...
        # Compute variance: Π(τ) = τ(1-τ) f_τ^{-2} E[H_t H_t']^{-1}
        E_HH = H_t.T @ H_t / n
