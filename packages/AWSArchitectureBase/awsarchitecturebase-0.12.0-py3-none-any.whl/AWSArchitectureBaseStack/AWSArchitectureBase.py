...
from AWSArchitectureBase.AWSArchitectureBaseStack import utils, iam, s3, security_hub
from AWSArchitectureBase.AWSArchitectureBaseStack import ftr_compliance
...
class AWSArchitectureBase(TerraformStack):
    ...
    def __init__(self, scope, id, **kwargs):
        ...
        **FTR Compliance Configuration:**
        ...
        Pass a dictionary with service-specific configurations:
        ...
        # ===== FTR Compliance Configuration =====
        self.ftr_compliance_config = kwargs.get("ftr_compliance_config", {})
    ...
    def get_extra_secret_env(self, env_var_name="SECRET_STRING"):
        ...
        **Environment Variable Format:**
        ...
        """
        extra_secrets = utils.secrets.parse_secrets_from_env(env_var_name)
