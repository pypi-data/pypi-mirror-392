...
def merge_files(parts, output_file):
    ...
    merge_bar = ModernProgressBar(total=total_steps, process_name="Marge", spinner_mode=False, box_left="(", box_right=")")
    merge_bar.start()
...
def main():
    ...
    download_bar_all = ModernProgressBar(total=total_download_steps, process_name="DL All", spinner_mode=False, box_left="(", box_right=")")
    ...
    for i in range(threads):
        ...
        bar = ModernProgressBar(total=part_steps, process_name=f"DL #{i + 1}", spinner_mode=False, box_left="(", box_right=")")
