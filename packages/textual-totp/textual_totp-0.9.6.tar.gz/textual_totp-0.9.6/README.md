...
![ttotp in action](https://codeberg.org/jepler/textual-totp/raw/branch/main/ttotp.png)
...
tested on stable Debian Trixie with Python 3.13.9. Improvements for
compatibility on other platforms, including Python versions as old as 3.10 are
welcome.
