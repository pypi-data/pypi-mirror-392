...
class BaseRequest(abc.ABC):
    ...
    def __init__(self, proxy_url: str, headers: dict = None, cookies: dict = None, exceptions=None) -> None:
        ...
        self.flush_proxy()
        self.data = {}  # 扩展字段
        self.catch_exceptions: list = exceptions if exceptions else []
...
class Request(BaseRequest):
    ...
    def __init__(self, proxy_url: str, headers=None, cookies=None, timeout=6,exceptions=None):
        super().__init__(proxy_url=proxy_url,headers=headers,cookies=cookies,exceptions=exceptions)
        self.req = requests
