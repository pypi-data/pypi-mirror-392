...
class RustInitializer:
    ...
    def _copy_and_update_cargo_toml(
        ...
        if "-" in project_name:
            log_info("Warning: Project name contains hyphens which are not allowed in Rust library names.")
        ...
        updated_content = updated_content.replace('name = "py_wlcommands_native"', f'name = "{lib_name}"')
