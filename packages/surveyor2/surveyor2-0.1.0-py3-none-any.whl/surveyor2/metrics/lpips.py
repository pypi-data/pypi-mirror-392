...
class LPIPS(Metric):
    ...
    higher_is_better = False  # Lower LPIPS scores are better (lower distance = better)
    ...
    def evaluate(
        ...
        return (self.name, score, {"per_frame": per_frame, "paired_frames": n})
