...
class CLIPScore(Metric):
    ...
    higher_is_better = True  # Higher CLIPScore scores are better
    enabled_by_default = False # CLIPScore is a part of VBENCH, so we don't need to enable it by default
    ...
    def init(self, settings: Mapping[str, Any]) -> None:
        self.device = _resolve_device(str(settings.get("device", "auto")))
