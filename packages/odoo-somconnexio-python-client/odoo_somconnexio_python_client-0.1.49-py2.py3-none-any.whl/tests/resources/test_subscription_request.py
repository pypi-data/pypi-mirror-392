...
class SubscriptionRequestTests(unittest.TestCase):
    ...
    @patch("odoo_somconnexio_python_client.resources.subscription_request.Client.post")
    def test_partner_create(self, client_post_mock):
        partner_subscription_request_data = {"customer_ref": "12345"}
        SubscriptionRequest.partner_create(**partner_subscription_request_data)
        client_post_mock.assert_called_with(
            "/subscription-request/partner", partner_subscription_request_data
        )
