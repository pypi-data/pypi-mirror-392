...
The resulting wheel is compatible with Python ≥ 3.8. Remember to sync large reference databases manually—the package ships only orchestration logic and helper scripts.
