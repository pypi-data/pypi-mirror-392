...
class DataAPI:
    ...
    def _prepare_request(
        ...
        req_headers.update(self.config.get_headers())
        ...
        url, req_headers, query = self.auth(url, req_headers, query)
    ...
    async def get_async(
        ...
        return await self._make_request_async("GET", url, headers=headers)
    ...
    async def patch_async(
        ...
        url = self.with_path(path, query=query)
        return await self._make_request_async(
            "PATCH", url, data=data, headers=headers
        )
    ...
    async def delete_async(
        ...
        """
        url = self.with_path(path, query=query)
        return await self._make_request_async("DELETE", url, headers=headers)
