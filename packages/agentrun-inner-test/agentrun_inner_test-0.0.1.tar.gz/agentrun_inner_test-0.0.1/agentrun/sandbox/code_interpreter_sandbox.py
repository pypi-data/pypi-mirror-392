...
class ContextOperations:
    ...
    def execute(
        ...
        if context_id is None and language is None:
            logger.info("context id is not set, use default language: python")
...
class CodeInterpreterSandbox(Sandbox):
    ...
    def __enter__(self):
        ...
        logger.info("Waiting for code interpreter to be ready...")
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        logger.info(f"Stopping code interpreter sandbox {self.sandbox_id}...")
