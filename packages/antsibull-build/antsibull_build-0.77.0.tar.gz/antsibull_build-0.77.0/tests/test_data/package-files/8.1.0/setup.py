...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.ansible.com/projects/ansible/',
        'Mailing lists': 'https://docs.ansible.com/projects/ansible/latest/community/communication.html#mailing-list-information',
