...
- **Include the license** in any distributions
- **Include the copyright notice** in any distributions
- **Obtain a commercial license** for any commercial use

### ❌ You Cannot (Without Commercial License)

- Use for **commercial purposes** (products, services, consulting, SaaS)
- **Re-license** or rebrand under different terms
- Use **Lexsi Labs trademarks** without permission
- **Hold us liable** for any damages or issues
...
To obtain a commercial license, please contact **[support@lexsi.ai](mailto:support@lexsi.ai)**.
...
### NetworkX
- **License**: BSD 3-Clause License
- **Link**: [https://github.com/networkx/networkx](https://github.com/networkx/networkx)
...
See `requirements.txt` for complete list. All dependencies use OSI-approved open-source licenses.

---

## Attribution

While not required by the LSAL, we appreciate:
...
For the complete license text, see the [LICENSE.md](https://github.com/Lexsi-Labs/DLBacktrace/blob/main/LICENSE.md) file in the repository.
