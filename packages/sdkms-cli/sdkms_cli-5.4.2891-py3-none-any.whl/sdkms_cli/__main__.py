...
def token_file():
    return os.getenv("SDKMS_CLI_TOKEN_FILE", TOKEN_FILE)
...
SDKMS_CLI_TOKEN_FILE: The path to the file that contains session tokens, etc.
                    Session tokens are persisted to this file across invocations
                    of this tool. If not specified, the default location {TOKEN_FILE} is used.
