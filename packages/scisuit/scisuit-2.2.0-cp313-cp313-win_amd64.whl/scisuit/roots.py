...
__all__ = ['bisect','itp', 'brentq', 'muller', 'newton', 'ridder', 'fsolve', "toms748"]
...
def bisect(
	...
	return bisect_result(method=method, **dct)
...
def newton(
	...
	return newton_result(method=methodName, **dct )
