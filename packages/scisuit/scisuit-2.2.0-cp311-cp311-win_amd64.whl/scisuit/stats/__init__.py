...
from .anova import anom, anom_result
...
from .basictests import test_variance, testvar_onesample_Result, testvar_twosample_Result
...
from .basictests import grubbs, grubbsResult, dixon_qratio, dixonqratioResult
