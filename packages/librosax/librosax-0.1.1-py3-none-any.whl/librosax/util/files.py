...
from ..version import version as librosax_version
...
__GOODBOY = pooch.create(
    __data_path, base_url="https://librosax.org/data/audio/", registry=None
)
...
def example(key: str, *, hq: bool = False) -> str:
    ...
    For a list of examples (and their keys), see `librosax.util.list_examples`.
...
def list_examples() -> None:
    """List the available audio recordings included with librosax.
