...
def generate_script_lammps_singlepoint(
    ...
    read_restart: str = None,
    pair_style: list[str] = None,
    pair_coeff: list[str] = None,
...
def generate_script_lammps_minimize(
    ...
    dmax: float = 0.01,
    ### control pressure
    press: Union[list[int], float, bool] = [None, None, None],
    mask: list[int] = [1, 1, 1],
    couple: str = "none",
    output_script: str = "cli_script_lammps.lmp",
    **kwargs,
...
def generate_script_lammps_md(
    ...
    ### pressure control
    press: Optional[Union[float, list[float]]] = None,  # can be [None, None, None]
    mask: list[int] = [1, 1, 1],
    couple: str = "none",  # "none", xyz, xy, yz, xz
    pdamp: int = 1000,
    barostat: Literal["nose_hoover_chain"] = "nose_hoover_chain",
    deform_limit: Optional[float] = None,
    output_script: str = "cli_script_lammps.lmp",
    **kwargs,
):
