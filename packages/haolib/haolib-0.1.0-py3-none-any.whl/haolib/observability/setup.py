...
from haolib.observability.logfmt import LogfmtFormatter

HTTPX_EXISTS = importlib.util.find_spec("httpx") is not None
if HTTPX_EXISTS:
...
def setup_httpx(config: ObservabilityConfig) -> None:
    ...
    if HTTPX_EXISTS:
        try:
            ...
            logger.warning("httpx instrumentation is not available, skipping httpx instrumentation")
...
def setup_observability(config: ObservabilityConfig, service_name: str | None = None) -> None:
    """Setup observability."""
