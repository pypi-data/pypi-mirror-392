...
Then [fork the mom1/dddkit repo](https://github.com/mom1/dddkit/fork) (having your own
...
agents because the Makefile will generate `CLAUDE.md` and `AGENTS.md` from the same rules.
