...
class HFPretrainedTokenizer:
    def __init__(self, opt):
        ...
        self.hf_tokenizer = AutoTokenizer.from_pretrained(
            opt.hf_model_name, trust_remote_code=True
        )
        ...
        logging.info(
            f"Special tokens: {self.hf_tokenizer.special_tokens_map},\n"
    ...
    @property
    def null_token(self):
        if self.hf_tokenizer.pad_token is not None:
            return self.hf_tokenizer.pad_token
        elif self.hf_tokenizer.unk_token is not None:
    ...
    def null_token_id(self):
        ...
        elif self.hf_tokenizer.unk_token_id is not None:
