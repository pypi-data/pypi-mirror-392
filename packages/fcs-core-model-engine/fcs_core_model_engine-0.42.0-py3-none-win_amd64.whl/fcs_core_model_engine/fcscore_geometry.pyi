...
class GeometryShapeOperations:
	...
	def make_circle_to_circle_sweep(self, circle1_center_point: XYZ, circle1_radius: float, circle1_normal: XYZ, circle2_center_point: XYZ, circle2_radius: float, circle2_normal: XYZ) -> GEOM_Object:
		...
		"""
		...
	def make_wire_to_wire_sweep(self, wire1: GEOM_Object, wire2: GEOM_Object) -> GEOM_Object:
		"""
		Creates a swept solid by morphing between two arbitrary wire profiles.
		
		:param wire1: First wire profile (must be a TopoDS_Wire)
		:param wire2: Second wire profile (must be a TopoDS_Wire)
		:return: A GEOM_Object representing the swept/morphed solid
		"""
		...
