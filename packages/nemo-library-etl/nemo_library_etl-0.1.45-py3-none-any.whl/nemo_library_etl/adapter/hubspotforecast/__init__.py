"""
HubSpotForecast ETL Adapter Package.

This package provides a complete ETL (Extract, Transform, Load) adapter for 
HubSpotForecast systems. It is built using the Prefect workflow 
orchestration framework and integrates with the Nemo Library ecosystem.

The adapter includes:
- Extract module for data retrieval from HubSpotForecast systems
...
Modules:
    extract: Handles data extraction from HubSpotForecast systems
