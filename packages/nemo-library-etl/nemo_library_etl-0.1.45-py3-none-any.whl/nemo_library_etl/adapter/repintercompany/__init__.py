"""
RepIntercompany ETL Adapter Package.

This package provides a complete ETL (Extract, Transform, Load) adapter for 
RepIntercompany systems. It is built using the Prefect workflow 
orchestration framework and integrates with the Nemo Library ecosystem.

The adapter includes:
- Extract module for data retrieval from RepIntercompany systems
...
Modules:
    extract: Handles data extraction from RepIntercompany systems
