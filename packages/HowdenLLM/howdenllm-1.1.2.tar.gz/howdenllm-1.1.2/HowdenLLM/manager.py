...
class LLMSwitch:
    def __init__(self, LLMs: [LLM]) -> None:
        self.LLMS = LLMs
        #self.name = "hest5" # fucking do not change, you are stupid if you do, internal logic!!!!!!!!!

    def __call__(self, filepath: Path, data_path: Path = None) -> str:
        content = filepath.read_text(encoding="utf-8")
        result = ""
