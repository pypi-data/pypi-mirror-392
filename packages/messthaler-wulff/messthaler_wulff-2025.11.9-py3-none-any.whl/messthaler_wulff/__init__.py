...
def parse_lattice(lattice):
    ...
    transform = eval(f"import numpy as np;from math import *;{lattice}")
...
def main():
    ...
    match args.MODE.lower():
        ...
        case 'interactive':
            mode_interactive.run_mode(goal=int(args.goal), dimension=int(args.dimension), lattice=parse_lattice(args.lattice))
        case _:
