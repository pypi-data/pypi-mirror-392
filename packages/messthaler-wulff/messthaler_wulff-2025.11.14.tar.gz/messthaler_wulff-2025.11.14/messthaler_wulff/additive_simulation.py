...
class OmniSimulation:
    ...
    def visualise_slice(self, atomiser=lambda x, y: (0, x, y), crosshair=False, view_energies=False):
        width, height = shutil.get_terminal_size()
        margin = 3
        fg_red = "\x1b[38;2;200;0;0;1m"
        bg_green = "\x1b[48;2;0;70;0;1m"
        unset = "\x1b[m"
    ...
    def interactive(self, dimension=2):
        z = 0
        view_energies = False
        crosshair = False
        atomiser = None
        ...
        try:
            while True:
                wipe_screen()
                self.visualise_slice(atomiser, crosshair=crosshair, view_energies=view_energies)
...
""")
            ...
            self.interactive(dimension=dimension)
