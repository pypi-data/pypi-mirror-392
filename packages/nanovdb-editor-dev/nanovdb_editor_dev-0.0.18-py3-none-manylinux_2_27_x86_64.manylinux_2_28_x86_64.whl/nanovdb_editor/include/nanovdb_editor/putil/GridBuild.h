...
/*!
    \file   nanovdb_editor/putil/GridBuild.h
...
typedef struct pnanovdb_grid_build_t
{
    ...
    pnanovdb_grid_build_context_t*(PNANOVDB_ABI* create_context)(const pnanovdb_compute_t* compute,
    ...
    void(PNANOVDB_ABI* grid_build_init)(const pnanovdb_compute_t* compute,
                                        pnanovdb_compute_queue_t* queue,
                                        pnanovdb_grid_build_context_t* context,
    ...
    void(PNANOVDB_ABI* grid_build_reset)(const pnanovdb_compute_t* compute,
                                         pnanovdb_compute_queue_t* queue,
                                         pnanovdb_grid_build_context_t* context,
                                         pnanovdb_grid_build_state_t* state,
                                         pnanovdb_compute_buffer_t* nanovdb_out,
    ...
    void(PNANOVDB_ABI* grid_build_destroy)(const pnanovdb_compute_t* compute,
                                           pnanovdb_compute_queue_t* queue,
                                           pnanovdb_grid_build_state_t* state);

    void(PNANOVDB_ABI* grid_build)(const pnanovdb_compute_t* compute,
                                   pnanovdb_compute_queue_t* queue,
                                   pnanovdb_grid_build_context_t* context,
                                   pnanovdb_grid_build_state_t* state,
    ...
    void(PNANOVDB_ABI* grid_build_finalize)(const pnanovdb_compute_t* compute,
                                            pnanovdb_compute_queue_t* queue,
                                            pnanovdb_grid_build_context_t* context,
                                            pnanovdb_grid_build_state_t* state,
                                            pnanovdb_compute_buffer_t* point_ijk_in,
    ...
    void(PNANOVDB_ABI* fanout_state_reset)(const pnanovdb_compute_t* compute,
                                           pnanovdb_compute_queue_t* queue,
                                           pnanovdb_grid_build_context_t* context,
                                           pnanovdb_grid_build_fanout_state_t* state);

    pnanovdb_bool_t(PNANOVDB_ABI* fanout_state_valid)(const pnanovdb_compute_t* compute,
                                                      pnanovdb_compute_queue_t* queue,
                                                      pnanovdb_grid_build_context_t* context,
                                                      pnanovdb_grid_build_fanout_state_t* state);

    void(PNANOVDB_ABI* fanout_state_increment)(const pnanovdb_compute_t* compute,
                                               pnanovdb_compute_queue_t* queue,
                                               pnanovdb_grid_build_context_t* context,
                                               pnanovdb_grid_build_fanout_state_t* state);

    void(PNANOVDB_ABI* fanout_state_init)(const pnanovdb_compute_t* compute,
                                          pnanovdb_compute_queue_t* queue,
                                          pnanovdb_grid_build_context_t* context,
                                          pnanovdb_grid_build_fanout_state_t* state,
                                          pnanovdb_uint32_t prim_batch_size,
    ...
    void(PNANOVDB_ABI* fanout_state_destroy)(const pnanovdb_compute_t* compute,
                                             pnanovdb_compute_queue_t* queue,
                                             pnanovdb_grid_build_fanout_state_t* state);

    void(PNANOVDB_ABI* fanout)(const pnanovdb_compute_t* compute,
                               pnanovdb_compute_queue_t* queue,
                               pnanovdb_grid_build_context_t* context,
                               pnanovdb_grid_build_fanout_state_t* state,
                               pnanovdb_uint32_t dispatch_count);
...
static void pnanovdb_grid_build_load(pnanovdb_grid_build_t* grid_build, const pnanovdb_compute_t* compute)
{
    auto get_grid_build =
        (PFN_pnanovdb_get_grid_build)pnanovdb_get_proc_address(compute->module, "pnanovdb_get_grid_build");
    if (!get_grid_build)
    {
