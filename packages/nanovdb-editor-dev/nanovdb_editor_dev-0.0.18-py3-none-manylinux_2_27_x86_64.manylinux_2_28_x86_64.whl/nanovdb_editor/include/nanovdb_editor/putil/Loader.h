...
#if defined(_WIN32)
#    include <Windows.h>
static inline void* pnanovdb_load_library(const char* winName, const char* linuxName, const char* macName)
{
    return (void*)LoadLibraryA(winName);
}
static inline void* pnanovdb_get_proc_address(void* module, const char* name)
{
    return GetProcAddress((HMODULE)module, name);
}
static inline void pnanovdb_free_library(void* module)
{
    FreeLibrary((HMODULE)module);
}
static inline const char* pnanovdb_load_library_error()
{
