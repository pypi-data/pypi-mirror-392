...
/*!
    \file   nanovdb_editor/putil/ParallelPrimitives.h
...
typedef struct pnanovdb_parallel_primitives_t
{
    ...
    pnanovdb_parallel_primitives_context_t*(PNANOVDB_ABI* create_context)(const pnanovdb_compute_t* compute,
    ...
    void(PNANOVDB_ABI* global_scan)(const pnanovdb_compute_t* compute,
                                    pnanovdb_compute_queue_t* queue,
                                    pnanovdb_parallel_primitives_context_t* context,
    ...
    void(PNANOVDB_ABI* global_scan_uint64)(const pnanovdb_compute_t* compute,
                                           pnanovdb_compute_queue_t* queue,
                                           pnanovdb_parallel_primitives_context_t* context,
                                           pnanovdb_compute_buffer_t* val_in,
                                           pnanovdb_compute_buffer_t* val_out,
    ...
    void(PNANOVDB_ABI* global_scan_max)(const pnanovdb_compute_t* compute,
                                        pnanovdb_compute_queue_t* queue,
                                        pnanovdb_parallel_primitives_context_t* context,
                                        pnanovdb_compute_buffer_t* val_in,
                                        pnanovdb_compute_buffer_t* val_out,
    ...
    void(PNANOVDB_ABI* radix_sort)(const pnanovdb_compute_t* compute,
                                   pnanovdb_compute_queue_t* queue,
...
static void pnanovdb_parallel_primitives_load(pnanovdb_parallel_primitives_t* parallel_primitives,
                                              const pnanovdb_compute_t* compute)
{
    auto get_parallel_primitives = (PFN_pnanovdb_get_parallel_primitives)pnanovdb_get_proc_address(
        compute->module, "pnanovdb_get_parallel_primitives");
