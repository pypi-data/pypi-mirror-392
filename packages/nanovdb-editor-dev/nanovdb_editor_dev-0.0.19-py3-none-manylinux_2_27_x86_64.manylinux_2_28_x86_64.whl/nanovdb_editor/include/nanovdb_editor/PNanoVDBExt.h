...
/*!
    \file   nanovdb_editor/PNanoVDBExt.h
...
#ifndef NANOVDB_PNANOVDBEXT_H_HAS_BEEN_INCLUDED
#define NANOVDB_PNANOVDBEXT_H_HAS_BEEN_INCLUDED

#if defined(PNANOVDB_C)
#    include <nanovdb/PNanoVDB.h>
#endif

// Add grid type enum, extends PNanoVDB.h
...
{
    pnanovdb_uint32_t node_n = (((ijk.x & pnanovdb_node2_ijk_mask[node_type]) >> pnanovdb_node2_tiledim_bits[node_type])
                                << pnanovdb_node2_fanout_bits2[node_type]) |
                               (((ijk.y & pnanovdb_node2_ijk_mask[node_type]) >> pnanovdb_node2_tiledim_bits[node_type])
                                << pnanovdb_node2_fanout_bits[node_type]) |
                               ((ijk.z & pnanovdb_node2_ijk_mask[node_type]) >> pnanovdb_node2_tiledim_bits[node_type]);
    return node_n;
}

PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_node2_adaptive_n(pnanovdb_buf_t buf,
                                                                  ...
                                                                  PNANOVDB_INOUT(pnanovdb_uint32_t) out_level)
{
    ...
    pnanovdb_uint32_t level_idx = ((node_n & pnanovdb_node2_level_mask_i[node_type]) >> 3) |
                                  ((node_n & pnanovdb_node2_level_mask_j[node_type]) >> 2) |
                                  ((node_n & pnanovdb_node2_level_mask_k[node_type]) >> 1);
    // fetch 4-bit level
    pnanovdb_uint32_t level =
        pnanovdb_uint32_t(pnanovdb_node2_read(buf, node.idx64 + pnanovdb_node2_off_value_level + (level_idx >> 4u)) >>
                          ((level_idx << 2u) & 63u)) &
        15;
...
PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_node2_mask_n_to_idx(pnanovdb_buf_t buf,
                                                                     pnanovdb_uint32_t prefix_sum_idx64,
                                                                     pnanovdb_uint32_t node_type,
                                                                     pnanovdb_uint32_t node_n,
                                                                     PNANOVDB_INOUT(pnanovdb_bool_t) out_is_active)
{
    pnanovdb_uint64_t mask =
        pnanovdb_node2_read(buf, prefix_sum_idx64 + pnanovdb_node2_prefix_sum_off_mask[node_type] + (node_n >> 6u));
    pnanovdb_uint32_t prefix_sum =
        pnanovdb_uint32_t(pnanovdb_node2_read(buf, prefix_sum_idx64 + (node_n >> 8u)) >> ((node_n >> 2u) & 0x30)) &
        0xFFFF;
...
PNANOVDB_FORCE_INLINE pnanovdb_int32_t pnanovdb_node2_find_n_offset_to_key(pnanovdb_buf_t buf,
                                                                           pnanovdb_node2_handle_t node,
                                                                           pnanovdb_uint32_t node_type,
                                                                           pnanovdb_uint32_t n_off,
                                                                           pnanovdb_uint32_t node_n,
                                                                           pnanovdb_coord_t ijk)
{
    ...
    if (node_type == PNANOVDB_NODE2_TYPE_ROOT)
    {
        ...
        pnanovdb_uint64_t key = pnanovdb_uint64_t(pnanovdb_uint32_t(ijk.z) >> 12) |
                                (pnanovdb_uint64_t(pnanovdb_uint32_t(ijk.y) >> 12) << 21) |
                                (pnanovdb_uint64_t(pnanovdb_uint32_t(ijk.x) >> 12) << 42);
        pnanovdb_uint32_t child_count = pnanovdb_uint32_t(pnanovdb_node2_read(
                                            buf, node.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[node_type])) &
                                        0xFFFF;
        for (; n_off < 32768u; n_off++)
        {
            pnanovdb_uint32_t cmp_n = (node_n + n_off) & (32767u);
            pnanovdb_bool_t key_active;
            pnanovdb_uint32_t key_idx =
                pnanovdb_node2_mask_n_to_idx(buf, node.idx64 + pnanovdb_node2_off_key_mask_prefix_sum[node_type],
                                             node_type, cmp_n, PNANOVDB_REF(key_active));
            if (key_active)
            {
                pnanovdb_uint64_t cmp_key = pnanovdb_node2_read(
                    buf, node.idx64 + pnanovdb_node2_off_children[node_type] + child_count + key_idx);
...
PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_node2_coord_to_n_keyed(pnanovdb_buf_t buf,
                                                                        pnanovdb_node2_handle_t node,
                                                                        pnanovdb_uint32_t node_type,
                                                                        pnanovdb_coord_t ijk)
{
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_find_node_pass(pnanovdb_buf_t buf,
                                                         pnanovdb_node2_handle_t node,
                                                         ...
                                                         pnanovdb_coord_t ijk)
{
    ...
    for (; node_type < 4u; node_type++)
    {
        ...
        if (node_type == PNANOVDB_NODE2_TYPE_ROOT)
        {
            ...
            pnanovdb_uint32_t key_idx =
                pnanovdb_node2_mask_n_to_idx(buf, node.idx64 + pnanovdb_node2_off_key_mask_prefix_sum[node_type],
                                             node_type, node_n, PNANOVDB_REF(key_active));
            pnanovdb_uint64_t cmp_key =
                pnanovdb_node2_read(buf, node.idx64 + pnanovdb_node2_off_children[node_type] + child_count + key_idx);
            PNANOVDB_DEREF(key_is_match) =
                !key_active || (key_active && (key == cmp_key || pnanovdb_node2_end_key == cmp_key));
        }
        ...
        pnanovdb_uint32_t child_idx =
            pnanovdb_node2_mask_n_to_idx(buf, node.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[node_type],
                                         node_type, node_n, PNANOVDB_REF(is_active));
        pnanovdb_uint32_t child = 0u;
        if (is_active)
        {
            child = pnanovdb_uint32_t(
                pnanovdb_node2_read(buf, node.idx64 + pnanovdb_node2_off_children[node_type] + child_idx) >> 3u);
        }
        if (child == 0u)
        {
            break;
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_find_node(pnanovdb_buf_t buf,
                                                    ...
                                                    pnanovdb_coord_t ijk)
{
    ...
    pnanovdb_node2_find_node_pass(
        buf, root, 0, out_node, out_node_type, out_node_n, out_level, PNANOVDB_REF(key_is_match), ijk);
    if (!key_is_match)
    {
        ...
        pnanovdb_int32_t n_off =
            pnanovdb_node2_find_n_offset_to_key(buf, root, PNANOVDB_NODE2_TYPE_ROOT, 1u, node_n, ijk);
        pnanovdb_node2_find_node_pass(
            buf, root, n_off, out_node, out_node_type, out_node_n, out_level, PNANOVDB_REF(key_is_match), ijk);
    }
}

PNANOVDB_FORCE_INLINE pnanovdb_uint64_t pnanovdb_node2_get_value_index(pnanovdb_buf_t buf,
                                                                       pnanovdb_node2_handle_t node,
                                                                       pnanovdb_uint32_t node_type,
                                                                       pnanovdb_uint32_t node_n,
                                                                       ...
                                                                       pnanovdb_address_t inactive_value_idxs)
{
    ...
    pnanovdb_bool_t is_active;
    pnanovdb_uint32_t local_value_idx =
        pnanovdb_node2_mask_n_to_idx(buf, node.idx64 + pnanovdb_node2_off_value_mask_prefix_sum[node_type], node_type,
                                     node_n, PNANOVDB_REF(is_active));
    ...
    else if (is_levelset)
    {
        ...
        pnanovdb_uint64_t inactive_idx =
            pnanovdb_read_uint64(buf, pnanovdb_address_offset64_product(node_inactive_idxs, node_idx, 8u));
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_accessor_init(PNANOVDB_INOUT(pnanovdb_node2_accessor_t) acc,
                                                        pnanovdb_node2_handle_t root)
{
...
PNANOVDB_FORCE_INLINE void pnanovdb_accessor_node2_find_node_pass(pnanovdb_buf_t buf,
...
PNANOVDB_FORCE_INLINE void pnanovdb_accessor_node2_find_node(pnanovdb_buf_t buf,
                                                             PNANOVDB_INOUT(pnanovdb_node2_accessor_t) acc,
                                                             pnanovdb_node2_handle_t node,
                                                             pnanovdb_uint32_t node_type,
                                                             pnanovdb_coord_t ijk)
{
    ...
    {
        pnanovdb_uint32_t node_n = pnanovdb_node2_coord_to_n(PNANOVDB_NODE2_TYPE_ROOT, ijk);
        node_n = pnanovdb_node2_adaptive_n(
            buf, PNANOVDB_DEREF(acc).root, PNANOVDB_NODE2_TYPE_ROOT, node_n, PNANOVDB_REF(PNANOVDB_DEREF(acc).level));
        pnanovdb_int32_t n_off = pnanovdb_node2_find_n_offset_to_key(
            buf, PNANOVDB_DEREF(acc).root, PNANOVDB_NODE2_TYPE_ROOT, 1u, node_n, ijk);
        pnanovdb_accessor_node2_find_node_pass(buf, acc, node, node_type, n_off, PNANOVDB_REF(key_is_match), ijk);
    }
}

PNANOVDB_FORCE_INLINE void pnanovdb_node2_accessor_find_node(pnanovdb_buf_t buf,
                                                             PNANOVDB_INOUT(pnanovdb_node2_accessor_t) acc,
                                                             PNANOVDB_INOUT(pnanovdb_node2_handle_t) out_node,
                                                             PNANOVDB_INOUT(pnanovdb_uint32_t) out_node_type,
                                                             PNANOVDB_INOUT(pnanovdb_uint32_t) out_node_n,
                                                             ...
                                                             pnanovdb_coord_t ijk)
{
    pnanovdb_int32_t dirty =
        (ijk.x ^ PNANOVDB_DEREF(acc).key.x) | (ijk.y ^ PNANOVDB_DEREF(acc).key.y) | (ijk.z ^ PNANOVDB_DEREF(acc).key.z);
...
PNANOVDB_FORCE_INLINE pnanovdb_bool_t pnanovdb_node2_get_child_mask_bit(pnanovdb_buf_t buf,
                                                                        pnanovdb_node2_handle_t node,
                                                                        pnanovdb_uint32_t node_type,
                                                                        pnanovdb_uint32_t node_n)
{
    pnanovdb_uint64_t mask =
        pnanovdb_node2_read(buf, node.idx64 + pnanovdb_node2_off_child_mask[node_type] + (node_n >> 6u));
    pnanovdb_uint64_t cmp_mask = 1llu << (node_n & 63u);
    return (mask & cmp_mask) != 0llu;
}

PNANOVDB_FORCE_INLINE pnanovdb_node2_handle_t pnanovdb_node2_get_child(pnanovdb_buf_t buf,
                                                                       pnanovdb_node2_handle_t node,
                                                                       pnanovdb_uint32_t node_type,
                                                                       pnanovdb_uint32_t node_n)
{
    pnanovdb_bool_t is_active;
    pnanovdb_uint32_t child_idx =
        pnanovdb_node2_mask_n_to_idx(buf, node.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[node_type], node_type,
                                     node_n, PNANOVDB_REF(is_active));
    pnanovdb_uint32_t child = 0u;
    if (is_active)
    {
...
PNANOVDB_FORCE_INLINE pnanovdb_uint64_t pnanovdb_node2_get_key(pnanovdb_buf_t buf,
                                                               pnanovdb_node2_handle_t node,
                                                               pnanovdb_uint32_t node_type,
                                                               pnanovdb_uint32_t node_n)
{
    ...
    if (node_type == PNANOVDB_NODE2_TYPE_ROOT)
    {
        pnanovdb_bool_t key_active;
        pnanovdb_uint32_t key_idx =
            pnanovdb_node2_mask_n_to_idx(buf, node.idx64 + pnanovdb_node2_off_key_mask_prefix_sum[node_type], node_type,
                                         node_n, PNANOVDB_REF(key_active));
        if (key_active)
        {
            pnanovdb_uint32_t child_count = pnanovdb_uint32_t(pnanovdb_node2_read(
                                                buf, node.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[node_type])) &
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_set_child(pnanovdb_buf_t buf,
                                                    pnanovdb_node2_handle_t node,
                                                    pnanovdb_uint32_t node_type,
                                                    pnanovdb_uint32_t node_n,
                                                    pnanovdb_node2_handle_t child_node)
{
    pnanovdb_bool_t is_active;
    pnanovdb_uint32_t child_idx =
        pnanovdb_node2_mask_n_to_idx(buf, node.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[node_type], node_type,
    ...
    if (is_active)
    {
        pnanovdb_node2_write(buf, node.idx64 + pnanovdb_node2_off_children[node_type] + child_idx,
                             pnanovdb_uint64_t(child_node.idx64 - node.idx64) << 3u);
    }
}

PNANOVDB_FORCE_INLINE pnanovdb_bool_t pnanovdb_node2_get_value_mask_bit(pnanovdb_buf_t buf,
                                                                        pnanovdb_node2_handle_t node,
                                                                        pnanovdb_uint32_t node_type,
                                                                        pnanovdb_uint32_t node_n)
{
    pnanovdb_uint64_t mask =
        pnanovdb_node2_read(buf, node.idx64 + pnanovdb_node2_off_value_mask[node_type] + (node_n >> 6u));
    pnanovdb_uint64_t cmp_mask = 1llu << (node_n & 63u);
    return (mask & cmp_mask) != 0llu;
}
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_key_range_accum(PNANOVDB_INOUT(pnanovdb_uint64_t) key_min,
                                                          PNANOVDB_INOUT(pnanovdb_uint64_t) key_max,
                                                          pnanovdb_uint64_t key)
{
    ...
    PNANOVDB_DEREF(key_min) = pnanovdb_uint64_t(pnanovdb_uint32_t(kmin.z) >> 12) |
                              (pnanovdb_uint64_t(pnanovdb_uint32_t(kmin.y) >> 12) << 21) |
                              (pnanovdb_uint64_t(pnanovdb_uint32_t(kmin.x) >> 12) << 42);
    PNANOVDB_DEREF(key_max) = pnanovdb_uint64_t(pnanovdb_uint32_t(kmax.z) >> 12) |
...
PNANOVDB_FORCE_INLINE float pnanovdb_node2_read_float_index(pnanovdb_buf_t buf,
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_write_float_index(pnanovdb_buf_t buf,
                                                            pnanovdb_address_t addr,
                                                            pnanovdb_uint64_t index,
                                                            float val)
{
...
PNANOVDB_FORCE_INLINE pnanovdb_coord_t pnanovdb_node2_upper_coord_to_lower_coord(pnanovdb_coord_t upper_ijk,
                                                                                 pnanovdb_uint32_t upper_n)
{
    pnanovdb_coord_t lower_ijk = { upper_ijk.x + (((pnanovdb_uint32_as_int32(upper_n) >> 10) & 31) << 7),
                                   upper_ijk.y + (((pnanovdb_uint32_as_int32(upper_n) >> 5) & 31) << 7),
                                   upper_ijk.z + (((pnanovdb_uint32_as_int32(upper_n)) & 31) << 7) };
    return lower_ijk;
}

PNANOVDB_FORCE_INLINE pnanovdb_coord_t pnanovdb_node2_lower_coord_to_leaf_coord(pnanovdb_coord_t lower_ijk,
                                                                                pnanovdb_uint32_t lower_n)
{
    pnanovdb_coord_t leaf_ijk = { lower_ijk.x + (((pnanovdb_uint32_as_int32(lower_n) >> 8) & 15) << 3),
                                  lower_ijk.y + (((pnanovdb_uint32_as_int32(lower_n) >> 4) & 15) << 3),
                                  lower_ijk.z + (((pnanovdb_uint32_as_int32(lower_n)) & 15) << 3) };
    return leaf_ijk;
}

PNANOVDB_FORCE_INLINE void pnanovdb_node2_compute_mask_prefix_sum(pnanovdb_buf_t buf,
                                                                  pnanovdb_uint32_t mask_idx64,
                                                                  pnanovdb_uint32_t node_type)
{
    ...
    for (pnanovdb_uint32_t mask_idx = 0u; mask_idx < mask_word_count; mask_idx++)
    {
        ...
        pnanovdb_uint64_t value_mask =
            pnanovdb_node2_read(buf, mask_idx64 + pnanovdb_node2_prefix_sum_off_mask[node_type] + mask_idx);

        value_mask_sum += pnanovdb_uint64_countbits(value_mask);

        pnanovdb_uint64_t value_mask_prefix_sum = pnanovdb_node2_read(buf, mask_idx64 + (word_idx >> 2u));
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_compute_prefix_sums(pnanovdb_buf_t dst_buf,
                                                              pnanovdb_node2_handle_t dst_node,
                                                              pnanovdb_uint32_t node_type)
{
    pnanovdb_node2_compute_mask_prefix_sum(
        dst_buf, dst_node.idx64 + pnanovdb_node2_off_value_mask_prefix_sum[node_type], node_type);
    if (node_type != PNANOVDB_NODE2_TYPE_LEAF)
    {
        pnanovdb_node2_compute_mask_prefix_sum(
            dst_buf, dst_node.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[node_type], node_type);
    }
    if (node_type == PNANOVDB_NODE2_TYPE_ROOT)
    {
        pnanovdb_node2_compute_mask_prefix_sum(
            dst_buf, dst_node.idx64 + pnanovdb_node2_off_key_mask_prefix_sum[node_type], node_type);
    }
}

PNANOVDB_FORCE_INLINE void pnanovdb_node2_memcpy(pnanovdb_buf_t dst_buf,
                                                 pnanovdb_address_t dst_addr,
                                                 pnanovdb_buf_t src_buf,
                                                 pnanovdb_address_t src_addr,
...
PNANOVDB_FORCE_INLINE void pnanovdb_convert_to_node2_value_copy(pnanovdb_buf_t buf,
                                                                pnanovdb_node2_handle_t node,
                                                                pnanovdb_uint32_t node_type,
                                                                ...
                                                                pnanovdb_root_handle_t src_root)
{
    ...
    for (pnanovdb_uint32_t dense_n_l = 0u; dense_n_l < dst_node_fanout; dense_n_l++)
    {
        ...
        if (!has_child)
        {
            ...
            else
            {
                ...
                ijk = { base_ijk.x +
                            pnanovdb_uint32_as_int32(
                                ((node_n >> (fanout_bits + fanout_bits)) & ((1u << fanout_bits) - 1u)) << tiledim_bits),
                        base_ijk.y + pnanovdb_uint32_as_int32(((node_n >> fanout_bits) & ((1u << fanout_bits) - 1u))
                                                              << tiledim_bits),
                        base_ijk.z + pnanovdb_uint32_as_int32((node_n & ((1u << fanout_bits) - 1u)) << tiledim_bits) };
            }

            pnanovdb_address_t val_addr =
                pnanovdb_root_get_value_address(src_grid_type, src_buf, src_root, PNANOVDB_REF(ijk));
            if (node_type == PNANOVDB_NODE2_TYPE_ROOT)
            {
                pnanovdb_uint64_t key = pnanovdb_node2_get_key(buf, node, node_type, node_n);
            ...
            pnanovdb_bool_t is_active;
            pnanovdb_uint32_t node_value_idx =
                pnanovdb_node2_mask_n_to_idx(buf, node.idx64 + pnanovdb_node2_off_value_mask_prefix_sum[node_type],
                                             node_type, node_n, PNANOVDB_REF(is_active));
...
PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_node2_compute_values_word_count(pnanovdb_buf_t buf,
                                                                                 pnanovdb_node2_handle_t node,
                                                                                 pnanovdb_uint32_t node_type)
{
    pnanovdb_uint32_t size = 0u;
    pnanovdb_uint32_t active_count =
        pnanovdb_uint32_t(pnanovdb_node2_read(buf, node.idx64 + pnanovdb_node2_off_value_mask_prefix_sum[node_type])) &
        0xFFFF;
    size += active_count;
    return size;
}

PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_node2_compute_inactive_word_count(pnanovdb_buf_t buf,
                                                                                   pnanovdb_node2_handle_t node,
                                                                                   pnanovdb_uint32_t node_type)
{
    pnanovdb_uint32_t size = 0u;
...
PNANOVDB_FORCE_INLINE void pnanovdb_convert_to_node2(pnanovdb_buf_t dst_buf,
                                                     ...
                                                     pnanovdb_grid_handle_t grid)
{
    ...
    {
        pnanovdb_node2_write(dst_buf, dst_root.idx64 + pnanovdb_node2_off_children[PNANOVDB_NODE2_TYPE_ROOT] + root_n,
                             pnanovdb_node2_end_key);
    }
    // set masks and keys
    ...
    for (pnanovdb_uint32_t tile_idx = 0u; tile_idx < tile_count; tile_idx++)
    {
        ...
        if (state != 0u && pnanovdb_int64_is_zero(child))
        {
            ...
            pnanovdb_uint64_t mask_val = pnanovdb_node2_read(
                dst_buf, dst_root.idx64 + pnanovdb_node2_off_value_mask[PNANOVDB_NODE2_TYPE_ROOT] + word_idx);
            mask_val = mask_val | pnanovdb_uint64_bit_mask(root_n & 63u);
            pnanovdb_node2_write(
                dst_buf, dst_root.idx64 + pnanovdb_node2_off_value_mask[PNANOVDB_NODE2_TYPE_ROOT] + word_idx, mask_val);
        }
        pnanovdb_bool_t is_new_child = PNANOVDB_FALSE;
        if (!pnanovdb_int64_is_zero(child))
        {
            pnanovdb_uint32_t word_idx = root_n >> 6u;
            pnanovdb_uint64_t mask_val_old = pnanovdb_node2_read(
                dst_buf, dst_root.idx64 + pnanovdb_node2_off_child_mask[PNANOVDB_NODE2_TYPE_ROOT] + word_idx);
            pnanovdb_uint64_t mask_val = mask_val_old | pnanovdb_uint64_bit_mask(root_n & 63u);
            pnanovdb_node2_write(
                dst_buf, dst_root.idx64 + pnanovdb_node2_off_child_mask[PNANOVDB_NODE2_TYPE_ROOT] + word_idx, mask_val);
        ...
        // pnanovdb_bool_t is_key_child = PNANOVDB_FALSE;
        {
            pnanovdb_uint32_t word_idx = root_n >> 6u;
            pnanovdb_uint64_t mask_val_old = pnanovdb_node2_read(
                dst_buf, dst_root.idx64 + pnanovdb_node2_off_key_mask[PNANOVDB_NODE2_TYPE_ROOT] + word_idx);
            pnanovdb_uint64_t mask_val = mask_val_old | pnanovdb_uint64_bit_mask(root_n & 63u);
            pnanovdb_node2_write(
                dst_buf, dst_root.idx64 + pnanovdb_node2_off_key_mask[PNANOVDB_NODE2_TYPE_ROOT] + word_idx, mask_val);
        ...
        pnanovdb_node2_mask_n_to_idx(dst_buf,
                                     dst_root.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[PNANOVDB_NODE2_TYPE_ROOT],
                                     PNANOVDB_NODE2_TYPE_ROOT, root_n, PNANOVDB_REF(child_active));
        pnanovdb_bool_t key_active;
        pnanovdb_uint32_t key_idx = pnanovdb_node2_mask_n_to_idx(
            dst_buf, dst_root.idx64 + pnanovdb_node2_off_key_mask_prefix_sum[PNANOVDB_NODE2_TYPE_ROOT],
            PNANOVDB_NODE2_TYPE_ROOT, root_n, PNANOVDB_REF(key_active));

        pnanovdb_uint32_t child_count =
            pnanovdb_uint32_t(pnanovdb_node2_read(
                dst_buf, dst_root.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[PNANOVDB_NODE2_TYPE_ROOT])) &
            0xFFFF;
        ...
        for (pnanovdb_uint32_t idx = key_count - 1u; idx < key_count; idx--)
        {
            ...
            pnanovdb_uint64_t key_tmp =
                pnanovdb_node2_read(dst_buf, dst_root.idx64 + pnanovdb_node2_off_children[PNANOVDB_NODE2_TYPE_ROOT] +
                                                 child_count_old + src_idx);
            if (key_active && idx == key_idx)
            {
                key_tmp = key;
            }
            pnanovdb_node2_write(
                dst_buf, dst_root.idx64 + pnanovdb_node2_off_children[PNANOVDB_NODE2_TYPE_ROOT] + child_count + idx,
                key_tmp);
        }
        for (pnanovdb_uint32_t idx = 0u; idx < child_count; idx++)
        {
            pnanovdb_node2_write(
                dst_buf, dst_root.idx64 + pnanovdb_node2_off_children[PNANOVDB_NODE2_TYPE_ROOT] + idx, 0llu);
        }
        if (tile_idx == 0u)
        {
    ...
    pnanovdb_uint32_t key_count =
        pnanovdb_uint32_t(pnanovdb_node2_read(
            dst_buf, dst_root.idx64 + pnanovdb_node2_off_key_mask_prefix_sum[PNANOVDB_NODE2_TYPE_ROOT])) &
        0xFFFF;
    pnanovdb_uint32_t root_excess =
        32u * ((2u * pnanovdb_node2_fanout_1d[PNANOVDB_NODE2_TYPE_ROOT] - child_count - key_count) / 4u);
    ...
    for (pnanovdb_uint32_t tile_idx = 0u; tile_idx < tile_count; tile_idx++)
    {
        ...
        if (pnanovdb_root_tile_get_child_mask(buf, root_tile))
        {
            ...
            {
                pnanovdb_uint64_t child_mask = pnanovdb_read_uint64(
                    buf, pnanovdb_address_offset(upper.address, PNANOVDB_UPPER_OFF_CHILD_MASK + 8u * word_idx));
                pnanovdb_uint64_t value_mask = pnanovdb_read_uint64(
                    buf, pnanovdb_address_offset(upper.address, PNANOVDB_UPPER_OFF_VALUE_MASK + 8u * word_idx));
                value_mask = value_mask & ~child_mask;
                pnanovdb_node2_write(
                    dst_buf, dst_upper.idx64 + pnanovdb_node2_off_child_mask[PNANOVDB_NODE2_TYPE_UPPER] + word_idx,
                    child_mask);
                pnanovdb_node2_write(
                    dst_buf, dst_upper.idx64 + pnanovdb_node2_off_value_mask[PNANOVDB_NODE2_TYPE_UPPER] + word_idx,
                    value_mask);
            }
            ...
            // return unused memory
            pnanovdb_uint32_t upper_child_count =
                pnanovdb_uint32_t(pnanovdb_node2_read(
                    dst_buf, dst_upper.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[PNANOVDB_NODE2_TYPE_UPPER])) &
                0xFFFF;
            pnanovdb_uint32_t upper_excess =
                32u * ((pnanovdb_node2_fanout_1d[PNANOVDB_NODE2_TYPE_UPPER] - upper_child_count) / 4u);
    ...
    for (pnanovdb_uint32_t tile_idx = 0u; tile_idx < tile_count; tile_idx++)
    {
        ...
        if (pnanovdb_root_tile_get_child_mask(buf, root_tile))
        {
            ...
            pnanovdb_coord_t ijk = pnanovdb_node2_key_to_coord(pnanovdb_root_tile_get_key(buf, root_tile));
            pnanovdb_uint32_t root_n = pnanovdb_node2_coord_to_n_keyed(dst_buf, dst_root, PNANOVDB_NODE2_TYPE_ROOT, ijk);
            pnanovdb_node2_handle_t dst_upper =
                pnanovdb_node2_get_child(dst_buf, dst_root, PNANOVDB_NODE2_TYPE_ROOT, root_n);
            ...
            for (pnanovdb_uint32_t upper_n = 0u; upper_n < PNANOVDB_UPPER_TABLE_COUNT; upper_n++)
            {
                if (pnanovdb_upper_get_child_mask(buf, upper, upper_n))
                {
                    ...
                    {
                        pnanovdb_uint64_t child_mask = pnanovdb_read_uint64(
                            buf, pnanovdb_address_offset(lower.address, PNANOVDB_LOWER_OFF_CHILD_MASK + 8u * word_idx));
                        pnanovdb_uint64_t value_mask = pnanovdb_read_uint64(
                            buf, pnanovdb_address_offset(lower.address, PNANOVDB_LOWER_OFF_VALUE_MASK + 8u * word_idx));
                        value_mask = value_mask & ~child_mask;
                        pnanovdb_node2_write(
                            dst_buf,
                            dst_lower.idx64 + pnanovdb_node2_off_child_mask[PNANOVDB_NODE2_TYPE_LOWER] + word_idx,
                            child_mask);
                        pnanovdb_node2_write(
                            dst_buf,
                            dst_lower.idx64 + pnanovdb_node2_off_value_mask[PNANOVDB_NODE2_TYPE_LOWER] + word_idx,
                            value_mask);
                    }
                    pnanovdb_node2_compute_prefix_sums(dst_buf, dst_lower, PNANOVDB_NODE2_TYPE_LOWER);

                    // return unused memory
                    pnanovdb_uint32_t lower_child_count =
                        pnanovdb_uint32_t(pnanovdb_node2_read(
                            dst_buf,
                            dst_lower.idx64 + pnanovdb_node2_off_child_mask_prefix_sum[PNANOVDB_NODE2_TYPE_LOWER])) &
                        0xFFFF;
                    pnanovdb_uint32_t lower_excess =
                        32u * ((pnanovdb_node2_fanout_1d[PNANOVDB_NODE2_TYPE_LOWER] - lower_child_count) / 4u);
        ...
        if (pnanovdb_root_tile_get_child_mask(buf, root_tile))
        {
            ...
            for (pnanovdb_uint32_t upper_n = 0u; upper_n < PNANOVDB_UPPER_TABLE_COUNT; upper_n++)
            {
                if (pnanovdb_upper_get_child_mask(buf, upper, upper_n))
                {
                    pnanovdb_lower_handle_t lower = pnanovdb_upper_get_child(grid_type, buf, upper, upper_n);
                    // get dst_lower
                    pnanovdb_node2_handle_t dst_lower =
                        pnanovdb_node2_get_child(dst_buf, dst_upper, PNANOVDB_NODE2_TYPE_UPPER, upper_n);
                    ...
                    for (pnanovdb_uint32_t lower_n = 0u; lower_n < PNANOVDB_LOWER_TABLE_COUNT; lower_n++)
                    {
                        if (pnanovdb_lower_get_child_mask(buf, lower, lower_n))
                        {
                            ...
                            // copy value masks
                            pnanovdb_uint32_t leaf_mask_word_count =
                                pnanovdb_node2_fanout_1d[PNANOVDB_NODE2_TYPE_LEAF] >> 6u;
                            for (pnanovdb_uint32_t word_idx = 0u; word_idx < leaf_mask_word_count; word_idx++)
                            {
                                ...
                                pnanovdb_node2_write(
                                    dst_buf,
                                    dst_leaf.idx64 + pnanovdb_node2_off_value_mask[PNANOVDB_NODE2_TYPE_LEAF] + word_idx,
                                    value_mask);
                            }
    ...
    value_count = pnanovdb_uint64_offset(
        value_count, pnanovdb_node2_compute_values_word_count(dst_buf, dst_root, PNANOVDB_NODE2_TYPE_ROOT));
    inactive_count = pnanovdb_uint64_offset(
        inactive_count, pnanovdb_node2_compute_inactive_word_count(dst_buf, dst_root, PNANOVDB_NODE2_TYPE_ROOT));
    ...
    for (pnanovdb_uint32_t root_n = 0u; root_n < node2_root_fanout; root_n++)
    {
        ...
        value_count = pnanovdb_uint64_offset(
            value_count, pnanovdb_node2_compute_values_word_count(dst_buf, dst_upper, PNANOVDB_NODE2_TYPE_UPPER));
        inactive_count = pnanovdb_uint64_offset(
            inactive_count, pnanovdb_node2_compute_inactive_word_count(dst_buf, dst_upper, PNANOVDB_NODE2_TYPE_UPPER));
        ...
        for (pnanovdb_uint32_t upper_n = 0u; upper_n < node2_upper_fanout; upper_n++)
        {
            ...
            value_count = pnanovdb_uint64_offset(
                value_count, pnanovdb_node2_compute_values_word_count(dst_buf, dst_lower, PNANOVDB_NODE2_TYPE_LOWER));
            inactive_count = pnanovdb_uint64_offset(inactive_count, pnanovdb_node2_compute_inactive_word_count(
                                                                        dst_buf, dst_lower, PNANOVDB_NODE2_TYPE_LOWER));
            ...
            {
                pnanovdb_node2_handle_t dst_leaf =
                    pnanovdb_node2_get_child(dst_buf, dst_lower, PNANOVDB_NODE2_TYPE_LOWER, lower_n);
                ...
                value_count = pnanovdb_uint64_offset(
                    value_count, pnanovdb_node2_compute_values_word_count(dst_buf, dst_leaf, PNANOVDB_NODE2_TYPE_LEAF));
                inactive_count = pnanovdb_uint64_offset(inactive_count, pnanovdb_node2_compute_inactive_word_count(
                                                                            dst_buf, dst_leaf, PNANOVDB_NODE2_TYPE_LEAF));
            }
        }
    }
    ...
    // bbox header
    pnanovdb_gridblindmetadata_set_data_offset(
        dst_buf, dst_metadata, pnanovdb_address_diff(dst_bboxes, dst_metadata.address));
    ...
    pnanovdb_gridblindmetadata_set_data_offset(
        dst_buf, dst_metadata, pnanovdb_address_diff(dst_values, dst_metadata.address));
    ...
    dst_metadata.address = pnanovdb_address_offset(dst_metadata.address, PNANOVDB_GRIDBLINDMETADATA_SIZE);
    pnanovdb_gridblindmetadata_set_data_offset(
        dst_buf, dst_metadata, pnanovdb_address_diff(dst_node_inactive_idxs, dst_metadata.address));
    ...
    dst_metadata.address = pnanovdb_address_offset(dst_metadata.address, PNANOVDB_GRIDBLINDMETADATA_SIZE);
    pnanovdb_gridblindmetadata_set_data_offset(
        dst_buf, dst_metadata, pnanovdb_address_diff(dst_inactive_value_idxs, dst_metadata.address));
    ...
    for (pnanovdb_uint32_t root_n = 0u; root_n < node2_root_fanout; root_n++)
    {
        ...
        for (pnanovdb_uint32_t upper_n = 0u; upper_n < node2_upper_fanout; upper_n++)
        {
            ...
            for (pnanovdb_uint32_t lower_n = 0u; lower_n < node2_lower_fanout; lower_n++)
            {
                ...
                pnanovdb_node2_write(
                    dst_buf, (dst_node_inactive_idxs.byte_offset >> 3u) + node_idx_inactive, inactive_count);
                inactive_count = pnanovdb_uint64_offset(inactive_count, pnanovdb_node2_compute_inactive_word_count(
                                                                            dst_buf, dst_leaf, PNANOVDB_NODE2_TYPE_LEAF));
            }
        }
    ...
    pnanovdb_convert_to_node2_value_copy(dst_buf, dst_root, PNANOVDB_NODE2_TYPE_ROOT, root_ijk, dst_values,
                                         dst_node_inactive_idxs, dst_inactive_value_idxs, buf, grid_type, root);
    ...
    for (pnanovdb_uint32_t root_n = 0u; root_n < node2_root_fanout; root_n++)
    {
        ...
        pnanovdb_convert_to_node2_value_copy(dst_buf, dst_upper, PNANOVDB_NODE2_TYPE_UPPER, upper_ijk, dst_values,
                                             dst_node_inactive_idxs, dst_inactive_value_idxs, buf, grid_type, root);
        ...
        for (pnanovdb_uint32_t upper_n = 0u; upper_n < node2_upper_fanout; upper_n++)
        {
            ...
            pnanovdb_convert_to_node2_value_copy(dst_buf, dst_lower, PNANOVDB_NODE2_TYPE_LOWER, lower_ijk, dst_values,
                                                 dst_node_inactive_idxs, dst_inactive_value_idxs, buf, grid_type, root);
            ...
            for (pnanovdb_uint32_t lower_n = 0u; lower_n < node2_lower_fanout; lower_n++)
            {
                ...
                pnanovdb_convert_to_node2_value_copy(dst_buf, dst_leaf, PNANOVDB_NODE2_TYPE_LEAF, leaf_ijk, dst_values,
                                                     dst_node_inactive_idxs, dst_inactive_value_idxs, buf, grid_type,
                                                     root);
            }
        }
    }
...
#endif // end of NANOVDB_PNANOVDBEXT_H_HAS_BEEN_INCLUDED
