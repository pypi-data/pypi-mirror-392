...
class AIAnalysisRepository(BaseRepository[AIAnalysisResult]):
    ...
    async def create_twitter_analysis(
        ...
        """
        Create Twitter analysis result.
        ...
        Returns:
            Created AIAnalysisResult object or None
        """
        try:
            if analysis is None:
                analysis = {}
            ...
            logger.error(f"Error creating Twitter analysis: {e}")
            return None
    ...
    async def create_news_analysis(
        ...
        try:
            ...
            logger.error(f"Error creating news analysis: {e}")
            return None
