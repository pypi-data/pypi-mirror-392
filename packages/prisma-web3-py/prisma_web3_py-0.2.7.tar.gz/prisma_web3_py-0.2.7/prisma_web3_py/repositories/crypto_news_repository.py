    ...
    async def upsert_news(
        ...
        try:
            ...
            stmt = stmt.on_conflict_do_update(
                constraint='unique_news_source_link',
                set_=upsert_data
            )
    ...
    async def upsert_twitter(
        ...
        try:
            ...
            values = {
                ...
                'tags': tags,
                'news_created_at': tweet_time or datetime.now(),
                'content_hash': content_hash,
            ...
            logger.error(f"Error in upsert_twitter: {e}", exc_info=True)
            return None
