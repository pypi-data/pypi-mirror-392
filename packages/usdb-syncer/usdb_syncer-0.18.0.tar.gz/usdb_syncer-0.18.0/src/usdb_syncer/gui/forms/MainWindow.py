...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon25 = QIcon()
        icon25.addFile(u":/icons/drive-download.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.button_download.setIcon(icon25)
        ...
        icon26 = QIcon()
        icon26.addFile(u":/icons/control-pause.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.button_pause.setIcon(icon26)
        ...
        icon27 = QIcon()
        icon27.addFile(u":/icons/drawer.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menu_custom_data.setIcon(icon27)
        self.menu_open_song_in = QMenu(self.menu_songs)
        self.menu_open_song_in.setObjectName(u"menu_open_song_in")
        icon28 = QIcon()
        icon28.addFile(u":/icons/music--arrow.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menu_open_song_in.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/icons/error.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_errors.setIcon(icon29)
        ...
        icon30 = QIcon()
        icon30.addFile(u":/icons/warning.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_warnings.setIcon(icon30)
        ...
        icon31 = QIcon()
        icon31.addFile(u":/icons/info.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_infos.setIcon(icon31)
        ...
        icon32 = QIcon()
        icon32.addFile(u":/icons/bug.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_debugs.setIcon(icon32)
