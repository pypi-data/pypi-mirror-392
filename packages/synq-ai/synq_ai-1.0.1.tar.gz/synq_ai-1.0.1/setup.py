...
setup(
    ...
    description="[DEPRECATED] This package has been renamed to 'synqed'. Please use 'synqed' instead: https://pypi.org/project/synqed/",
    long_description="""
# synq-ai is now synqed

This package has been renamed to **[synqed](https://pypi.org/project/synqed/)**.
