# Auto-generated single-file for GhostModuleV2
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.ghost_module_v2 = GhostModuleV2(in_chs=32, out_chs=32, kernel_size=1, ratio=2, dw_size=3, stride=1, act_layer=nn.ReLU)
