...
class Net(nn.Module):
    def train_setup(self, prm):
        ...
        new_lr = random.uniform(0.001, 0.1)
        selected_params[0] = 'lr'
        prm[selected_params[0]] = new_lr
        
                         
        new_momentum = random.uniform(0.5, 0.99)
        selected_params[1] = 'momentum'
        prm[selected_params[1]] = new_momentum
