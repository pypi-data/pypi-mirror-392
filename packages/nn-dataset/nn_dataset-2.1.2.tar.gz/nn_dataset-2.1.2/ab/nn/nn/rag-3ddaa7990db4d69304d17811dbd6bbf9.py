# Auto-generated single-file for DepthwiseSeparableConv2d
...
def differentiable_all_reduce(tensor):
    return tensor
...
# ---- DepthwiseSeparableConv2d (target) ----
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.depthwise_sep_conv2d = DepthwiseSeparableConv2d(
            in_channels=32,
            out_channels=32,
            kernel_size=3,
            padding=1,
