...
class AirBlock(nn.Module):
    def __init__(self, in_channels, out_channels, groups=4, ratio=4):
...
class AirNeXtUnit(nn.Module):
    def __init__(self, in_channels, out_channels, stride, cardinality=16, bottleneck_width=2, ratio=4):
