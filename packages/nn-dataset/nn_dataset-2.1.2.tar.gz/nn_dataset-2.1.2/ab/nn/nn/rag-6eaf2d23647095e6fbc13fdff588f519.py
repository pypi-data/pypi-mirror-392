# Auto-generated single-file for ConvBlock
...
class Net(nn.Module):
    ...
    def build_features(self):
        layers = []
        layers += [
            ConvBlock(self.in_channels, 32, kernel_size=3, stride=1, expand_ratio=1, use_bias=False),
            ConvBlock(32, 32, kernel_size=3, stride=1, expand_ratio=1, use_bias=False),
        ]
