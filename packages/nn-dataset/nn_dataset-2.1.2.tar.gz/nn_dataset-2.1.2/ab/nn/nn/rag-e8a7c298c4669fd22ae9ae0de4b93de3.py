# Auto-generated single-file for MobileNetV2
...
# ---- torchvision.models._utils._make_divisible ----
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.mobilenetv2 = MobileNetV2(num_classes=self.num_classes, width_mult=1.0, dropout=0.2)
