# Auto-generated single-file for MaxPool2dSamePadding
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.max_pool_same_padding = MaxPool2dSamePadding(kernel_size=3, stride=2)
    ...
    def forward(self, x):
        x = self.features(x)
        x = self.max_pool_same_padding(x)
