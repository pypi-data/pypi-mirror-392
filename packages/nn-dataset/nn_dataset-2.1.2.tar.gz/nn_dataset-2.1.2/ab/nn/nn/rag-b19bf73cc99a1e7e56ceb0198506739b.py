# Auto-generated single-file for GlobalSubSampleAttn
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.global_subsample_attn = GlobalSubSampleAttn(dim=32, num_heads=1, attn_drop=0.1, proj_drop=0.1, sr_ratio=4)
    ...
    def forward(self, x):
        ...
        x = self.global_subsample_attn(x, (H, W))
