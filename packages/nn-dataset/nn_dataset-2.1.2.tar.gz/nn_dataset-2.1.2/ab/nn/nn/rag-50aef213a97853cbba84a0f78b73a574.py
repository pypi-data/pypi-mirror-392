# Auto-generated single-file for BasicBlock
# Dependencies are emitted in topological order (utilities first).
# UNRESOLVED DEPENDENCIES:
# comm, differentiable_all_reduce, dist, env, weight_init
...
def differentiable_all_reduce(x): return x
...
# ---- detectron2.layers.blocks.CNNBlockBase ----
...
class Net(nn.Module):
    ...
    def build_features(self):
        ...
        self.basic_block = BasicBlock(inplanes=32, planes=32, stride=1)
