# Auto-generated single-file for MobileVitV2Block
...
# ---- timm.models.mobilevit.LinearTransformerBlock ----
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.mobilevitv2_block = MobileVitV2Block(
            in_chs=32,
            out_chs=32,
            kernel_size=3,
            bottle_ratio=1.0,
