# Auto-generated single-file for ResPostRelPosBlock
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.res_post_rel_pos_block = ResPostRelPosBlock(
            dim=64, 
            num_heads=8, 
            mlp_ratio=4.0, 
            qkv_bias=False, 
    ...
    def forward(self, x):
        ...
        x = self.res_post_rel_pos_block(x)
        x = x.mean(dim=1)
        x = self.classifier(x)
        return x
