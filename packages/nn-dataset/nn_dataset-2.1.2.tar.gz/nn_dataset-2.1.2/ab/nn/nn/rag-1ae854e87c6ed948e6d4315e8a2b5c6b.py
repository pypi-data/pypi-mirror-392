# Auto-generated single-file for FastAdaptiveCatAvgMaxPool
...
# ---- FastAdaptiveCatAvgMaxPool (target) ----
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.fast_cat_pool = FastAdaptiveCatAvgMaxPool(flatten=True, input_fmt='NCHW')
