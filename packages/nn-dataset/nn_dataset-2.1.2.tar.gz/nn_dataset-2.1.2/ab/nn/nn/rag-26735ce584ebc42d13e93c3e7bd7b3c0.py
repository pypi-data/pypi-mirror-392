# Auto-generated single-file for LightConvBNAct
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.light_conv_bn_act = LightConvBNAct(in_chs=32, out_chs=32, kernel_size=3, groups=1, use_lab=False)
