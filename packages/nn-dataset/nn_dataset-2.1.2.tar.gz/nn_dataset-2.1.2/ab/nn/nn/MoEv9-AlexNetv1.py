# Remove lr_schedule from supported hyperparameters


# MoEv9-AlexNet: Enhanced MoE with AlexNet Experts
import torch
...
class Net(nn.Module):
    ...
    def train_setup(self, prm):
        ...
        # AdamW optimizer (no scheduler as per professor's feedback)
