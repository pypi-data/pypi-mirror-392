...
class DPN131(nn.Module):
    def __init__(self, in_channels=3, num_classes=10, num_blocks=6, growth_rate=20):
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.model = model_class(self.channel_number, self.class_number, num_blocks=6, growth_rate=20)
