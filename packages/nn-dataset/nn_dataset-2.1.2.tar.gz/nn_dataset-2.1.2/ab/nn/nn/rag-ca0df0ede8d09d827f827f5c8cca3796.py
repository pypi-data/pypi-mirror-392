# Auto-generated single-file for HaloAttn
...
# ---- timm.layers.halo_attn.rel_logits_1d ----
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.halo_attn = HaloAttn(dim=32, dim_out=32, feat_size=(16, 16), stride=1, num_heads=4, dim_head=None, block_size=8, halo_size=3, qk_ratio=1.0, qkv_bias=False, avg_down=False, scale_pos_embed=False)
