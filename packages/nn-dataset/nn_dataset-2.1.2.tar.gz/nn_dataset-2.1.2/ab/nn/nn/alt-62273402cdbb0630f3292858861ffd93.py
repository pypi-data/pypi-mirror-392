...
if __name__ == "__main__":
    net = Net((3, 224, 224), (10, 64), {'lr': 0.01, 'momentum': 0.95, 'dropout': 0.4}, torch.device('cuda:0'))
                                      
    net.__init__._modules[6].out_channels = 64
    net.__init__._modules[7].in_channels = 64
    print("Modified network with neighboring channels set to 64")
    print(net)