# Auto-generated single-file for FastAdaptiveMaxPool
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.fast_max_pool = FastAdaptiveMaxPool(flatten=True, input_fmt='NCHW')
