# Auto-generated single-file for RandomAutocontrast
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.random_autocontrast = RandomAutocontrast(p=0.5)
