...
class ICInitBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv2 = nn.Conv2d(mid_channels, 16, kernel_size=3, stride=2, padding=1)
        self.conv3 = nn.Conv2d(16, out_channels, kernel_size=3, stride=2, padding=1)
