# Auto-generated single-file for TwoWayTransformer
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        point_embedding = torch.randn(B, 10, 64, device=x.device)
        
        queries, keys = self.two_way_transformer(image_embedding, image_pe, point_embedding)
