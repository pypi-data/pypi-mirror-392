# Auto-generated single-file for BilinearAttnTransform
...
class Net(torch.nn.Module):
    ...
    def build_features(self):
        ...
        self.bilinear_attn = BilinearAttnTransform(in_channels=32, block_size=4, groups=8, act_layer=torch.nn.ReLU, norm_layer=torch.nn.BatchNorm2d)
