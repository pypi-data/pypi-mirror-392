# Auto-generated single-file for DeformConv2d
...
# ---- torchvision.ops.deform_conv.deform_conv2d ----
def deform_conv2d(
    input: Tensor,
    offset: Tensor,
    weight: Tensor,
...
class Net(nn.Module):
    ...
    def build_features(self):
        ...
        layers += [
            ...
            DeformConv2d(in_channels=32, out_channels=32, kernel_size=3, padding=1),
        ]
