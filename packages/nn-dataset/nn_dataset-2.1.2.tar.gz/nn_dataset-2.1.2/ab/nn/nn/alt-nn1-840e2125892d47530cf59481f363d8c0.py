...
class ICNetClassification(nn.Module):
    def __init__(self, num_classes, in_channels):
        ...
        self.psp_block = PSPBlock(64, pool_sizes=[1, 3, 5, 7])                               
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.class_num = out_shape[0]                                        
        self.model = ICNetClassification(num_classes=self.class_num, in_channels=self.channel)
