# Auto-generated single-file for RepViTBlock
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.rep_vit_block = RepViTBlock(in_dim=64, mlp_ratio=4, kernel_size=3, use_se=True, act_layer=GELU, legacy=False)
