...
class ICInitBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = nn.Conv2d(in_channels, mid_channels, kernel_size=5, stride=2, padding=1)
        self.conv2 = nn.Conv2d(mid_channels, 64, kernel_size=5, stride=2, padding=1)
        self.conv3 = nn.Conv2d(64, out_channels, kernel_size=5, stride=2, padding=1)
