# Auto-generated single-file for Block8
...
class Block8(nn.Module):
    ...
    def __init__(self, scale=1.0, no_relu=False, conv_block=None):
        ...
        self.branch1 = nn.Sequential(
            ...
            conv_block(8, 8, kernel_size=(1, 3), stride=1, padding=(0, 1)),
            conv_block(8, 8, kernel_size=(3, 1), stride=1, padding=(1, 0))
        )

        self.conv2d = nn.Conv2d(16, 32, kernel_size=1, stride=1)
...
class Net(torch.nn.Module):
    ...
    def build_features(self):
        ...
        self.block8 = Block8(scale=0.2, no_relu=False)
