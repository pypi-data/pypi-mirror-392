...
def supported_hyperparameters():
    return {'lr': 'learning rate', 'momentum': 'momentum', 'dropout': 'dropout', 'lr': 'learning rate', 'momentum': 'momentum', 'dropout': 'dropout', 'lr': 'learning rate', 'momentum': 'momentum', 'dropout': 'dropout'}
