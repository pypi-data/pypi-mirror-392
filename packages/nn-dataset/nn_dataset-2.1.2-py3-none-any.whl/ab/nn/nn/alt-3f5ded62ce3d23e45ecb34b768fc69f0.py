...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        layers += [
            nn.Conv2d(in_channels, 192, kernel_size=3, stride=2, padding=2),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
        ]
        in_channels = 192
        ...
        layers[6] = nn.Conv2d(192, 256, kernel_size=3, padding=1)
        layers[8] = nn.Conv2d(256, 256, kernel_size=3, padding=1)
