...
class BagNetUnit(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride):
        ...
        self.body = BagNetBottleneck(in_channels, out_channels, kernel_size=5, stride=stride)                       
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        for i, stage_channels in enumerate(self.channels):
            ...
            for j, out_channels in enumerate(stage_channels):
                ...
                stage.add_module(f"unit{j + 1}", BagNetUnit(in_channels, out_channels, kernel_size=5, stride=stride))                       
