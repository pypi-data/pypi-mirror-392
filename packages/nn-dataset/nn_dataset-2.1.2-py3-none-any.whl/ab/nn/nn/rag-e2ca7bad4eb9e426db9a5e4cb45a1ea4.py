# Auto-generated single-file for MobileNetV5MultiScaleFusionAdapter
# Dependencies are emitted in topological order (utilities first).
# UNRESOLVED DEPENDENCIES:
# in_ch, out_ch, register_notrace_module
...
# ---- timm.models._efficientnet_blocks.UniversalInvertedResidual ----
...
# ---- timm.models.mobilenetv5._GELU ----
_GELU = partial(nn.GELU, approximate='tanh')

# ---- MobileNetV5MultiScaleFusionAdapter (target) ----
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.scale1_conv = nn.Conv2d(32, 16, 1, 1, 0, bias=False)
        self.scale2_conv = nn.Conv2d(32, 8, 1, 1, 0, bias=False)
        self.fusion_adapter = MobileNetV5MultiScaleFusionAdapter(
            in_chs=[32, 16, 8],
            out_chs=32,
            output_resolution=4,
            expansion_ratio=1.5,
    ...
    def forward(self, x):
        ...
        x2 = F.avg_pool2d(x, kernel_size=4, stride=4)
        
        x1 = self.scale1_conv(x1)
        x2 = self.scale2_conv(x2)
        
        multi_scale_inputs = [x, x1, x2]
        x = self.fusion_adapter(multi_scale_inputs)
