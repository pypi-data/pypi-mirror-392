# Auto-generated single-file for RepVggBlock
...
# ---- timm.models.byobnet.num_groups ----
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.rep_vgg_block = RepVggBlock(in_chs=64, out_chs=128, kernel_size=3, stride=1, dilation=(1, 1), bottle_ratio=1.0, group_size=None, downsample='', layers=None, drop_block=None, drop_path_rate=0.0, inference_mode=False)
