# Auto-generated single-file for DiceLoss
...
# ---- mmseg.models.losses.dice_loss._expand_onehot_labels_dice ----
...
# ---- mmseg.models.losses.dice_loss.dice_loss ----
...
class Net(nn.Module):
    ...
    def learn(self, data_roll):
        ...
        for batch_idx, (data, target) in enumerate(data_roll):
            ...
            # Reshape for DiceLoss (expects 4D: N, C, H, W)
            output_4d = output.unsqueeze(-1).unsqueeze(-1)  # [N, C, 1, 1]
            target_4d = target_onehot.unsqueeze(-1).unsqueeze(-1)  # [N, C, 1, 1]
            
            loss = self.dice_loss(output_4d, target_4d)
            loss.backward()
            self.optimizer.step()
