# Auto-generated single-file for SwinTransformerLayer_v2
...
# ---- SwinTransformerLayer_v2 (target) ----
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.swin_transformer_layer_v2 = SwinTransformerLayer_v2(
            dim=64,
            num_heads=4,
            window_size=7,
            shift_size=3,
    ...
    def forward(self, x):
        x = self.features(x)
        x = self.swin_transformer_layer_v2(x)
