# Auto-generated single-file for AAttn
...
class Net(nn.Module):
    ...
    def build_features(self):
        ...
        # Use the provided AAttn block at least once.
        # AAttn expects (B, C, H, W) input and outputs (B, C, H, W)
        layers += [
            AAttn(dim=32, num_heads=4, area=1),
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
        ]
