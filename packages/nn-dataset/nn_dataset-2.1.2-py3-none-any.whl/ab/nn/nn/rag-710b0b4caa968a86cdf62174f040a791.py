# Auto-generated single-file for BasicTransform
...
class Net(nn.Module):
    ...
    def build_features(self):
        ...
        self.basic_transform = BasicTransform(w_in=32, w_out=32, stride=1, norm="BN", activation_class=nn.ReLU, _params={})
