...
class Net(nn.Module):
    ...
    def build_features(self):
        ...
        # Use the provided _InvertedResidual block at least once.
        # This is a well-formed block that can be used directly
        layers += [
            _InvertedResidual(32, 32, kernel_size=3, stride=1, expansion_factor=6, bn_momentum=0.1),
            nn.ReLU(inplace=True),
        ]
