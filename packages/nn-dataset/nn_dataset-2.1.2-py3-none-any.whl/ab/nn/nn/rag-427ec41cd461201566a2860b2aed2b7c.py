# Auto-generated single-file for RepMixerBlock
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.rep_mixer_block = RepMixerBlock(dim=64, kernel_size=3, mlp_ratio=4.0, act_layer=nn.GELU, proj_drop=0.0, drop_path=0.0, layer_scale_init_value=1e-5, inference_mode=False)
