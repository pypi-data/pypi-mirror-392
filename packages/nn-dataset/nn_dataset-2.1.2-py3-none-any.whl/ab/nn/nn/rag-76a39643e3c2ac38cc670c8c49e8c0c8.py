# Auto-generated single-file for MaskedSquareDiceLoss
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.masked_square_dice_loss = MaskedSquareDiceLoss(eps=1e-3)
    ...
    def forward(self, x):
        ...
        loss_value = self.masked_square_dice_loss(pred, gt, mask)
