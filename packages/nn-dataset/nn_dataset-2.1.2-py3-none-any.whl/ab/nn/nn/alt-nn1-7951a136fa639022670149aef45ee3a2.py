...
class DPN68(nn.Module):
    def __init__(self, in_channels, num_classes, num_blocks, growth_rate=64):
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.model = model_class(self.channel_number, self.class_number, num_blocks=3, growth_rate=64)
