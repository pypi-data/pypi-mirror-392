# Auto-generated single-file for PatchDropoutWithIndices
...
# ---- PatchDropoutWithIndices (target) ----
...
class Net(nn.Module):
    def __init__(self, in_shape, out_shape, prm, device):
        ...
        self.patch_dropout = PatchDropoutWithIndices(prob=0.3, num_prefix_tokens=0, ordered=False)
