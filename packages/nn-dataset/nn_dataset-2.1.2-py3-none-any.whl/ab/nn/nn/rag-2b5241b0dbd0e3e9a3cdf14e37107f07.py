# Auto-generated single-file for SeparableConvNormAct
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.separable_conv_norm_act = SeparableConvNormAct(
            in_channels=64, 
            out_channels=128, 
            kernel_size=3, 
            stride=1, 
    ...
    def forward(self, x):
        x = self.features(x)
        x = self.separable_conv_norm_act(x)
