# Auto-generated single-file for ConvBNAct
...
class Net(nn.Module):
    ...
    def build_features(self):
        layers = []
        layers += [
            ConvBNAct(self.in_channels, 32, kernel_size=3, stride=1, padding='same', use_act=True, use_lab=False),
            ConvBNAct(32, 32, kernel_size=3, stride=1, padding='same', use_act=True, use_lab=False),
        ]
