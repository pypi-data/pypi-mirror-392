# Auto-generated single-file for XceptionModule
...
# ---- timm.models.xception_aligned.SeparableConv2d ----
...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device) -> None:
        ...
        self.xception_module = XceptionModule(
            in_chs=64,
            out_chs=128,
            stride=1,
            dilation=1,
