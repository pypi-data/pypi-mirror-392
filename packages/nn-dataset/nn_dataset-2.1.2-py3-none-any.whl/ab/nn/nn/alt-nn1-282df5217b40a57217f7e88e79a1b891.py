...
class DPNBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.conv1 = nn.Conv2d(in_channels, self.out_channels, kernel_size=5, stride=stride, padding=2, groups=4, bias=False)
        self.bn1 = nn.BatchNorm2d(self.out_channels)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = nn.Conv2d(self.out_channels, self.out_channels, kernel_size=5, padding=2, groups=4, bias=False)
