# Auto-generated single-file for BatNonLocalAttn
...
def fused_rms_norm_affine(x, weight, normalized_shape, eps):
    return rms_norm(x, normalized_shape, weight, eps)

def fused_rms_norm(x, normalized_shape, eps):
    return rms_norm(x, normalized_shape, None, eps)
...
class Net(nn.Module):
    ...
    def build_features(self):
        ...
        self.bat_non_local_attn = BatNonLocalAttn(in_channels=32, block_size=7, groups=2, rd_ratio=0.25)
