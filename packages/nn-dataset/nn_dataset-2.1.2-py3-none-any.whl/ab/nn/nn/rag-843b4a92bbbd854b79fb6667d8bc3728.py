# Auto-generated single-file for CellStem0
...
class Net(torch.nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.classifier = torch.nn.Linear(168, self.num_classes)
    ...
    def build_features(self):
        ...
        self.cell_stem = CellStem0(stem_size=32, num_channels=42, pad_type='')

        self._last_channels = 168
