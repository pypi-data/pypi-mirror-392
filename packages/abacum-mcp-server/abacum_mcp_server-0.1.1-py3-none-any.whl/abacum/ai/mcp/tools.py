...
async def get_abacum_model_actuals(
    ...
    Returns:
        ...
        - module_data_json: json raw data containing the actuals for the given module
...
async def get_abacum_scenario_data(
    ...
    Returns:
        Dictionary containing:
        - module_data_json: json raw data containing the scenario data
        - metadata: Schema information about the data structure
    """
    return await _call_api_safely(
...
async def get_abacum_rolling_data(
    ...
    Returns:
        Dictionary containing:
        - module_data_json: json raw data containing the rolling forecast data
        - metadata: Schema information about the data structure
    """
    return await _call_api_safely(
