...
def run_pipeline(config_path: str, document_path: str, output_dir: str, *, use_cache: bool = True) -> Dict[str, Any]:
    """
...
def run_generation(document_path: str, output_dir: str) -> Dict[str, Any]:
    """
    ...
    return run_pipeline(pipeline_yml_path, document_path, output_dir, use_cache=True)


def run_review(document_path: str, output_dir: str) -> Dict[str, Any]:
    """
    运行“评审（review）”流水线。
