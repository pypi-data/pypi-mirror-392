...
export default [
  {
    ...
    component: ComponentCreator('/solace-agent-mesh/docs', '2d1'),
    routes: [
      {
        path: '/solace-agent-mesh/docs',
        component: ComponentCreator('/solace-agent-mesh/docs', '3a7'),
        routes: [
          {
            path: '/solace-agent-mesh/docs',
            component: ComponentCreator('/solace-agent-mesh/docs', 'e37'),
            routes: [
              {
