    ...
    for sequence_composition in sequences_compositions:
        ...
        for sequence_length in sequence_lengths:
            for i in range(iterations):
                ...
                model_GRU = GRU(validation_data=validation_data, target_column=target_column, seq_length = sequence_length, numeric_features= [col for col in X_train.columns if (col != timestamp_column and col != 'GROUP')],context_feature=['GROUP'],random_seed=None,device=device)
