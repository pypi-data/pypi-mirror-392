...
for cluster_name, cluster_model in cluster_algorithms.items():
    ...
    for sequence_composition in sequences_compositions:
        ...
        for sequence_length in sequence_lengths:
            ...
            evaluator = StandardEvaluator(f"GRU_Layers-{num_layers}_HiddenSize-{hidden_size}_SequenceLength-{sequence_length}_{sequence_composition}_{threshold_strategy}_{cluster_name}", threshold_selection)
