...
- Added test for DL0 to DL1 transformation with a camcalib monitoring file from calibpipe. [`!47 <https://gitlab.cta-observatory.org/cta-computing/dpps/datapipe/datapipe/-/merge_requests/47>`__]

- Added CWL workflows for training gammaness, energy, and disp reconstruction models [`!48 <https://gitlab.cta-observatory.org/cta-computing/dpps/datapipe/datapipe/-/merge_requests/48>`__]
