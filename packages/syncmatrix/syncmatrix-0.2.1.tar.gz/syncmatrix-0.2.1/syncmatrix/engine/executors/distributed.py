...
from syncmatrix.engine.executors import Executor
...
def distributed_client(address=None, separate_thread=False):
    ...
    Depending on how this function is called,
        ...
        2. If the context is entered outside the cluster a standard Client is
            ...
            and maintained for the life of this Syncmatrix process. Note that
            other Syncmatrix processes will NOT automatically discover the
            LocalCluster.
    ...
    Args:
        address (str): if provided, a Client will be returned that connects
            to that address. If None, the address will be read from the Syncmatrix
            ...
            for the life of this Syncmatrix process. Other Syncmatrix processes can
