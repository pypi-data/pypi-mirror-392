...
import syncmatrix
from syncmatrix.utilities import collections

DEFAULT_CONFIG = os.path.join(os.path.dirname(syncmatrix.__file__), "config.toml")
USER_CONFIG = "~/.syncmatrix/config.toml"
ENV_VAR_PREFIX = "syncmatrix"
...
configure_logging(logger_name="Syncmatrix")
