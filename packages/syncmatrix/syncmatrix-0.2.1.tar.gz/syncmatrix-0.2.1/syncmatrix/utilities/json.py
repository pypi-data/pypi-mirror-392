...
class SyncmatrixJSONEncoder(json.JSONEncoder):
...
class SyncmatrixJSONDecoder(json.JSONDecoder):
...
json._default_encoder = SyncmatrixJSONEncoder()
json._default_decoder = SyncmatrixJSONDecoder()
