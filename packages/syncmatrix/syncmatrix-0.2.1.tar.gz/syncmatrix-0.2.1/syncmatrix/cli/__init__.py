...
server = config.get("syncmatrix", "server")
...
#         '\nYou are not logged in to the Syncmatrix CLI!'
#         '\nRun `syncmatrix login <email> <password>` to continue.\n',
#         fg='red', bold=True))
