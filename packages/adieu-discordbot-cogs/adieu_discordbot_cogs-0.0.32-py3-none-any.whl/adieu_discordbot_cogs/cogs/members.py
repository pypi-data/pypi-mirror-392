...
class Members(commands.Cog):
    ...
    def get_lookup_embed(self, input_name):
        ...
        try:
            ...
            try:
                ...
                alt_list = ["[{}](https://auth.black-rose.space/audit/r/{}) *[ [{}](https://auth.black-rose.space/audit/r/corp/glance?cid={}) ]*".format(
                ...
                alt_list = ["[{}](https://auth.black-rose.space/audit/r/{}) *[ [{}](https://auth.black-rose.space/audit/r/corp/glance?cid={}) ]*".format(a.character_name,
                                                                                                                         a.character_id,
    ...
    async def slash_lookup(
        ...
        if gib_csv:
            ...
            return await ctx.respond(embed=self.get_lookup_embed(character), file=file, ephemeral=True)
