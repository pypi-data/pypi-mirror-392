...
from chem_eclipse.hiclass import BinaryPolicy
from chem_eclipse.hiclass.ConstantClassifier import ConstantClassifier
from chem_eclipse.hiclass.HierarchicalClassifier import HierarchicalClassifier
from chem_eclipse.hiclass._calibration.Calibrator import _Calibrator

from chem_eclipse.hiclass.probability_combiner import (
...
class LocalClassifierPerNode(BaseEstimator, HierarchicalClassifier):
    ...
    Examples
    --------
    >>> from chem_eclipse.hiclass import LocalClassifierPerNode
    >>> y = [['1', '1.1'], ['2', '2.1']]
    >>> X = [[1, 2], [3, 4]]
