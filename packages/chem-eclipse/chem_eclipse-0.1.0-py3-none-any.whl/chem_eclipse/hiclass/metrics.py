...
from chem_eclipse.hiclass import HierarchicalClassifier
from chem_eclipse.hiclass.HierarchicalClassifier import make_leveled
...
def f1(
    ...
    --------
    >>> import numpy as np
    >>> from chem_eclipse.hiclass.metrics import f1
    >>> y_true = [[0, 1, 2], [3, 4, 5]]
    >>> y_pred = [[0, 1, 2], [6, 7, 8]]
