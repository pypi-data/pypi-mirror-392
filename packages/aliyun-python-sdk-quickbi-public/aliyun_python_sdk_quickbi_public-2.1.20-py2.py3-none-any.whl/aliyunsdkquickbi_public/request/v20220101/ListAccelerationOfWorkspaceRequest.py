...
class ListAccelerationOfWorkspaceRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'quickbi-public', '2022-01-01', 'ListAccelerationOfWorkspace','2.2.0')
		self.set_protocol_type('https')
		self.set_method('POST')

	def get_CubeName(self): # String
		return self.get_query_params().get('CubeName')

	def set_CubeName(self, CubeName):  # String
		self.add_query_param('CubeName', CubeName)
