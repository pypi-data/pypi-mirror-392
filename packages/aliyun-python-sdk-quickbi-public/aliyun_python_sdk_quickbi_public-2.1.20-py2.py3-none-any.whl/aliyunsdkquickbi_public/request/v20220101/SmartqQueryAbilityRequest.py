...
class SmartqQueryAbilityRequest(RpcRequest):
	...
	def get_MultipleCubeIds(self): # String
		return self.get_query_params().get('MultipleCubeIds')

	def set_MultipleCubeIds(self, MultipleCubeIds):  # String
		self.add_query_param('MultipleCubeIds', MultipleCubeIds)
