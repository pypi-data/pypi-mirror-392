...
# %%  USER：===将量子码转换为量子线路===
def Code2Circuit(code:MajoranaCode|PauliCode,p_noise:float|int,p_measure:float|int,noise_model:str,cycle_number:int):
    """""
    code：要转换的量子码
    p_noise：去极化噪声发生的几率
    p_measure：测量噪声发生的几率
...
def MajoranaCSSCode2PhenomenologicalCircuit(code:MajoranaCSSCode,p_noise:float|int,p_measure:float|int,cycle_number:int)->Circuit:
    """""
...
def MajoranaCSSCode2CircuitLevelCircuit(code:MajoranaCSSCode,p_noise:float|int,p_measure:float|int,cycle_number:int)->Circuit:
    """""
    input.code：一个MajoranaCSSCode
    input.p_noise：去极化噪声发生的几率
    input.p_measure：测量结果出错的几率
...
def PauliCSSCode2PhenomenologicalCircuit(code:PauliCSSCode,p_noise:float|int,p_measure:float|int,cycle_number:int)->tuple[Circuit, Circuit]:
    """""
...
def PauliCSSCode2CircuitLevelCircuit(code:PauliCSSCode,p_noise:float|int,p_measure:float|int,cycle_number:int)->tuple[Circuit,Circuit]:
    """""
    input.code：一个PauliCSSCode
    input.p_noise：去极化噪声发生的几率
    input.p_measure：测量结果出错的几率
...
def syndrome_majorana_css_measurement_circuit(stabilizer:MajoranaOperator, qubit_index:int, type:str, p_noise:float|int, p_measure:float|int)->list[dict]:
    """""
...
def syndrome_pauli_css_measurement_circuit(stabilizer:PauliOperator, qubit_index:int, type:str, p_noise:float|int, p_measure:float|int)->list[dict]:
    """""
