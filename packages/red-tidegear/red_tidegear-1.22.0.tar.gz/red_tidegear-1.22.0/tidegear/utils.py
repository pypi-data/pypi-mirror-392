...
from tidegear.pydantic.basemodel import recurse_modify as _recurse_modify
from tidegear.pydantic.basemodel import truncate_string as _truncate_string
...
truncate_string = deprecated_alias(new_func=_truncate_string, old_name=f"{__name__}.truncate_string", removal_version="1.23.0")
recurse_modify = deprecated_alias(new_func=_recurse_modify, old_name=f"{__name__}.recurse_modify", removal_version="1.23.0")
