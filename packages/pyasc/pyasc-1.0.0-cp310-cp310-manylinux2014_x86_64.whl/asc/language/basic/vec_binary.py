...
@overload
def add_deq_relu(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@overload
def add_relu(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@overload
def bitwise_and(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@require_jit
@set_binary_docstring(cpp_name="And", append_text="每对elements按位与运算。")
...
@overload
def bitwise_or(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@require_jit
@set_binary_docstring(cpp_name="Or", append_text="每对elements按位或运算。")
...
@overload
def div(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@overload
def fused_mul_add(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@overload
def fused_mul_add_relu(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@overload
def max(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@overload
def min(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@overload
def mul(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@overload
def mul_add_dst(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
def mul_cast(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, mask: int, repeat_times: int,
             params: BinaryRepeatParams) -> None:
    ...
...
def mul_cast(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, *args, **kwargs) -> None:
    ...
    def _(mask: RuntimeInt, repeat_times: RuntimeInt, params: BinaryRepeatParams):
        builder.create_asc_MulCastL0Op(dst.to_ir(), src0.to_ir(), src1.to_ir(),
                 _mat(mask, KT.uint64).to_ir(), _mat(repeat_times, KT.int8).to_ir(), params.to_ir())

    @dispatcher.register(mask=list, repeat_times=RuntimeInt, params=BinaryRepeatParams)
    def _(mask: list, repeat_times: RuntimeInt, params: BinaryRepeatParams):
...
@overload
def sub(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
...
@overload
def sub_relu(dst: LocalTensor, src0: LocalTensor, src1: LocalTensor, count: int) -> None:
    ...
