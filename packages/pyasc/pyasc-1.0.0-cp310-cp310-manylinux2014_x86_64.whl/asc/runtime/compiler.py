...
class Compiler:
    ...
    @staticmethod
    def _schedule_optimizing(pm: passes.PassManager) -> None:
    ...
    def run(self, mod: ir.ModuleOp, func_name: str) -> CompiledKernel:
        ...
        return self.run_compilation(source)
    ...
    def run_compilation(self, source: str) -> CompiledKernel:
        with tempfile.TemporaryDirectory(prefix="pyasc_compiler_") as tmp_dir:
            ...
            return CompiledKernel(dst.read_bytes(), core_type, self.enable_debug)
