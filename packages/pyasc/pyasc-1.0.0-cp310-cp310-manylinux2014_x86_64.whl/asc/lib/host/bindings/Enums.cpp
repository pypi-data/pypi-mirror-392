...
void pyasc_init_enums(py::module &m) {
  ...
  py::enum_<DataType>(m, "DataType", py::module_local())
      ...
      .value("DT_HIFLOAT8", DataType::DT_HIFLOAT8)
      .value("DT_FLOAT8_E4M3FN", DataType::DT_FLOAT8_E4M3FN)
      .value("DT_FLOAT8_E5M2", DataType::DT_FLOAT8_E5M2)
      .value("DT_FLOAT4_E2M1", DataType::DT_FLOAT4_E2M1)
      .value("DT_FLOAT8_E8M0", DataType::DT_FLOAT8_E8M0)
      .value("DT_FLOAT4_E1M2", DataType::DT_FLOAT4_E1M2)
