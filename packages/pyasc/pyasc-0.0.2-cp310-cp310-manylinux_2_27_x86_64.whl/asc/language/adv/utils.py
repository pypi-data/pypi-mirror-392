...
def set_regist_matmul_docstring():
    ...
    **调用示例**
        ...
        .. code-block:: python
            ...
            regist_matmul(&pipe, get_sys_workspace_ptr(), mm, &tiling);
            // 推荐：初始化多个matmul对象，传入对应的tiling参数
            regist_matmul(&pipe, get_sys_workspace_ptr(), mm1, mm1tiling, mm2, mm2tiling, mm3, mm3tiling, mm4, mm4tiling);
...
def set_matmul_docstring(api_name: Optional[str] = None) -> Callable[[T], T]:
    ...
    if api_name == "set_quant_scalar":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_quant_scalar_docstring()
    elif api_name == "set_quant_vector":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_quant_vector_docstring()
    elif api_name == "set_org_shape":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_org_shape_docstring()
    elif api_name == "set_single_shape":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_single_shape_docstring()
    elif api_name == "set_self_define_data":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_self_define_data_docstring()
    elif api_name == "set_user_def_info":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_user_def_info_docstring()
    elif api_name == "set_sparse_index":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_sparse_index_docstring()
    elif api_name == "get_matmul_api_tiling":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_matmul_api_tiling_docstring()
    elif api_name == "iterate_n_batch":
        func_introduction, cpp_signature, param_list, return_list, py_example = iterate_n_batch_docstring()
    elif api_name == "end":
        func_introduction, cpp_signature, param_list, return_list, py_example = end_docstring()
    elif api_name == "set_hf32":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_hf32_docstring()
    elif api_name == "set_tail":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_tail_docstring()
    elif api_name == "set_batch_num":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_batch_num_docstring()
    elif api_name == "set_workspace":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_workspace_docstring()
    elif api_name == "wait_get_tensor_c":
        func_introduction, cpp_signature, param_list, return_list, py_example = wait_get_tensor_c_docstring()
    elif api_name == "get_offset_c":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_offset_c_docstring()
    elif api_name == "async_get_tensor_c":
        func_introduction, cpp_signature, param_list, return_list, py_example = async_get_tensor_c_docstring()
    elif api_name == "set_tensor_a":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_tensor_a_docstring()
    elif api_name == "set_tensor_b":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_tensor_b_docstring()
    elif api_name == "set_bias":
        func_introduction, cpp_signature, param_list, return_list, py_example = set_bias_docstring()
    elif api_name == "disable_bias":
        func_introduction, cpp_signature, param_list, return_list, py_example = disable_bias_docstring()
    elif api_name == "get_batch_tensor_c":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_batch_tensor_c_docstring()
    elif api_name == "iterate":
        func_introduction, cpp_signature, param_list, return_list, py_example = iterate_docstring()
    elif api_name == "get_tensor_c":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_tensor_c_docstring()
    elif api_name == "iterate_all":
        func_introduction, cpp_signature, param_list, return_list, py_example = iterate_all_docstring()
    elif api_name == "wait_iterate_all":
        func_introduction, cpp_signature, param_list, return_list, py_example = wait_iterate_all_docstring()
    elif api_name == "iterate_batch":
        func_introduction, cpp_signature, param_list, return_list, py_example = iterate_batch_docstring()
    elif api_name == "wait_iterate_batch":
        func_introduction, cpp_signature, param_list, return_list, py_example = wait_iterate_batch_docstring()
    elif api_name == "get_basic_config":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_basic_config_docstring()
    elif api_name == "get_special_basic_config":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_special_basic_config_docstring()
    elif api_name == "get_normal_config":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_normal_config_docstring()
    elif api_name == "get_mdl_config":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_mdl_config_docstring()
    elif api_name == "get_special_mdl_config":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_special_mdl_config_docstring()
    elif api_name == "get_ib_share_norm_config":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_ib_share_norm_config_docstring()
    elif api_name == "get_mm_config":
        func_introduction, cpp_signature, param_list, return_list, py_example = get_mm_config_docstring()
    elif api_name == "init":
        func_introduction, cpp_signature, param_list, py_example = get_init_docstring()
    elif api_name == "register_matmul":
        func_introduction, cpp_signature, param_list, py_example = set_regist_matmul_docstring()
    else:
...
def set_sort_docstring(api_name: Optional[str] = None) -> Callable[[T], T]:
    ...
    if api_name == "concat":
        func_introduction, cpp_signature, param_list, return_list, py_example = concat_docstring()
    elif api_name == "extract":
        func_introduction, cpp_signature, param_list, return_list, py_example = extract_docstring()
    else:
