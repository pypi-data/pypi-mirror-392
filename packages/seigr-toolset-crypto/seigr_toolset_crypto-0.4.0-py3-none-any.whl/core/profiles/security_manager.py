...
class UnifiedSecurityManager:
    ...
    def _generate_comprehensive_recommendations(self, content_analysis: Dict[str, Any],
        ...
        current_profile = profile_analysis.get('recommended_profile', '')
