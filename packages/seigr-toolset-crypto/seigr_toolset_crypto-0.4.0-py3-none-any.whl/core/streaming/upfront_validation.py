...
class UpfrontDecoyValidator:
    ...
    def _validate_algorithmic_decoy(self, 
        ...
        try:
            # For algorithmic decoys, we need to attempt reconstruction
            # and validate the resulting decoy makes sense
            
            # Generate the specific decoy for validation
            decoys = self.algorithmic_system.reconstruct_decoys(
            ...
            # Check decoy size and structure
