...
class FastMish(nn.Module):
    """Fast Mish activation layer with automatic Triton/PyTorch backend selection.

    Mish is a smooth, non-monotonic activation function: x * tanh(softplus(x)).
    ...
    Examples:
        >>> layer = FastMish(hidden_size=1024)
