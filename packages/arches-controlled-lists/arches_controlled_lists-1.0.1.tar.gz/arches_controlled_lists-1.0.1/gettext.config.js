...
module.exports = {
  input: {
    path: "./arches_controlled_lists/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_controlled_lists/locale", // output path of all created files
