...
class _RDKitInitMixin(_RDKitCovertMixin):
    ...
    def from_mol(cls, mol: Chem.Mol,
                 ...
                 pcharge_prop_name: str='_GasteigerCharge') -> '_RDKitInitMixin':
        """
    ...
    @classmethod
    def from_smiles(cls, smiles: str, name: str = 'LIG', generic: bool = False,
                    atomnames: Optional[Dict[int, str]] = None,
                    pcharge_prop_name: str = '_GasteigerCharge') -> '_RDKitInitMixin':
        """
    ...
    @classmethod
    def from_smiles_w_pdbblock(cls,
                               pdb_block: str,
                               smiles: str,
                               generic: bool = False,
                               name: str = 'LIG',
                              proximityBonding: bool = True) -> '_RDKitInitMixin':
        """
