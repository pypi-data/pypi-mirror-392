...
class _RDKitPrepMixin(_RDKitRenameMixin):
    ...
    @classmethod
    def load_mol(cls, mol: Chem.Mol,
                 generic: bool = False,
                 name: Optional[str] = None,
                 pcharge_prop_name: str = '_GasteigerCharge') -> '_RDKitPrepMixin':
        """
    ...
    def _prep_dump_pdb(self, filename: str, overwrite: bool = False, stripped: bool = True) -> Chem.Mol:
    ...
    def _add_partial_charges(self, pcharge_prop_name: str = '_GasteigerCharge') -> None:
        ...
        for i, atom in enumerate(self.mol.GetAtoms()):
            ...
            if str(gc) != 'nan':
                atom.SetDoubleProp(pcharge_prop_name, 0.)

    def set_partial_charges_from_list(self,
                                      charges: List[float],
                                      pcharge_prop_name: str = '_GasteigerCharge') -> None:
        """
    ...
    def generate_conformers(self, num_confs: int = 100) -> int:
        ...
        with DummyMasker(self.mol):
            ...
            first_atoms = [0, 1, 2] if self.mol.GetNumAtoms() >=3 else list(range(self.mol.GetNumAtoms()))
