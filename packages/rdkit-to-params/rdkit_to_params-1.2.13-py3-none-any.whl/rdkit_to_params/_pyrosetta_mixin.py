...
"""
from .version import __author__, __email__, __date__, __license__, __version__, __citation__
...
class _PoserMixin:
    ...
    def to_polymeric_pose(self, relax: bool = False, sequence: Optional[str] = None) -> pyrosetta.Pose:
        if sequence is None:
    ...
    def _relax(self, pose: 'pyrosetta.Pose', scorefxn: Optional['pyrosetta.ScoreFunction'] = None, cycles: Optional[int] = 15) -> None:
        if scorefxn is None:
            scorefxn = pyrosetta.get_fa_scorefxn()
        relax = pyrosetta.rosetta.protocols.relax.FastRelax(scorefxn, cycles)
        relax.apply(pose)

    def add_residuetype(self, pose: 'pyrosetta.Pose', reset: bool = True) -> prc.chemical.ResidueTypeSet:
        """
