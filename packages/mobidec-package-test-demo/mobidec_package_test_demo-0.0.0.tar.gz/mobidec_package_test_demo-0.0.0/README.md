...
```bash
pip install mobidec_package_test_demo
```
...
```bash
# On-premise
pip install mobidec_package_test_demo --extra-index-url https://nexus.ifpen.fr/repository/fast-it/simple

# On Cloud
pip install mobidec_package_test_demo --extra-index-url https://nexus.fastit.dev/repository/fast-it/simple
```
