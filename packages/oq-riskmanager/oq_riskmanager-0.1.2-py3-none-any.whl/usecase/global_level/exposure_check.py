...
def symbol_exposure_check(
    ...
    for symbol in symbols:
        ...
        if pos_size_delta / pos_1_size > abnormal_position_exposure_threshold:
...
def symbol_notional_exposure_check(
    ...
    for symbol in symbols:
        ...
        if (
            taker_notional / maker_notional - 1 > abnormal_position_exposure_threshold
            or maker_notional / taker_notional - 1 > abnormal_position_exposure_threshold
        ):
            result['exposure'].append(symbol)
