...
class Commit(BaseModel):
    ...
    associations: Optional[List[IssueIdOrKeysAssociation]] = Field(default=None, description="The Jira issue keys or IDs to associate the commit with.")
    ...
    __properties: ClassVar[List[str]] = ["id", "issueKeys", "associations", "updateSequenceId", "hash", "flags", "message", "author", "fileCount", "url", "files", "authorTimestamp", "displayId"]
