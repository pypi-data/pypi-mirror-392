...
class IssueBeanEditmetaAllOfFieldsValue(BaseModel):
    """
    ...
    var_schema: FieldMetadataSchema = Field(alias="schema")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueBeanEditmetaAllOfFieldsValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueBeanEditmetaAllOfFieldsValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "schema": FieldMetadataSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None
        })
        return _obj
