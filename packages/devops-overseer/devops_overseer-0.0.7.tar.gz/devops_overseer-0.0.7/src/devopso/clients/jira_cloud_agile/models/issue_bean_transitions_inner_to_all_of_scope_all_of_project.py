...
class IssueBeanTransitionsInnerToAllOfScopeAllOfProject(BaseModel):
    """
    The project the item has scope in.
    """ # noqa: E501
    avatar_urls: Optional[IssueBeanTransitionsInnerToAllOfScopeAllOfProjectAllOfAvatarUrls] = Field(default=None, alias="avatarUrls")
    ...
    project_category: Optional[IssueBeanTransitionsInnerToAllOfScopeAllOfProjectAllOfProjectCategory] = Field(default=None, alias="projectCategory")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueBeanTransitionsInnerToAllOfScopeAllOfProject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueBeanTransitionsInnerToAllOfScopeAllOfProject from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "avatarUrls": IssueBeanTransitionsInnerToAllOfScopeAllOfProjectAllOfAvatarUrls.from_dict(obj["avatarUrls"]) if obj.get("avatarUrls") is not None else None,
            "id": obj.get("id"),
            "key": obj.get("key"),
            "name": obj.get("name"),
            "projectCategory": IssueBeanTransitionsInnerToAllOfScopeAllOfProjectAllOfProjectCategory.from_dict(obj["projectCategory"]) if obj.get("projectCategory") is not None else None,
