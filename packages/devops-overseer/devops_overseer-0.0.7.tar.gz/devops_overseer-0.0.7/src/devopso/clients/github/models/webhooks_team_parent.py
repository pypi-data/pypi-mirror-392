...
class WebhooksTeamParent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "html_url", "id", "members_url", "name", "node_id", "permission", "privacy", "notification_setting", "repositories_url", "slug", "url", "type", "organization_id", "enterprise_id"]
