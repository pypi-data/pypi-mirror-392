...
class CodeScanningDefaultSetup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["state", "languages", "runner_type", "runner_label", "query_suite", "threat_model", "updated_at", "schedule"]
    ...
    def languages_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['actions', 'c-cpp', 'csharp', 'go', 'java-kotlin', 'javascript-typescript', 'javascript', 'python', 'ruby', 'typescript', 'swift']):
                raise ValueError("each list item must be one of ('actions', 'c-cpp', 'csharp', 'go', 'java-kotlin', 'javascript-typescript', 'javascript', 'python', 'ruby', 'typescript', 'swift')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if runner_type (nullable) is None
        # and model_fields_set contains the field
        if self.runner_type is None and "runner_type" in self.model_fields_set:
            _dict['runner_type'] = None
