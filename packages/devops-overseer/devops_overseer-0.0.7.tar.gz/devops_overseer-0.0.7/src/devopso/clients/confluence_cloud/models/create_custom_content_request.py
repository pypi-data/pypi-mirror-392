...
class CreateCustomContentRequest(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The status of the custom content. Defaults to `current` when status not provided.")
    space_id: Optional[StrictStr] = Field(default=None, description="ID of the containing space.", alias="spaceId")
    ...
    __properties: ClassVar[List[str]] = ["type", "status", "spaceId", "pageId", "blogPostId", "customContentId", "title", "body"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCustomContentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCustomContentRequest from a dict"""
        if obj is None:
            return None
