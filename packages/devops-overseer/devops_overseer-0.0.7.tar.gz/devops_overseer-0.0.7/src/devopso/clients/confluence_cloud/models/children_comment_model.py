...
class ChildrenCommentModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "title", "parentCommentId", "version", "body", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChildrenCommentModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChildrenCommentModel from a dict"""
        if obj is None:
            return None
