...
class CustomContentCommentModel(BaseModel):
    ...
    custom_content_id: Optional[StrictStr] = Field(default=None, description="ID of the custom content containing the comment.", alias="customContentId")
    version: Optional[Version] = None
    body: Optional[BodySingle] = None
    links: Optional[CommentLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "status", "title", "customContentId", "version", "body", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomContentCommentModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomContentCommentModel from a dict"""
        if obj is None:
            return None
