...
class PageVersion(BaseModel):
    ...
    page: Optional[VersionedEntity] = None
    __properties: ClassVar[List[str]] = ["createdAt", "message", "number", "minorEdit", "authorId", "page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageVersion from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "page": VersionedEntity.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
