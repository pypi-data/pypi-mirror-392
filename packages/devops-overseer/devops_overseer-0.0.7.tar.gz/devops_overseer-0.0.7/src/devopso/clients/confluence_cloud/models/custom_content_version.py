...
class CustomContentVersion(BaseModel):
    ...
    custom: Optional[VersionedEntity] = None
    __properties: ClassVar[List[str]] = ["createdAt", "message", "number", "minorEdit", "authorId", "custom"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomContentVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomContentVersion from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "custom": VersionedEntity.from_dict(obj["custom"]) if obj.get("custom") is not None else None
        })
        return _obj
