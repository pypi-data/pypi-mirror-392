...
class LikeApi:
    ...
    @validate_call
    def get_blog_post_like_count(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the blog post for which like count should be returned.")],
        ...
        _param = self._get_blog_post_like_count_serialize(
            id=id,
    ...
    @validate_call
    def get_blog_post_like_count_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the blog post for which like count should be returned.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_blog_post_like_count_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the blog post for which like count should be returned.")],
        _request_timeout: Union[
            None,
    ...
    def _get_blog_post_like_count_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/blogposts/{id}/likes/count',
    ...
    @validate_call
    def get_blog_post_like_users(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the blog post for which account IDs should be returned.")],
        ...
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Maximum number of account IDs per result to return. If more results exist, use the `Link` header to retrieve a relative URL that will return the next set of results.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_blog_post_like_users_serialize(
            id=id,
            cursor=cursor,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_blog_post_like_users_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the blog post for which account IDs should be returned.")],
        cursor: Annotated[Optional[StrictStr], Field(description="Used for pagination, this opaque cursor will be returned in the `next` URL in the `Link` response header. Use the relative URL in the `Link` header to retrieve the `next` set of results.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Maximum number of account IDs per result to return. If more results exist, use the `Link` header to retrieve a relative URL that will return the next set of results.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MultiEntityResultString]:
        """Get account IDs of likes for blog post
    ...
    @validate_call
    def get_blog_post_like_users_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the blog post for which account IDs should be returned.")],
        cursor: Annotated[Optional[StrictStr], Field(description="Used for pagination, this opaque cursor will be returned in the `next` URL in the `Link` response header. Use the relative URL in the `Link` header to retrieve the `next` set of results.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Maximum number of account IDs per result to return. If more results exist, use the `Link` header to retrieve a relative URL that will return the next set of results.")] = None,
    ...
    def _get_blog_post_like_users_serialize(
        self,
        id,
        cursor,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/blogposts/{id}/likes/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_footer_like_count(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the footer comment for which like count should be returned.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_footer_like_count_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_footer_like_count_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the footer comment for which like count should be returned.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_footer_like_count_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the footer comment for which like count should be returned.")],
        _request_timeout: Union[
            None,
    ...
    def _get_footer_like_count_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/footer-comments/{id}/likes/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_footer_like_users(
        ...
        _param = self._get_footer_like_users_serialize(
            id=id,
            cursor=cursor,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_footer_like_users_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the footer comment for which like count should be returned.")],
        cursor: Annotated[Optional[StrictStr], Field(description="Used for pagination, this opaque cursor will be returned in the `next` URL in the `Link` response header. Use the relative URL in the `Link` header to retrieve the `next` set of results.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Maximum number of account IDs per result to return. If more results exist, use the `Link` header to retrieve a relative URL that will return the next set of results.")] = None,
    ...
    @validate_call
    def get_footer_like_users_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the footer comment for which like count should be returned.")],
        cursor: Annotated[Optional[StrictStr], Field(description="Used for pagination, this opaque cursor will be returned in the `next` URL in the `Link` response header. Use the relative URL in the `Link` header to retrieve the `next` set of results.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Maximum number of account IDs per result to return. If more results exist, use the `Link` header to retrieve a relative URL that will return the next set of results.")] = None,
    ...
    def _get_footer_like_users_serialize(
        self,
        id,
        cursor,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/footer-comments/{id}/likes/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_inline_like_count(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the inline comment for which like count should be returned.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_inline_like_count_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_inline_like_count_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the inline comment for which like count should be returned.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_inline_like_count_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the inline comment for which like count should be returned.")],
        _request_timeout: Union[
            None,
    ...
    def _get_inline_like_count_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/inline-comments/{id}/likes/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_inline_like_users(
        ...
        _param = self._get_inline_like_users_serialize(
            id=id,
            cursor=cursor,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_inline_like_users_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the inline comment for which like count should be returned.")],
        cursor: Annotated[Optional[StrictStr], Field(description="Used for pagination, this opaque cursor will be returned in the `next` URL in the `Link` response header. Use the relative URL in the `Link` header to retrieve the `next` set of results.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Maximum number of account IDs per result to return. If more results exist, use the `Link` header to retrieve a relative URL that will return the next set of results.")] = None,
    ...
    @validate_call
    def get_inline_like_users_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the inline comment for which like count should be returned.")],
        cursor: Annotated[Optional[StrictStr], Field(description="Used for pagination, this opaque cursor will be returned in the `next` URL in the `Link` response header. Use the relative URL in the `Link` header to retrieve the `next` set of results.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Maximum number of account IDs per result to return. If more results exist, use the `Link` header to retrieve a relative URL that will return the next set of results.")] = None,
    ...
    def _get_inline_like_users_serialize(
        self,
        id,
        cursor,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/inline-comments/{id}/likes/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_page_like_count(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the page for which like count should be returned.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_page_like_count_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_page_like_count_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the page for which like count should be returned.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_page_like_count_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the page for which like count should be returned.")],
        _request_timeout: Union[
            None,
    ...
    def _get_page_like_count_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pages/{id}/likes/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_page_like_users(
        ...
        _param = self._get_page_like_users_serialize(
            id=id,
            cursor=cursor,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_page_like_users_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the page for which like count should be returned.")],
        cursor: Annotated[Optional[StrictStr], Field(description="Used for pagination, this opaque cursor will be returned in the `next` URL in the `Link` response header. Use the relative URL in the `Link` header to retrieve the `next` set of results.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Maximum number of account IDs per result to return. If more results exist, use the `Link` header to retrieve a relative URL that will return the next set of results.")] = None,
    ...
    @validate_call
    def get_page_like_users_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the page for which like count should be returned.")],
        cursor: Annotated[Optional[StrictStr], Field(description="Used for pagination, this opaque cursor will be returned in the `next` URL in the `Link` response header. Use the relative URL in the `Link` header to retrieve the `next` set of results.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Maximum number of account IDs per result to return. If more results exist, use the `Link` header to retrieve a relative URL that will return the next set of results.")] = None,
    ...
    def _get_page_like_users_serialize(
        self,
        id,
        cursor,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pages/{id}/likes/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
