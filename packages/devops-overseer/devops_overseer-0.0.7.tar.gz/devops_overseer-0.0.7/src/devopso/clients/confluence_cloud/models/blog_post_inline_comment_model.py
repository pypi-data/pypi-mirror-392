...
class BlogPostInlineCommentModel(BaseModel):
    ...
    blog_post_id: Optional[StrictStr] = Field(default=None, description="ID of the blog post the comment is in.", alias="blogPostId")
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "title", "blogPostId", "version", "body", "resolutionStatus", "properties", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BlogPostInlineCommentModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BlogPostInlineCommentModel from a dict"""
        if obj is None:
            return None
