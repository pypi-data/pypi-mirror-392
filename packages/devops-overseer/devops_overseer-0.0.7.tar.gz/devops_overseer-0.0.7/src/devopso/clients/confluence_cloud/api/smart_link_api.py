...
class SmartLinkApi:
    ...
    def create_smart_link(
        self,
        create_smart_link_request: CreateSmartLinkRequest,
        ...
        :param create_smart_link_request: (required)
        :type create_smart_link_request: CreateSmartLinkRequest
        ...
        _param = self._create_smart_link_serialize(
            create_smart_link_request=create_smart_link_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateSmartLink200Response",
            '400': None,
            '401': None,
            '404': None,
            '413': None,
    ...
    @validate_call
    def create_smart_link_with_http_info(
        self,
        create_smart_link_request: CreateSmartLinkRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateSmartLink200Response]:
        """Create Smart Link in the content tree
    ...
    @validate_call
    def create_smart_link_without_preload_content(
        self,
        create_smart_link_request: CreateSmartLinkRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_smart_link_serialize(
        self,
        ...
        if create_smart_link_request is not None:
            _body_params = create_smart_link_request
    ...
    @validate_call
    def delete_smart_link(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the Smart Link in the content tree to be deleted.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The ID of the Smart Link in the content tree to be deleted. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_smart_link_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_smart_link_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the Smart Link in the content tree to be deleted.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_smart_link_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the Smart Link in the content tree to be deleted.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_smart_link_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_smart_link_by_id(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the Smart Link in the content tree to be returned.")],
        include_collaborators: Annotated[Optional[StrictBool], Field(description="Includes collaborators on the Smart Link.")] = None,
        include_direct_children: Annotated[Optional[StrictBool], Field(description="Includes direct children of the Smart Link, as defined in the `ChildrenResponse` object.")] = None,
        include_operations: Annotated[Optional[StrictBool], Field(description="Includes operations associated with this Smart Link in the response, as defined in the `Operation` object. The number of results will be limited to 50 and sorted in the default sort order. A `meta` and `_links` property will be present to indicate if more results are available and a link to retrieve the rest of the results.")] = None,
        include_properties: Annotated[Optional[StrictBool], Field(description="Includes content properties associated with this Smart Link in the response. The number of results will be limited to 50 and sorted in the default sort order. A `meta` and `_links` property will be present to indicate if more results are available and a link to retrieve the rest of the results.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The ID of the Smart Link in the content tree to be returned. (required)
        :type id: int
        ...
        _param = self._get_smart_link_by_id_serialize(
            id=id,
    ...
    @validate_call
    def get_smart_link_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the Smart Link in the content tree to be returned.")],
        include_collaborators: Annotated[Optional[StrictBool], Field(description="Includes collaborators on the Smart Link.")] = None,
        include_direct_children: Annotated[Optional[StrictBool], Field(description="Includes direct children of the Smart Link, as defined in the `ChildrenResponse` object.")] = None,
    ...
    @validate_call
    def get_smart_link_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the Smart Link in the content tree to be returned.")],
        include_collaborators: Annotated[Optional[StrictBool], Field(description="Includes collaborators on the Smart Link.")] = None,
        include_direct_children: Annotated[Optional[StrictBool], Field(description="Includes direct children of the Smart Link, as defined in the `ChildrenResponse` object.")] = None,
    ...
    def _get_smart_link_by_id_serialize(
        self,
        id,
