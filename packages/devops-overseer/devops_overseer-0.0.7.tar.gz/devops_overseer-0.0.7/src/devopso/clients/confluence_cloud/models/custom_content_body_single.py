...
class CustomContentBodySingle(BaseModel):
    ...
    """ # noqa: E501
    raw: Optional[BodyType] = None
    storage: Optional[BodyType] = None
    atlas_doc_format: Optional[BodyType] = None
    view: Optional[BodyType] = None
    __properties: ClassVar[List[str]] = ["raw", "storage", "atlas_doc_format", "view"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomContentBodySingle from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomContentBodySingle from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "raw": BodyType.from_dict(obj["raw"]) if obj.get("raw") is not None else None,
            ...
            "view": BodyType.from_dict(obj["view"]) if obj.get("view") is not None else None
        })
        return _obj
