...
class FolderSingle(BaseModel):
    ...
    links: Optional[FolderLinks] = Field(default=None, alias="_links")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FolderSingle from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FolderSingle from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "_links": FolderLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
