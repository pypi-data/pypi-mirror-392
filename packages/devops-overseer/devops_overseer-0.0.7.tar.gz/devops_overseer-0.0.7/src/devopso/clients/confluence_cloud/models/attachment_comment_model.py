...
class AttachmentCommentModel(BaseModel):
    ...
    attachment_id: Optional[StrictStr] = Field(default=None, description="ID of the attachment containing the comment.", alias="attachmentId")
    version: Optional[Version] = None
    body: Optional[BodySingle] = None
    links: Optional[CommentLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "status", "title", "attachmentId", "version", "body", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttachmentCommentModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttachmentCommentModel from a dict"""
        if obj is None:
            return None
