...
class CreateSpaceRequestRoleAssignmentsInner(BaseModel):
    """
    ...
    role_id: Optional[StrictStr] = Field(default=None, description="The role to which the principal is assigned.", alias="roleId")
    __properties: ClassVar[List[str]] = ["principal", "roleId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSpaceRequestRoleAssignmentsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSpaceRequestRoleAssignmentsInner from a dict"""
        if obj is None:
            return None
