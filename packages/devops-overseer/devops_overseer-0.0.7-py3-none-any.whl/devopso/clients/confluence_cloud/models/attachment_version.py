...
class AttachmentVersion(BaseModel):
    ...
    attachment: Optional[VersionedEntity] = None
    __properties: ClassVar[List[str]] = ["createdAt", "message", "number", "minorEdit", "authorId", "attachment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attachment": VersionedEntity.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None
        })
        return _obj
