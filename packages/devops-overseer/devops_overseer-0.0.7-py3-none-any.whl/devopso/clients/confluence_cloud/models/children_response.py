...
class ChildrenResponse(BaseModel):
    ...
    ChildrenResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the child content.")
    status: Optional[OnlyArchivedAndCurrentContentStatus] = None
    title: Optional[StrictStr] = Field(default=None, description="Title of the child content.")
    type: Optional[StrictStr] = Field(default=None, description="Hierarchical content type (database/embed/folder/page/whiteboard).")
    space_id: Optional[StrictStr] = Field(default=None, description="ID of the space the content is in.", alias="spaceId")
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "title", "type", "spaceId", "childPosition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChildrenResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChildrenResponse from a dict"""
        if obj is None:
            return None
