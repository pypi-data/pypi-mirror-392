...
class ChildPage(BaseModel):
    ...
    child_position: Optional[StrictInt] = Field(default=None, description="Position of child page within the given parent page tree.", alias="childPosition")
    __properties: ClassVar[List[str]] = ["id", "status", "title", "spaceId", "childPosition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChildPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChildPage from a dict"""
        if obj is None:
            return None
