...
class BodySingle(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["storage", "atlas_doc_format", "view"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BodySingle from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BodySingle from a dict"""
        if obj is None:
            return None
