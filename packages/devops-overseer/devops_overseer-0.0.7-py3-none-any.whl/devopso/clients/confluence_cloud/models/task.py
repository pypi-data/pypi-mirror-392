...
class Task(BaseModel):
    ...
    body: Optional[TaskBodySingle] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "localId", "spaceId", "pageId", "blogPostId", "status", "body", "createdBy", "assignedTo", "completedBy", "createdAt", "updatedAt", "dueAt", "completedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "body": TaskBodySingle.from_dict(obj["body"]) if obj.get("body") is not None else None,
