...
class CommentVersion(BaseModel):
    ...
    comment: Optional[VersionedEntity] = None
    __properties: ClassVar[List[str]] = ["createdAt", "message", "number", "minorEdit", "authorId", "comment"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommentVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommentVersion from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "comment": VersionedEntity.from_dict(obj["comment"]) if obj.get("comment") is not None else None
        })
        return _obj
