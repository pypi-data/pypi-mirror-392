...
class UpdateBlogPostRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "title", "spaceId", "body", "version", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateBlogPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateBlogPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "version": UpdateBlogPostRequestVersion.from_dict(obj["version"]) if obj.get("version") is not None else None,
