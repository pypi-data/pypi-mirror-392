...
class SubmitIncidentsRequestAnyOf1(BaseModel):
    """
    SubmitIncidentsRequestAnyOf1
    """ # noqa: E501
    reviews: Optional[Annotated[List[Review], Field(min_length=1, max_length=1000)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitIncidentsRequestAnyOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitIncidentsRequestAnyOf1 from a dict"""
        if obj is None:
            return None
