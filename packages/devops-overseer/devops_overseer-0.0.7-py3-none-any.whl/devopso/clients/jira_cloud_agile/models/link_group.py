...
class LinkGroup(BaseModel):
    ...
    header: Optional[LinkGroupHeader] = None
    id: Optional[StrictStr] = None
    links: Optional[List[LinkGroupHeader]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "header": LinkGroupHeader.from_dict(obj["header"]) if obj.get("header") is not None else None,
            "id": obj.get("id"),
            "links": [LinkGroupHeader.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
