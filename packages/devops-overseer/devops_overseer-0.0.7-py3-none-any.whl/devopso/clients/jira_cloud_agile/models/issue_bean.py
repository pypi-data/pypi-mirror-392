...
class IssueBean(BaseModel):
    ...
    """ # noqa: E501
    changelog: Optional[IssueBeanChangelog] = None
    editmeta: Optional[IssueBeanEditmeta] = None
    ...
    fields_to_include: Optional[IssueBeanFieldsToInclude] = Field(default=None, alias="fieldsToInclude")
    ...
    var_schema: Optional[Dict[str, IssueBeanSchemaValue]] = Field(default=None, description="The schema describing each field present on the issue.", alias="schema")
    var_self: Optional[StrictStr] = Field(default=None, description="The URL of the issue details.", alias="self")
    transitions: Optional[List[IssueBeanTransitionsInner]] = Field(default=None, description="The transitions that can be performed on the issue.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changelog": IssueBeanChangelog.from_dict(obj["changelog"]) if obj.get("changelog") is not None else None,
            "editmeta": IssueBeanEditmeta.from_dict(obj["editmeta"]) if obj.get("editmeta") is not None else None,
            "expand": obj.get("expand"),
            "fields": obj.get("fields"),
            "fieldsToInclude": IssueBeanFieldsToInclude.from_dict(obj["fieldsToInclude"]) if obj.get("fieldsToInclude") is not None else None,
            "id": obj.get("id"),
            "key": obj.get("key"),
            "names": obj.get("names"),
            ...
            "self": obj.get("self"),
            "transitions": [IssueBeanTransitionsInner.from_dict(_item) for _item in obj["transitions"]] if obj.get("transitions") is not None else None,
