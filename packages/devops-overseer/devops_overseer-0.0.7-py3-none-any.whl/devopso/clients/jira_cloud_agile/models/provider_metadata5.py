...
class ProviderMetadata5(BaseModel):
    """
    ...
    """ # noqa: E501
    product: Optional[StrictStr] = Field(default=None, description="An optional name of the source of the vulnerabilities.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProviderMetadata5 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProviderMetadata5 from a dict"""
        if obj is None:
            return None
