...
class RejectedBuild(BaseModel):
    ...
    """ # noqa: E501
    key: BuildKey
    errors: List[ErrorMessage] = Field(description="The error messages for the rejected build")
    __properties: ClassVar[List[str]] = ["key", "errors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RejectedBuild from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RejectedBuild from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "key": BuildKey.from_dict(obj["key"]) if obj.get("key") is not None else None,
