...
class EntityError(BaseModel):
    ...
    error_messages: Optional[List[ErrorMessage]] = Field(default=None, description="Error message", alias="errorMessages")
    __properties: ClassVar[List[str]] = ["id", "errorMessages"]
