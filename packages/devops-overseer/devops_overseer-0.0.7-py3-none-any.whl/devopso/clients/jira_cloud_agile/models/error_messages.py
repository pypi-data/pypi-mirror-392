...
class ErrorMessages(BaseModel):
    ...
    """ # noqa: E501
    error_messages: List[ErrorMessage] = Field(description="List of errors occurred.", alias="errorMessages")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ErrorMessages from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ErrorMessages from a dict"""
        if obj is None:
            return None
