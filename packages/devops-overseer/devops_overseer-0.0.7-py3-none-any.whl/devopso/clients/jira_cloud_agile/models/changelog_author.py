...
class ChangelogAuthor(BaseModel):
    """
    ...
    avatar_urls: Optional[ChangelogAuthorAllOfAvatarUrls] = Field(default=None, alias="avatarUrls")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChangelogAuthor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChangelogAuthor from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "avatarUrls": ChangelogAuthorAllOfAvatarUrls.from_dict(obj["avatarUrls"]) if obj.get("avatarUrls") is not None else None,
