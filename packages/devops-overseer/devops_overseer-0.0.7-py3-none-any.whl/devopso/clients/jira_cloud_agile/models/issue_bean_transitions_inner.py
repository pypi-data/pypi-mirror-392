...
class IssueBeanTransitionsInner(BaseModel):
    """
    ...
    fields: Optional[Dict[str, IssueBeanEditmetaAllOfFieldsValue]] = Field(default=None, description="Details of the fields associated with the issue transition screen. Use this information to populate `fields` and `update` in a transition request.")
    ...
    to: Optional[IssueBeanTransitionsInnerTo] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueBeanTransitionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueBeanTransitionsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fields": dict(
                (_k, IssueBeanEditmetaAllOfFieldsValue.from_dict(_v))
            ...
            "name": obj.get("name"),
            "to": IssueBeanTransitionsInnerTo.from_dict(obj["to"]) if obj.get("to") is not None else None
        })
