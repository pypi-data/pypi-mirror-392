...
class ActionsUpdateSelfHostedRunnerGroupForOrgRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "visibility", "allows_public_repositories", "restricted_to_workflows", "selected_workflows", "network_configuration_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if network_configuration_id (nullable) is None
        # and model_fields_set contains the field
        if self.network_configuration_id is None and "network_configuration_id" in self.model_fields_set:
            _dict['network_configuration_id'] = None
