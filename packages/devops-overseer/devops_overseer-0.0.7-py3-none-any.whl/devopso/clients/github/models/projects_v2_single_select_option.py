...
class ProjectsV2SingleSelectOption(BaseModel):
    ...
    name: StrictStr = Field(description="The display name of the option.")
    color: Optional[StrictStr] = Field(default=None, description="The color associated with the option.")
    description: Optional[StrictStr] = Field(default=None, description="A short description of the option.")
