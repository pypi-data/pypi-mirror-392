...
class SaveProjectTemplateRequest(BaseModel):
    ...
    """ # noqa: E501
    project_id: Optional[StrictInt] = Field(default=None, description="The ID of the target project", alias="projectId")
    template_generation_options: Optional[CustomTemplateOptions] = Field(default=None, alias="templateGenerationOptions")
    template_type: Optional[StrictStr] = Field(default=None, description="The type of the template: LIVE | SNAPSHOT", alias="templateType")
    __properties: ClassVar[List[str]] = ["projectId", "templateGenerationOptions", "templateType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SaveProjectTemplateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SaveProjectTemplateRequest from a dict"""
        if obj is None:
            return None
