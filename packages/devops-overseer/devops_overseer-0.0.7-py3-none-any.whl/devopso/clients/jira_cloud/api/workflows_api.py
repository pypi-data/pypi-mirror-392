...
class WorkflowsApi:
    ...
    def get_default_editor(
        ...
        _param = self._get_default_editor_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DefaultWorkflowEditorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_default_editor_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DefaultWorkflowEditorResponse]:
        """Get the user's default workflow editor
    ...
    @validate_call
    def get_default_editor_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_default_editor_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/3/workflows/defaultEditor',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def read_workflow_previews(
        ...
        :param workflow_preview_request: (required)
        :type workflow_preview_request: WorkflowPreviewRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._read_workflow_previews_serialize(
            workflow_preview_request=workflow_preview_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def read_workflow_previews_with_http_info(
        self,
        workflow_preview_request: WorkflowPreviewRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_workflow_previews_without_preload_content(
        self,
        workflow_preview_request: WorkflowPreviewRequest,
        _request_timeout: Union[
            None,
    ...
    def _read_workflow_previews_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if workflow_preview_request is not None:
            _body_params = workflow_preview_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/api/3/workflows/preview',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
