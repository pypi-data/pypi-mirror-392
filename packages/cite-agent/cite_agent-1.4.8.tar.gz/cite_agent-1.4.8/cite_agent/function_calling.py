        ...
        if is_data_analysis:
            ...
            synthesis_instruction = {
                ...
                "content": (
                    ...
                    "RULES:\n"
                    "- Be BRIEF and DIRECT\n"
                    "- ANSWER THE USER'S QUESTION first, then provide details\n"
                    "- If user asked 'is there CSV data?', answer YES or NO first, then list files\n"
                    "- If user asked 'what files are here?', list the key files\n"
