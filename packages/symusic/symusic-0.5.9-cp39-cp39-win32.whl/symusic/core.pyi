...
class ScoreTick:
    ...
    @staticmethod
    def from_file(path: str | os.PathLike, format: Optional[str] = None) -> ScoreTick: ...
...
class ScoreQuarter:
    ...
    @staticmethod
    def from_file(path: str | os.PathLike, format: Optional[str] = None) -> ScoreQuarter: ...
...
class ScoreSecond:
    ...
    @staticmethod
    def from_file(path: str | os.PathLike, format: Optional[str] = None) -> ScoreSecond: ...
