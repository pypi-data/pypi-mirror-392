...
class TelegramClient:
    ...
    async def send(
        ...
        async with self._sdk._session.post(
            f"{self._sdk.base_url}/api/v1/tools/telegram/send",
            json=payload,
            ...
            # Handle other responses using standard error handling
            return await self._sdk._handle_response(response, expected_status=200)
