...
def _patch_multi_connector_wait_for_save() -> None:
    ...
    try:
        ...
        logger.warning("Could not patch MultiConnector.wait_for_save - module not found")
...
def _patch_outputs_finished_dumping() -> None:
    ...
    try:
        ...
        patched_ModelRunnerOutput = make_dataclass(
            'ModelRunnerOutput',
            [
                ('finished_dumping', Optional[dict[str, list[str]]], field(default=None)),
...
def _patch_scheduler_update_from_output() -> None:
    ...
    try:
        ...
        logger.warning("Could not patch Scheduler.update_from_output - module not found")
