...
motor = board.set_pin_mode_stepper(interface=1, pin1=8, pin2=10, pin3=9, pin4=11)
...
board.stepper_set_acceleration(motor, 100)
board.stepper_set_speed(motor, 200)

# set the absolute position in steps
board.stepper_move_to(motor, -32769)
