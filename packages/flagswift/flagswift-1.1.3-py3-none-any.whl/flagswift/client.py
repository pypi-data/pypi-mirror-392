...
class FlagSwift:
    ...
    def is_enabled(
        ...
        Args:
            ...
            user_id: Optional user ID(s) for targeting (email, username, etc.)
        ...
        Returns:
            True if flag is enabled, False otherwise
                 ...
                 Examples:
         >>>  # Using email
         >>> flags.is_enabled('premium-feature', user_id='user@example.com')
        
         >>>  # Using username
         >>> flags.is_enabled('beta-feature', user_id='john_doe')
        
         >>>  # Using any identifier your app uses
         >>> flags.is_enabled('new-dashboard', user_id='customer-123')
        """
        ...
        if targeting and targeting.get('enabled'):
            ...
            if target_users:
                ...
                is_explicitly_targeted = any(uid in target_users for uid in user_ids)
