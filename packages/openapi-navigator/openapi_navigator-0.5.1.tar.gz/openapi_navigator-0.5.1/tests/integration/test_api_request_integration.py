...
class TestApiRequestIntegration:
    ...
    def test_real_api_connection_error(self, mock_request):
        ...
        import requests
        mock_request.side_effect = requests.ConnectionError("Failed to resolve hostname")
    ...
    @pytest.mark.integration
    @patch("openapi_navigator.server.requests.request")
    def test_combined_workflow_spec_loading_and_api_requests(self, mock_request, sample_openapi_spec):
        ...
        mock_get_response.text = json.dumps({"args": {}, "url": "https://httpbin.org/get"})
        mock_get_response.json.return_value = {"args": {}, "url": "https://httpbin.org/get"}
        ...
        mock_request.side_effect = [mock_get_response, mock_post_response, mock_error_response]
