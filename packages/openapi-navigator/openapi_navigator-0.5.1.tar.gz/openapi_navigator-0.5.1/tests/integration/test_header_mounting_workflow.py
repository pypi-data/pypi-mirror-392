...
class TestHeaderMountingWorkflow:
    ...
    def test_complete_workflow_with_mocked_api(self, mock_request, sample_openapi_spec):
        ...
        mock_get_response.text = json.dumps({"args": {}, "headers": {}, "url": "https://httpbin.org/get"})
        mock_get_response.json.return_value = {"args": {}, "headers": {}, "url": "https://httpbin.org/get"}
    ...
    @patch("openapi_navigator.server.requests.request")
    def test_multiple_specs_with_different_headers(self, mock_request, sample_openapi_spec):
