...
class Client:
  ...
  def send_guild_message(self, message: str, character_to_name: str = "", officer_message: bool = False) -> Response:
    if self.state.character.guild_id == 0:
      return Response(status_code=400, error="Not in a guild.")
    ...
    return self.call(
      ...
      {
        "message": message,
        "character_to_name": character_to_name,
        "officer_message": "true" if officer_message else "false",
      }
    )