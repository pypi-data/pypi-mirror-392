...
class RedistributeVehicles:
    def __init__(
        ...
        self.__final_columns = ["TRACT", "VEHICLE_CLASS", "FUEL", "POWERTRAIN", "VINTAGE", "PROPORTION"]
        # Polaris codes
    ...
    def fix_across_tracts(self):
        self.__results = correct_across_tracts(self.__results.reset_index()).set_index(self.__final_columns)
