...
class ListFeatureEntitiesRequest(RoaRequest):
	...
	def get_ParentFeatureEntityId(self): # String
		return self.get_query_params().get('ParentFeatureEntityId')

	def set_ParentFeatureEntityId(self, ParentFeatureEntityId):  # String
		self.add_query_param('ParentFeatureEntityId', ParentFeatureEntityId)
