...
class FeatureAlgorithm : public ComputationTask {
	public:
		int n_features;
		// The memory for features_out is allocated and disposed of elsewhere
		// The ammount of memory allocated is at least sufficient to contain n_features
		virtual void execute (const ImageMatrix &IN_matrix, double *features_out) const {};
