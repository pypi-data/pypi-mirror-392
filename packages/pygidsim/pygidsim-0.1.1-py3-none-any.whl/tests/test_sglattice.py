...
class TestGIWAXSFromSGLattice:
    ...
    def test_giwaxs_sim_random_orientation_with_mi_restriction(self, xu_lattice, exp_parameters, mi_restriction):
        """Test GIWAXS simulation with random orientation, MI return and MI restriction."""
        el = GIWAXSFromSGLattice(xu_lattice, exp_parameters)
        q_2d, intensity_2d, mi_2d = el.giwaxs.giwaxs_sim(
            orientation='random',
