...
from perfview._null_file import NULL_FILE
...
class Capture:
    ...
    See :meth:`~perfview.console.Console.capture` for how to use.
...
class ThemeContext:
    """A context manager to use a temporary theme. See :meth:`~perfview.console.Console.use_theme` for usage."""
...
class PagerContext:
    """A context manager that 'pages' content. See :meth:`~perfview.console.Console.pager` for usage."""
...
class ScreenContext:
    """A context manager that enables an alternative screen. See :meth:`~perfview.console.Console.screen` for usage."""
...
class Console:
    ...
    def push_theme(self, theme: Theme, *, inherit: bool = True) -> None:
        ...
        Generally speaking, you should call :meth:`~perfview.console.Console.use_theme` to get a context manager, rather
    ...
    def pager(
        ...
        Args:
            pager (Pager, optional): A pager object, or None to use :class:`~perfview.pager.SystemPager`. Defaults to None.
            styles (bool, optional): Show styles in pager. Defaults to False.
            links (bool, optional): Show links in pager. Defaults to False.

        Example:
            >>> from perfview.console import Console
            >>> from perfview.__main__ import make_test_card
            >>> console = Console()
            >>> with console.pager():
    ...
    def set_alt_screen(self, enable: bool = True) -> bool:
        ...
        the application exits. See :meth:`~perfview.Console.screen` for a context manager
    ...
    def measure(
        ...
        """Measure a renderable. Returns a :class:`~perfview.measure.Measurement` object which contains
    ...
    def out(
        ...
        *objects: Any,
        ...
        :meth:`~perfview.console.Console.print` won't pretty print, wrap text, or apply markup, but will
    ...
    def print_json(
        ...
        *,
        ...
        """
        from perfview.json import JSON
    ...
    def update_screen_lines(
        ...
        Args:
            lines (List[List[Segment]]): Rendered lines (as produced by :meth:`~perfview.Console.render_lines`).
                ...
                if self.is_jupyter:  # pragma: no cover
                    ...
                    if WINDOWS:
                        ...
                        if use_legacy_windows_render:
                            from perfview._win32_console import LegacyWindowsTerm
                            from perfview._windows_renderer import legacy_windows_render
    ...
    def export_svg(
        ...
        *,
        ...
        from perfview.cells import cell_len
