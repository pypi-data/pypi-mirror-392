...
def test_lookup_no_result(test_app, test_client, actor_id, bearer_header, test_broker):
...
def test_lookup_result(test_app, test_client, actor_id, bearer_header, test_broker):
    test_broker.request = AsyncMock(
...
def test_perform_action(test_app, test_client, actor_id, bearer_header, test_broker):
