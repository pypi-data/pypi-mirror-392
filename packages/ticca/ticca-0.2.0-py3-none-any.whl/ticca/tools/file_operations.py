...
def _list_files(
    ...
    try:
        ...
        if not recursive:
            try:
                from ticca.tools.common import should_ignore_dir_path
...
def _grep(context: RunContext, search_string: str, directory: str = ".") -> GrepOutput:
    ...
    try:
        ...
        # Add ignore patterns to the command via a temporary file
        from ticca.tools.common import DIR_IGNORE_PATTERNS
        ...
        if not matches:
            ...
            from ticca.config import get_grep_output_verbose
...
def register_list_files(agent):
    ...
    from ticca.config import get_allow_recursion
