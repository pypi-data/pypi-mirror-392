...
> For **built-in commands**, see the built-in command files in `ticca/command_line/`.
...
- Located in `ticca/command_line/core_commands.py`, `session_commands.py`, `config_commands.py`
...
```
ticca/plugins/example_custom_command/
...
```bash
mkdir -p ticca/plugins/my_plugin
touch ticca/plugins/my_plugin/__init__.py
touch ticca/plugins/my_plugin/register_callbacks.py
```

### Step 2: Implement Callbacks

```python
# ticca/plugins/my_plugin/register_callbacks.py

from ticca.callbacks import register_callback
from ticca.messaging import emit_info, emit_success
...
from ticca.plugins.my_plugin.register_callbacks import _handle_custom_command
...
- `ticca/callbacks.py` - Callback system implementation
- `ticca/command_line/command_handler.py` - Command dispatcher
- `ticca/command_line/core_commands.py` - Example built-in commands
- `ticca/command_line/command_registry.py` - Registry system
