...
from ticca.plugins.chatgpt_oauth import config, utils
...
def test_config_paths():
    ...
    assert ".ticca" in str(token_path)

    config_dir = config.get_config_dir()
    assert config_dir.name == ".ticca"
...
@patch("ticca.plugins.chatgpt_oauth.utils.requests.post")
...
@patch("ticca.plugins.chatgpt_oauth.utils.requests.get")
