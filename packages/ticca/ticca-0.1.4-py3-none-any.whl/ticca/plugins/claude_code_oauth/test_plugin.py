...
def test_plugin_imports() -> bool:
    ...
    try:
        from ticca.plugins.claude_code_oauth.config import (
    ...
    try:
        from ticca.plugins.claude_code_oauth.utils import (
    ...
    try:
        from ticca.plugins.claude_code_oauth.register_callbacks import (
            _custom_help,
