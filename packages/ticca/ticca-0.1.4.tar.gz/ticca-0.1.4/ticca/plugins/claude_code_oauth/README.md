...
After authentication, models will be added to `~/.ticca/extra_models.json`:
...
- **Token Storage**: Tokens are saved to `~/.ticca/claude_code_oauth.json` with `0o600` permissions
