...
from ticca.config import CONTEXTS_DIR
from ticca.session_storage import list_sessions, load_session, save_session
...
def handle_session_command(command: str) -> bool:
    ...
    from ticca.messaging import emit_info, emit_success, emit_warning
...
def handle_compact_command(command: str) -> bool:
    ...
    from ticca.config import get_compaction_strategy, get_protected_token_count
...
def handle_load_context_command(command: str) -> bool:
    ...
    from ticca.agents.agent_manager import get_current_agent
    from ticca.config import rotate_autosave_id
    from ticca.messaging import emit_error, emit_info, emit_success, emit_warning
