...
import ticca.command_line.config_commands  # noqa: F401
import ticca.command_line.core_commands  # noqa: F401
import ticca.command_line.session_commands  # noqa: F401
...
def handle_command(command: str):
    ...
    """
    from ticca.messaging import emit_info, emit_warning
    ...
    if command.startswith("/"):
        ...
        try:
            ...
            try:
                from ticca.plugins.customizable_commands.register_callbacks import (
