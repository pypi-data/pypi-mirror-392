...
from fango.utils import replace_proto, reverse_ordering, run_async
...
class CursorPagination:
    ...
    async def get_enumerated_page(self, queryset: "QuerySet") -> dict[str, "Model"]:
        return {instance.pk: instance for instance in await run_async(self.get_page, queryset)}
