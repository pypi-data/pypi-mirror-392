...
class ClientMessageAssistantStarted(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageAssistantStartedPhoneNumber], FieldMetadata(alias="phoneNumber")
    ...
    new_assistant: typing_extensions.Annotated["CreateAssistantDto", FieldMetadata(alias="newAssistant")] = (
        pydantic.Field()
    )
    """
...
update_forward_refs(ClientMessageAssistantStarted)
