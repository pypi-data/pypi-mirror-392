...
class CodeInterpreterApiRoutes:
    ...
    def __init__(self, router: Router, config: ConfigService, get_default_auth_scheme: Callable[[], AuthenticationScheme], client_aware_service: ClientAwareService, token_service: VerifyTokenService, third_party_integration_service: ThirdPartyIntegrationService) -> None:
