...
def get_organization_members(auth_scheme: AuthenticationScheme, cache_service: CacheService, organization: str) -> tuple[list[str], Any]:
    ...
    """
def get_repository_commits(owner: str, repo: str, auth_scheme: AuthenticationScheme, *, sha: str | None = None, path: str | None = None, author: str | None = None, since: str | None = None, until: str | None = None, per_page: int | None = None, page: int | None = None) -> tuple[list[Commit], Any]:
    ...
    Returns:
        ...
        - Any: The pagination metadata.
    """
def get_repository_collaborators(owner: str, repo: str, auth_scheme: AuthenticationScheme, *, affiliation: GithubCollaboratorAffiliation | None = None, permission: GithubCollaboratorPermission | None = None, per_page: int | None = None, page: int | None = None) -> tuple[list[Collaborator], Any]:
    ...
    Returns:
        ...
        - Any: The pagination metadata.
    """
def get_repository_releases(owner: str, repo: str, auth_scheme: AuthenticationScheme, per_page: int | None = None, page: int | None = None) -> list[Release]:
