...
class FinanFutClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._api_url = resolved["api_url"].rstrip("/")
        self._dry_run = dry_run

        self._session = requests.Session()
        self._interact_client: Optional["InteractClient"] = None
        self._requests_client: Optional["RequestsClient"] = None
        self._applications_client: Optional["ApplicationsClient"] = None
        self._agents_client: Optional["AgentsClient"] = None
        self._intents_client: Optional["IntentsClient"] = None
        self._memory_client: Optional["MemoryClient"] = None
        self._contexts_client: Optional["ContextsClient"] = None
        self._context_sessions_client: Optional["ContextSessionsClient"] = None
        self._billing_client: Optional["BillingClient"] = None
        self._analytics_client: Optional["AnalyticsClient"] = None
        self._access_tokens_client: Optional["AccessTokensClient"] = None
