from forgeo.core.data import InterpolationMethod, Interpolator, Item
from forgeo.core.faultnetwork import FaultNetwork
from forgeo.core.unit import ModellingUnit
from forgeo.utils import BBox
...
class Model:
    ...
    def update_interpolator(self, other):
        ...
        if interpolator is None:
            raise ValueError(
                "None of this model interpolators matches the input interpolator dataset"
            )
