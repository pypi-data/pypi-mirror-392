...
Examples:
  ...
  python workflow_demo.py examples/return_workflow.yaml --thread-id order_12345
    ...
    parser.add_argument("workflow", default="../examples/greeting_workflow.yaml", help="Path to workflow YAML file")
    parser.add_argument(
        "--thread-id",
    ...
    try:
        run_workflow("../examples/greeting_workflow.yaml", thread_id="test", mongodb_uri=None)
