    ...
    if non_pv_generation_components is not None:
      for non_pv in non_pv_generation_components:
        ...
        if non_pv['domestic_hot_water'] is not None:
          dhw = non_pv['domestic_hot_water'] == 'True'

        reversible = None
        if non_pv['reversible'] is not None:
          reversible = non_pv['reversible'] == 'True'
        dual_supply = None
        if non_pv['simultaneous_heat_cold'] is not None:
          dual_supply = non_pv['simultaneous_heat_cold'] == 'True'
