...
Sample:
![](https://github.com/iowarp/agent-toolkit/blob/main/agent-toolkit-mcp-servers/adios/assets/list_files.png)
...
Sample:
![](https://github.com/iowarp/agent-toolkit/blob/main/agent-toolkit-mcp-servers/adios/assets/steps.png) 
...
Sample:
![](https://github.com/iowarp/agent-toolkit/blob/main/agent-toolkit-mcp-servers/adios/assets/attributes.png)  
...
Sample:
![](https://github.com/iowarp/agent-toolkit/blob/main/agent-toolkit-mcp-servers/adios/assets/read_steps.png)
...
Sample:
![](https://github.com/iowarp/agent-toolkit/blob/main/agent-toolkit-mcp-servers/adios/assets/read_bp5.png)
...
Sample:
![](https://github.com/iowarp/agent-toolkit/blob/main/agent-toolkit-mcp-servers/adios/assets/minmax.png)
...
Sample:
![](https://github.com/iowarp/agent-toolkit/blob/main/agent-toolkit-mcp-servers/adios/assets/add_variables.png)