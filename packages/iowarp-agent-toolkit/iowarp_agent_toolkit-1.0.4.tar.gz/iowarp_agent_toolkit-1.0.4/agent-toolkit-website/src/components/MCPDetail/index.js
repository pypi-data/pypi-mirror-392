...
const MCPDetail = ({ 
  ...
  "mcpServers": {
    "${name.toLowerCase()}-mcp": {
      "command": "uvx",
      "args": ["agent-toolkit", "${name.toLowerCase()}"]
    }
  }
}`
    },
  ...
  "servers": {
    ...
    claude_code: {
      title: 'Claude Code',
      language: 'bash',
      code: `claude mcp add ${name.toLowerCase()}-mcp -- uvx agent-toolkit ${name.toLowerCase()}`
    },
    claude_desktop: {
...
uv --directory=$CLONE_DIR/agent-toolkit/agent-toolkit-mcp-servers/${name.toLowerCase().replace(/ /g, '-')} run ${name.toLowerCase().replace(/ /g, '-')}-mcp --help
...
$env:CLONE_DIR=$PWD
git clone https://github.com/iowarp/agent-toolkit.git
uv --directory=$env:CLONE_DIR\\agent-toolkit\\agent-toolkit-mcp-servers\\${name.toLowerCase().replace(/ /g, '-')} run ${name.toLowerCase().replace(/ /g, '-')}-mcp --help`
    }
  };
  ...
  return (
    <div className={styles.mcpDetail}>
      ...
      <div className={styles.header}>
        <Link to="/agent-toolkit" className={styles.backButton}>
          ← Back to MCPs
        </Link>
      ...
      <div className={styles.footer}>
        <div className={styles.footerLinks}>
          <Link href="https://github.com/iowarp/agent-toolkit" className={styles.footerLink}>
            📖 View on GitHub
          </Link>
          <Link href="https://github.com/iowarp/agent-toolkit/issues" className={styles.footerLink}>
            🐛 Report Issue
          </Link>
        </div>
        <p className={styles.footerText}>
          Part of the Agent Toolkit collection - bringing AI practically to science!
        </p>
      </div>
    </div>
  );
