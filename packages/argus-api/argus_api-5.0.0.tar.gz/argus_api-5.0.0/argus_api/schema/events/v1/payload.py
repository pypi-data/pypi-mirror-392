...
get_payload = {
    ...
    "responses": {
        "default": {
            "description": "Fetch specified event payload",
            "content": {
                "application/json": {
                    "schema": {
                        "type": "object",
                        "properties": {
                            ...
                            "data": {
                                ...
                                "properties": {
                                    "id": {
                                        "type": "string",
                                        "description": "ID of the event this payload belongs to",
                                    },
                                    "payload": {
                                        "type": "string",
                                        "description": "Payload string (may be base64-encoded binary, depending on type)",
                                    },
                                    "type": {
                                        "type": "string",
