...
change_password = {
    "tags": ["currentuser/v1"],
    "summary": "This endpoint is deprecated. Use PUT /authentication/v1/password instead. (PUBLIC)",
    "description": "",
    ...
    "responses": {
        "default": {
            "description": "This endpoint is deprecated. Use PUT /authentication/v1/password instead.",
            "content": {
                "application/json": {
                    "schema": {
                        "type": "object",
