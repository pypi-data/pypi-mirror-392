...
check_permission = {
    "tags": ["currentuser/v1"],
    "summary": "Validate current user permission to perform function on specific customer. Use /authentication/v1/session/permission/{function}/{customer} instead. (PUBLIC)",
    "description": "",
    "operationId": "checkCurrentUserPermission",
    "parameters": [
        {
            "name": "function",
            "in": "path",
    ...
    "responses": {
        "default": {
            "description": "Validate current user permission to perform function on specific customer. Use /authentication/v1/session/permission/{function}/{customer} instead.",
            "content": {
                "application/json": {
                    "schema": {
                        "type": "object",
