...
list_indicator_types = {
    "tags": ["v2/type"],
    "summary": "List all available indicator types, sorted by shortName. (DEV)",
    "description": "",
    "operationId": "listIndicatorTypes",
    "responses": {
        "default": {
            "description": "List all available indicator types, sorted by shortName.",
            "content": {
                "application/json": {
                    "schema": {
                        "type": "object",
                        "properties": {
                            ...
                            "data": {
                                ...
                                "items": {
                                    "type": "object",
                                    "description": "Information about an indicator type.",
                                    "properties": {
                                        "name": {
                                            "type": "string",
    ...
    "x-Argus-Required-Permissions": ["viewReputationIndicatorTypes"],
