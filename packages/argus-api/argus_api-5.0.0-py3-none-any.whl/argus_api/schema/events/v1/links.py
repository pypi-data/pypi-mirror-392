...
get_event_links = {
    "tags": ["events/v1"],
    "summary": "Fetches links of the corresponding event (PUBLIC)",
    "description": "",
    "operationId": "getEventLinks",
    "parameters": [
        {
            "name": "type",
            "in": "path",
    ...
    "responses": {
        "default": {
            "description": "Fetches links of the corresponding event",
            "content": {
                "application/json": {
                    "schema": {
                        "type": "object",
