...
from python_agent.tests.unit.build_scanner.test_hashing.cases.decorators.class_decorator_add.after import C
...
class ConfigData(object):
    def __init__(
        ...
        self.testProjectId = constants.DEFAULT_TEST_PROJECT_ID
