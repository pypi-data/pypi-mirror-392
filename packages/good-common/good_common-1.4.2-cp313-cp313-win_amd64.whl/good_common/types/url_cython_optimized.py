...
from typing import Optional, Set, Dict, List, Tuple, Any, TYPE_CHECKING
import warnings
...
if not CYTHON_AVAILABLE:
    warnings.warn(
        f"Cython URL extensions not available, falling back to pure Python",
        RuntimeWarning,
        stacklevel=2
    )
...
class OptimizedURL:
    ...
    _canonicalizer: Optional[Any] = None
    _classifier: Optional[Any] = None
    _domain_matcher: Optional[Any] = None
