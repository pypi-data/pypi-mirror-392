...
from recipes.intel_ndns.spiking_fullsubnet.efficient_spiking_neuron import (
    MemoryState,
...
class Model(nn.Module):
    ...
    def forward(self, input):
        ...
        enh_stft = deepfiltering(
            noisy_cmp, df_coef, self.df_order, self.num_spks
        )  # [B, c, s, f, t]
