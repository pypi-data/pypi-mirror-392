...
N3_AUDIOGRAM_FREQUENCIES: Final = np.array(
...
MEL_FREQUENCIES_16_CHANNELS: Final = np.array(
    [
        0,
        200,
        400,
...
N3_NAL_NL2_TABLE_16_CHANNELS_COMP_THRESHOLDS: Final = np.array([65] * 16)
N3_NAL_NL2_TABLE_16_CHANNELS_COMP_RATIOS: Final = np.array(
    [1.4, 1.4, 1.4, 1.3, 1.3, 2.0, 2.2, 2.2, 2.3, 2.4, 2.7, 2.8, 2.6, 2.5, 2.2, 2.1]
)
N3_NAL_NL2_TABLE_16_CHANNELS_LOW_GAINS: Final = np.array(
    [
        3.7,
        3.7,
        3.8,
