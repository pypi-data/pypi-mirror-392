...
class BulkOperationCoordinator:
    ...
    def update(
        ...
        logger.error(f"🟧 COORDINATOR.update ENTRY: fields={fields}, objs count={len(objs)}")
        ...
        logger.error(f"🟧 COORDINATOR.update: About to call executor with fields={fields}")
        
        def operation():
            logger.error(f"🟧 COORDINATOR.update OPERATION: Calling executor.bulk_update with fields={fields}")
