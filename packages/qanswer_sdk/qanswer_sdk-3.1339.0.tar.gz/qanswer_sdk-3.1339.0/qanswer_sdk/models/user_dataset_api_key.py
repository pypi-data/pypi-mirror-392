...
class UserDatasetApiKey(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "username", "dataset", "apiKey", "apiKeyName", "expiryDate", "questionCreditsStart", "questionCreditsUsed", "quotaQuestionCredits", "accessType"]
