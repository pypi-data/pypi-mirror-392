...
class ChatbotChatPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["question", "username", "conversation_id", "llm_choice", "image_urls", "parent_message_id", "is_regenerate", "system_message", "addon_system_message", "additional_fields", "bypass_guardrail", "origin", "oauth_token", "agentic_chatbot_enabled", "current_time", "auto_filters", "filters", "apply_map_reduce"]
