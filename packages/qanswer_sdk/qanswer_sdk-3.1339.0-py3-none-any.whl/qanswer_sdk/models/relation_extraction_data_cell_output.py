...
class RelationExtractionDataCellOutput(BaseModel):
    """
    RelationExtractionDataCellOutput
    """ # noqa: E501
    subject: SubjectModel
    relation: RelationModel
    value: ValueModel
    __properties: ClassVar[List[str]] = ["subject", "relation", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RelationExtractionDataCellOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RelationExtractionDataCellOutput from a dict"""
        if obj is None:
            return None
