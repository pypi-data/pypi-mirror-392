...
class SearchPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["question", "username", "dataset", "auto_apply_filters", "apply_map_reduce", "text_fragmentation", "limit", "offset", "oauth_token", "conversation_id", "filters", "exclude_filters", "index_hashes", "conversation_has_clip", "dataset_id"]
