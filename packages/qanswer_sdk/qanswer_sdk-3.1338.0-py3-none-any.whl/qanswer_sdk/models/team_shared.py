...
class TeamShared(BaseModel):
    """
    The team with their shared rights.
    """ # noqa: E501
    ...
    access_type: Optional[StrictStr] = Field(default=None, description="The access type to the team", alias="accessType")
    __properties: ClassVar[List[str]] = ["name", "description", "id", "organizationId", "accessType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TeamShared from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TeamShared from a dict"""
        if obj is None:
            return None
