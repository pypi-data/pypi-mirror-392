...
#define NEURON_DATA_DIR "/tmp/tmpsxkicvjk/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpsxkicvjk/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-1zpygn92/bin/python)"};
