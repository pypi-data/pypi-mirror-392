...
#define NEURON_DATA_DIR "/tmp/tmptxarcq8l/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmptxarcq8l/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-gdjtpkj0/bin/python)"};
