...
#define NEURON_DATA_DIR "/tmp/tmpkfv7kewo/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpkfv7kewo/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-h2j1lbbi/bin/python)"};
