...
#define NEURON_DATA_DIR "/tmp/tmp22tsgvwq/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp22tsgvwq/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-wbopngrh/bin/python)"};
