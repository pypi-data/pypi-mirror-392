...
#define NEURON_DATA_DIR "/tmp/tmpxzg66zp3/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpxzg66zp3/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-rr6dhf6u/bin/python)"};
