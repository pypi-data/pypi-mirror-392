...
#define NEURON_DATA_DIR "/tmp/tmpzdnnymn9/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpzdnnymn9/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-oxrd0gry/bin/python)"};
