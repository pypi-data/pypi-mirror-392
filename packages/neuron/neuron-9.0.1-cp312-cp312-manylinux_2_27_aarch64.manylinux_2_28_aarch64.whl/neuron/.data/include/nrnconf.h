...
#define NEURON_DATA_DIR "/tmp/tmponp319xj/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmponp319xj/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-ox6c0t6p/bin/python)"};
