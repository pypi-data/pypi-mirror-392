...
#define NEURON_DATA_DIR "/tmp/tmpx_vq39u1/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpx_vq39u1/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-6uulnj_p/bin/python)"};
