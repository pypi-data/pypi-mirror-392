...
#define NEURON_DATA_DIR "/tmp/tmprazuonxp/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmprazuonxp/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-ye281p8e/bin/python)"};
