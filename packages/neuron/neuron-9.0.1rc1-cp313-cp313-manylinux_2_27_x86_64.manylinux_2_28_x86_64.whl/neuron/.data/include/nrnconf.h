...
#define NEURON_DATA_DIR "/tmp/tmp_zsddfas/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp_zsddfas/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-fu8zu4am/bin/python)"};
