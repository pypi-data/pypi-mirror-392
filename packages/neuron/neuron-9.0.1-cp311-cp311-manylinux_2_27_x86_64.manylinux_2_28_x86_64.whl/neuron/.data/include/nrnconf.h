...
#define NEURON_DATA_DIR "/tmp/tmpv3g1joa9/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpv3g1joa9/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-dg83dgtp/bin/python)"};
