...
#define NEURON_DATA_DIR "/tmp/tmp8wzj3bhr/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp8wzj3bhr/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-o_cjpjir/bin/python)"};
