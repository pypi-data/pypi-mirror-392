...
#define NEURON_DATA_DIR "/tmp/tmpgn2zfqrn/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpgn2zfqrn/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-ljgk0b97/bin/python)"};
