...
#define NEURON_DATA_DIR "/tmp/tmpsouathhp/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpsouathhp/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-_92xgf6u/bin/python)"};
