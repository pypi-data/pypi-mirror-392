...
#define NEURON_DATA_DIR "/tmp/tmpr8zyuikz/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpr8zyuikz/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-mbg_mdwt/bin/python)"};
