...
#define NEURON_DATA_DIR "/tmp/tmpoyofjvb9/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpoyofjvb9/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-4kueer4a/bin/python)"};
