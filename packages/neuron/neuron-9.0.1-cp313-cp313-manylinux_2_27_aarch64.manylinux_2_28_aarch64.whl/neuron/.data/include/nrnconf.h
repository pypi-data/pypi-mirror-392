...
#define NEURON_DATA_DIR "/tmp/tmpp0zqdw4t/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpp0zqdw4t/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-4lhgomik/bin/python)"};
