...
#define NEURON_DATA_DIR "/tmp/tmpp4tzygdw/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpp4tzygdw/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-3xw8sexy/bin/python)"};
