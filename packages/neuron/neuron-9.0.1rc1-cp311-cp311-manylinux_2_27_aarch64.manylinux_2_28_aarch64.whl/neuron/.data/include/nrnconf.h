...
#define NEURON_DATA_DIR "/tmp/tmph19t4qkc/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmph19t4qkc/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-3lhn_hlo/bin/python)"};
