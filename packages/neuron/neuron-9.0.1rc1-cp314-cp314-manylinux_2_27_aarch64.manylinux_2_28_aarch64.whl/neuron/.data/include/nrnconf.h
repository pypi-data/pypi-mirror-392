...
#define NEURON_DATA_DIR "/tmp/tmp_0iazsm0/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp_0iazsm0/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-khn0v00l/bin/python)"};
