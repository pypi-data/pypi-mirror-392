...
#define NEURON_DATA_DIR "/tmp/tmpfu9igldz/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpfu9igldz/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-cq4p_8_s/bin/python)"};
