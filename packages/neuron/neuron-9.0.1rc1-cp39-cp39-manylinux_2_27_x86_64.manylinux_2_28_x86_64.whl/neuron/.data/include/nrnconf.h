...
#define NEURON_DATA_DIR "/tmp/tmps3z2gh6b/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmps3z2gh6b/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-mouso8dn/bin/python)"};
