...
#define NEURON_DATA_DIR "/tmp/tmp2gsjvnid/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp2gsjvnid/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-el52hy_x/bin/python)"};
