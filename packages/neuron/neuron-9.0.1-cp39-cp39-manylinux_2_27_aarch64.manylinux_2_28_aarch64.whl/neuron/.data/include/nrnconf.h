...
#define NEURON_DATA_DIR "/tmp/tmp8v7e4_pz/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp8v7e4_pz/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-nzd_r1jy/bin/python)"};
