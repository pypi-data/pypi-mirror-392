...
Primary use case: Automating "Run > Unsteady Flow Analysis > Compute" workflow
for floodplain mapping operations that require GUI execution.

This module is part of the ras-commander library and uses a centralized logging configuration.

Classes:
    RasGuiAutomation: Static class for HEC-RAS GUI automation operations.
"""
