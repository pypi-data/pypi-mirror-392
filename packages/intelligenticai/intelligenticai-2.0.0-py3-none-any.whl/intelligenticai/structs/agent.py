...
from intelligenticai.agents.ape_agent import auto_generate_prompt
from intelligenticai.artifacts.main_artifact import Artifact
from intelligenticai.prompts.agent_system_prompts import AGENT_SYSTEM_PROMPT_3
from intelligenticai.prompts.max_loop_prompt import generate_reasoning_prompt
from intelligenticai.prompts.multi_modal_autonomous_instruction_prompt import (
    MULTI_MODAL_AUTO_AGENT_SYSTEM_PROMPT_1,
)
from intelligenticai.prompts.react_base_prompt import REACT_SYS_PROMPT
from intelligenticai.prompts.safety_prompt import SAFETY_PROMPT
from intelligenticai.prompts.tools import tool_sop_prompt
from intelligenticai.schemas.agent_mcp_errors import (
    AgentMCPConnectionError,
    AgentMCPToolError,
)
from intelligenticai.schemas.agent_step_schemas import ManySteps, Step
from intelligenticai.schemas.base_schemas import (
    AgentChatCompletionResponse,
)
from intelligenticai.schemas.conversation_schema import ConversationSchema
from intelligenticai.schemas.mcp_schemas import (
    MCPConnection,
    MultipleMCPConnections,
)
from intelligenticai.structs.agent_roles import agent_roles
...
from intelligenticai.structs.safe_loading import (
    SafeLoaderUtils,
    SafeStateManager,
)
from intelligenticai.structs.transforms import (
    MessageTransforms,
    TransformConfig,
    handle_transforms,
)
from intelligenticai.telemetry.main import log_agent_data
...
from intelligenticai.utils.data_to_text import data_to_text
from intelligenticai.utils.dynamic_context_window import dynamic_auto_chunking
...
from intelligenticai.utils.index import (
    exists,
...
from intelligenticai.utils.agent_groups_marketplace_utils import (
...
class Agent:
    ...
    def __init__(
        ...
        agent_name: Optional[str] = "agent_group-worker-01",
    ...
    def _handle_run_error(self, error: any):
        ...
        logger.error(
            ...
            f"Please optimize your input parameters, or create an issue on the AgentGroups GitHub and contact our team on Discord for support. "
            f"For technical support, refer to this document: https://docs.agent_groups.world/en/latest/agent_groups/support/"
        )
        ...
        **kwargs,
        ...
        try:
            ...
            logger.warning(
                ...
                "For technical support, refer to this document: https://docs.agent_groups.world/en/latest/agent_groups/support/"
            )
