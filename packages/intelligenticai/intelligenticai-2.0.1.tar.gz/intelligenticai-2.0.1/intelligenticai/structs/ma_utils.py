...
from intelligenticai.prompts.collaborative_prompts import (
...
def list_all_agents(
    ...
    """Lists all agents in a agent_group and optionally adds them to a conversation.

    This function compiles information about all agents in a agent_group, including their names and descriptions.
    ...
    Args:
        ...
        name (str): Name of the agent_group/group of agents
    ...
    Example:
        ...
        >>> agent_info = list_all_agents(agents, conversation, "MyAgentGroup")
        >>> print(agent_info)
...
def set_random_models_for_agents(
    ...
    """Sets random models for agents in the agent_group or returns a random model name.
