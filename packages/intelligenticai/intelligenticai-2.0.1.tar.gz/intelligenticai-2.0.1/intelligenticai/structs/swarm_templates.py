...
logger = initialize_logger(log_folder="agent_group_templates")


class AgentGroupTemplates:
    """
    A comprehensive library of pre-built, production-ready agent_group templates for common use cases.
    ...
    Methods:
        ...
        create: Create a agent_group from a template name
    ...
    Example:
        >>> from intelligenticai.structs.agent_group_templates import AgentGroupTemplates
        >>>
        >>> # Create a research workflow
        >>> agent_group = AgentGroupTemplates.create(
        ...     "research_analysis_synthesis",
        ...     model_name="gpt-4o-mini"
        ... )
        >>> result = agent_group.run("Analyze the impact of AI on healthcare")
        >>> print(result)
        >>>
        >>> # List all available templates
        >>> templates = AgentGroupTemplates.list_templates()
    ...
    def list_templates(cls) -> List[Dict[str, str]]:
        """
        Get a list of all available agent_group templates with descriptions.
    ...
    def get_template_info(cls, template_name: str) -> Dict[str, Any]:
        ...
        Example:
            >>> info = AgentGroupTemplates.get_template_info("research_analysis_synthesis")
    ...
    def create(
        ...
        """
        Create a agent_group from a template name.
        ...
        Returns:
            Any: Configured agent_group workflow (SequentialWorkflow, AgentRearrange, etc.)
        ...
        Example:
            ...
            ...     max_loops=1
            ... )
            >>> result = agent_group.run("Analyze quantum computing trends")
        """
        ...
        logger.info(f"Creating agent_group template: {template_name}")
    ...
    def research_analysis_synthesis(
        ...
        Example:
            >>> agent_group = AgentGroupTemplates.research_analysis_synthesis(
            ...     model_name="gpt-4o-mini"
            ... )
            >>> result = agent_group.run("Research the latest trends in renewable energy")
            >>> print(result)
        """
        researcher = Agent(
...
- Balance depth with clarity and conciseness""",
    ...
    def content_creation_pipeline(
        ...
        Example:
            >>> agent_group = AgentGroupTemplates.content_creation_pipeline()
            >>> result = agent_group.run("Create a blog post about AI in healthcare")
            >>> print(result)
        """
        strategist = Agent(
...
- Provide final SEO recommendations and checklist""",
    ...
    def code_development_team(
        ...
        Example:
            >>> agent_group = AgentGroupTemplates.code_development_team()
            >>> result = agent_group.run("Create a REST API for user authentication")
            >>> print(result)
        """
...
- Highlight both strengths and areas for improvement""",
    ...
    def financial_analysis_team(
        ...
        Example:
            >>> agent_group = AgentGroupTemplates.financial_analysis_team()
            >>> result = agent_group.run("Analyze Tesla's Q4 2024 financial performance")
            >>> print(result)
        """
...
- Make the report accessible to non-financial stakeholders""",
    ...
    def marketing_campaign_team(
        ...
        Example:
            >>> agent_group = AgentGroupTemplates.marketing_campaign_team()
            >>> result = agent_group.run("Create a product launch campaign for an AI-powered fitness app")
            >>> print(result)
        """
        strategist = Agent(
...
- Provide implementation roadmap and next steps""",
    ...
    def customer_support_team(
        ...
        Example:
            >>> agent_group = AgentGroupTemplates.customer_support_team()
            >>> result = agent_group.run("Customer reports login issues after password reset")
            >>> print(result)
        """
...
- Include clear next steps if any action required""",
    ...
    def legal_document_review(
        ...
        Example:
            >>> agent_group = AgentGroupTemplates.legal_document_review()
            >>> result = agent_group.run("Review this software licensing agreement")
            >>> print(result)
        """
        legal_analyst = Agent(
...
- Summarize recommended next steps""",
    ...
    def data_science_pipeline(
        ...
        Example:
            >>> agent_group = AgentGroupTemplates.data_science_pipeline()
            >>> result = agent_group.run("Analyze customer churn data and identify key factors")
            >>> print(result)
        """
        data_collector = Agent(
