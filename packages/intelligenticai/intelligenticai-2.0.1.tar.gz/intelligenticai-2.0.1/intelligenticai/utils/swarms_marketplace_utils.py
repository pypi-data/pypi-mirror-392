...
def add_prompt_to_marketplace(
    ...
    """
    Add a prompt to the AgentGroups marketplace.
    ...
    """
    try:
        url = "https://agent_groups.world/api/add-prompt"
        api_key = os.getenv("AGENT_GROUPS_API_KEY")
                    ...
                    if isinstance(error_body, dict):
                        if (
                            ...
                            logger.error(
                                ...
                                "1. Your AGENT_GROUPS_API_KEY environment variable is set correctly\n"
                                "2. Your API key is valid and not expired\n"
                                "3. You can verify your key at: https://agent_groups.world/platform/api-keys"
                            )
            except Exception:
                logger.error(
