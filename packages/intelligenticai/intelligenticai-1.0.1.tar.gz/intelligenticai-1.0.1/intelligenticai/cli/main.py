...
from intelligenticai.agents.auto_generate_swarm_config import (
...
def create_detailed_command_table() -> Table:
    ...
    commands = [
        ...
        },
        {
            ...
            "usage": "intelligentic autoswarm --task 'analyze data' --model gpt-4",
            "args": "--task, --model",
        },
        {
            "cmd": "setup-check",
...
def show_help():
    ...
    usage_panel = Panel(
        ...
        "• [yellow]intelligentic autoswarm --task 'analyze data' --model gpt-4[/yellow] - Auto-generate swarm",
