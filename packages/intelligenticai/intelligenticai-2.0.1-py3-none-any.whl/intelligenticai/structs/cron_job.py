...
class CronJob:
    """A wrapper class that turns any callable (including AgentGroups agents) into a scheduled cron job.
    ...
    Attributes:
        agent: The AgentGroups Agent instance or callable to be scheduled
