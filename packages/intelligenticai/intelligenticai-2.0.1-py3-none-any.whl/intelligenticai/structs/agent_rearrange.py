...
from intelligenticai.structs.multi_agent_exec import run_agents_concurrently
...
class AgentRearrange:
    ...
    def __init__(
        ...
        description: str = "A agent_group of agents for rearranging tasks.",
        ...
        Args:
            id (str): Unique identifier for the agent rearrange system.
                Defaults to a generated agent_group ID.
            name (str): Human-readable name for the system.
                Defaults to "AgentRearrange".
            description (str): Description of the system's purpose.
                Defaults to "A agent_group of agents for rearranging tasks.".
    ...
    def add_agent(self, agent: Agent):
        """
        Adds an agent to the agent_group.

        Args:
            agent (Agent): The agent to be added.
        """
        logger.info(f"Adding agent {agent.agent_name} to the agent_group.")
    ...
    def track_history(
        ...
        Records the result of an agent's execution in the agent_group history
        ...
        """
        self.agent_group_history[agent_name].append(result)

    def remove_agent(self, agent_name: str):
        """
        Removes an agent from the agent_group.
    ...
    def add_agents(self, agents: List[Agent]):
        """
        Adds multiple agents to the agent_group.
    ...
    def _run(
        ...
        **kwargs,
        ...
        """
        Runs the agent_group to rearrange the tasks according to the defined flow.
    ...
    def _catch_error(self, e: Exception):
        """
        Handles errors that occur during agent_group execution.
        ...
        during the execution of the agent_group.
        ...
        Note:
            If autosave is enabled, the current state of the agent_group will be
...
def rearrange(
    ...
    **kwargs,
    ...
    Example:
        >>> from intelligenticai import Agent, rearrange
        >>>
        >>> # Create agents
        >>> agent1 = Agent(name="researcher", ...)
        >>> agent2 = Agent(name="writer", ...)
