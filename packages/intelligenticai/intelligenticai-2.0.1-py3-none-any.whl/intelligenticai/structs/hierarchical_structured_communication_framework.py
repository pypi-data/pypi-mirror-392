...
# =============================================================================
# MAIN AGENT_GROUP ORCHESTRATOR
# =============================================================================


class HierarchicalStructuredCommunicationFramework(BaseAgentGroup):
    """
    Talk Structurally, Act Hierarchically: A Collaborative Framework for LLM Multi-Agent Systems
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            description: Description of the agent_group
        ...
        """
        # Initialize the agent_group components first
        self.name = name
        ...
        # Initialize the agent_group components
    ...
    def init_agent_group(self):
        ...
        logger.info(
            f"AgentGroup initialized with {len(self.generators)} generators, "
