...
class IterativeReflectiveExpansion:
    ...
    This algorithm leverages a AgentGroups agent to iteratively generate, simulate, reflect on, and refine reasoning paths
    ...
    def __init__(
        ...
        :param agent: The AgentGroups agent instance used to perform reasoning tasks.
