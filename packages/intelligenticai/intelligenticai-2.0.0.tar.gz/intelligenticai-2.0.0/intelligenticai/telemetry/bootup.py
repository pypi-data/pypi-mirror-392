...
from intelligenticai.utils.disable_logging import disable_logging
from loguru import logger


def bootup():
    """Super-fast initialization of agent_groups environment"""
    try:
        # Cache env vars
        verbose = os.getenv("AGENT_GROUPS_VERBOSE_GLOBAL", "False").lower()
