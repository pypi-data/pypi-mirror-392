...
class TerminalLLMChat:
    ...
    def __init__(self) -> None:
        ...
        if local_config_dir.exists():
            ...
            logger.info(f"Using local config directory: {self.config_dir}")
        else:
            self.config_dir = Path.home() / ".kollabor"
            logger.info(f"Using global config directory: {self.config_dir}")
