...
class InputConfig:
    ...
    def __post_init__(self):
        ...
        if self.gradient_colors is None:
            self.gradient_colors = ["#1e3a8a", "#1e40af", "#1d4ed8"]
    ...
    def from_config_manager(cls, config: 'ConfigManager') -> 'InputConfig':
        ...
        return cls(
            ...
            border_color=colors_config.get("border", "default"),
            text_color=colors_config.get("text", "default"),
            placeholder_color=colors_config.get("placeholder", "dim"),
            gradient_mode=colors_config.get("gradient_mode", False),
            gradient_colors=colors_config.get("gradient_colors", ["#1e3a8a", "#1e40af", "#1d4ed8"]),
            border_gradient=colors_config.get("border_gradient", True),
            text_gradient=colors_config.get("text_gradient", False)
        )
