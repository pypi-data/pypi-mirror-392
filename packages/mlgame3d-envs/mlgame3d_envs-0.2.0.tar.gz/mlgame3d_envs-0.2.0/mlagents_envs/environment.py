...
class UnityEnvironment(BaseEnv):
    ...
    def _check_communication_compatibility(
        ...
        if unity_communicator_version._version[0] == 0:
            if (
                unity_communicator_version._version[0] != api_version._version[0]
                or unity_communicator_version._version[1] != api_version._version[1]
            ):
                # Minor beta versions differ.
                return False
        elif unity_communicator_version._version[0] != api_version._version[0]:
