...
from spoox.agents.UbuntuMASGroupAgent.Supervisor.agents.utils import get_SMAS_APPROVER_SYSTEM_MESSAGE
from spoox.environment.Environment import Environment
from spoox.interface.Interface import Interface


class SMASApproverAgent(BaseGroupChatAgent):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            system_message=get_SMAS_APPROVER_SYSTEM_MESSAGE(topic_type, supervisor_agent_topic_type),
