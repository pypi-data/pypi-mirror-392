...
from spoox.agents.UbuntuMASGroupAgent.Supervisor.agents.utils import get_SMAS_PLAN_EXECUTOR_SYSTEM_MESSAGE
from spoox.environment.Environment import Environment
from spoox.interface.Interface import Interface


class SMASPlanExecutorAgent(BaseGroupChatAgent):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            description="Agent tasked to execute a given plan via its tools.",
            system_message=get_SMAS_PLAN_EXECUTOR_SYSTEM_MESSAGE(topic_type, supervisor_agent_topic_type,
