...
from minerva.base.vectorstores.model import LCVectorStoreComponent, check_cached_vector_store
from minerva.helpers import docs_to_data
from minerva.inputs import FloatInput, NestedDictInput
...
class AstraDBVectorStoreComponent(LCVectorStoreComponent):
    ...
    documentation: str = "https://docs.datastax.com/en/minerva/astra-components.html"
    name = "AstraDB"
    icon: str = "AstraDB"
    ...
    def build_vector_store(self):
        ...
        # Get Minerva version and platform information
        ...
        try:
            vector_store = AstraDBVectorStore(
                ...
                ext_callers=[(f"{minerva_prefix}minerva", __version__)],
