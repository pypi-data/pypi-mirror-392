...
from minerva.inputs.inputs import MessageTextInput
from minerva.memory import aget_messages, astore_message
...
class MessageStoreComponent(Component):
    ...
    description = "Stores a chat message or text into Minerva tables or an external memory."
    ...
    inputs = [
        ...
        HandleInput(
            ...
            input_types=["Memory"],
            info="The external memory to store the message. If empty, it will use the Minerva tables.",
        ),
        MessageTextInput(
            name="sender",
            display_name="Sender",
