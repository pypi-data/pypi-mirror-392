...
from minerva.base.mcp.util import create_tool_coroutine, create_tool_func
from minerva.components.tools.mcp_stdio import create_input_schema_from_json_schema
from minerva.custom import Component
from minerva.field_typing import Tool
from minerva.io import MessageTextInput, Output
from minerva.utils.async_helpers import timeout_context
...
class MCPSse(Component):
    ...
    description = "Connects to an MCP server over SSE and exposes it's tools as minerva tools to be used by an Agent."
