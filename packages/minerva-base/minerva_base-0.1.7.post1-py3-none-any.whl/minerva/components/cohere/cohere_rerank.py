from minerva.base.compressors.model import LCCompressorComponent
from minerva.field_typing import BaseDocumentCompressor
from minerva.io import DropdownInput
