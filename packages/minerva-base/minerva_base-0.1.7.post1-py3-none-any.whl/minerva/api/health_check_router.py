...
from minerva.api.utils import DbSession
from minerva.services.database.models.flow import Flow
from minerva.services.deps import get_chat_service
...
# it means uvicorn's /health serves first before the minerva instance is up
# therefore it's not a reliable health check for a minerva instance
...
# It's a reliable health check for a minerva instance
