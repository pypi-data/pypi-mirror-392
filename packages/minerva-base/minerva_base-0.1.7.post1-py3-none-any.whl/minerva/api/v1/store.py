...
from minerva.api.utils import CurrentActiveUser, check_minerva_version
from minerva.services.auth import utils as auth_utils
from minerva.services.deps import get_settings_service, get_store_service
from minerva.services.store.exceptions import CustomError
...
async def share_component(
    ...
    try:
        await check_minerva_version(component)
