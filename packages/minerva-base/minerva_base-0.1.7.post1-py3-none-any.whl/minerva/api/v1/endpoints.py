...
from minerva.api.utils import CurrentActiveUser, DbSession, parse_value
from minerva.api.v1.schemas import (
    ConfigResponse,
...
from minerva.custom.utils import build_custom_component_template, get_instance_name, update_component_build_config
from minerva.events.event_manager import create_stream_tokens_event_manager
from minerva.exceptions.api import APIException, InvalidChatInputError
from minerva.exceptions.serialization import SerializationError
from minerva.graph.graph.base import Graph
from minerva.graph.schema import RunOutputs
from minerva.helpers.flow import get_flow_by_id_or_endpoint_name
from minerva.helpers.user import get_user_by_flow_id_or_endpoint_name
from minerva.interface.initialize.loading import update_params_with_load_from_db_fields
from minerva.processing.process import process_tweaks, run_graph_internal
from minerva.schema.graph import Tweaks
from minerva.services.auth.utils import api_key_security, get_current_active_user
from minerva.services.cache.utils import save_uploaded_file
from minerva.services.database.models.flow import Flow
from minerva.services.database.models.flow.model import FlowRead
from minerva.services.database.models.flow.utils import get_all_webhook_components_in_flow
from minerva.services.database.models.user.model import User, UserRead
from minerva.services.deps import get_session_service, get_settings_service, get_task_service, get_telemetry_service
from minerva.services.settings.feature_flags import FEATURE_FLAGS
from minerva.services.telemetry.schema import RunPayload
from minerva.utils.version import get_version_info

if TYPE_CHECKING:
    from minerva.services.event_manager import EventManager
...
# get endpoint to return version of minerva
@router.get("/version")
