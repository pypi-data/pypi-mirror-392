...
from minerva.events.event_manager import EventManager, create_default_event_manager
from minerva.exceptions.component import ComponentBuildError
from minerva.graph.graph.base import Graph
from minerva.graph.utils import log_vertex_build
from minerva.schema.message import ErrorMessage
...
from minerva.services.deps import get_chat_service, get_session, get_telemetry_service, session_scope
from minerva.services.telemetry.schema import ComponentPayload, PlaygroundPayload

if TYPE_CHECKING:
    from minerva.graph.vertex.vertex_types import InterfaceVertex
...
async def try_running_celery_task(vertex, user_id):
    ...
    try:
        from minerva.worker import build_vertex
