...
from minerva.inputs.validators import CoalesceBool
from minerva.schema.data import Data
from minerva.schema.message import Message
from minerva.services.database.models.message.model import MessageBase
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the Minerva system.

    This component is used to handle text inputs in the Minerva system.
