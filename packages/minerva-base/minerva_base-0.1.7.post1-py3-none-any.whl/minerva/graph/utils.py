...
from minerva.interface.utils import extract_input_variables_from_prompt
...
from minerva.services.database.models.transactions.crud import log_transaction as crud_log_transaction
from minerva.services.database.models.transactions.model import TransactionBase
from minerva.services.database.models.vertex_builds.crud import log_vertex_build as crud_log_vertex_build
from minerva.services.database.models.vertex_builds.model import VertexBuildBase
...
if TYPE_CHECKING:
    from minerva.api.v1.schemas import ResultDataResponse
...
def has_chat_output(vertices: dict[Vertex, int]):
    from minerva.graph.schema import InterfaceComponentTypes
