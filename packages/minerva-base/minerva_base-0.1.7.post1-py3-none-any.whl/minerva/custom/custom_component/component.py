...
from minerva.base.tools.constants import (
...
from minerva.custom.tree_visitor import RequiredInputsVisitor
from minerva.exceptions.component import StreamingError
from minerva.field_typing import Tool  # noqa: TC001 Needed by _add_toolkit_output
from minerva.graph.state.model import create_state_model
from minerva.graph.utils import has_chat_output
from minerva.helpers.custom import format_type
from minerva.memory import astore_message, aupdate_messages, delete_message
from minerva.schema.artifact import get_artifact_type, post_process_raw
from minerva.schema.data import Data
from minerva.schema.message import ErrorMessage, Message
from minerva.schema.properties import Source
from minerva.schema.table import FieldParserType, TableOptions
from minerva.services.tracing.schema import Log
from minerva.template.field.base import UNDEFINED, Input, Output
from minerva.template.frontend_node.custom_components import ComponentFrontendNode
from minerva.utils.async_helpers import run_until_complete
from minerva.utils.util import find_closest_match
...
if TYPE_CHECKING:
    ...
    from minerva.inputs.inputs import InputTypes
...
class Component(CustomComponent):
    ...
    async def _build_tools_metadata_input(self):
        ...
        try:
            from minerva.io import TableInput
        except ImportError as e:
            msg = "Failed to import TableInput from minerva.io"
