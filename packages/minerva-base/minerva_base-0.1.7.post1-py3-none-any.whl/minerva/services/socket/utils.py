...
from minerva.services.deps import get_session


def set_socketio_server(socketio_server) -> None:
    from minerva.services.deps import get_socket_service
