...
from minerva.services.database import models
from minerva.services.database.models.user.crud import get_user_by_username
from minerva.services.database.utils import Result, TableResults
...
class DatabaseService(Service):
    ...
    def __init__(self, settings_service: SettingsService):
        ...
        # This file is in minerva.services.database.manager.py
        # the ini is in minerva
        minerva_dir = Path(__file__).parent.parent.parent
        self.script_location = minerva_dir / "alembic"
        self.alembic_cfg_path = minerva_dir / "alembic.ini"
        ...
        if Path(alembic_log_file).is_absolute():
            ...
            self.alembic_log_path = Path(minerva_dir) / alembic_log_file
