# Path: src/backend/minerva/services/database/models/flow/model.py
...
if TYPE_CHECKING:
    from minerva.services.database.models import TransactionTable
    from minerva.services.database.models.folder import Folder
    from minerva.services.database.models.message import MessageTable
