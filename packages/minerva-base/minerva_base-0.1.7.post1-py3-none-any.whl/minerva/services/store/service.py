...
from minerva.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
from minerva.services.store.schema import (
...
from minerva.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.minerva.store/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates minerva with the store which is a Directus instance.
