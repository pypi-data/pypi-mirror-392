...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(self, trace_name: str, trace_type: str, project_name: str, trace_id: UUID):
        ...
        try:
            ...
            self.root_span.set_attribute("minerva.project.name", self.project_name)
            self.root_span.set_attribute("minerva.flow.name", self.flow_name)
            self.root_span.set_attribute("minerva.flow.id", self.flow_id)
