...
from minerva.services.schema import ServiceType
...
if TYPE_CHECKING:
    ...
    from minerva.services.cache.service import AsyncBaseCacheService, CacheService
    from minerva.services.chat.service import ChatService
    from minerva.services.database.service import DatabaseService
    from minerva.services.session.service import SessionService
    from minerva.services.settings.service import SettingsService
    from minerva.services.socket.service import SocketIOService
    from minerva.services.state.service import StateService
    from minerva.services.storage.service import StorageService
    from minerva.services.store.service import StoreService
    from minerva.services.task.service import TaskService
    from minerva.services.telemetry.service import TelemetryService
    from minerva.services.tracing.service import TracingService
    from minerva.services.variable.service import VariableService
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from minerva.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from minerva.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from minerva.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from minerva.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from minerva.services.variable.factory import VariableServiceFactory
...
def get_settings_service() -> SettingsService:
    ...
    """
    from minerva.services.settings.factory import SettingsServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from minerva.services.database.factory import DatabaseServiceFactory
...
def get_cache_service() -> CacheService | AsyncBaseCacheService:
    ...
    """
    from minerva.services.cache.factory import CacheServiceFactory
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from minerva.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from minerva.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from minerva.services.task.factory import TaskServiceFactory
