...
from minerva.services.chat.config import ChatConfig
...
def set_langchain_cache(settings) -> None:
    ...
    from minerva.interface.importing.utils import import_class

    if cache_type := os.getenv("MINERVA_LANGCHAIN_CACHE"):
        try:
