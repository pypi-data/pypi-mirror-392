...
from minerva.logging.logger import InterceptHandler


class MinervaUvicornWorker(UvicornWorker):
...
class MinervaApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "minerva.server.MinervaUvicornWorker"
