...
def wrap_group_function(func: Callable[[], None], group_name: str, label: str) -> Callable[[TestFramework], None]:
    """
...
def make_wrapped_test(test_func: Callable, test_name: str, group_name: str) -> Callable[[TestFramework], None]:
    """
