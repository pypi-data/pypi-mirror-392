        ...
        if GPA.pai_tracker.member_vars["mode"] == "p" and dendrite_module.mode == "p":
            ...
            if dendrite_module.candidate_processors != []:
                try:
                    ...
                    print(f'Your candidate pre_d processor for {dendrite_module.name} caused this error')
            ...
            if dendrite_module.candidate_processors != []:
                try:
                    ...
                    traceback.print_exc(limit=None, chain=True)
                    print(f'Your post_d processor for {dendrite_module.name} caused this error')
                    print(f'You must check how this is defined and ensure that it is properly')
