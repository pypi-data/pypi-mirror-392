...
class TestCompileOnly:
    ...
    @pytest.mark.skip(reason="compile_source() removed - use run_with_proof() instead")
    def test_compile_minimal_program(self):
        """Test compiling a minimal valid RLang program.
        
        SKIPPED: compile_source() removed - use run_with_proof() instead.
        """
        pass
...
class TestRunWithProof:
    ...
    def test_run_with_proof_raises_when_backend_unavailable(self):
        ...
        from semantic_compiler_core.rlang_runtime import run_with_proof, is_backend_available
...
class TestBundleToDict:
    ...
    def test_bundle_to_dict_with_dict_input(self):
        ...
        from semantic_compiler_core.rlang_runtime import bundle_to_dict
...
class TestHashExtraction:
    ...
    def test_extract_hashes_top_level_keys(self):
        ...
        from semantic_compiler_core.rlang_runtime import extract_hashes
    ...
    def test_extract_hashes_from_raw_bundle(self):
        ...
        from semantic_compiler_core.rlang_runtime import run_with_proof, extract_hashes
...
class TestBackendSafeImport:
    ...
    def test_runtime_error_on_unavailable_backend(self):
        ...
        # Should raise RuntimeError with same message pattern
        with pytest.raises(RuntimeError, match="not available"):
...
class TestRLangRuntimeClass:
    ...
    def test_runtime_class_initialization(self):
        ...
        from semantic_compiler_core.rlang_runtime import RLangRuntime
