    ...
    def save_outputs(self, path: str = "test_outputs", subfolder: str | None = None,
        ...
        for i, output in enumerate(self.binary_output):
            ...
            for j, entry in enumerate(output):
                file_name: str = f"binary_output_{i}_{j}{ext}"
            ...
            if binary_zip:
                ...
                with open(os.path.join(output_path, f"{i}_remaining_{total_output - 5}_binary_results.zip"), "wb") as f:
                    f.write(zip_file)
        ...
        for i, output in enumerate(self.json_output):
            ...
            total_output: int = len(output)
            for j, entry in enumerate(output):
                file_name: str = f"json_output_{i}_{j}.json"
                if j >= 5 and total_output > 6:
            ...
            if json_zip:
                ...
                with open(os.path.join(output_path, f"{i}_remaining_{total_output - 5}_json_results.zip"), "wb") as f:
                    f.write(zip_file)
        ...
        for i, output in enumerate(self.text_output):
            ...
            total_output: int = len(output)
            for j, entry in enumerate(output):
                file_name: str = f"text_output_{i}_{j}.txt"
                if j >= 5 and total_output > 6:
            ...
            if text_zip:
                ...
                with open(os.path.join(output_path, f"{i}_remaining_{total_output - 5}_text_results.zip"), "wb") as f:
                    f.write(zip_file)
