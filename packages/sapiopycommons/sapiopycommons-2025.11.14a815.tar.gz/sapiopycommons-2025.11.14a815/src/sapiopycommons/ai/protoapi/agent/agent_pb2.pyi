...
class ProcessStepRequestPbo(_message.Message):
    __slots__ = ("sapio_user", "agent_name", "pipeline_id", "pipeline_step_id", "invocation_id", "input_configs", "output_configs", "config_field_values", "dry_run", "verbose_logging", "external_credential", "input")
...
class AgentDetailsPbo(_message.Message):
    __slots__ = ("import_id", "name", "description", "output_data_type_name", "input_configs", "output_configs", "config_fields", "license_info", "category", "citation", "review_on_instance_field_names", "output_data_type_display_name", "output_type_fields")
