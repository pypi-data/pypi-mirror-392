NEURON {
POINT_PROCESS glia__dbbs__NMDA__autistic
	...
	RANGE diffuse,Trelease,lamd, Diff, M, Rd, nd, syntype, gmax_factor, difwave_init
}
...
INITIAL {
	...
	T  = 0
	numpulses=0
	:printf("difwave init %4.2f", difwave_init)
