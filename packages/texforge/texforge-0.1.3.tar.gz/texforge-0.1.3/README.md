...
3. **texforge compile** - Smart LaTeX compilation
...
4. **texforge init** - Project scaffolding
...
- [Brainstorming Guide](docs/BRAINSTORMING_GUIDE.md) - Steps 2-3
- [APS Review Guide](docs/APS_REVIEW_GUIDE.md) - Step 5
- [Cover Letter Guide](docs/COVER_LETTER_GUIDE.md) - Step 6
