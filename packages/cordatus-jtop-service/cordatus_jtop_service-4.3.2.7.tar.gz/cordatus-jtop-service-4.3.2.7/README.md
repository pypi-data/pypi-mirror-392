...
_Don't forget to **logout/login** or **reboot** your board for group permissions to take effect_

### Original jetson-stats

The original jetson-stats can be installed with [pip](https://pip.pypa.io), but need **superuser**:
