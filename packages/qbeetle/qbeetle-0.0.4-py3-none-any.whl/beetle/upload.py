from beetle import _server, SETTINGS, path
from beetle._aws import upload_file, upload_folder_contents
from beetle_runtime import BeetleError
from beetle_runtime.platform import is_linux
...
def _upload_repo(username, password):
    ...
    unexpected_response = lambda: BeetleError(
