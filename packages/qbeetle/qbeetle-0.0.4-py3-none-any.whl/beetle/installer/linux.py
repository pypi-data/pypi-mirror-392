...
from beetle.installer import _generate_installer_resources
from beetle.resources import get_icons
from beetle_runtime.platform import is_arch_linux
...
def run_fpm(output_type):
    ...
    try:
        ...
        raise FileNotFoundError(
            "beetle could not find executable 'fpm'. Please install fpm using the "
            "instructions at "
