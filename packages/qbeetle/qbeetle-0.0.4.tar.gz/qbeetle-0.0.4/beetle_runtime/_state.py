"""
This INTERNAL module is used to manage beetle_runtime's global state. Having it
here, in one central place, allows beetle's test suite to manipulate the state to
