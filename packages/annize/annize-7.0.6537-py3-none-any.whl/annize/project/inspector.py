...
class FullInspector(BasicInspector):
    ...
    def creatable_type_info(self, for_type: type) -> "CreatableTypeInfo":
        ...
        for type_info in self.__all_creatable_types():
            if FullInspector.__type_full_name(type_info.type) == FullInspector.__type_full_name(for_type):
                return type_info
    ...
    def __all_creatable_types(self, *, with_value_types: bool = True) -> t.Sequence["FullInspector.CreatableTypeInfo"]:
        ...
        for feature_name in self.__feature_loader.all_available_feature_names():
    ...
    @staticmethod
    def __type_full_name(for_type: type) -> str:
        return f"{for_type.__module__}.{for_type.__qualname__}"
